...
./scripts/bmm-auto.py run brainstorm-project
```
...
```bash
# Phase 0: Discovery
./scripts/bmm-auto.py run brainstorm-project  # Creative exploration
./scripts/bmm-auto.py run research             # Technical analysis
./scripts/bmm-auto.py run product-brief        # Strategic planning

# Phase 1: Planning
./scripts/bmm-auto.py run prd                  # Requirements
./scripts/bmm-auto.py run validate-prd         # Validation
./scripts/bmm-auto.py run create-design        # UX Design

# Phase 2: Solutioning
./scripts/bmm-auto.py run create-architecture  # Architecture
./scripts/bmm-auto.py run test-design          # Test strategy
./scripts/bmm-auto.py run validate-architecture
./scripts/bmm-auto.py run create-epics-and-stories
./scripts/bmm-auto.py run implementation-readiness

# Phase 3: Implementation
./scripts/bmm-auto.py run sprint-planning
```
