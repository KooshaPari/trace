...
### 1. `scripts/bmm-auto.py` (632 lines)
...
### 3. `scripts/QUICKSTART.md` (175 lines)
...
### 4. `scripts/ARCHITECTURE.md` (150 lines)
...
# Run all workflows
/path/to/trace/scripts/bmm-auto.py run
