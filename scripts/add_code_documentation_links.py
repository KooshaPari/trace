...
def get_module_doc_link(filepath: str) -> Optional[Dict[str, str]]:
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"Code Documentation Linking Complete")
    print(f"Files processed: {total_processed}")
    print(f"Files updated: {files_updated}")
    print(f"Index generated: docs/code-documentation-index.md")
    print(f"{'='*70}")
