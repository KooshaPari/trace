...
CLI_COMMANDS = [
    "agents", "history", "query", "sync", "import_cmd", "link", "design",
    "export", "backup", "chaos", "benchmark", "drill", "droid", "dashboard",
    "cursor", "db", "config", "install", "list", "metrics", "monitor",
    "progress", "purge", "repair", "restore", "search", "stats", "trace",
    "verify", "view", "watch", "mvp_shortcuts"
]


# Service modules that need tests
SERVICE_MODULES = [
    "stateless_ingestion_service", "advanced_traceability_enhancements_service",
    "chaos_mode_service", "shortest_path_service", "graph_analysis_service",
    "sync_service", "auto_link_service", "agent_coordination_service",
    "agent_metrics_service", "agent_monitoring_service", "agent_performance_service",
    "api_webhooks_service", "benchmark_service", "bulk_operation_service",
    "bulk_service", "cache_service", "commit_linking_service",
    "conflict_resolution_service", "dependency_analysis_service",
    "drill_down_service", "export_service", "file_watcher_service",
    "graph_service", "history_service", "import_service", "ingestion_service",
    "link_service", "metrics_service", "notification_service",
    "progress_tracking_service", "purge_service", "query_service",
    "repair_service", "search_service", "stats_service", "storage_service",
    "trace_service", "traceability_service", "verification_service",
    "view_service", "watch_service", "advanced_analytics_service",
    "advanced_traceability_service", "cycle_detection_service"
]
...
# Storage modules
STORAGE_MODULES = [
    "local_storage", "file_watcher", "sync_engine",
    "item_repository", "project_repository", "link_repository",
    "agent_repository", "event_repository"
]
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Phase 3 Test Generation Complete!")
    print(f"{'='*60}")
