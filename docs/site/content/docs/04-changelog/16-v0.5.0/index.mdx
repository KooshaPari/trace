---
title: "v0.5.0"
description: "Documentation for v0.5.0"
---
...
```bash
tracertm migrate --to v0.5.0
```

### Verify Migration

```bash
tracertm verify --version v0.5.0
```
...
[View on GitHub](https://github.com/tracertm/tracertm/releases/tag/v0.5.0)
