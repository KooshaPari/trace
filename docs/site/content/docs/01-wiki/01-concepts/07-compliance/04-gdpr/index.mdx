...
description: "Documentation for GDPR Compliance"
---
...
Understanding GDPR Compliance compliance requirements and how TraceRTM helps achieve them.

## Introduction to GDPR Compliance

GDPR Compliance is a critical standard for ensuring safety and quality in software development.
...
tracertm report compliance --standard gdpr
```
...
```bash
tracertm evidence generate --standard gdpr
```
...
- [GDPR Compliance Standard Documentation](https://example.com)
