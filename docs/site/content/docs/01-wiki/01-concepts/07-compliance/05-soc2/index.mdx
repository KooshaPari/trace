---
title: "SOC 2"
description: "Documentation for SOC 2"
---
...
Understanding SOC 2 compliance requirements and how TraceRTM helps achieve them.

## Introduction to SOC 2

SOC 2 is a critical standard for ensuring safety and quality in software development.
...
tracertm report compliance --standard soc2
```
...
```bash
tracertm evidence generate --standard soc2
```
...
- [SOC 2 Standard Documentation](https://example.com)
