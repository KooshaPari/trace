---
title: "init Command"
description: "Documentation for init Command"
---
...
Comprehensive guide for init Command.

## Introduction

This guide covers everything you need to know about init Command.
...
```bash
tracertm init
tracertm config set init enabled
```
...
async function example() {
  const tracertm = new TraceRTM()
  const result = await tracertm.init()
  console.log(result)
}
```
