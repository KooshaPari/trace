---
title: "Log Analysis"
description: "Documentation for Log Analysis"
---
...
Comprehensive guide for Log Analysis.

## Introduction

This guide covers everything you need to know about Log Analysis.
...
```bash
tracertm init
tracertm config set logs enabled
```
...
async function example() {
  const tracertm = new TraceRTM()
  const result = await tracertm.logs()
  console.log(result)
}
```
