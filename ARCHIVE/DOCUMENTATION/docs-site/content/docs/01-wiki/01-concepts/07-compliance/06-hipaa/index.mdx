---
title: "HIPAA"
description: "Documentation for HIPAA"
---
...
Understanding HIPAA compliance requirements and how TraceRTM helps achieve them.

## Introduction to HIPAA

HIPAA is a critical standard for ensuring safety and quality in software development.
...
tracertm report compliance --standard hipaa
```
...
```bash
tracertm evidence generate --standard hipaa
```
...
- [HIPAA Standard Documentation](https://example.com)
