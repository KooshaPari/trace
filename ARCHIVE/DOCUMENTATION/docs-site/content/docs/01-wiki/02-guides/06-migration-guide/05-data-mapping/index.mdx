---
title: "Data Mapping"
description: "Documentation for Data Mapping"
---
...
Comprehensive guide for Data Mapping.

## Introduction

This guide covers everything you need to know about Data Mapping.
...
```bash
tracertm init
tracertm config set data.mapping enabled
```
...
```bash
# Step 1: Initialize
tracertm data-mapping init

# Step 2: Execute
tracertm data-mapping run

# Step 3: Verify
tracertm data-mapping status
```
...
**Solution:**
```bash
tracertm optimize data-mapping
```
...
async function example() {
  const tracertm = new TraceRTM()
  const result = await tracertm.datamapping()
  console.log(result)
}
```
