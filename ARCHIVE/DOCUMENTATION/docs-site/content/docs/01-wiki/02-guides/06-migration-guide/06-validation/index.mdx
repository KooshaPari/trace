...
description: "Documentation for Migration Validation"
---
...
Comprehensive guide for Migration Validation.

## Introduction

This guide covers everything you need to know about Migration Validation.
...
```bash
# Step 1: Initialize
tracertm validation init

# Step 2: Execute
tracertm validation run

# Step 3: Verify
tracertm validation status
```
