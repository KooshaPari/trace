...
export declare class CommandBuilder implements PromiseLike<CommandResult> {
    ...
    stdout(kind: dntShim.WritableStream<Uint8Array>, options?: dntShim.PipeOptions): CommandBuilder;
    /** Set the stderr kind. */
    stderr(kind: ShellPipeWriterKind): CommandBuilder;
    stderr(kind: dntShim.WritableStream<Uint8Array>, options?: dntShim.PipeOptions): CommandBuilder;
