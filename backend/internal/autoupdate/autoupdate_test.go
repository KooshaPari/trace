...
func TestNewUpdateChecker_WithEmptyConfig(t *testing.T) {
	...
	assert.NotNil(t, checker)
	assert.Equal(t, "", checker.config.UpdateServer)
	assert.Equal(t, "", checker.config.CurrentVersion)
...
func TestGetCurrentVersion(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			config := UpdateConfig{CurrentVersion: tc.version}
			checker := NewUpdateChecker(config)
...
func TestSetUpdateServer(t *testing.T) {
	config := UpdateConfig{UpdateServer: "https://old.example.com"}
	checker := NewUpdateChecker(config)
...
func TestSetUpdateServer_WithEmptyString(t *testing.T) {
	config := UpdateConfig{UpdateServer: "https://example.com"}
	checker := NewUpdateChecker(config)
...
func TestIsNewerVersion_Comparison(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			config := UpdateConfig{CurrentVersion: tc.currentVersion}
			checker := NewUpdateChecker(config)
...
func TestFetchLatestVersion_ServerError(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			defer server.Close()
			config := UpdateConfig{UpdateServer: server.URL}
			checker := NewUpdateChecker(config)
...
func TestFetchLatestVersion_NetworkError(t *testing.T) {
	config := UpdateConfig{UpdateServer: "http://invalid-server-that-doesnt-exist.local"}
	checker := NewUpdateChecker(config)
...
func TestDownloadAndInstall_NetworkError(t *testing.T) {
	config := UpdateConfig{UpdateServer: "http://invalid-server.local"}
	checker := NewUpdateChecker(config)
...
func TestUpdateConfig_ZeroValues(t *testing.T) {
	...
	assert.Equal(t, "", config.UpdateServer)
	assert.Equal(t, "", config.CurrentVersion)
