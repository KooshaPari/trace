...
func TestSaveMultipleDocEntities(t *testing.T) {
	...
	assert.Equal(t, 2, len(repo.savedEntities))
}
...
func TestDeleteDocEntity(t *testing.T) {
	...
	assert.Equal(t, 1, len(repo.deletedIDs))
...
func TestSaveTraceLink(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, 1, len(repo.savedLinks))
}
...
func TestDeleteTraceLink(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, 1, len(repo.deletedLinkIDs))
}
...
func TestSearchOptionsConfiguration(t *testing.T) {
	...
	assert.Equal(t, 2, len(opts.Types))
...
func TestDocEntityReferences(t *testing.T) {
	...
	assert.Equal(t, 2, len(entity.CodeRefs))
	assert.Equal(t, 1, len(entity.APIRefs))
	assert.Equal(t, 1, len(entity.InternalLinks))
...
func TestDocEntityEmbeddings(t *testing.T) {
	...
	assert.Equal(t, 768, len(entity.Embedding))
...
func TestDocEntityTags(t *testing.T) {
	...
	assert.Equal(t, 3, len(entity.Tags))
