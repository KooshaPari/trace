...
func (m *MockTemporalService) CreateBranch(ctx context.Context, branch *services.VersionBranch) (*services.VersionBranch, error) {
	...
	return args.Get(0).(*services.VersionBranch), args.Error(1)
}
...
func (m *MockTemporalService) CreateVersion(ctx context.Context, version *services.Version) (*services.Version, error) {
	...
	return args.Get(0).(*services.Version), args.Error(1)
}
...
func (m *MockTemporalService) GetItemVersion(ctx context.Context, itemID, versionID string) (*services.ItemVersionSnapshot, error) {
	...
	return args.Get(0).(*services.ItemVersionSnapshot), args.Error(1)
}

func (m *MockTemporalService) GetItemVersionHistory(ctx context.Context, itemID string, branchID string) ([]*services.ItemVersionSnapshot, error) {
...
func (m *MockTemporalService) GetItemAtTime(ctx context.Context, itemID string, timestamp time.Time) (*services.ItemVersionSnapshot, error) {
...
func (m *MockTemporalService) CreateAlternative(ctx context.Context, alt *services.ItemAlternative) (*services.ItemAlternative, error) {
	...
	return args.Get(0).(*services.ItemAlternative), args.Error(1)
}
...
func (m *MockTemporalService) CreateMergeRequest(ctx context.Context, mr *services.MergeRequest) (*services.MergeRequest, error) {
	...
	return args.Get(0).(*services.MergeRequest), args.Error(1)
}
...
func (m *MockTemporalService) ComputeMergeDiff(ctx context.Context, mrID string) (*services.VersionDiff, error) {
	...
	return args.Get(0).(*services.VersionDiff), args.Error(1)
}
...
func TestCreateBranch_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodPost, "/projects/proj-1/branches", map[string]interface{}{
		"name":        "main",
		"slug":        "main",
		"branch_type": "main",
		"created_by":  "user-1",
...
func TestGetBranch_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodGet, "/branches/branch-1", nil)
...
func TestListBranches_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodGet, "/projects/proj-1/branches", nil)
	c.SetParamNames("projectId")
	c.SetParamValues("proj-1")
...
func TestDeleteBranch_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodDelete, "/branches/branch-1", nil)
	c.SetParamNames("branchId")
	c.SetParamValues("branch-1")
...
func TestCreateVersion_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodPost, "/branches/branch-1/versions", map[string]interface{}{
		"project_id": "proj-1",
		"message":    "Initial version",
		"created_by": "user-1",
	})
...
func TestApproveVersion_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodPost, "/versions/ver-1/approve", map[string]interface{}{
...
func TestMergeBranches_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodPost, "/merge-requests/mr-1/merge", map[string]interface{}{
		"merged_by": "user-1",
	})
...
func TestListMergeRequests_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodGet, "/projects/proj-1/merge-requests", nil)
	c.SetParamNames("projectId")
	c.SetParamValues("proj-1")
...
func TestCompareVersions_Success(t *testing.T) {
	...
	c, rec := setupEchoContext(http.MethodGet, "/versions/ver-1/compare/ver-2", nil)
