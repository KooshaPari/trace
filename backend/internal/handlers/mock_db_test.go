...
func (m *MockQueries) ListProjects(ctx context.Context, arg db.ListProjectsParams) ([]db.Project, error) {
	...
	// Apply pagination
	//nolint:gosec //G115 - slice size won't exceed int32 max in tests
	if arg.Offset >= int32(len(projects)) {
...
func (m *MockQueries) ListItemsByProjectAndType(_ context.Context, _ db.ListItemsByProjectAndTypeParams) ([]db.ListItemsByProjectAndTypeRow, error) {
