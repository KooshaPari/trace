...
func TestJSONExporterBasic(t *testing.T) {
	...
	assert.Equal(t, 1, len(data.CanonicalConcepts))
...
func TestYAMLExporterBasic(t *testing.T) {
	...
	assert.Contains(t, content, "project_id:")
...
func TestExportRoundTrip(t *testing.T) {
	...
	assert.Equal(t, originalConcepts[0].Confidence, data.CanonicalConcepts[0].Confidence)
}
