...
func TestNewConfidenceScorer(t *testing.T) {
	...
	assert.Equal(t, 0.05, scorer.agreementBoostPerSignal)
	assert.Equal(t, 0.15, scorer.maxAgreementBoost)
	assert.Equal(t, 0.3, scorer.minConfidenceThreshold)
	assert.Equal(t, 0.99, scorer.maxConfidence)
}
...
func TestComputeConfidenceEmptyEvidence(t *testing.T) {
	...
	assert.Len(t, result.RawScores, 0)
}
...
func TestComputeConfidenceSingleStrategy(t *testing.T) {
	...
	// Assert
	assert.Equal(t, 0.7, result.BaseScore)
...
func TestComputeConfidenceExplicitAnnotation(t *testing.T) {
	...
	assert.Equal(t, 1.0, result.BaseScore)
}
...
func TestComputeConfidenceMultipleStrategies(t *testing.T) {
	...
	assert.Greater(t, len(result.Boosts), 0)
}
...
func TestComputeConfidenceAgreementBoost(t *testing.T) {
	...
	assert.Greater(t, len(multipleResult.Boosts), 0)
}
...
func TestNewConfidenceValidator(t *testing.T) {
	...
	assert.Equal(t, 0.3, validator.minThreshold)
	assert.Equal(t, 0.7, validator.requiresReviewMin)
	assert.Equal(t, 0.95, validator.autoConfirmMin)
}
