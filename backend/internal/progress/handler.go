...
func (h *Handler) createWithProjectID(
	...
	result, err := create(context.Background(), projID)
	if err != nil {
...
func (h *Handler) ListMilestones(w http.ResponseWriter, r *http.Request) {
	...
	milestones, err := h.milestoneService.GetMilestones(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetMilestone(w http.ResponseWriter, r *http.Request) {
	...
	milestone, err := h.milestoneService.GetMilestone(context.Background(), id)
	if err != nil {
...
func (h *Handler) UpdateMilestone(w http.ResponseWriter, r *http.Request) {
	...
	milestone, err := h.milestoneService.UpdateMilestone(context.Background(), id, &req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) DeleteMilestone(w http.ResponseWriter, r *http.Request) {
	...
	err = h.milestoneService.DeleteMilestone(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetMilestoneProgress(w http.ResponseWriter, r *http.Request) {
	...
	progress, err := h.milestoneService.GetMilestoneProgress(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) UpdateMilestoneHealth(w http.ResponseWriter, r *http.Request) {
	...
	err = h.milestoneService.UpdateMilestoneHealth(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) AddItemToMilestone(w http.ResponseWriter, r *http.Request) {
	...
	err = h.milestoneService.AddItemToMilestone(context.Background(), milestoneID, itemID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) RemoveItemFromMilestone(w http.ResponseWriter, r *http.Request) {
	...
	err = h.milestoneService.RemoveItemFromMilestone(context.Background(), milestoneID, itemID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) ListSprints(w http.ResponseWriter, r *http.Request) {
	...
	sprints, err := h.sprintService.GetSprints(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetSprint(w http.ResponseWriter, r *http.Request) {
	...
	sprint, err := h.sprintService.GetSprint(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusNotFound)
		return
	}
...
func (h *Handler) UpdateSprint(w http.ResponseWriter, r *http.Request) {
	...
	sprint, err := h.sprintService.UpdateSprint(context.Background(), id, &req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) DeleteSprint(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.DeleteSprint(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) CloseSprint(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.CloseSprint(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) RecordBurndown(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.RecordBurndown(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) UpdateSprintHealth(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.UpdateSprintHealth(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) AddItemToSprint(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.AddItemToSprint(context.Background(), sprintID, itemID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) RemoveItemFromSprint(w http.ResponseWriter, r *http.Request) {
	...
	err = h.sprintService.RemoveItemFromSprint(context.Background(), sprintID, itemID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetProjectMetrics(w http.ResponseWriter, r *http.Request) {
	...
	metrics, err := h.metricsService.CalculateProjectMetrics(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetVelocity(w http.ResponseWriter, r *http.Request) {
	...
	velocity, err := h.metricsService.CalculateVelocity(context.Background(), projID, periods)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetVelocityHistory(w http.ResponseWriter, r *http.Request) {
	...
	history, err := h.metricsService.GetVelocityHistory(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetCycleTime(w http.ResponseWriter, r *http.Request) {
	...
	cycleTime, err := h.metricsService.CalculateCycleTime(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) ListSnapshots(w http.ResponseWriter, r *http.Request) {
	...
	snapshots, err := h.snapshotService.GetSnapshots(context.Background(), projID, limit)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) CreateSnapshot(w http.ResponseWriter, r *http.Request) {
	...
	snapshot, err := h.snapshotService.RecordDailySnapshot(context.Background(), projID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *Handler) GetSnapshot(w http.ResponseWriter, r *http.Request) {
	...
	snapshot, err := h.snapshotService.GetSnapshot(context.Background(), id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusNotFound)
		return
	}
