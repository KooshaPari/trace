...
func TestGetProjectMetrics_Success(t *testing.T) {
	ms := &mockMetricsService{
		metrics: &ProjectMetrics{TotalItems: 42, ByStatus: map[string]int{}, ByPriority: map[string]int{}, ByType: map[string]int{}, ByLifecycle: map[string]int{}},
	}
