...
type BurndownData struct {
	ID              string    `gorm:"column:id;primaryKey;type:uuid" json:"id"`
	SprintID        string    `gorm:"column:sprint_id;type:uuid;not null;index:idx_burndown_data_sprint_id;index:idx_burndown_data_date,composite:recorded_date" json:"sprint_id"`
...
type ProgressSnapshot struct {
	ID           string         `gorm:"column:id;primaryKey;type:uuid" json:"id"`
	ProjectID    string         `gorm:"column:project_id;type:uuid;not null;index:idx_progress_snapshots_project_id;uniqueIndex:idx_progress_snapshots_unique,composite:snapshot_date" json:"project_id"`
	SnapshotDate time.Time      `gorm:"column:snapshot_date;not null;index:idx_progress_snapshots_date,composite:project_id" json:"snapshot_date"`
...
type VelocityHistory struct {
	ID              string    `gorm:"column:id;primaryKey;type:uuid" json:"id"`
	ProjectID       string    `gorm:"column:project_id;type:uuid;not null;index:idx_velocity_history_project_id;index:idx_velocity_history_period,composite:period_start" json:"project_id"`
...
type MilestoneDependency struct {
	...
	DependencyID     string    `gorm:"column:dependency_id;primaryKey;type:uuid;index:idx_milestone_dependencies_dependency_id" json:"dependency_id"`
