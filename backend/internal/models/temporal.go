...
type VersionBranch struct {
	...
	BranchType     string         `gorm:"column:branch_type;size:50;not null;default:'feature'" json:"branch_type"` // main, release, feature, experiment, hotfix, archive
	...
	Status         string         `gorm:"column:status;size:50;not null;default:'active'" json:"status"` // active, review, merged, abandoned, archived
...
type Version struct {
	...
	Status          string         `gorm:"column:status;size:50;not null;default:'draft'" json:"status"` // draft, pending_review, approved, rejected, superseded
...
type ItemVersion struct {
	...
	LastModifiedInVersionID *string        `gorm:"column:last_modified_in_version_id;type:uuid" json:"last_modified_in_version_id,omitempty"`
	CreatedAt               time.Time      `gorm:"column:created_at;not null;autoCreateTime" json:"created_at"`
...
type ItemAlternative struct {
	...
	Relationship      string         `gorm:"column:relationship;size:100;not null" json:"relationship"` // alternative_to, supersedes, experiment_of
	Description       *string        `gorm:"column:description;type:text" json:"description,omitempty"`
...
type MergeRequest struct {
	...
	BaseVersionID   *string        `gorm:"column:base_version_id;type:uuid" json:"base_version_id,omitempty"`
	Status          string         `gorm:"column:status;size:50;not null;default:'open'" json:"status"` // open, approved, merged, closed, conflict
