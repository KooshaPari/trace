...
func TestItemRepository_GetByID(t *testing.T) {
	...
	t.Run("get deleted item", func(t *testing.T) {
		...
		_ = repo.Create(ctx, deletedItem)
		_ = repo.Delete(ctx, "item-deleted")
...
func TestItemRepository_List(t *testing.T) {
	...
	runUnitListCase(ctx, t, "filter by priority", repo, unitFilterByPriority(models.PriorityHigh), func(t *testing.T, result []*models.Item) {
	...
	runUnitListCase(ctx, t, "combined filters", repo, unitFilterByProjectAndType("proj-1", "task"), func(t *testing.T, result []*models.Item) {
...
func TestItemRepository_Update(t *testing.T) {
	...
	t.Run("update item successfully", func(t *testing.T) {
		...
		updated, _ := repo.GetByID(ctx, "item-update")
...
func TestLinkRepository_DeleteByItemID(t *testing.T) {
	...
	t.Run("delete all links for item", func(t *testing.T) {
		...
		result, _ := repo.GetBySourceID(ctx, "item-del")
		assert.Empty(t, result)

		result, _ = repo.GetByTargetID(ctx, "item-del")
		assert.Empty(t, result)
...
func TestAgentRepository_UpdateStatus(t *testing.T) {
	...
	t.Run("update agent status", func(t *testing.T) {
		...
		updated, _ := repo.GetByID(ctx, "agent-status")
