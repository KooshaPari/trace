...
func (m *MockCodeEntityRepository) GetByID(ctx context.Context, id string) (*models.CodeEntity, error) {
	...
	return args.Get(0).(*models.CodeEntity), args.Error(1)
}

func (m *MockCodeEntityRepository) GetByProjectID(ctx context.Context, projectID string, limit, offset int) ([]*models.CodeEntity, error) {
...
func (m *MockCodeEntityRepository) Search(ctx context.Context, projectID string, query string, limit, offset int) ([]*models.CodeEntity, error) {
...
func (m *MockCodeEntityRepository) GetStats(ctx context.Context, projectID string) (*models.CodeIndexStats, error) {
	...
	return args.Get(0).(*models.CodeIndexStats), args.Error(1)
}
...
func (m *MockCodeEntityRelationshipRepository) GetByID(ctx context.Context, id string) (*models.CodeEntityRelationship, error) {
	...
	return args.Get(0).(*models.CodeEntityRelationship), args.Error(1)
}

func (m *MockCodeEntityRelationshipRepository) GetBySourceID(ctx context.Context, sourceID string) ([]*models.CodeEntityRelationship, error) {
...
func (m *MockCodeEntityRelationshipRepository) GetByTargetID(ctx context.Context, targetID string) ([]*models.CodeEntityRelationship, error) {
...
func (m *MockCodeEntityRelationshipRepository) List(ctx context.Context, filter repository.CodeEntityRelationshipFilter) ([]*models.CodeEntityRelationship, error) {
	args := m.Called(ctx, filter)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockCodeEntityRelationshipRepository) GetRelationships(ctx context.Context, entityID string) ([]*models.CodeEntityRelationship, error) {
...
func (suite *CodeIndexServiceTestSuite) TestCreateRelationship_Success() {
	...
	sourceEntity := &models.CodeEntity{ID: "entity-1", ProjectID: "project-1", Name: "Service1", EntityType: "class", FilePath: "s1.go", Language: "go"}
	targetEntity := &models.CodeEntity{ID: "entity-2", ProjectID: "project-1", Name: "Service2", EntityType: "class", FilePath: "s2.go", Language: "go"}
...
func (suite *CodeIndexServiceTestSuite) TestGetCodeIndexStats_Success() {
	stats := &models.CodeIndexStats{
		...
		EntitiesByLang: map[string]int64{"go": 80, "python": 20},
		TotalRelations: 150,
	}
...
func TestValidateCodeEntity_InvalidLineNumbers(t *testing.T) {
	...
	service := NewCodeIndexServiceImpl(entityRepo, relationshipRepo, cache).(*CodeIndexServiceImpl)
