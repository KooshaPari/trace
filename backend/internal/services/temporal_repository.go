...
func (r *BranchRepositoryPgx) Create(ctx context.Context, branch *VersionBranch) error {
	...
	metadataJSON, _ := json.Marshal(branch.Metadata)
...
func (r *AlternativeRepositoryPgx) Create(ctx context.Context, alt *ItemAlternative) error {
	...
	metricsJSON, _ := json.Marshal(alt.Metrics)
...
func (r *MergeRepositoryPgx) Create(ctx context.Context, mr *MergeRequest) error {
	...
	diffJSON, _ := json.Marshal(mr.Diff)
	conflictsJSON, _ := json.Marshal(mr.Conflicts)
	reviewersJSON, _ := json.Marshal(mr.Reviewers)
	approvedByJSON, _ := json.Marshal(mr.ApprovedBy)
...
func scanBranch(row pgx.Row) (*VersionBranch, error) {
	...
	if metadataJSON != nil {
		_ = json.Unmarshal(metadataJSON, &branch.Metadata)
	} else {
...
func scanVersion(row pgx.Row) (*Version, error) {
	...
	if metadataJSON != nil {
		_ = json.Unmarshal(metadataJSON, &version.Metadata)
	} else {
...
func scanAlternative(row pgx.Row) (*ItemAlternative, error) {
	...
	if metricsJSON != nil {
		_ = json.Unmarshal(metricsJSON, &alt.Metrics)
	} else {
...
func scanMergeRequest(row pgx.Row) (*MergeRequest, error) {
	...
	if diffJSON != nil {
		_ = json.Unmarshal(diffJSON, &mr.Diff)
	}
	if conflictsJSON != nil {
		_ = json.Unmarshal(conflictsJSON, &mr.Conflicts)
	}
	if reviewersJSON != nil {
		_ = json.Unmarshal(reviewersJSON, &mr.Reviewers)
	}
	if approvedByJSON != nil {
		_ = json.Unmarshal(approvedByJSON, &mr.ApprovedBy)
	}
