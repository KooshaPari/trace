...
// allowedImageTypes lazily initialized set of allowed image MIME types
//
...
// getAllowedImageTypes returns the allowed image MIME types (lazy init)
...
// allowedDocumentTypes lazily initialized set of allowed document MIME types
//
//nolint:gochecknoglobals
var (
...
// sqlInjectionPatterns lazily initialized regex patterns for SQL injection detection
//
//nolint:gochecknoglobals
var (
...
// xssPatterns lazily initialized regex patterns for XSS detection
//
//nolint:gochecknoglobals
var (
