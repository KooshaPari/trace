...
type CentralNode struct {
	...
	BetweennessSc float64 `json:"betweenness_score"`
	ClosenessSc   float64 `json:"closeness_score"`
	PageRankSc    float64 `json:"pagerank_score"`
}
...
type Metrics struct {
	...
	ConnectedComps int     `json:"connected_components"`
}
