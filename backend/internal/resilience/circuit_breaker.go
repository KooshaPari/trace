...
func DefaultCircuitBreakerConfig() CircuitBreakerConfig {
	return CircuitBreakerConfig{
		...
		OnStateChange: func(name string, from gobreaker.State, to gobreaker.State) {
			...
			// TODO: Send alert notification (Slack/email) for production
		},
	}
}
...
func (m *CircuitBreakerManager) GetOrCreateBreaker(serviceName string) *gobreaker.CircuitBreaker {
	...
	log.Printf("✅ Created circuit breaker for service: %s", serviceName)
	return breaker
}
...
func (m *CircuitBreakerManager) ExecuteWithContext(ctx context.Context, serviceName string, fn func() (interface{}, error)) (interface{}, error) {
