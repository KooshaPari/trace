...
func buildLargeSnapshots(itemCount int, modifyPercentage, addPercentage, removePercentage float64) (map[string]map[string]interface{}, map[string]map[string]interface{}, int) {
