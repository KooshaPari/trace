...
func NewService(cfg *Config) (*Service, error) {
	...
	// Register workflows
	w.RegisterWorkflow(SnapshotWorkflow)
	w.RegisterWorkflow(ScheduledSnapshotWorkflow)

	// Register activities
	w.RegisterActivity(activities.QuerySnapshot)
	w.RegisterActivity(activities.CreateSnapshot)
	w.RegisterActivity(activities.UploadSnapshot)
