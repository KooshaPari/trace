...
async def async_db_session(temp_dir):
...
class TestChangeDetector:
    ...
    def test_detect_changes_empty_directory(self, temp_dir) -> None:
        """Test detect_changes with empty directory."""
        changes = ChangeDetector.detect_changes_in_directory(temp_dir, {})

        assert changes == []

    def test_detect_changes_nonexistent_directory(self, temp_dir) -> None:
    ...
    def test_detect_changes_new_file(self, temp_dir) -> None:
    ...
    def test_detect_changes_modified_file(self, temp_dir) -> None:
    ...
    def test_detect_changes_unchanged_file(self, temp_dir) -> None:
...
class TestSyncQueue:
    ...
    def test_enqueue_new_item(self, mock_db_connection) -> None:
    ...
    def test_enqueue_duplicate_replaces(self, mock_db_connection) -> None:
    ...
    def test_get_pending_respects_limit(self, mock_db_connection) -> None:
    ...
    def test_update_retry_increments_count(self, mock_db_connection) -> None:
    ...
    def test_get_count_accurate(self, mock_db_connection) -> None:
...
class TestSyncStateManager:
    ...
    def test_update_last_sync(self, mock_db_connection) -> None:
    ...
    def test_update_last_sync_default_now(self, mock_db_connection) -> None:
    ...
    def test_update_status(self, mock_db_connection) -> None:
    ...
    def test_update_error(self, mock_db_connection) -> None:
...
class TestSyncEngine:
    ...
    def test_queue_change(self, sync_engine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_sync_prevents_concurrent_execution(self, sync_engine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_sync_handles_exception(self, sync_engine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_queue_success(self, sync_engine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_queue_skips_max_retries(self, sync_engine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_queue_handles_upload_failure(self, sync_engine) -> None:
    ...
    def test_resolve_conflict_last_write_wins_remote(self, sync_engine) -> None:
    ...
    def test_resolve_conflict_last_write_wins_local(self, sync_engine) -> None:
    ...
    def test_resolve_conflict_local_wins_strategy(self, sync_engine) -> None:
    ...
    def test_resolve_conflict_remote_wins_strategy(self, sync_engine) -> None:
    ...
    def test_is_syncing_false_initially(self, sync_engine) -> None:
        """Test is_syncing returns False initially."""
        assert sync_engine.is_syncing() is False

    def test_is_syncing_true_during_sync(self, sync_engine) -> None:
...
class TestSyncEngineFactory:
    ...
    def test_create_sync_engine(self, mock_db_connection) -> None:
...
class TestConflictResolver:
    ...
    def test_initialization(self, conflict_resolver) -> None:
    ...
    def test_detect_conflict_concurrent_changes(self, conflict_resolver) -> None:
    ...
    def test_detect_conflict_no_conflict_same_content(self, conflict_resolver) -> None:
    ...
    def test_detect_conflict_no_conflict_ordered_changes(self, conflict_resolver) -> None:
    ...
    def test_resolve_local_wins_strategy(self, conflict_resolver) -> None:
    ...
    def test_resolve_remote_wins_strategy(self, conflict_resolver) -> None:
    ...
    def test_resolve_manual_strategy_raises(self, conflict_resolver) -> None:
    ...
    def test_resolve_manual_with_merged_data(self, conflict_resolver) -> None:
    ...
    def test_create_backup(self, conflict_resolver) -> None:
    ...
    def test_list_unresolved(self, conflict_resolver) -> None:
    ...
    def test_get_conflict(self, conflict_resolver) -> None:
    ...
    def test_get_conflict_nonexistent(self, conflict_resolver) -> None:
        """Test getting nonexistent conflict returns None."""
        result = conflict_resolver.get_conflict("nonexistent-id")

        assert result is None

    def test_get_conflict_stats(self, conflict_resolver) -> None:
...
class TestConflictBackup:
    ...
    def test_list_backups_empty(self, temp_dir) -> None:
    ...
    def test_load_backup(self, temp_dir) -> None:
        """Test loading backup."""
    ...
    def test_load_backup_missing_files(self, temp_dir) -> None:
    ...
    def test_delete_backup(self, temp_dir) -> None:
    ...
    def test_delete_backup_nonexistent(self, temp_dir) -> None:
...
class TestMarkdownParser:
    ...
    def test_parse_item_markdown_success(self, temp_dir, sample_item_markdown) -> None:
    ...
    def test_write_item_markdown(self, temp_dir) -> None:
    ...
    def test_parse_links_yaml_success(self, temp_dir, sample_links_yaml) -> None:
    ...
    def test_parse_links_yaml_missing_file(self, temp_dir) -> None:
    ...
    def test_parse_links_yaml_empty_links(self, temp_dir) -> None:
    ...
    def test_write_links_yaml(self, temp_dir) -> None:
    ...
    def test_parse_config_yaml(self, temp_dir) -> None:
    ...
    def test_parse_config_yaml_missing_file(self, temp_dir) -> None:
    ...
    def test_write_config_yaml(self, temp_dir) -> None:
    ...
    def test_get_item_path(self, temp_dir) -> None:
    ...
    def test_get_item_path_story_plural(self, temp_dir) -> None:
    ...
    def test_get_links_path(self, temp_dir) -> None:
    ...
    def test_get_config_path(self, temp_dir) -> None:
    ...
    def test_list_items_empty_project(self, temp_dir) -> None:
        """Test listing items in nonexistent project."""
        items = list_items(temp_dir, "nonexistent-project")

        assert items == []

    def test_list_items_with_type_filter(self, temp_dir) -> None:
