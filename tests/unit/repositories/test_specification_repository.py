...
class TestADRRepositoryGet:
    ...
    @pytest_asyncio.fixture
    async def adr_setup(self, db_session: AsyncSession):
...
class TestADRRepositoryList:
    ...
    @pytest_asyncio.fixture
    async def multiple_adrs(self, db_session: AsyncSession):
...
class TestADRRepositoryUpdate:
    ...
    @pytest_asyncio.fixture
    async def adr_for_update(self, db_session: AsyncSession):
...
class TestADRRepositoryTransition:
    ...
    @pytest_asyncio.fixture
    async def adr_for_transition(self, db_session: AsyncSession):
...
class TestADRRepositoryVerify:
    ...
    @pytest_asyncio.fixture
    async def adr_for_verify(self, db_session: AsyncSession):
...
class TestADRRepositoryDelete:
    ...
    @pytest_asyncio.fixture
    async def adr_for_delete(self, db_session: AsyncSession):
...
class TestADRRepositoryStats:
    ...
    @pytest_asyncio.fixture
    async def adrs_for_stats(self, db_session: AsyncSession):
...
class TestContractRepositoryCreate:
    ...
    @pytest_asyncio.fixture
    async def setup_for_contract(self, db_session: AsyncSession):
...
class TestContractRepositoryGet:
    ...
    @pytest_asyncio.fixture
    async def contract_setup(self, db_session: AsyncSession):
...
class TestContractRepositoryList:
    ...
    @pytest_asyncio.fixture
    async def multiple_contracts(self, db_session: AsyncSession):
...
class TestFeatureRepositoryGet:
    ...
    @pytest_asyncio.fixture
    async def feature_setup(self, db_session: AsyncSession):
...
class TestFeatureRepositoryList:
    ...
    @pytest_asyncio.fixture
    async def multiple_features(self, db_session: AsyncSession):
...
class TestScenarioRepositoryGet:
    ...
    @pytest_asyncio.fixture
    async def scenario_setup(self, db_session: AsyncSession):
...
class TestScenarioRepositoryList:
    ...
    @pytest_asyncio.fixture
    async def multiple_scenarios(self, db_session: AsyncSession):
...
class TestADRRepositoryFindRelated:
    ...
    @pytest_asyncio.fixture
    async def related_adrs(self, db_session: AsyncSession):
...
class TestContractRepositoryUpdate:
    ...
    @pytest_asyncio.fixture
    async def contract_for_update(self, db_session: AsyncSession):
...
class TestContractRepositoryTransition:
    ...
    @pytest_asyncio.fixture
    async def contract_for_transition(self, db_session: AsyncSession):
...
class TestContractRepositoryDelete:
    ...
    @pytest_asyncio.fixture
    async def contract_for_delete(self, db_session: AsyncSession):
...
class TestContractRepositoryStats:
    ...
    @pytest_asyncio.fixture
    async def contracts_for_stats(self, db_session: AsyncSession):
...
class TestContractRepositoryVerify:
    ...
    @pytest_asyncio.fixture
    async def contract_for_verify(self, db_session: AsyncSession):
...
class TestFeatureRepositoryUpdate:
    ...
    @pytest_asyncio.fixture
    async def feature_for_update(self, db_session: AsyncSession):
...
class TestFeatureRepositoryTransition:
    ...
    @pytest_asyncio.fixture
    async def feature_for_transition(self, db_session: AsyncSession):
...
class TestFeatureRepositoryDelete:
    ...
    @pytest_asyncio.fixture
    async def feature_with_scenarios(self, db_session: AsyncSession):
...
class TestFeatureRepositoryListWithScenarios:
    ...
    @pytest_asyncio.fixture
    async def features_with_scenarios(self, db_session: AsyncSession):
...
class TestScenarioRepositoryUpdate:
    ...
    @pytest_asyncio.fixture
    async def scenario_for_update(self, db_session: AsyncSession):
...
class TestScenarioRepositoryTransition:
    ...
    @pytest_asyncio.fixture
    async def scenario_for_transition(self, db_session: AsyncSession):
...
class TestScenarioRepositoryDelete:
    ...
    @pytest_asyncio.fixture
    async def scenario_for_delete(self, db_session: AsyncSession):
...
class TestScenarioRepositoryStats:
    ...
    @pytest_asyncio.fixture
    async def scenarios_for_stats(self, db_session: AsyncSession):
...
class TestScenarioRepositoryUpdatePassRate:
    ...
    @pytest_asyncio.fixture
    async def scenario_for_pass_rate(self, db_session: AsyncSession):
...
class TestScenarioRepositoryFindByStatus:
    ...
    @pytest_asyncio.fixture
    async def scenarios_with_statuses(self, db_session: AsyncSession):
...
class TestScenarioNumberFormat:
    ...
    @pytest_asyncio.fixture
    async def feature(self, db_session: AsyncSession):
...
class TestADRRepositoryUpdateEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def adr_for_edge_cases(self, db_session: AsyncSession):
...
class TestContractRepositoryListFilters:
    ...
    @pytest_asyncio.fixture
    async def contracts_with_statuses(self, db_session: AsyncSession):
...
class TestContractRepositoryUpdateEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def contract_for_edge_cases(self, db_session: AsyncSession):
...
class TestContractRepositoryTransitionEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def contracts_for_transition(self, db_session: AsyncSession):
...
class TestFeatureRepositoryFilters:
    ...
    @pytest_asyncio.fixture
    async def features_setup(self, db_session: AsyncSession):
...
class TestFeatureRepositoryUpdateEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def feature_for_edge_cases(self, db_session: AsyncSession):
...
class TestScenarioRepositoryFilters:
    ...
    @pytest_asyncio.fixture
    async def scenarios_for_filters(self, db_session: AsyncSession):
...
class TestScenarioRepositoryUpdateEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def scenario_for_edge_cases(self, db_session: AsyncSession):
...
class TestContractRepositoryProjectScope:
    ...
    @pytest_asyncio.fixture
    async def contracts_multi_project(self, db_session: AsyncSession):
