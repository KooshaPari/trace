...
class TestCoverageRepositoryGet:
    ...
    @pytest_asyncio.fixture
    async def coverage_with_entities(self, db_session: AsyncSession):
...
class TestCoverageRepositoryList:
    ...
    @pytest_asyncio.fixture
    async def multiple_coverages(self, db_session: AsyncSession):
...
class TestCoverageRepositoryUpdate:
    ...
    @pytest_asyncio.fixture
    async def coverage_for_update(self, db_session: AsyncSession):
...
class TestCoverageRepositoryDelete:
    ...
    @pytest_asyncio.fixture
    async def coverage_for_delete(self, db_session: AsyncSession):
...
class TestCoverageRepositoryTraceability:
    ...
    @pytest_asyncio.fixture
    async def traceability_setup(self, db_session: AsyncSession):
...
class TestCoverageRepositoryStats:
    ...
    @pytest_asyncio.fixture
    async def stats_setup(self, db_session: AsyncSession):
...
class TestCoverageRepositoryActivities:
    ...
    @pytest_asyncio.fixture
    async def coverage_with_activities(self, db_session: AsyncSession):
...
class TestCoverageRepositoryEdgeCases:
    ...
    @pytest_asyncio.fixture
    async def edge_case_setup(self, db_session: AsyncSession):
