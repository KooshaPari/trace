...
class TestItemUpdate:
    ...
    async def test_update_item_success(self, item_service, mock_session) -> None:  # noqa: ARG002
    ...
    async def test_update_item_concurrency_retry(self, item_service, mock_session) -> None:  # noqa: ARG002
