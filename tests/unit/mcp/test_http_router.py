...
@pytest.fixture
def test_http_client(mock_fastmcp):
...
class TestJSONRPCFormat:
    ...
    def test_valid_jsonrpc_request(self, valid_jsonrpc_request):
...
class TestHTTPAuthentication:
    ...
    def test_valid_token_allows_access(self, valid_auth_headers):
    ...
    def test_bearer_token_format(self, valid_auth_headers):
...
class TestMCPHTTPMethods:
    ...
    def test_tools_list_method(self, valid_jsonrpc_request):
...
class TestSSEStreaming:
    ...
    def test_sse_retry_mechanism(self):
