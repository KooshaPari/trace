...
class TestJSONRPCFormat:
    ...
    def test_valid_jsonrpc_request(self, valid_jsonrpc_request) -> None:
...
class TestHTTPAuthentication:
    ...
    def test_valid_token_allows_access(self, valid_auth_headers) -> None:
    ...
    def test_bearer_token_format(self, valid_auth_headers) -> None:
...
class TestMCPHTTPMethods:
    ...
    def test_tools_list_method(self, valid_jsonrpc_request) -> None:
