...
class TestQueryOptimizationService:
    ...
    def test_rate_performance_excellent(self):
    ...
    def test_rate_performance_good(self):
    ...
    def test_rate_performance_fair(self):
    ...
    def test_rate_performance_poor(self):
    ...
    def test_suggest_optimizations_large_result(self):
    ...
    def test_suggest_optimizations_cache_candidate(self):
    ...
    def test_get_cached_query_expired(self):
    ...
    def test_recommend_indexes_not_enough_data(self):
    ...
    def test_recommend_indexes_status_heavy(self):
    ...
    def test_recommend_indexes_view_heavy(self):
...
class TestIngestionService:
    ...
    @pytest.mark.asyncio
    async def test_ingestion_service_ingest(self):
