...
class TestItemMetadata:
    ...
    async def test_add_metadata_merge(self, item_service, mock_session) -> None:  # noqa: ARG002
    ...
    async def test_replace_metadata(self, item_service, mock_session) -> None:  # noqa: ARG002
