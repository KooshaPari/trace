...
class TestImpactAnalysisEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_deep_hierarchy(self, client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_single_level(self, client) -> None:
...
class TestCycleDetectionEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_cycle_detection_no_cycles(self, client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cycle_detection_multiple_cycles(self, client) -> None:
...
class TestShortestPathEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_no_path(self, client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_direct_link(self, client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_multiple_hops(self, client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_missing_parameters(self, client) -> None:
