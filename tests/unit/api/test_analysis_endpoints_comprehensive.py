...
class TestImpactAnalysisEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_deep_hierarchy(self, client):
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_no_dependencies(self, client):
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_single_level(self, client):
...
class TestCycleDetectionEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_cycle_detection_no_cycles(self, client):
    ...
    @pytest.mark.asyncio
    async def test_cycle_detection_multiple_cycles(self, client):
    ...
    @pytest.mark.asyncio
    async def test_cycle_detection_low_severity(self, client):
...
class TestShortestPathEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_no_path(self, client):
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_direct_link(self, client):
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_multiple_hops(self, client):
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_same_source_target(self, client):
    ...
    @pytest.mark.asyncio
    async def test_shortest_path_missing_parameters(self, client):
