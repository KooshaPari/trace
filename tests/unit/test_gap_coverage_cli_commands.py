...
class TestHistoryCommand:
    ...
    def test_show_history_item_not_found(self):
    ...
    def test_show_history_invalid_date(self):
    ...
    def test_show_history_command_name(self):
...
class TestStateCommand:
    ...
    def test_show_state_with_view_filter(self):
