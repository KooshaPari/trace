...
class TestValidateUUID:
    ...
    def test_valid_uuid_with_spaces(self):
...
class TestIsValidUUID:
    ...
    def test_uppercase_uuid_returns_true(self):
        """Should return True for uppercase UUID"""
        valid_uuid = "123E4567-E89B-12D3-A456-426614174000"
        assert is_valid_uuid(valid_uuid) is True

    def test_uuid_with_spaces_returns_true(self):
...
class TestValidateUUIDs:
    ...
    def test_one_invalid_uuid(self):
    ...
    def test_mixed_case_valid_uuids(self):
