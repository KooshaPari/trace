...
class TestItemFieldValidation:
    ...
    def test_item_project_id_required(self):
    ...
    def test_item_project_id_string(self):
    ...
    def test_item_title_required(self):
    ...
    def test_item_title_can_exceed_500(self):
    ...
    def test_item_description_text_type(self):
    ...
    def test_item_view_string_type(self):
    ...
    def test_item_status_custom(self):
    ...
    def test_item_parent_id_optional(self):
        """Test that parent_id is optional."""
        item = Item(project_id="p1", title="Test", view="FEATURE", item_type="req")
        assert item.parent_id is None

    def test_item_parent_id_hierarchical(self):
    ...
    def test_item_metadata_default_empty(self):
    ...
    def test_item_metadata_dict_type(self):
    ...
    def test_item_metadata_various_types(self):
...
class TestLinkFieldValidation:
    ...
    def test_link_id_auto_generation(self):
    ...
    def test_link_source_target_same(self):
    ...
    def test_link_type_various(self):
    ...
    def test_link_metadata_default_empty(self):
        """Test that metadata is initialized (None until DB insertion)."""
        link = Link(project_id="p1", source_item_id="i1", target_item_id="i2", link_type="implements")
        # Metadata defaults to dict via default_factory in DB
...
class TestProjectFieldValidation:
    ...
    def test_project_id_auto_generation(self):
    ...
    def test_project_name_unique_constraint(self):
    ...
    def test_project_name_max_length_255(self):
    ...
    def test_project_description_text(self):
        """Test that description can be long text."""
        desc = "x" * 5000
    ...
    def test_project_metadata_dict(self):
        """Test that metadata can be set."""
...
class TestItemCreateSchemaValidation:
    ...
    def test_item_create_description_optional(self):
        """Test that description is optional."""
        item = ItemCreate(title="Test", view="FEATURE", item_type="req")
        assert item.description is None

    def test_item_create_description_custom(self):
    ...
    def test_item_create_parent_id_optional(self):
        """Test that parent_id is optional."""
        item = ItemCreate(title="Test", view="FEATURE", item_type="req")
        assert item.parent_id is None

    def test_item_create_parent_id_custom(self):
        """Test that parent_id can be set."""
        item = ItemCreate(title="Test", view="FEATURE", item_type="req", parent_id="parent-123")
        assert item.parent_id == "parent-123"

    def test_item_create_metadata_default_empty(self):
        """Test that metadata defaults to empty dict."""
        item = ItemCreate(title="Test", view="FEATURE", item_type="req")
        assert item.metadata == {}

    def test_item_create_metadata_custom(self):
        """Test that metadata can be set."""
        metadata = {"priority": "high", "tags": ["urgent"]}
        item = ItemCreate(title="Test", view="FEATURE", item_type="req", metadata=metadata)
        assert item.metadata == metadata

    def test_item_create_metadata_nested_objects(self):
...
class TestLinkCreateSchemaValidation:
    ...
    def test_link_create_required_fields(self):
        """Test that required fields are enforced."""
    ...
    def test_link_create_metadata_optional(self):
        """Test that metadata is optional."""
        link = LinkCreate(source_item_id="i1", target_item_id="i2", link_type="implements")
        assert link.metadata == {}

    def test_link_create_metadata_custom(self):
        """Test that metadata can be set."""
        metadata = {"strength": 0.9, "tags": ["important"]}
...
class TestLinkResponseSchemaValidation:
    ...
    def test_link_response_required_fields(self):
...
class TestEnumConstraints:
    ...
    def test_item_status_types(self):
    ...
    def test_item_priority_types(self):
...
class TestForeignKeyRelationships:
    ...
    def test_item_self_reference_parent(self):
    ...
    def test_link_foreign_key_project(self):
    ...
    def test_link_foreign_key_source_item(self):
    ...
    def test_link_foreign_key_target_item(self):
...
class TestInvalidDataHandling:
    ...
    def test_schema_validation_failure_type_error(self):
        """Test that validation fails on type errors."""
        with pytest.raises(ValidationError):
            ItemCreate(title=123, view="FEATURE", item_type="req")  # type: ignore

    def test_schema_validation_failure_missing_required(self):
        """Test that validation fails on missing required fields."""
        with pytest.raises(ValidationError):
            ItemCreate(view="FEATURE", item_type="req")  # type: ignore

    def test_schema_validation_failure_invalid_constraint(self):
        """Test that validation fails on constraint violations."""
        with pytest.raises(ValidationError):
            ItemCreate(title="x" * 501, view="FEATURE", item_type="req")

    def test_item_model_with_none_project_id(self):
        """Test Item model allows None project_id (ORM doesn't validate)."""
        # The ORM allows this; DB constraint catches it
        item = Item(project_id=None, title="Test", view="FEATURE", item_type="req")  # type: ignore
        assert item.project_id is None

    def test_link_model_with_none_source_id(self):
        """Test Link model allows None source_item_id (ORM doesn't validate)."""
        # The ORM allows this; DB constraint catches it
        link = Link(project_id="p1", source_item_id=None, target_item_id="i2", link_type="impl")  # type: ignore
...
class TestEdgeCases:
    ...
    def test_item_metadata_empty_dict_preserved(self):
    ...
    def test_item_metadata_none_converts_to_dict(self):
    ...
    def test_link_with_unicode_metadata(self):
    ...
    def test_metadata_with_empty_nested_dict(self):
