...
class TestItemDeletion:
    ...
    async def test_soft_delete_item(self, item_service, mock_session):
    ...
    async def test_hard_delete_item(self, item_service, mock_session):
    ...
    async def test_delete_non_existent_item(self, item_service, mock_session):
    ...
    async def test_undelete_item(self, item_service, mock_session):
