...
class TestFigmaMetadataProperties:
    ...
    @pytest.mark.unit
    def test_base_url_with_encoded_file_name(self):
    ...
    @pytest.mark.unit
    def test_node_url_without_node_id(self):
        """Test node_url returns None without node_id."""
        meta = FigmaMetadata(file_key="abc123", file_name="MyProject")
        assert meta.node_url is None

    @pytest.mark.unit
    def test_node_url_with_node_id(self):
    ...
    @pytest.mark.unit
    def test_node_url_with_complex_node_id(self):
...
class TestParseFigmaUrlEdgeCases:
    ...
    @pytest.mark.unit
    def test_parse_url_with_leading_whitespace(self):
    ...
    @pytest.mark.unit
    def test_parse_url_without_file_name(self):
    ...
    @pytest.mark.unit
    def test_parse_url_with_encoded_file_name(self):
    ...
    @pytest.mark.unit
    def test_parse_url_with_hyphenated_node_id(self):
...
class TestIsFigmaUrl:
    ...
    @pytest.mark.unit
    def test_is_figma_url_valid(self):
    ...
    @pytest.mark.unit
    def test_is_figma_url_invalid(self):
    ...
    @pytest.mark.unit
    def test_is_figma_url_empty_string(self):
        """Test is_figma_url with empty string."""
        assert is_figma_url("") is False

    @pytest.mark.unit
    def test_is_figma_url_whitespace(self):
        """Test is_figma_url with whitespace."""
        assert is_figma_url("   ") is False

    @pytest.mark.unit
    def test_is_figma_url_partial_url(self):
...
class TestBuildFigmaUrl:
    ...
    @pytest.mark.unit
    def test_build_url_with_node_id(self):
    ...
    @pytest.mark.unit
    def test_build_url_with_special_characters_in_name(self):
    ...
    @pytest.mark.unit
    def test_build_url_with_complex_node_id(self):
    ...
    @pytest.mark.unit
    def test_build_url_none_file_name(self):
...
class TestExtractFigmaProtocolUrl:
    ...
    @pytest.mark.unit
    def test_extract_single_protocol_url(self):
    ...
    @pytest.mark.unit
    def test_extract_multiple_protocol_urls(self):
    ...
    @pytest.mark.unit
    def test_extract_no_protocol_urls(self):
    ...
    @pytest.mark.unit
    def test_extract_with_regular_urls(self):
    ...
    @pytest.mark.unit
    def test_extract_with_complex_node_ids(self):
...
class TestConvertFigmaProtocolToUrl:
    ...
    @pytest.mark.unit
    def test_convert_single_protocol_url(self):
    ...
    @pytest.mark.unit
    def test_convert_multiple_protocol_urls(self):
    ...
    @pytest.mark.unit
    def test_convert_no_protocol_urls(self):
    ...
    @pytest.mark.unit
    def test_convert_preserves_other_content(self):
...
class TestValidateFigmaMetadata:
    ...
    @pytest.mark.unit
    def test_validate_invalid_figma_url(self):
    ...
    @pytest.mark.unit
    def test_validate_file_key_mismatch(self):
    ...
    @pytest.mark.unit
    def test_validate_node_id_mismatch(self):
    ...
    @pytest.mark.unit
    def test_validate_invalid_file_key_format(self):
    ...
    @pytest.mark.unit
    def test_validate_valid_file_key(self):
    ...
    @pytest.mark.unit
    def test_validate_valid_node_id(self):
    ...
    @pytest.mark.unit
    def test_validate_matching_metadata(self):
...
class TestPropertyBasedFigmaHypothesis:
    ...
    def test_build_url_accepts_alphanumeric_file_keys(self, file_key):
...
class TestLoggingConfiguration:
    ...
    def test_logger_basic_logging(self):
        ...
        logs = []
        test_logger.add(lambda msg: logs.append(msg), format="{message}")
    ...
    def test_logger_different_levels(self):
        ...
        test_logger.remove()
        logs = []
        test_logger.add(lambda msg: logs.append(msg), format="{level}:{message}", level="DEBUG")
    ...
    def test_logger_structured_logging(self):
        ...
        test_logger.remove()
        logs = []
        test_logger.add(lambda msg: logs.append(msg), format="{message}", serialize=True)
    ...
    def test_logger_filtering(self):
        ...
        test_logger.remove()
        logs = []
        test_logger.add(lambda msg: logs.append(msg), format="{message}", level="WARNING")
    ...
    def test_logger_format_customization(self):
        ...
        test_logger.add(lambda msg: logs.append(msg), format=custom_format)
    ...
    def test_logger_multiple_handlers(self):
        ...
        test_logger.add(lambda msg: logs1.append(msg), format="{message}", level="INFO")
        test_logger.add(lambda msg: logs2.append(msg), format="{message}", level="ERROR")
    ...
    @pytest.mark.unit
    def test_logger_catch_decorator(self):
...
class TestEdgeCasesAndRobustness:
    ...
    @pytest.mark.unit
    def test_figma_metadata_equality(self):
    ...
    @pytest.mark.unit
    def test_parse_figma_url_with_uppercase(self):
    ...
    @pytest.mark.unit
    def test_build_figma_url_empty_file_key(self):
        """Test building URL with empty file key."""
        url = build_figma_url("")
        assert url == "https://www.figma.com/file/"

    @pytest.mark.unit
    def test_validate_figma_metadata_with_none_values(self):
    ...
    @pytest.mark.unit
    def test_extract_protocol_url_with_malformed_pattern(self):
    ...
    @pytest.mark.unit
    def test_convert_protocol_url_with_no_matches(self):
