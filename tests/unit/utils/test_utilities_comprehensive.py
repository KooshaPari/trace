...
class TestPropertyBasedFigmaHypothesis:
    ...
    def test_build_url_accepts_alphanumeric_file_keys(self, file_key) -> None:
    ...
    def test_build_url_with_arbitrary_file_names(self, file_key, file_name) -> None:
    ...
    def test_build_url_with_generated_node_ids(self, file_key, node_parts) -> None:
    ...
    def test_extract_protocol_url_never_crashes(self, text) -> None:
    ...
    @pytest.mark.property
    @given(text=st.text(min_size=0, max_size=500))
    def test_convert_protocol_url_never_crashes(self, text) -> None:
    ...
    def test_is_figma_url_never_crashes(self, url) -> None:
