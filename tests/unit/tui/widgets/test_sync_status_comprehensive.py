...
class TestSyncStatusWidgetDisplay:
    ...
    def test_update_display_syncing_state(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_error_state(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_online_state(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_offline_state(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_pending_changes(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_singular_pending_change(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_with_conflicts(self, mock_query_one) -> None:
    ...
    @patch.object(SyncStatusWidget, "query_one")
    def test_update_display_no_conflicts(self, mock_query_one) -> None:
