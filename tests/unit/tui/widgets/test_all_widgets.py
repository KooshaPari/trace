...
class TestWidgetAvailability:
    ...
    def test_graph_view_available(self):
    ...
    def test_item_list_available(self):
    ...
    def test_state_display_available(self):
    ...
    def test_view_switcher_available(self):
...
class TestWidgetFallbacks:
    ...
    def test_graph_view_fallback_exists(self):
    ...
    def test_view_switcher_fallback_exists(self):
