...
class TestProjectModelCreation:
    ...
    def test_project_creation_with_name_only(self):
    ...
    def test_project_creation_with_explicit_id(self):
    ...
    def test_project_metadata_can_be_set(self):
...
class TestProjectModelMetadataAlias:
    ...
    def test_metadata_alias_getter(self):
    ...
    def test_metadata_alias_setter(self):
...
class TestProjectModelValidation:
    ...
    def test_project_name_is_stored(self):
...
class TestProjectModelComparison:
    ...
    def test_projects_with_different_ids(self):
    ...
    def test_project_name_independence(self):
...
class TestProjectModelIndexing:
    ...
    def test_project_getitem_access(self):
        """Project supports dictionary-style access."""
        project = Project(name="Test")
        assert project["name"] == "Test"

    def test_project_getitem_for_metadata(self):
