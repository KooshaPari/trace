...
class TestItemModelCreation:
    ...
    def test_item_creation_with_required_fields(self, project_id) -> None:
    ...
    def test_item_creation_with_all_fields(self, project_id) -> None:
    ...
    def test_item_creation_with_explicit_id(self, project_id) -> None:
    ...
    def test_item_description_optional(self, project_id) -> None:
    ...
    def test_item_has_timestamp_attributes(self, project_id) -> None:
...
class TestItemModelFields:
    ...
    def test_item_title_storage(self, project_id) -> None:
    ...
    def test_item_status_storage(self, project_id) -> None:
    ...
    def test_item_priority_storage(self, project_id) -> None:
    ...
    def test_item_owner_storage(self, project_id) -> None:
        """Item has owner property (not stored in Go-backed schema; returns None)."""
        item = Item(project_id=project_id, title="Test", view="Feature", item_type="requirement")
        assert item.owner is None

    def test_item_metadata_storage(self, project_id) -> None:
        """Item metadata can be stored."""
        metadata = {"priority_score": 100, "tags": ["urgent"]}
        item = Item(
            project_id=project_id, title="Test", view="Feature", item_type="requirement", item_metadata=metadata,
        )
        assert item.item_metadata == metadata

    def test_item_parent_reference(self, project_id) -> None:
        """Item can have parent_id reference."""
        parent_id = str(uuid4())
        item = Item(
            project_id=project_id, title="Child Item", view="Feature", item_type="requirement", parent_id=parent_id,
        )
...
class TestItemModelValidation:
    ...
    def test_item_multiple_statuses(self, project_id) -> None:
    ...
    def test_item_multiple_priorities(self, project_id) -> None:
    ...
    def test_item_multiple_item_types(self, project_id) -> None:
    ...
    def test_item_multiple_views(self, project_id) -> None:
...
class TestItemModelComparison:
    ...
    def test_items_with_different_ids(self, project_id) -> None:
    ...
    def test_items_same_project_different_instances(self, project_id) -> None:
...
class TestItemModelRepresentation:
    ...
    def test_item_has_repr(self, project_id) -> None:
