...
class TestLinkModelCreation:
    ...
    def test_link_creation_with_required_fields(self, test_ids):
    ...
    def test_link_creation_with_metadata(self, test_ids):
    ...
    def test_link_with_explicit_id(self, test_ids):
...
class TestLinkModelTypes:
    ...
    def test_link_type_depends_on(self, test_ids):
    ...
    def test_link_type_blocked_by(self, test_ids):
    ...
    def test_link_type_implements(self, test_ids):
    ...
    def test_link_type_tests(self, test_ids):
...
class TestLinkModelComparison:
    ...
    def test_links_with_different_ids(self, test_ids):
    ...
    def test_links_same_items_different_types(self, test_ids):
...
class TestLinkModelAttributes:
    ...
    def test_link_has_timestamp_attributes(self, test_ids):
...
class TestLinkModelRepresentation:
    ...
    def test_link_repr(self, test_ids):
