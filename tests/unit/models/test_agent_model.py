...
class TestAgentModelCreation:
    ...
    def test_agent_defaults_agent_type(self):
...
class TestAgentModelMetadata:
    ...
    def test_agent_config_and_metadata(self):
