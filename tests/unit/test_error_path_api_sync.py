...
class TestLoggingErrors:
    ...
    def test_log_file_write_failure(self) -> None:
        ...
        with (
            ...
            pathlib.Path("logfile.log").open("w", encoding="utf-8") as f,
        ):
            f.write("message")
...
class TestValidationErrors:
    ...
    def test_range_validation(self) -> None:
        ...
        def validate_version(version) -> None:
    ...
    def test_regex_validation_error(self) -> None:
        ...
        def validate_pattern(value, pattern) -> None:
