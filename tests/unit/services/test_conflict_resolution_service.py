"""
Tests for conflict_resolution_service module.
...
from tracertm.services.conflict_resolution_service import *


class TestConflictResolutionService:
    """Test ConflictResolutionService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.conflict_resolution_service")
            service_classes = [
