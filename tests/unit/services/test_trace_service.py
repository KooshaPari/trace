"""
Tests for trace_service module.
...
from tracertm.services.trace_service import *


class TestTraceService:
    """Test TraceService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.trace_service")
            service_classes = [
