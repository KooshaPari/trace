...
from tracertm.services.view_service import *


class TestViewService:
    """Test ViewService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.view_service")
            service_classes = [
