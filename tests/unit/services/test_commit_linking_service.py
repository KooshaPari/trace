"""
Tests for commit_linking_service module.
...
from tracertm.services.commit_linking_service import *


class TestCommitLinkingService:
    """Test CommitLinkingService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.commit_linking_service")
            service_classes = [
...
class TestCommitLinkingErrorHandling:
    """Test error handling."""
