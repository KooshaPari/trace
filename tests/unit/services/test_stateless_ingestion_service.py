"""
Tests for stateless_ingestion_service module.
...
from tracertm.services.stateless_ingestion_service import *


class TestStatelessIngestionService:
    """Test StatelessIngestionService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.stateless_ingestion_service")
            service_classes = [
...
class TestStatelessIngestionErrorHandling:
    """Test error handling."""
