"""
Tests for agent_performance_service module.
...
from tracertm.services.agent_performance_service import *


class TestAgentPerformanceService:
    """Test AgentPerformanceService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.agent_performance_service")
            service_classes = [
...
class TestAgentPerformanceErrorHandling:
    """Test error handling."""
