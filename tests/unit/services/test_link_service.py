...
from tracertm.services.link_service import *


class TestLinkService:
    """Test LinkService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.link_service")
            service_classes = [
