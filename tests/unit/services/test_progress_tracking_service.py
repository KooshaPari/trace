"""
Tests for progress_tracking_service module.
...
from tracertm.services.progress_tracking_service import *


class TestProgressTrackingService:
    """Test ProgressTrackingService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.progress_tracking_service")
            service_classes = [
