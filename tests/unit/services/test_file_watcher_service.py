"""
Tests for file_watcher_service module.
...
from tracertm.services.file_watcher_service import *


class TestFileWatcherService:
    """Test FileWatcherService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.file_watcher_service")
            service_classes = [
