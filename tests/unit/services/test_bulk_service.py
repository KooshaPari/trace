...
from tracertm.services.bulk_service import *


class TestBulkService:
    """Test BulkService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.bulk_service")
            service_classes = [
