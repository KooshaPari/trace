"""
Tests for bulk_operation_service module.
...
from tracertm.services.bulk_operation_service import *


class TestBulkOperationService:
    """Test BulkOperationService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.bulk_operation_service")
            service_classes = [
