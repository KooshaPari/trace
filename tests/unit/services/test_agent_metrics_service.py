"""
Tests for agent_metrics_service module.
...
from tracertm.services.agent_metrics_service import *


class TestAgentMetricsService:
    """Test AgentMetricsService class."""
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.agent_metrics_service")
            service_classes = [
