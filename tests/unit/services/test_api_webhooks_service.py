"""
Tests for api_webhooks_service module.
...
class TestApiWebhooksService:
    ...
    def service(self, mock_db_session):
        ...
        try:
            ...
            import importlib
            module = importlib.import_module(f"tracertm.services.api_webhooks_service")
            service_classes = [
...
class TestApiWebhooksErrorHandling:
    """Test error handling."""
