...
class TestStatelessIngestionServiceGapCoverage:
    ...
    def test_ingest_markdown_file_not_found_error(self, service):
        """Test FileNotFoundError when markdown file doesn't exist."""
        with pytest.raises(FileNotFoundError, match="File not found"):
            service.ingest_markdown("/nonexistent/path/file.md")

    def test_ingest_markdown_invalid_extension_validation(self, service):
...
""")
    ...
    def test_ingest_markdown_with_provided_project_id(self, service, mock_session):
    ...
    def test_ingest_markdown_project_not_found_error(self, service, mock_session):
    ...
    def test_ingest_markdown_hierarchical_headers(self, service, mock_session):
...
""")
    ...
    def test_ingest_markdown_internal_links(self, service, mock_session):
...
""")
    ...
    def test_ingest_mdx_file_not_found_error(self, service):
        """Test FileNotFoundError for MDX file."""
        with pytest.raises(FileNotFoundError, match="File not found"):
            service.ingest_mdx("/nonexistent/file.mdx")

    def test_ingest_mdx_invalid_extension_validation(self, service):
    ...
    def test_ingest_mdx_with_jsx_components(self, service, mock_session):
...
""")
    ...
    def test_ingest_yaml_file_not_found_error(self, service):
        """Test FileNotFoundError for YAML file."""
        with pytest.raises(FileNotFoundError, match="File not found"):
            service.ingest_yaml("/nonexistent/file.yaml")

    def test_ingest_yaml_invalid_extension_validation(self, service):
    ...
    def test_ingest_openapi_spec_complete(self, service, mock_session):
    ...
    def test_ingest_openapi_skip_extension_fields(self, service, mock_session):
    ...
    def test_ingest_openapi_related_endpoints_linking(self, service, mock_session):
    ...
    def test_ingest_bmad_format_complete(self, service, mock_session):
    ...
    def test_ingest_bmad_alternative_structure(self, service, mock_session):
    ...
    def test_ingest_bmad_view_routing(self, service, mock_session):
    ...
    def test_ingest_bmad_dependency_linking(self, service, mock_session):
    ...
    def test_ingest_bmad_parent_child_linking(self, service, mock_session):
    ...
    def test_ingest_generic_yaml_nested_structure(self, service, mock_session):
    ...
    def test_ingest_generic_yaml_list_items(self, service, mock_session):
    ...
    def test_determine_item_type_default_mapping(self, service):
    ...
    def test_extract_section_content_found(self, service):
...
Different content"""
    ...
    def test_extract_section_content_until_next_header(self, service):
...
class TestCriticalPathServiceGapCoverage:
    ...
    @pytest.mark.asyncio
    async def test_calculate_critical_path_empty_project(self, service, mock_async_session):
    ...
    @pytest.mark.asyncio
    async def test_calculate_critical_path_single_item(self, service, mock_async_session):
    ...
    @pytest.mark.asyncio
    async def test_calculate_critical_path_linear_chain(self, service):
    ...
    @pytest.mark.asyncio
    async def test_calculate_critical_path_with_link_type_filter(self, service):
    ...
    @pytest.mark.asyncio
    async def test_calculate_critical_path_parallel_paths(self, service):
    ...
    def test_find_critical_path_empty_critical_items(self, service):
    ...
    def test_find_critical_path_single_critical_item(self, service):
...
class TestProgressServiceGapCoverage:
    ...
    def test_calculate_completion_item_not_found(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_todo(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_in_progress(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_blocked(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_complete(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_cancelled(self, service, mock_session):
    ...
    def test_calculate_completion_leaf_item_unknown_status(self, service, mock_session):
    ...
    def test_calculate_completion_parent_with_children(self, service, mock_session):
    ...
    def test_calculate_completion_parent_no_children(self, service, mock_session):
    ...
    def test_get_blocked_items_no_blocks(self, service, mock_session):
    ...
    def test_get_blocked_items_with_blockers(self, service, mock_session):
    ...
    def test_get_blocked_items_missing_blocker_items(self, service, mock_session):
    ...
    def test_get_stalled_items_no_stalled(self, service, mock_session):
    ...
    def test_get_stalled_items_null_updated_at(self, service, mock_session):
    ...
    def test_calculate_velocity_default_period(self, service, mock_session):
    ...
    def test_calculate_velocity_custom_period(self, service, mock_session):
    ...
    def test_calculate_velocity_zero_completed(self, service, mock_session):
    ...
    def test_calculate_velocity_null_results(self, service, mock_session):
    ...
    def test_generate_progress_report_default_dates(self, service, mock_session):
    ...
    def test_generate_progress_report_custom_dates(self, service, mock_session):
    ...
    def test_generate_progress_report_empty_project(self, service, mock_session):
    ...
    def test_generate_progress_report_includes_velocity(self, service, mock_session):
    ...
    def test_generate_progress_report_limits_blocked_stalled(self, service, mock_session):
...
class TestExportImportServiceGapCoverage:
    ...
    @pytest.mark.asyncio
    async def test_export_to_json_project_not_found(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_json_success(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_csv_success(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_csv_empty_project(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_markdown_project_not_found(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_markdown_success(self, service):
    ...
    @pytest.mark.asyncio
    async def test_export_to_markdown_groups_by_view(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_json_invalid_json(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_json_missing_items_field(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_json_success(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_csv_success(self, service):
...
Item 2,TEST,test,in_progress"""
    ...
    @pytest.mark.asyncio
    async def test_import_from_csv_empty_file(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_csv_missing_columns(self, service):
    ...
    @pytest.mark.asyncio
    async def test_import_from_csv_with_errors(self, service):
...
class TestTUIServiceGapCoverage:
    ...
    def test_register_component_with_data(self, service):
    ...
    def test_register_component_stores_in_dict(self, service):
    ...
    def test_get_component_not_exists(self, service):
    ...
    def test_list_components_all(self, service):
    ...
    def test_list_components_filtered_by_type(self, service):
    ...
    def test_update_component_data_success(self, service):
    ...
    def test_update_component_data_overwrites_existing(self, service):
    ...
    def test_update_component_data_nonexistent(self, service):
    ...
    def test_set_current_view_success(self, service):
    ...
    def test_set_current_view_nonexistent(self, service):
    ...
    def test_get_current_view_when_set(self, service):
    ...
    def test_get_current_view_when_not_set(self, service):
        """Test getting current view when not set."""
        current = service.get_current_view()

        assert current is None

    def test_get_current_view_after_component_deleted(self, service):
    ...
    def test_register_event_handler_single(self, service):
    ...
    def test_register_event_handler_multiple(self, service):
    ...
    def test_trigger_event_calls_handlers(self, service):
    ...
    def test_trigger_event_no_handlers(self, service):
    ...
    def test_set_theme_valid(self, service):
    ...
    def test_set_theme_invalid(self, service):
    ...
    def test_get_theme(self, service):
    ...
    def test_is_mouse_enabled_default(self, service):
        """Test default mouse enabled state."""
        assert service.is_mouse_enabled() is True

    def test_is_mouse_enabled_after_toggle(self, service):
    ...
    def test_get_ui_stats_empty(self, service):
    ...
    def test_get_ui_stats_with_components(self, service):
    ...
    def test_create_dashboard_empty_widgets(self, service):
    ...
    def test_create_dashboard_registers_component(self, service):
    ...
    def test_create_table_basic(self, service):
    ...
    def test_create_table_empty_rows(self, service):
    ...
    def test_create_table_registers_component(self, service):
