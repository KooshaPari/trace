...
class TestProjectCreation:
    ...
    def test_create_project_basic(self, project_repo) -> None:
    ...
    def test_create_project_with_metadata(self, project_repo) -> None:
    ...
    def test_create_multiple_projects(self, project_repo) -> None:
    ...
    def test_create_project_generates_unique_ids(self, project_repo) -> None:
        ids = set()
        for i in range(10):
...
class TestProjectRetrieval:
    ...
    def test_get_project_by_id(self, project_repo) -> None:
    ...
    def test_get_project_by_name(self, project_repo) -> None:
    ...
    def test_get_nonexistent_project_by_id(self, project_repo) -> None:
        result = project_repo.get_by_id("nonexistent-id")
        assert result is None

    def test_get_nonexistent_project_by_name(self, project_repo) -> None:
        result = project_repo.get_by_name("nonexistent-name")
        assert result is None

    def test_get_all_projects_empty(self, project_repo) -> None:
        projects = project_repo.get_all()
        assert projects == []

    def test_get_all_projects(self, project_repo) -> None:
...
class TestSettingsPersistence:
    ...
    def test_persist_project_settings(self, project_repo) -> None:
    ...
    def test_update_project_metadata(self, project_repo) -> None:
    ...
    def test_metadata_complex_structure(self, project_repo) -> None:
        metadata = {
            "owner": "team-a",
            "settings": {
    ...
    def test_empty_metadata_default(self, project_repo) -> None:
        project = project_repo.create("Empty Metadata Test")
        assert project.project_metadata == {}
        assert isinstance(project.project_metadata, dict)

    def test_metadata_none_becomes_empty_dict(self, project_repo) -> None:
...
class TestSchemaVersioning:
    ...
    def test_schema_version_in_metadata(self, project_repo) -> None:
    ...
    def test_multiple_schema_versions(self, project_repo) -> None:
    ...
    def test_schema_migration_metadata(self, project_repo) -> None:
...
class TestProjectIsolation:
    ...
    def test_items_isolated_to_project(self, db_session, project_repo) -> None:
    ...
    def test_links_isolated_to_project(self, db_session, project_repo) -> None:
    ...
    def test_events_isolated_to_project(self, db_session, project_repo) -> None:
    ...
    def test_cross_project_queries_filtered(self, db_session, project_repo) -> None:
...
class TestDeletionCascades:
    ...
    def test_delete_project_cascades_items(self, db_session, project_repo) -> None:
    ...
    def test_delete_project_cascades_links(self, db_session, project_repo) -> None:
    ...
    def test_delete_project_cascades_events(self, db_session, project_repo) -> None:
    ...
    def test_cascade_preserves_other_projects(self, db_session, project_repo) -> None:
...
class TestProjectUpdates:
    ...
    def test_update_project_name(self, project_repo) -> None:
    ...
    def test_update_project_description(self, project_repo) -> None:
        created = project_repo.create("Test", description="Old desc")
        updated = project_repo.update(created.id, description="New desc")
        assert updated.description == "New desc"

    def test_update_nonexistent_project(self, project_repo) -> None:
        result = project_repo.update("nonexistent", name="New Name")
        assert result is None

    def test_update_preserves_other_fields(self, project_repo) -> None:
    ...
    def test_update_timestamp_changed(self, project_repo) -> None:
...
class TestMultiProjectScenarios:
    ...
    def test_large_number_of_projects(self, project_repo) -> None:
        count = 50
    ...
    def test_projects_with_shared_items_metadata(self, project_repo) -> None:
    ...
    def test_project_name_uniqueness(self, project_repo) -> None:
        project_repo.create("Unique Name")
        project = Project(name="Unique Name", project_metadata={})

    def test_complex_metadata_operations(self, project_repo) -> None:
...
class TestProjectMetadataEdgeCases:
    ...
    def test_boolean_metadata_values(self, project_repo) -> None:
...
class TestProjectConsistency:
    ...
    def test_consistency_after_multiple_updates(self, project_repo) -> None:
    ...
    def test_metadata_immutability_between_projects(self, project_repo) -> None:
...
class TestProjectDeletionEdgeCases:
    ...
    def test_delete_empty_project(self, db_session, project_repo) -> None:
    ...
    def test_delete_project_with_complex_relations(self, db_session, project_repo) -> None:
...
class TestProjectRepositoryBasicAsync:
    ...
    def test_project_repository_handles_async_session(self, project_repo) -> None:
    ...
    def test_project_repository_methods_are_async_ready(self, project_repo) -> None:
...
class TestProjectCreationValidation:
    ...
    def test_create_project_with_empty_name(self, project_repo) -> None:
        """Test creating project with empty name - should succeed but edge case."""
        project = project_repo.create("")
        assert project.name == ""

    def test_create_project_with_very_long_name(self, project_repo) -> None:
        """Test creating project with very long name."""
        long_name = "A" * 255
        project = project_repo.create(long_name)
        assert project.name == long_name

    def test_create_project_with_special_characters(self, project_repo) -> None:
    ...
    def test_create_project_with_unicode_characters(self, project_repo) -> None:
    ...
    def test_create_project_with_whitespace_only_name(self, project_repo) -> None:
        """Test project name with only whitespace."""
        project = project_repo.create("   ")
        assert project.name == "   "

    def test_create_project_with_newlines_in_name(self, project_repo) -> None:
        """Test project name containing newlines."""
        project = project_repo.create("Line1\nLine2\nLine3")
        assert "Line1\nLine2\nLine3" in project.name

    def test_create_project_with_very_long_description(self, project_repo) -> None:
    ...
    def test_create_project_preserves_metadata_structure(self, project_repo) -> None:
...
class TestProjectRetrievalAdvanced:
    ...
    def test_get_by_id_after_update(self, project_repo) -> None:
    ...
    def test_get_by_name_case_sensitive(self, project_repo) -> None:
        """Test that get by name is case sensitive."""
        project_repo.create("TestProject")
        result = project_repo.get_by_name("testproject")
        assert result is None

    def test_get_all_returns_copy_not_reference(self, project_repo) -> None:
    ...
    def test_get_all_ordering(self, project_repo) -> None:
    ...
    def test_get_by_id_returns_different_instance(self, project_repo) -> None:
...
class TestProjectUpdateAdvanced:
    ...
    def test_update_only_name_preserves_description_metadata(self, project_repo) -> None:
    ...
    def test_update_only_description_preserves_others(self, project_repo) -> None:
    ...
    def test_update_only_metadata_preserves_others(self, project_repo) -> None:
    ...
    def test_update_all_fields_simultaneously(self, project_repo) -> None:
    ...
    def test_update_metadata_to_empty_dict(self, project_repo) -> None:
    ...
    def test_update_with_none_values_unchanged(self, project_repo) -> None:
    ...
    def test_update_to_empty_string_name(self, project_repo) -> None:
        """Test updating name to empty string."""
        created = project_repo.create("NonEmpty")
        updated = project_repo.update(created.id, name="")
        assert updated.name == ""

    def test_update_to_empty_string_description(self, project_repo) -> None:
    ...
    def test_update_to_very_large_metadata(self, project_repo) -> None:
...
class TestProjectListingAndFiltering:
    ...
    def test_list_with_single_project(self, project_repo) -> None:
    ...
    def test_list_multiple_projects_maintains_identity(self, project_repo) -> None:
    ...
    def test_list_large_number_of_projects(self, project_repo) -> None:
    ...
    def test_list_with_mixed_metadata_sizes(self, project_repo) -> None:
...
class TestProjectDeletion:
    ...
    def test_delete_existing_project(self, db_session, project_repo) -> None:
    ...
    def test_delete_multiple_projects_independently(self, db_session, project_repo) -> None:
    ...
    def test_delete_preserves_other_projects_metadata(self, db_session, project_repo) -> None:
...
class TestProjectSettingsAndConfiguration:
    ...
    def test_settings_nested_structure(self, project_repo) -> None:
    ...
    def test_settings_with_defaults(self, project_repo) -> None:
    ...
    def test_settings_override(self, project_repo) -> None:
    ...
    def test_settings_with_array_values(self, project_repo) -> None:
...
class TestProjectIntegrationWorkflows:
    ...
    def test_create_update_retrieve_workflow(self, project_repo) -> None:
    ...
    def test_multiple_projects_independent_operations(self, project_repo) -> None:
    ...
    def test_project_lifecycle_complete(self, db_session, project_repo) -> None:
    ...
    def test_bulk_operations_consistency(self, project_repo) -> None:
...
class TestProjectConcurrency:
    ...
    def test_sequential_project_creation_stress(self, project_repo) -> None:
    ...
    def test_bulk_read_then_write_pattern(self, project_repo) -> None:
...
class TestProjectEdgeCasesAndErrors:
    ...
    def test_project_id_uniqueness(self, project_repo) -> None:
    ...
    def test_metadata_with_null_values(self, project_repo) -> None:
    ...
    def test_metadata_with_empty_arrays(self, project_repo) -> None:
    ...
    def test_metadata_with_mixed_types(self, project_repo) -> None:
    ...
    def test_get_all_after_multiple_deletes(self, db_session, project_repo) -> None:
...
class TestProjectPerformanceCharacteristics:
    ...
    def test_create_many_projects_performance(self, project_repo) -> None:
    ...
    def test_retrieval_with_many_projects(self, project_repo) -> None:
