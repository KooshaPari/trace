...
@pytest.fixture(scope="function")
def mock_db_connection(db_engine):
...
@pytest.fixture(scope="function")
def sync_engine(mock_db_connection, mock_api_client, mock_storage_manager):
...
class TestChangeDetectorComprehensive:
    ...
    def test_has_changed_content_modified(self):
    ...
    def test_has_changed_whitespace_matters(self):
    ...
    def test_detect_changes_in_directory_no_files(self, tmp_path):
        """Test directory detection with no files."""
        detector = ChangeDetector()
        changes = detector.detect_changes_in_directory(tmp_path, {})
        assert changes == []

    def test_detect_changes_in_directory_new_files(self, tmp_path):
    ...
    def test_detect_changes_in_directory_no_changes(self, tmp_markdown_dir):
    ...
    def test_detect_changes_in_directory_modified_file(self, tmp_markdown_dir):
    ...
    def test_detect_changes_in_directory_new_file_added(self, tmp_markdown_dir):
    ...
    def test_detect_changes_in_directory_non_md_files_ignored(self, tmp_path):
    ...
    def test_detect_changes_nested_directories(self, tmp_path):
...
class TestSyncQueueComprehensive:
    ...
    def test_sync_queue_initialization(self, mock_db_connection):
        """Test SyncQueue initialization."""
        queue = SyncQueue(mock_db_connection)
        assert queue.db == mock_db_connection

    def test_enqueue_basic(self, mock_db_connection):
    ...
    def test_enqueue_multiple_operations(self, mock_db_connection):
    ...
    def test_enqueue_all_entity_types(self, mock_db_connection):
    ...
    def test_enqueue_all_operations(self, mock_db_connection):
    ...
    def test_enqueue_complex_payload(self, mock_db_connection):
    ...
    def test_enqueue_empty_payload(self, mock_db_connection):
        """Test enqueue with empty payload."""
        queue = SyncQueue(mock_db_connection)
        queue_id = queue.enqueue(EntityType.ITEM, "item-empty", OperationType.DELETE, {})
        assert queue_id is not None

    def test_enqueue_large_payload(self, mock_db_connection):
    ...
    def test_get_pending_empty_queue(self, mock_db_connection):
        """Test get_pending on empty queue."""
        queue = SyncQueue(mock_db_connection)
        pending = queue.get_pending()
        assert pending == []

    def test_get_pending_single_item(self, mock_db_connection):
    ...
    def test_get_pending_multiple_items(self, mock_db_connection):
    ...
    def test_get_pending_limit(self, mock_db_connection):
    ...
    def test_get_pending_order(self, mock_db_connection):
    ...
    def test_remove_item(self, mock_db_connection):
    ...
    def test_remove_nonexistent_item(self, mock_db_connection):
        """Test removing non-existent item (should not error)."""
        queue = SyncQueue(mock_db_connection)
        queue.remove(999)  # Should not raise

    def test_update_retry_basic(self, mock_db_connection):
    ...
    def test_update_retry_multiple_times(self, mock_db_connection):
    ...
    def test_clear_queue(self, mock_db_connection):
    ...
    def test_get_count_empty(self, mock_db_connection):
        """Test count on empty queue."""
        queue = SyncQueue(mock_db_connection)
        assert queue.get_count() == 0

    def test_get_count_with_items(self, mock_db_connection):
    ...
    def test_get_count_after_remove(self, mock_db_connection):
    ...
    def test_queued_change_dataclass(self):
    ...
    def test_queued_change_with_error(self):
...
class TestSyncStateManagerComprehensive:
    ...
    def test_update_last_sync_default_time(self, mock_db_connection):
    ...
    def test_update_last_sync_custom_time(self, mock_db_connection):
    ...
    def test_update_status_idle(self, mock_db_connection):
    ...
    def test_update_status_syncing(self, mock_db_connection):
    ...
    def test_update_status_success(self, mock_db_connection):
    ...
    def test_update_status_error(self, mock_db_connection):
    ...
    def test_update_status_conflict(self, mock_db_connection):
    ...
    def test_update_error_with_message(self, mock_db_connection):
    ...
    def test_update_error_clear(self, mock_db_connection):
        """Test clearing error."""
        manager = SyncStateManager(mock_db_connection)
    ...
    def test_update_error_multiple_times(self, mock_db_connection):
    ...
    def test_sync_state_default_values(self):
    ...
    def test_multiple_status_updates(self, mock_db_connection):
    ...
    def test_concurrent_state_updates(self, mock_db_connection):
    ...
    def test_sync_result_with_many_errors(self):
    ...
    def test_sync_result_with_many_conflicts(self):
...
class TestSyncEngineLifecycleComprehensive:
    ...
    def test_queue_change_item_update(self, sync_engine):
        """Test queuing an item update."""
        queue_id = sync_engine.queue_change(
            entity_type=EntityType.ITEM, entity_id="item-1", operation=OperationType.UPDATE, payload={"status": "done"}
        )
        assert queue_id is not None

    def test_queue_change_item_delete(self, sync_engine):
        """Test queuing an item deletion."""
        queue_id = sync_engine.queue_change(
            entity_type=EntityType.ITEM, entity_id="item-1", operation=OperationType.DELETE, payload={}
        )
        assert queue_id is not None

    def test_queue_change_link(self, sync_engine):
    ...
    def test_queue_change_project(self, sync_engine):
    ...
    def test_queue_change_agent(self, sync_engine):
    ...
    def test_queue_multiple_changes(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_updates_status(self, sync_engine):
        """Test that sync updates status."""
        # Queue a change first
        sync_engine.queue_change(
            entity_type=EntityType.ITEM, entity_id="item-1", operation=OperationType.CREATE, payload={}
        )
        result = await sync_engine.sync()
    ...
    @pytest.mark.asyncio
    async def test_sync_records_errors(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_prevents_concurrent(self, sync_engine):
    ...
    def test_get_status_returns_sync_state(self, sync_engine):
    ...
    def test_conflict_strategy_initialization(self, mock_db_connection, mock_api_client, mock_storage_manager):
    ...
    def test_custom_retry_settings(self, mock_db_connection, mock_api_client, mock_storage_manager):
    ...
    def test_vector_clock_creation(self, sync_engine):
    ...
    def test_vector_clock_timestamp(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_process_queue_with_retries(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_pull_changes_with_timestamp(self, sync_engine):
...
class TestSyncEngineBatchOperations:
    ...
    @pytest.mark.asyncio
    async def test_batch_item_sync(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_link_sync(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_mixed_operations(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_large_batch_1000_items(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_large_batch_pagination(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_with_large_payloads(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_queue_access(self, sync_engine):
        """Test queue operations under concurrent access."""

        async def queue_items(start, count):
    ...
    def test_queue_memory_efficiency(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_sync_with_errors(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_retry_logic(self, sync_engine):
    ...
    def test_batch_deduplication(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_rollback_simulation(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_batch_sync_timing(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_handle_max_retries(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_with_timestamp_tracking(self, sync_engine):
    ...
    def test_handle_different_operation_sequences(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_integration_sync_complete_workflow(self, sync_engine):
        ...
        status_before = sync_engine.get_status()
        initial_pending = sync_engine.queue.get_count()
    ...
    def test_state_persistence_across_operations(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_error_propagation_in_batch(self, sync_engine):
...
class TestSyncEngineConcurrency:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_queue_operations(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_lock_prevents_concurrent_sync(self, sync_engine):
    ...
    def test_multiple_state_managers_consistency(self, mock_db_connection):
    ...
    def test_queue_ordering_under_load(self, sync_engine):
...
class TestSyncEngineEdgeCases:
    ...
    def test_queue_with_special_characters_in_id(self, sync_engine):
    ...
    def test_queue_with_unicode_in_payload(self, sync_engine):
    ...
    def test_sync_status_with_null_error(self, sync_engine):
        """Test sync status when error is None."""
        sync_engine.state_manager.update_error(None)
        state = sync_engine.get_status()
        assert state.last_error is None

    def test_sync_status_with_empty_string_error(self, sync_engine):
        """Test sync status with empty error string."""
        sync_engine.state_manager.update_error("")
        state = sync_engine.get_status()
        assert state.last_error == ""

    def test_sync_status_with_very_long_error(self, sync_engine):
    ...
    def test_queue_get_pending_negative_limit(self, sync_engine):
    ...
    def test_queue_get_pending_zero_limit(self, sync_engine):
        """Test get_pending with zero limit."""
        sync_engine.queue_change(EntityType.ITEM, "item-1", OperationType.CREATE, {})
        pending = sync_engine.queue.get_pending(limit=0)
        assert isinstance(pending, list)

    def test_queue_get_pending_very_large_limit(self, sync_engine):
    ...
    def test_payload_with_null_values(self, sync_engine):
        """Test payload with None values."""
        payload = {"title": None, "value": None}
        queue_id = sync_engine.queue_change(EntityType.ITEM, "item-1", OperationType.CREATE, payload)
        assert queue_id is not None

    def test_payload_with_nested_null_values(self, sync_engine):
        """Test payload with nested None values."""
        payload = {"nested": {"key": None}, "list": [1, None, 3]}
        queue_id = sync_engine.queue_change(EntityType.ITEM, "item-1", OperationType.CREATE, payload)
        assert queue_id is not None

    def test_remove_already_removed_item(self, sync_engine):
    ...
    def test_update_retry_removed_item(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_with_no_database_connection(self):
        ...
        try:
            if mock_db:
                engine = SyncEngine(mock_db, mock_api, mock_storage)
        except Exception:
            pass  # Expected

    def test_conflict_resolution_with_missing_timestamps(self, sync_engine):
    ...
    def test_conflict_resolution_with_invalid_timestamps(self, sync_engine):
    ...
    def test_state_update_with_very_old_timestamp(self, sync_engine):
    ...
    def test_state_update_with_future_timestamp(self, sync_engine):
    ...
    def test_change_detector_with_binary_like_content(self):
    ...
    def test_sync_result_with_negative_duration(self):
        """Test SyncResult with negative duration."""
        result = SyncResult(success=True, duration_seconds=-1.5)
        assert result.duration_seconds == -1.5

    def test_sync_result_with_extreme_entity_count(self):
    ...
    def test_queue_change_with_empty_entity_id(self, sync_engine):
        """Test queuing with empty entity ID."""
        queue_id = sync_engine.queue_change(EntityType.ITEM, "", OperationType.CREATE, {})
        assert queue_id is not None

    def test_queue_change_with_very_long_entity_id(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_with_mixed_success_and_failure(self, sync_engine):
    ...
    def test_vector_clock_with_extreme_versions(self, sync_engine):
    ...
    def test_multiple_clear_operations(self, sync_engine):
...
class TestSyncEngineIntegration:
    ...
    @pytest.mark.asyncio
    async def test_sync_with_item_service_integration(self, sync_engine, db_session, sample_project):
        ...
        # Queue a sync change
        queue_id = sync_engine.queue_change(
            EntityType.ITEM, "int-item-1", OperationType.UPDATE, {"status": "in_progress"}
        )
        assert queue_id is not None

    @pytest.mark.asyncio
    async def test_sync_with_link_service_integration(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_preserves_data_integrity(self, sync_engine):
        ...
        queue_id = sync_engine.queue_change(EntityType.ITEM, "integrity-test", OperationType.CREATE, test_payload)
    ...
    @pytest.mark.asyncio
    async def test_sync_with_api_client_integration(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_state_with_storage_integration(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_full_sync_cycle_simulation(self, sync_engine):
    ...
    def test_conflict_detection_basic(self, sync_engine):
    ...
    def test_conflict_history_tracking(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_ui_feedback_during_sync(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_recovery_from_failure(self, sync_engine):
    ...
    def test_change_tracking_completeness(self, sync_engine):
    ...
    def test_change_compaction(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_with_empty_database(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_checkpoint_resume(self, sync_engine):
    ...
    def test_metadata_versioning(self, sync_engine):
    ...
    @pytest.mark.asyncio
    async def test_performance_sync_1000_items(self, sync_engine):
