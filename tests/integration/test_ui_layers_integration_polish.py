...
class TestCliServiceIntegration:
    ...
    def test_cli_create_item_basic(self):
    ...
    def test_cli_create_link_basic(self):
    ...
    def test_cli_list_items_basic(self):
...
class TestCliServiceDataFlow:
    ...
    def test_cli_parses_input_with_special_chars(self):
    ...
    def test_cli_handles_long_arguments(self):
...
class TestTuiServiceIntegration:
    ...
    def test_tui_widget_instantiation(self):
...
class TestCrossLayerDataConsistency:
    ...
    def test_cli_item_command_variations(self):
...
class TestUnicodeIntegration:
    ...
    def test_cli_with_chinese_characters(self):
    ...
    def test_cli_with_japanese_characters(self):
    ...
    def test_cli_with_korean_characters(self):
...
class TestSearchIntegration:
    ...
    def test_search_command_with_simple_query(self):
    ...
    def test_search_command_with_unicode_query(self):
    ...
    def test_search_command_with_special_chars(self):
...
class TestProjectIntegration:
    ...
    def test_project_list_command(self):
    ...
    def test_project_init_command(self):
    ...
    def test_project_init_with_description(self):
