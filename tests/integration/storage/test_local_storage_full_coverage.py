...
class TestLocalStorageManagerInitialization:
    ...
    def test_get_session_returns_session(self, storage_manager) -> None:
        """Test that get_session returns valid session."""
        session = storage_manager.get_session()
        assert session is not None
        session.close()

    def test_multiple_managers_use_same_db(self, temp_base_dir) -> None:
...
class TestProjectInitialization:
    ...
    def test_init_project_creates_subdirectories(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_creates_project_yaml(self, temp_project_dir, storage_manager) -> None:
        """Test that init_project creates project.yaml."""
        trace_dir, project_id = storage_manager.init_project(
            temp_project_dir, project_name="MyProject", description="My test project",
        )
    ...
    def test_init_project_creates_links_yaml(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_creates_agents_yaml(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_raises_if_already_exists(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_generates_unique_ids(self, temp_base_dir) -> None:
    ...
    def test_init_project_handles_file_path(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_initializes_counters(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_init_project_with_metadata(self, temp_project_dir, storage_manager) -> None:
...
class TestProjectRegistration:
    ...
    def test_register_project_creates_registry_entry(self, temp_base_dir) -> None:
    ...
    def test_register_project_raises_without_trace(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_register_project_generates_missing_id(self, temp_project_dir, storage_manager) -> None:
...
class TestProjectIndexing:
    ...
    def test_index_project_creates_project_in_db(self, temp_base_dir) -> None:
    ...
    def test_index_project_returns_counts(self, temp_base_dir) -> None:
    ...
    def test_index_project_with_markdown_files(self, temp_base_dir) -> None:
        """Test indexing project with existing markdown files."""
        manager = LocalStorageManager(base_dir=temp_base_dir / "storage")
        project_dir = temp_base_dir / "project"
        project_dir.mkdir()

        trace_dir, project_id = manager.init_project(project_dir)
...
"""
    ...
    def test_index_project_updates_timestamp(self, temp_base_dir) -> None:
...
class TestItemCRUD:
    ...
    def test_create_item(self, temp_base_dir) -> None:
    ...
    def test_create_item_generates_markdown(self, temp_base_dir) -> None:
    ...
    def test_create_item_queues_for_sync(self, temp_base_dir) -> None:
    ...
    def test_update_item(self, temp_base_dir) -> None:
    ...
    def test_update_item_updates_markdown(self, temp_base_dir) -> None:
    ...
    def test_delete_item_soft_deletes(self, temp_base_dir) -> None:
    ...
    def test_delete_item_removes_markdown(self, temp_base_dir) -> None:
    ...
    def test_get_item_returns_item(self, temp_base_dir) -> None:
    ...
    def test_list_items_returns_all(self, temp_base_dir) -> None:
    ...
    def test_list_items_filters_by_status(self, temp_base_dir) -> None:
...
class TestLinkManagement:
    ...
    def test_create_link(self, temp_base_dir) -> None:
    ...
    def test_delete_link(self, temp_base_dir) -> None:
    ...
    def test_list_links_by_source(self, temp_base_dir) -> None:
...
class TestCounterManagement:
    ...
    def test_get_project_counters(self, temp_base_dir) -> None:
    ...
    def test_increment_project_counter(self, temp_base_dir) -> None:
    ...
    def test_increment_counter_multiple_times(self, temp_base_dir) -> None:
...
class TestMarkdownFileIO:
    ...
    def test_write_item_markdown_creates_file(self, temp_base_dir) -> None:
    ...
    def test_markdown_contains_frontmatter(self, temp_base_dir) -> None:
    ...
    def test_markdown_contains_title_heading(self, temp_base_dir) -> None:
    ...
    def test_markdown_parsing_roundtrip(self, temp_base_dir) -> None:
...
class TestSyncQueue:
    ...
    def test_queue_sync_adds_entry(self, storage_manager) -> None:
    ...
    def test_get_sync_queue_returns_entries(self, storage_manager) -> None:
    ...
    def test_sync_queue_limit(self, storage_manager) -> None:
...
class TestSyncState:
    ...
    def test_get_sync_state_returns_none_if_missing(self, storage_manager) -> None:
        """Test that get_sync_state returns None if key not found."""
        value = storage_manager.get_sync_state("nonexistent_key")
        assert value is None

    def test_sync_state_update_timestamp(self, storage_manager) -> None:
...
class TestFullTextSearch:
    ...
    def test_search_items_by_title(self, temp_base_dir) -> None:
    ...
    def test_search_items_by_description(self, temp_base_dir) -> None:
    ...
    def test_search_items_filters_by_project(self, temp_base_dir) -> None:
...
class TestErrorHandling:
    ...
    def test_update_nonexistent_item_raises(self, temp_base_dir) -> None:
    ...
    def test_delete_nonexistent_item_raises(self, temp_base_dir) -> None:
    ...
    def test_delete_nonexistent_link_raises(self, temp_base_dir) -> None:
    ...
    def test_register_project_without_trace_raises(self, temp_project_dir, storage_manager) -> None:
        """Test that registering project without .trace/ raises."""
        with pytest.raises(ValueError, match="No .trace/ directory"):
            storage_manager.register_project(temp_project_dir)

    def test_index_project_without_trace_raises(self, temp_project_dir, storage_manager) -> None:
...
class TestEdgeCases:
    ...
    def test_item_with_unicode_title(self, temp_base_dir) -> None:
    ...
    def test_item_with_special_characters(self, temp_base_dir) -> None:
    ...
    def test_item_with_very_long_description(self, temp_base_dir) -> None:
    ...
    def test_item_with_multiline_description(self, temp_base_dir) -> None:
    ...
    def test_empty_item_title(self, temp_base_dir) -> None:
    ...
    def test_item_with_all_statuses(self, temp_base_dir) -> None:
    ...
    def test_item_with_all_priorities(self, temp_base_dir) -> None:
...
class TestConcurrentAccess:
    ...
    def test_concurrent_item_creation(self, temp_base_dir) -> None:
...
class TestProjectStorage:
    ...
    def test_project_storage_creates_project(self, temp_base_dir) -> None:
    ...
    def test_project_storage_gets_project(self, temp_base_dir) -> None:
    ...
    def test_project_storage_generates_readme(self, temp_base_dir) -> None:
...
class TestProjectPathDetection:
    ...
    def test_is_trace_project_returns_true(self, temp_base_dir) -> None:
    ...
    def test_is_trace_project_returns_false(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_get_project_trace_dir(self, temp_base_dir) -> None:
    ...
    def test_get_project_trace_dir_returns_none(self, temp_project_dir, storage_manager) -> None:
    ...
    def test_get_project_trace_dir_with_file_path(self, project_with_trace, storage_manager) -> None:
...
class TestIntegration:
    ...
    def test_full_workflow_epic_to_stories(self, temp_base_dir) -> None:
    ...
    def test_full_workflow_project_lifecycle(self, temp_base_dir) -> None:
        ...
        trace_dir, project_id = manager.init_project(
            project_dir, project_name="MyProject", description="A test project",
        )
...
class TestAdditionalCoverage:
    ...
    def test_get_current_project_path(self, temp_base_dir) -> None:
    ...
    def test_get_project_storage_global_projects_dir(self, temp_base_dir) -> None:
    ...
    def test_item_storage_with_tags_metadata(self, temp_base_dir) -> None:
    ...
    def test_item_with_parent_relationship(self, temp_base_dir) -> None:
    ...
    def test_link_creation_updates_markdown(self, temp_base_dir) -> None:
    ...
    def test_update_links_yaml(self, temp_base_dir) -> None:
    ...
    def test_get_item_storage(self, temp_base_dir) -> None:
    ...
    def test_create_or_update_project_updates_existing(self, temp_base_dir) -> None:
    ...
    def test_item_metadata_merge_on_update(self, temp_base_dir) -> None:
    ...
    def test_markdown_file_with_description(self, temp_base_dir) -> None:
    ...
    def test_hash_content_calculation(self, temp_base_dir) -> None:
    ...
    def test_fts_index_update(self, temp_base_dir) -> None:
    ...
    def test_get_item_path_for_different_types(self, temp_base_dir) -> None:
    ...
    def test_view_field_uppercase(self, temp_base_dir) -> None:
