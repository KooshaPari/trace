...
class TestLocalStorageManagerInitialization:
    ...
    def test_get_session_returns_session(self, storage_manager):
        """Test that get_session returns valid session."""
        session = storage_manager.get_session()
        assert session is not None
        session.close()

    def test_multiple_managers_use_same_db(self, temp_base_dir):
...
class TestProjectInitialization:
    ...
    def test_init_project_creates_subdirectories(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_creates_project_yaml(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_creates_links_yaml(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_creates_agents_yaml(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_raises_if_already_exists(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_generates_unique_ids(self, temp_base_dir):
    ...
    def test_init_project_handles_file_path(self, temp_project_dir, storage_manager):
    ...
    def test_init_project_initializes_counters(self, temp_project_dir, storage_manager):
...
class TestProjectRegistration:
    ...
    def test_register_project_creates_registry_entry(self, temp_base_dir):
    ...
    def test_register_project_raises_without_trace(self, temp_project_dir, storage_manager):
    ...
    def test_register_project_generates_missing_id(self, temp_project_dir, storage_manager):
...
class TestProjectIndexing:
    ...
    def test_index_project_creates_project_in_db(self, temp_base_dir):
    ...
    def test_index_project_returns_counts(self, temp_base_dir):
    ...
    def test_index_project_with_markdown_files(self, temp_base_dir):
...
"""
    ...
    def test_index_project_updates_timestamp(self, temp_base_dir):
...
class TestCounterManagement:
    ...
    def test_get_project_counters(self, temp_base_dir):
    ...
    def test_increment_counter_multiple_times(self, temp_base_dir):
...
class TestMarkdownFileIO:
    ...
    def test_markdown_parsing_roundtrip(self, temp_base_dir):
...
class TestSyncQueue:
    ...
    def test_queue_sync_adds_entry(self, storage_manager):
    ...
    def test_get_sync_queue_returns_entries(self, storage_manager):
    ...
    def test_sync_queue_limit(self, storage_manager):
    ...
    def test_sync_queue_payload_json(self, storage_manager):
...
class TestSyncState:
    ...
    def test_get_sync_state_returns_none_if_missing(self, storage_manager):
        """Test that get_sync_state returns None if key not found."""
        value = storage_manager.get_sync_state("nonexistent_key")
        assert value is None

    def test_sync_state_update_timestamp(self, storage_manager):
...
class TestFullTextSearch:
    ...
    def test_search_items_filters_by_project(self, temp_base_dir):
...
class TestErrorHandling:
    ...
    def test_register_project_without_trace_raises(self, temp_project_dir, storage_manager):
...
class TestProjectPathDetection:
    ...
    def test_is_trace_project_returns_true(self, temp_base_dir):
    ...
    def test_is_trace_project_returns_false(self, temp_project_dir, storage_manager):
    ...
    def test_get_project_trace_dir(self, temp_base_dir):
...
class TestAdditionalCoverage:
    ...
    def test_get_current_project_path(self, temp_base_dir):
