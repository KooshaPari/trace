...
class TestMCPHTTPAuth:
    ...
    def test_tools_list_with_valid_token(self, mock_verify, client, mock_valid_token) -> None:
    ...
    def test_tools_list_without_token(self, client) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_tools_list_with_invalid_token(self, mock_verify, client) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_user_context_injection(self, mock_verify, client, mock_valid_token) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_messages_endpoint_with_valid_token(self, mock_verify, client, mock_valid_token) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_messages_endpoint_with_invalid_token(self, mock_verify, client) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_jsonrpc_error_format(self, mock_verify, client, mock_valid_token) -> None:
    ...
    async def test_rls_with_user_context(self, mock_db, mock_verify, client, mock_valid_token) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_sse_endpoint_with_valid_token(self, mock_verify, client, mock_valid_token) -> None:
    ...
    @patch("tracertm.api.deps.verify_token")
    def test_same_token_works_for_rest_and_mcp(self, mock_verify, client, mock_valid_token) -> None:
...
class TestMCPToolExecution:
    ...
    @patch("tracertm.api.deps.verify_token")
    async def test_tool_call_with_user_context(self, mock_verify, client, mock_valid_token) -> None:
