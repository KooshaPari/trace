...
try:
    from textual.pilot import Pilot  # type: ignore[import-untyped]
...
@pytest.fixture
def test_database(temp_config_dir):
...
@pytest.fixture
def mock_storage_adapter(tmp_path):
    ...
    async def test_enhanced_dashboard_item_change_callback(self, tmp_path, mock_config_manager):
        ...
        with patch(
            ...
            async with app.run_test() as pilot:  # type: ignore[union-attr]  # type: ignore[union-attr]
                ...
                app.storage_adapter._notify_item_change("test-item-123")  # type: ignore[union-attr]
                await pilot.pause()
