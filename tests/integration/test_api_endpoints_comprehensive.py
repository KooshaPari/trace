...
def test_list_items_by_project(client, test_project, test_items):
...
def test_get_item(client, test_items):
...
def test_delete_item(client, test_items):
...
def test_list_links_by_project(client, test_project, test_links):
...
def test_list_links_by_source(client, test_items, test_links):
...
def test_list_links_by_target(client, test_items, test_links):
...
def test_list_links_by_source_and_target(client, test_items, test_links):
...
def test_impact_analysis(client, test_project, test_items):
...
def test_shortest_path(client, test_project, test_items):
...
def test_missing_required_fields(client, test_project):
...
def test_special_characters_in_data(client, test_project):
...
def test_unicode_handling(client, test_project):
...
def test_item_response_format(client, test_items):
...
def test_list_response_format(client, test_project, test_items):
...
def test_project_response_format(client, test_project):
...
def test_get_graph_neighbors_outgoing(client, test_project, test_items, test_links):
...
def test_get_graph_neighbors_incoming(client, test_project, test_items, test_links):
...
def test_get_graph_neighbors_both_directions(client, test_project, test_items):
...
def test_null_optional_fields_handling(client, test_project):
