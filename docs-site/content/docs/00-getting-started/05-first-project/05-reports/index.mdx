...
Welcome to the Generating Reports documentation.

## Introduction

This page provides comprehensive information about Generating Reports.
...
```typescript
const example = await tracertm.reports({
  option1: 'value1',
  option2: 'value2'
})
```
...
```typescript
const advanced = await tracertm.reports({
  advanced: {
    feature1: true,
    feature2: false
  }
