---
title: "Benefits"
description: "Documentation for Benefits"
---
...
Welcome to the Benefits documentation.

## Introduction

This page provides comprehensive information about Benefits.
...
```bash
tracertm init
tracertm config set benefits enabled
```
...
const result = await tracertm.benefits()
```
...
```typescript
const example = await tracertm.benefits({
  option1: 'value1',
  option2: 'value2'
})
```
...
```typescript
const advanced = await tracertm.benefits({
  advanced: {
    feature1: true,
    feature2: false
  }
