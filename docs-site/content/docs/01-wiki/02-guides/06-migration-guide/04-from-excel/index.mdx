---
title: "From Excel"
description: "Documentation for From Excel"
---
...
Comprehensive guide for From Excel.

## Introduction

This guide covers everything you need to know about From Excel.
...
```bash
tracertm init
tracertm config set from.excel enabled
```
...
```bash
# Step 1: Initialize
tracertm from-excel init

# Step 2: Execute
tracertm from-excel run

# Step 3: Verify
tracertm from-excel status
```
...
async function example() {
  const tracertm = new TraceRTM()
  const result = await tracertm.fromexcel()
  console.log(result)
}
```
