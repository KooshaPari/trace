---
title: "From IBM DOORS"
description: "Documentation for From IBM DOORS"
---
...
Comprehensive guide for From IBM DOORS.

## Introduction

This guide covers everything you need to know about From IBM DOORS.
...
```bash
tracertm init
tracertm config set from.doors enabled
```
...
```bash
# Step 1: Initialize
tracertm from-doors init

# Step 2: Execute
tracertm from-doors run

# Step 3: Verify
tracertm from-doors status
```
...
async function example() {
  const tracertm = new TraceRTM()
  const result = await tracertm.fromdoors()
  console.log(result)
}
```
