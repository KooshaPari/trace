...
Complete API reference for Users API.
...
```http
PUT /api/v1/users-api/:id
```

### Delete Users API

```http
DELETE /api/v1/users-api/:id
```
...
const items = await client.users-api.list()
```
