...
### List All GraphQL API

```http
GET /api/v1/graphql-api
```
...
```http
GET /api/v1/graphql-api/:id
```

### Create GraphQL API

```http
POST /api/v1/graphql-api
```
...
```http
PUT /api/v1/graphql-api/:id
```

### Delete GraphQL API

```http
DELETE /api/v1/graphql-api/:id
```
...
const items = await client.graphql-api.list()
```
