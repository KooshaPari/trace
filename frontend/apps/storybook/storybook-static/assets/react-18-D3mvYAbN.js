import { T as Qh, r as ei } from "./iframe-BP6kYN29.js";
import { r as Xh } from "./index-DqgLOw3J.js";
	...
	function gu(l) {
		...
		if (typeof l == "object")
			switch (l.$$typeof) {
				...
				case ya:
					return (
						(a = l.displayName || null), a !== null ? a : gu(l.type) || "Memo"
					);
				case rl:
...
` +
	...
	function Ge(l, a, t, u, e, n) {
		...
		if (((u = l), typeof l == "function")) bf(l) && (f = 1);
			...
			l: switch (l) {
				...
				case Ot:
					return (
						(l = ql(12, t, a, e | 2)), (l.elementType = Ot), (l.lanes = n), l
					);
				case et:
		...
		return (
			(a = ql(f, t, a, e)), (a.elementType = l), (a.type = u), (a.lanes = n), a
		);
	}
	function ht(l, a, t, u) {
		...
		function S(y, v, m, b, D) {
			...
			if (typeof b == "object" && b !== null) {
				switch (b.$$typeof) {
					case qa:
						return (
							(y = y.get(b.key === null ? m : b.key) || null), i(v, y, b, D)
						);
					case kl:
						return (
							(y = y.get(b.key === null ? m : b.key) || null), h(v, y, b, D)
						);
					case rl:
	...
	var iv = {
			...
			useOptimistic: function (l) {
				...
				return (
					(a.queue = t), (a = Pf.bind(null, _, !0, t)), (t.dispatch = a), [l, a]
				);
			},
			useMemoCache: xf,
...
`,
	...
	function Nh(l, a, t, u, e) {
		switch (a) {
			...
			case "gotpointercapture":
				return (
					(n = e.pointerId), fe.set(n, ce(fe.get(n) || null, l, a, t, u, e)), !0
				);
		}
		return !1;
	}
	...
	var ny = cl.version;
	if (ny !== "19.2.0") throw Error(s(527, ny, "19.2.0"));
