...
import { _ as F, a as G, r as we, G as Z } from "./iframe-BP6kYN29.js";
import "./preload-helper-PPVm8Dsz.js";
import "./react-18-D3mvYAbN.js";
import "./index-DqgLOw3J.js";
import "./index-Dj-uACAQ.js";
function xe(e) {
		...
		"../node_modules/refractor/lang/graphql.js"(e, r) {
			...
			function t(a) {
				(a.languages.graphql = {
					...
					a.hooks.add("after-tokenize", (n) => {
						if (n.language !== "graphql") return;
						var o = n.tokens.filter(
								(A) =>
									typeof A != "string" &&
									A.type !== "comment" &&
									A.type !== "scalar",
			...
			function t(a) {
				((n) => {
					...
					(n.languages.markdown = n.languages.extend("markup", {})),
						...
						["url", "bold", "italic", "strike"].forEach((y) => {
						...
						n.hooks.add("wrap", (y) => {
							if (y.type === "code-block") {
								...
								if (s) y.content = n.highlight(b(y.content.value), s, S);
									...
									(y.attributes.id = p),
										n.plugins.autoloader.loadLanguages(S, () => {
					...
					function b(y) {
						var S = y.replace(h, "");
						return (
							(S = S.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, (E, _) => {
					...
					var o = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
						...
						l = {
							...
							util: {
								...
								type: (i) => Object.prototype.toString.call(i).slice(8, -1),
								objId: (i) => (
							...
							languages: {
								...
								insertBefore: (i, s, p, g) => {
									g = g || l.languages;
									var m = g[i],
										c = {};
									for (var w in m)
										if (Object.hasOwn(m, w)) {
											if (w == s)
												for (var v in p) Object.hasOwn(p, v) && (c[v] = p[v]);
											Object.hasOwn(p, w) || (c[w] = m[w]);
										}
									var k = g[i];
									return (
										(g[i] = c),
									...
									for (
										...
										if (!(B instanceof f)) {
											...
											if (z) {
												...
												if (
													((j -= O.value.length), (L = j), O.value instanceof f)
												)
													continue;
												for (
													var I = O;
													I !== s.tail &&
													(j < ce || typeof I.value == "string");
													I = I.next
												)
													Q++, (j += I.value.length);
	...
	an = F({
		"../node_modules/refractor/core.js"(e, r) {
			...
			function S(c, w) {
				...
				for (N in k)
					for (
						$ = k[N], $ = typeof $ == "string" ? [$] : $, H = $.length, z = -1;
						++z < H;
					)
						v[$[z]] = v[N];
			}
...
function fe(e) {
	for (var r = 1; r < arguments.length; r++) {
		...
		r % 2
			? Ke(Object(t), !0).forEach((a) => {
					Ve(e, a, t[a]);
				})
			: Object.getOwnPropertyDescriptors
				? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
				: Ke(Object(t)).forEach((a) => {
...
function cn(e) {
	var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
		...
		a = e.filter((o) => o !== "token"),
		n = un(a);
	return n.reduce((o, u) => fe(fe({}, o), t[u]), r);
}
function Xe(e) {
	return e.join(" ");
}
	...
	if (f) {
		...
		if (!o) x = fe(fe({}, d), {}, { className: Xe(d.className) });
			...
			var b = Object.keys(t).reduce(
				...
				S = d.className && y.concat(d.className.filter((_) => !b.includes(_)));
			x = fe(
				fe({}, d),
				{},
				{
...
function ut(e) {
	for (
		...
		if (n.type === "text")
			...
			ut(n.children, o).forEach((u) => t.push(u));
		}
	}
	return t;
}
	...
	return (t) => {
		...
		return G.createElement(
			...
			G.createElement(
				...
				x,
				!A && Q,
				$({ rows: re, stylesheet: l, useInlineStyles: y }),
			),
		);
	};
}
var Be = Z(an()),
	Me = Kn(Be.default, {});
Me.registerLanguage = (e, r) => Be.default.register(r);
Me.alias = (e, r) => Be.default.alias(e, r);
var ze = Me,
	{ window: Xn } = ln,
	Yn = {
		jsextra: xn,
...
var Vn = (0, rn.default)(2)((e) =>
	...
	dt = ({
		...
		const [h, C] = we.useState("");
		we.useEffect(() => {
			u ? u(o, e).then(C) : C(e.trim());
		}, [e, o, u]);
		const [x, b] = we.useState(!1),
			y = we.useCallback(
				(E) => {
					E.preventDefault(),
						Jn(h)
...
var da = dt;
export { dt as SyntaxHighlighter, da as default, Yn as supportedLanguages };
