...
function Ae(n = !1) {
	const e = Re(n),
		...
		s = (a) => `\x1B[${a}m`;
	for (const [a, o] of Me) i[a] = e ? r(s(o[0]), s(o[1]), o[2]) : j;
	return i;
}
Ae();
function ae(n, e) {
...
function Oe() {
	...
	return (
		...
		(k.isElement = (c) =>
			typeof c == "object" && c !== null && c.$$typeof === n),
...
function Je() {
	...
	return (
		...
		(v.isElement = (u) =>
			typeof u == "object" && u !== null && u.$$typeof === n),
