...
import { AgentStatus, ItemPriority, ItemStatus, ItemType, LinkType } from '../../src/api/types'
 ...
 */
export function generateTestLink(sourceId: string, targetId: string, overrides: Partial<Link> = {}): Link {
  return {
