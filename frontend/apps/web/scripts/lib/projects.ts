...
export const PROJECTS: ProjectConfig[] = [
	...
	},
	{
		...
		description:
			"Cross-platform mobile application for TraceRTM with offline-first architecture",
		domain: "mobile",
		itemCounts: {
			requirements: 120,
			features: 180,
	...
	},
	{
		...
		description:
			"Real-time analytics, reporting, and predictive insights for project metrics",
		domain: "data",
		itemCounts: {
			requirements: 150,
			features: 200,
	...
	},
	{
		...
		description:
			"Kubernetes-based deployment, monitoring, and infrastructure-as-code automation",
		domain: "devops",
		itemCounts: {
			requirements: 100,
			features: 150,
