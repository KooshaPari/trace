...
export function useEARSAnalysis(projectId: string, specId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeEARSRequest) =>
...
export function useQualityAnalysis(projectId: string, specId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeQualityRequest) =>
		...
		onSuccess: (data) => {
			queryClient.setQueryData(
				specAnalyticsKeys.quality(projectId, specId),
				data,
			);
		},
	});
...
export function useVerifyBaseline(
	projectId: string,
	specType: SpecType,
	specId: string,
) {
	return useMutation({
		mutationFn: (baselineRoot: string) =>
...
export function useFlakinessAnalysis(projectId: string, specId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeFlakinessRequest) =>
		...
		onSuccess: (data) => {
			queryClient.setQueryData(
				specAnalyticsKeys.flakiness(projectId, specId),
				data,
			);
		},
	});
...
export function useODCClassification(projectId: string, specId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeODCRequest) =>
...
export function useCVSSScore(projectId: string, specId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeCVSSRequest) =>
...
export function useImpactAnalysis(
	...
	return useMutation({
		mutationFn: (request?: AnalyzeImpactRequest) =>
		...
		onSuccess: (data) => {
			queryClient.setQueryData(
				specAnalyticsKeys.impact(projectId, specType, specId),
				data,
			);
		},
	});
...
export function usePrioritization(
	...
	return useMutation({
		mutationFn: (request?: CalculatePrioritizationRequest) =>
		...
		onSuccess: (data) => {
			queryClient.setQueryData(
				specAnalyticsKeys.prioritization(projectId, specType, specId),
				data,
			);
		},
	});
...
export function useCoverageGapAnalysis(projectId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeCoverageGapsRequest) =>
...
export function useSuspectLinkAnalysis(projectId: string) {
	...
	return useMutation({
		mutationFn: (request?: AnalyzeSuspectLinksRequest) =>
...
export function useSimilarityAnalysis(
	...
	return useMutation({
		mutationFn: (request?: AnalyzeSimilarityRequest) =>
		...
		onSuccess: (data) => {
			queryClient.setQueryData(
				specAnalyticsKeys.similarity(projectId, specType, specId),
				data,
			);
		},
	});
