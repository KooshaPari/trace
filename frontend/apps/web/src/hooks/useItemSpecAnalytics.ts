  ...
  return {
    invalidateAll: (projectId: string) => {
      queryClient
        ...
        .catch((error) => logger.error('Failed to invalidate all:', error));
    },
    invalidateContentAddress: (projectId: string, specType: SpecType, specId: string) => {
      queryClient
        ...
        .catch((error) => logger.error('Failed to invalidate content address:', error));
    },
    invalidateVersionChain: (projectId: string, specType: SpecType, specId: string) => {
      queryClient
        ...
        .catch((error) => logger.error('Failed to invalidate version chain:', error));
    },
  };
}
