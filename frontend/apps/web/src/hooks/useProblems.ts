...
function transformProblem(data: Record<string, unknown>): Problem {
	return {
		...
		affectedUsersEstimated: data["affected_users_estimated"] as
			| number
			| undefined,
		assignedTeam: data["assigned_team"] as string | undefined,
		assignedTo: data["assigned_to"] as string | undefined,
		businessImpactDescription: data["business_impact_description"] as
			| string
			| undefined,
		...
		permanentFixDescription: data["permanent_fix_description"] as
			| string
			| undefined,
		...
		rootCauseCategory: data["root_cause_category"] as
			| RootCauseCategory
			| undefined,
