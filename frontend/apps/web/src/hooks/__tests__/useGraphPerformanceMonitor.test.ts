...
const mockCacheStats: {
	...
	grouping: {
		entriesBySize: { large: 0, medium: 1, small: 3, tiny: 1 },
		hitRatio: 0.8,
		maxEntries: 50,
		maxMemory: 26_214_400,
		memoryUsagePercent: 2,
		newestEntry: { age: 10, key: "grouping:graph2:status" },
		oldestEntry: { age: 200, key: "grouping:graph1:type" },
		totalEntries: 5,
		totalHits: 40,
		totalMemory: 512_000,
		totalMisses: 10,
	...
	layout: {
		entriesBySize: { large: 0, medium: 3, small: 5, tiny: 2 },
		hitRatio: 0.8,
		maxEntries: 100,
		maxMemory: 52_428_800,
		memoryUsagePercent: 2,
		newestEntry: { age: 5, key: "layout:graph2:force" },
		oldestEntry: { age: 300, key: "layout:graph1:dagre" },
		totalEntries: 10,
		totalHits: 80,
	...
	search: {
		entriesBySize: { large: 0, medium: 1, small: 3, tiny: 4 },
		hitRatio: 0.8,
		maxEntries: 100,
		maxMemory: 10_485_760,
		memoryUsagePercent: 2,
		newestEntry: { age: 2, key: "search:graph2:node" },
		oldestEntry: { age: 100, key: "search:graph1:test" },
		totalEntries: 8,
		totalHits: 60,
		totalMemory: 256_000,
		totalMisses: 15,
