...
function uploadBufferData(
  ...
  device.queue.writeBuffer(buffers.positions, 0, data.positions);
  device.queue.writeBuffer(buffers.velocities, 0, data.velocities);
  device.queue.writeBuffer(buffers.forces, 0, data.forces);
  device.queue.writeBuffer(buffers.edges, 0, params.edges);
