  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      ...
      return queryClient.invalidateQueries({
        queryKey: [queryKeys.branchComparison, variables.sourceBranchId, variables.targetBranchId],
      });
    },
  });
}
...
export function useCompareBranches(sourceBranchId: string, targetBranchId: string) {
  return useQuery({
