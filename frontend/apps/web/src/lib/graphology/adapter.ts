...
import type { GraphologyAdapter, GraphologyNodeAttributes, GraphologyEdgeAttributes } from './types';
    ...
    edges.forEach(edge => {
      ...
      try {
        const attributes: GraphologyEdgeAttributes = {
          ...
          weight: 1,
          color: typeof edge.style?.stroke === 'string' ? edge.style.stroke : '#94a3b8',
          ...edge.data,
        };
