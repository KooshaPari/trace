...
const apiGroups: ApiGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      { id: '3.1', method: 'GET', path: '/', description: 'List all links', status: 'implemented' },
      { id: '3.2', method: 'POST', path: '/', description: 'Create a link', status: 'implemented' },
      {
        id: '3.3',
        method: 'DELETE',
        path: '/{id}',
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2 text-xs">
          <span className="flex items-center gap-1">
            <span className={`h-2 w-2 rounded-full ${statusBadge.implemented}`} /> Implemented
          </span>
          <span className="flex items-center gap-1">
            <span className={`h-2 w-2 rounded-full ${statusBadge.planned}`} /> Planned
          </span>
        </div>
      </div>
        ...
        {apiGroups.map((group) => (
          <div key={group.id} className="border-b last:border-b-0">
            ...
            >
              ...
              <code className="ml-2 text-xs text-muted-foreground">{group.baseUrl}</code>
              ...
              <div className="border-t bg-muted/20">
                {group.endpoints.map((endpoint) => (
                  ...
                  >
                    ...
                    <button className="rounded p-1 hover:bg-accent" title="Try it">
