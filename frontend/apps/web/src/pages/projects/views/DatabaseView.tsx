...
const tables: TableDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'parent_id', type: 'UUID', nullable: true, isForeign: true, references: 'items.id' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'source_id', type: 'UUID', nullable: false, isForeign: true, references: 'items.id' },
      { name: 'target_id', type: 'UUID', nullable: false, isForeign: true, references: 'items.id' },
      { name: 'type', type: 'VARCHAR(50)', nullable: false },
      { name: 'description', type: 'TEXT', nullable: true },
      { name: 'metadata', type: 'JSONB', nullable: true },
      { name: 'created_at', type: 'TIMESTAMP', nullable: false },
  ...
  },
  {
    ...
    columns: [
      { name: 'id', type: 'UUID', nullable: false, isPrimary: true },
      { name: 'item_id', type: 'UUID', nullable: false, isForeign: true, references: 'items.id' },
      { name: 'version', type: 'INTEGER', nullable: false },
