...
export function WebhookIntegrationsView({
	...
	const [providerFilter, setProviderFilter] = useState<WebhookProvider | "all">(
		"all",
	);
		...
		<div className="p-6 space-y-6">
				...
				<Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
					...
					<DialogContent className="sm:max-w-[500px]">
						<DialogHeader>
							...
							<DialogDescription>
								Set up a new webhook to receive test results from CI/CD
								pipelines.
							</DialogDescription>
						</DialogHeader>
						<div className="space-y-4 py-4">
							...
							<div className="flex items-center justify-between">
								<Label htmlFor="verifySignatures">
					...
					<CardContent>
						{isLoading ? (
							...
							<div className="text-2xl font-bold">
								{stats?.byStatus?.["active" as any] || 0}
							</div>
						)}
					</CardContent>
				</Card>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Manage your webhook integrations for CI/CD pipelines
					</CardDescription>
				</CardHeader>
				<CardContent>
										...
										<TableCell>
											<div className="flex items-center gap-2">
												...
												<Button
													...
													size="icon"
													className="h-6 w-6"
													onClick={() => copyToClipboard(webhook.webhookSecret)}
												>
