...
const items = [
  {
    ...
    status: 'in_progress',
    children: [
      { id: '1.1', type: 'feature', title: 'Bun Workspace Setup', status: 'done' },
      { id: '1.2', type: 'feature', title: 'Turborepo Configuration', status: 'in_progress' },
      { id: '1.3', type: 'feature', title: 'Shared Packages Structure', status: 'todo' },
    ],
  },
  {
    id: '2',
    ...
    status: 'todo',
    children: [
      { id: '2.1', type: 'feature', title: 'Vite + React 19 Setup', status: 'todo' },
      { id: '2.2', type: 'feature', title: 'Legend State Integration', status: 'todo' },
    ],
  },
  { id: '3', type: 'epic', title: 'Desktop Application', status: 'todo', children: [] },
]
        ...
        {items.map((epic) => (
          <div key={epic.id} className="border-b last:border-b-0">
            ...
            >
              ...
              <span className={`rounded-full px-2 py-0.5 text-xs ${statusColors[epic.status]}`}>
                {epic.status}
              </span>
            </div>
            {expanded.has(epic.id) &&
