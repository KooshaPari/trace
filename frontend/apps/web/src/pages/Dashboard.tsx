...
const recentProjects = [
  { id: '1', name: 'TraceRTM Frontend', items: 44, links: 5, updated: '2 hours ago' },
  { id: '2', name: 'Pokemon Go Demo', items: 28, links: 12, updated: '1 day ago' },
  { id: '3', name: 'E-Commerce Platform', items: 156, links: 234, updated: '3 days ago' },
]
