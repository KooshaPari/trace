...
const createPatternActions = (
	...
	getInvalidationPatterns: (): InvalidationPattern[] =>
		get().invalidationPatterns,
});

const buildGraphCacheStore = (
	set: StoreSetter,
	get: StoreGetter,
): GraphCacheStoreState => {
