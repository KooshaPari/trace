...
describe('Louvain Community Detection', () => {
  ...
  describe('detectCommunities', () => {
    ...
    it('should detect communities in connected graph', async () => {
      ...
      const items: Item[] = [
        // Community 1
        { id: 'a1', title: 'A1', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'a2', title: 'A2', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'a3', title: 'A3', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        // Community 2
        { id: 'b1', title: 'B1', item_type: 'feature', status: 'todo', created_at: '', updated_at: '' },
        { id: 'b2', title: 'B2', item_type: 'feature', status: 'todo', created_at: '', updated_at: '' },
        { id: 'b3', title: 'B3', item_type: 'feature', status: 'todo', created_at: '', updated_at: '' },
      ];

      const links: Link[] = [
        // Dense connections within community 1
        { id: 'l1', source_id: 'a1', target_id: 'a2', link_type: 'depends_on', created_at: '' },
        { id: 'l2', source_id: 'a2', target_id: 'a3', link_type: 'depends_on', created_at: '' },
        { id: 'l3', source_id: 'a3', target_id: 'a1', link_type: 'depends_on', created_at: '' },
        // Dense connections within community 2
        { id: 'l4', source_id: 'b1', target_id: 'b2', link_type: 'depends_on', created_at: '' },
        { id: 'l5', source_id: 'b2', target_id: 'b3', link_type: 'depends_on', created_at: '' },
        { id: 'l6', source_id: 'b3', target_id: 'b1', link_type: 'depends_on', created_at: '' },
        // Weak connection between communities
        { id: 'l7', source_id: 'a1', target_id: 'b1', link_type: 'related_to', created_at: '' },
      ];
    ...
    it('should assign colors to communities', async () => {
      const items: Item[] = [
        { id: 'n1', title: 'N1', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'n2', title: 'N2', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
      ];

      const links: Link[] = [
        { id: 'l1', source_id: 'n1', target_id: 'n2', link_type: 'depends_on', created_at: '' },
      ];
    ...
    it('should cache results when useCache is true', async () => {
      ...
      expect(result2.performance.clusteringTimeMs).toBeLessThan(result1.performance.clusteringTimeMs + 1);
    });
    ...
    it('should handle disconnected components', async () => {
      const items: Item[] = [
        { id: 'n1', title: 'N1', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'n2', title: 'N2', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'n3', title: 'N3', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
      ];
    ...
    it('should respect minCommunitySize option', async () => {
      const items: Item[] = [
        ...
        { id: 'n2', title: 'N2', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'n3', title: 'N3', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
        { id: 'n4', title: 'N4', item_type: 'requirement', status: 'todo', created_at: '', updated_at: '' },
      ];

      const links: Link[] = [
        { id: 'l1', source_id: 'n1', target_id: 'n2', link_type: 'depends_on', created_at: '' },
        { id: 'l2', source_id: 'n3', target_id: 'n4', link_type: 'depends_on', created_at: '' },
      ];
