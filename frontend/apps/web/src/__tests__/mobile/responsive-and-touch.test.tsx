...
function MockResponsiveCard({
	...
	return (
		<div className="bg-white rounded-lg shadow p-4 sm:p-6 max-w-sm sm:max-w-md mx-auto">
			...
			<button
				onClick={onAction}
				className="mt-4 w-full px-4 py-3 bg-blue-600 text-white rounded font-medium hover:bg-blue-700 active:bg-blue-800 transition-colors"
...
function MockMobileForm({
	...
	return (
		<form
			...
			className="bg-white rounded-lg shadow p-4 sm:p-6 max-w-2xl mx-auto"
		>
			<h2 className="text-xl sm:text-2xl font-bold mb-6">Contact Form</h2>
			...
			<div className="mb-6">
				...
				<input
					...
					className="w-full px-4 py-3 border rounded-lg text-base focus:ring-2 focus:ring-blue-600 focus:border-transparent"
					required
				/>
			</div>
			...
			<button
				...
				className="w-full px-4 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 active:bg-blue-800 disabled:opacity-50 transition-colors"
			>
	...
	return (
		...
		>
			<div
				...
				className="absolute bottom-0 left-0 right-0 bg-white rounded-t-lg shadow-lg animate-slide-up"
...
function MockSwipeableListItem({
	...
	return (
		<div
			...
			className="bg-white border-b touch-pan-y"
				...
				{isOpen && (
					<div className="px-4 py-2 bg-gray-50 border-t">
						<button
							...
							className="block w-full text-left px-4 py-2 hover:bg-gray-200 rounded mb-2"
						>
							Home
						</button>
						<button
