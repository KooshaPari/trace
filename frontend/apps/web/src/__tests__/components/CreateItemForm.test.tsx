...
describe('CreateItemForm', () => {
  ...
  it('should render the form', async () => {
    ...
    const titleInput = container.querySelector('input[name="title"], input[aria-label*="Title" i]')
  ...
  it('should validate required fields', async () => {
    ...
    const form = container.querySelector('form')
    const submitButton = form?.querySelector('button[type="submit"]') || screen.queryByRole('button', { name: /create/i })
  ...
  it('should show loading state', () => {
    render(<CreateItemForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} isLoading={true} />)
  ...
  it('should handle all status options', () => {
    ...
    const statusSelect = container.querySelector('select[name*="status"]') || screen.queryByLabelText(/Status/)
  ...
  it('should handle all priority options', () => {
    ...
    const prioritySelect = container.querySelector('select[name*="priority"]') || screen.queryByLabelText(/Priority/)
  ...
  it('should validate title length', async () => {
    ...
    let titleInput = container.querySelector('input[name="title"]') as HTMLInputElement
    if (!titleInput) {
  ...
  it('should accept optional owner field', () => {
    ...
    const ownerInput = container.querySelector('input[name*="owner"]') || screen.queryByLabelText(/Owner/)
