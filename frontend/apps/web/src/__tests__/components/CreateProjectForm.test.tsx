...
describe('CreateProjectForm', () => {
  ...
  it('should submit form with valid data', async () => {
    ...
    // Find name input
    const nameInput = container.querySelector('input[type="text"]') || screen.queryByLabelText(/name/i)
    if (nameInput) {
      await user.type(nameInput as HTMLInputElement, 'Test Project')
    }

    // Find and click submit button
    const submitButton = screen.queryByRole('button', { name: /create project/i })
  ...
  it('should disable submit button when loading', () => {
    ...
    render(<CreateProjectForm onSubmit={onSubmit} onCancel={onCancel} isLoading={true} />)
