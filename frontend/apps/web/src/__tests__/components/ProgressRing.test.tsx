...
describe(ProgressRing, () => {
	...
	it("accepts custom color", () => {
		const { container } = render(
			<ProgressRing percentage={50} color="#ff0000" />,
		);
...
describe(ProgressBar, () => {
	...
	it("applies correct height classes", () => {
		const { container: smContainer } = render(
			<ProgressBar percentage={50} height="sm" />,
		);
		const { container: mdContainer } = render(
			<ProgressBar percentage={50} height="md" />,
		);
		const { container: lgContainer } = render(
			<ProgressBar percentage={50} height="lg" />,
		);
	...
	it("applies custom color", () => {
		const { container } = render(
			<ProgressBar percentage={50} color="bg-purple-500" />,
		);
...
describe(LinearProgress, () => {
	...
	it("applies custom color", () => {
		const { container } = render(
			<LinearProgress value={5} max={10} color="bg-red-500" />,
		);
