...
describe("useGraph - Comprehensive Coverage", () => {
	...
	describe(useFullGraph, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.getFullGraph).mockRejectedValue(
	...
	describe(useAncestors, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.getAncestors).mockRejectedValue(
				new Error("Network error"),
			);
	...
	describe(useDescendants, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.getDescendants).mockRejectedValue(
				new Error("Network error"),
			);
	...
	describe(useFindPath, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.findPath).mockRejectedValue(
	...
	describe(useDetectCycles, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.detectCycles).mockRejectedValue(
				new Error("Network error"),
			);
	...
	describe(useOrphanItems, () => {
		...
		it("should handle errors", async () => {
			vi.mocked(api.graph.getOrphanItems).mockRejectedValue(
				new Error("Network error"),
			);
