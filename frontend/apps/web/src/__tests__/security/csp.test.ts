...
describe('Content Security Policy Tests', () => {
  ...
  describe('External Resource Validation', () => {
    it('should validate allowed domains for scripts', () => {
      ...
      expect(isAllowedScriptSource('https://cdn.tracertm.com/script.js')).toBe(true);
      expect(isAllowedScriptSource('https://malicious.com/script.js')).toBe(false);
    });
    ...
    it('should validate allowed domains for styles', () => {
      ...
      expect(isAllowedStyleSource('https://fonts.googleapis.com/css')).toBe(true);
    ...
    it('should validate API endpoints for connect-src', () => {
      ...
      expect(isAllowedConnection('https://attacker.com/exfiltrate')).toBe(false);
    });
  });
  ...
  describe('Subresource Integrity (SRI)', () => {
    it('should validate script integrity hashes', () => {
      ...
      const scriptWithSRI = '<script src="..." integrity="sha384-abc123def456ghi789jkl012mno345pqr678=" crossorigin="anonymous"></script>';
  ...
  describe('Trusted Types API', () => {
    it('should use Trusted Types when available', () => {
      ...
      const supportsTrustedTypes = typeof window !== 'undefined' &&
