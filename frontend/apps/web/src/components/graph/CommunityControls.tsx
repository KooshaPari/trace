...
export function CommunityControls({
  ...
  const sortedCommunities = useMemo(() => {
    ...
    return Array.from(result.stats.communitySizes.entries())
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Detects and visualizes node communities using the Louvain algorithm.
                  Nodes in the same community are colored identically.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
          ...
          <Button
            ...
            className="h-8"
          >
            {enabled && <Check className="h-3.5 w-3.5 mr-1" />}
            {enabled ? 'On' : 'Off'}
          </Button>
        </div>
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm">
                ...
                <span className="text-muted-foreground">
                  {formatCommunityStats(result.stats)}
                </span>
              </div>
