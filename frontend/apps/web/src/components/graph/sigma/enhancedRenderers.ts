/* eslint-disable complexity, max-lines-per-function, max-statements, no-magic-numbers, func-style, max-params */
/**
...
const enhancedNodeRenderer = (
  ...
  const statusOpacity =
    status !== undefined ? STATUS_OPACITY[status as keyof typeof STATUS_OPACITY] : undefined;
