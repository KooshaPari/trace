...
import { VIEW_CONFIGS, type GraphViewMode, type ViewConfig } from './GraphViewConfig';
import { PERSPECTIVE_CONFIGS, type GraphPerspective } from './types';
...
const PROJECT_VIEW_CONFIG: ViewConfig = {
  category: 'graph',
  description: '',
  icon: PERSPECTIVE_CONFIGS[0].icon,
  id: 'traceability',
  label: '',
};
