        ...
        <div className='mb-2 space-y-0.5 pl-6'>
          {components.map((component) => (
            <ComponentListItem
              ...
              onViewInStorybook={
                onViewInStorybook ? () => onViewInStorybook(component.id) : undefined
              }
              onViewInFigma={onViewInFigma ? () => onViewInFigma(component.id) : undefined}
              onViewInCode={onViewInCode ? () => onViewInCode(component.id) : undefined}
            />
          ))}
        </div>
      </CollapsibleContent>
