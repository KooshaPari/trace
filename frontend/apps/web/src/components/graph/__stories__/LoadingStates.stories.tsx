		...
		return (
			<div className="h-[600px] w-full space-y-4">
				<div className="p-4 flex gap-2">
					...
					<Button onClick={() => setIsLoading(false)}>Show Content</Button>
				</div>
						...
						<div className="h-full flex items-center justify-center bg-card border rounded-lg">
							<div className="text-center space-y-2">
								...
								<p className="text-muted-foreground">
									This is the actual graph content
								</p>
							</div>
						</div>
					</LoadingTransition>
		...
		return (
			<div className="h-[600px] w-full p-4">
				<div className="space-y-4">
					...
					<div className="relative h-[400px] bg-card border rounded-lg">
		...
		<div className="h-[600px] w-full p-4">
			<div className="relative h-[400px] bg-card border rounded-lg">
				<LoadingProgress
					loaded={1234}
					total={5678}
					label="Processing large dataset"
				/>
			</div>
		</div>
	),
		...
		return (
			<div className="h-[600px] w-full space-y-4">
				<div className="p-4 flex gap-2">
					...
					<Button onClick={() => setState("content")}>Show Content</Button>
				</div>
				<div className="h-[500px]">
					{state === "loading" && (
						<div className="relative h-full">
							<GraphSkeleton />
							{progress > 0 && (
								<LoadingProgress loaded={progress} total={100} />
							)}
						</div>
					)}
