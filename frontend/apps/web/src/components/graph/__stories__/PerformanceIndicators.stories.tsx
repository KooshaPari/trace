...
export const OverlayTopRight: StoryObj = {
	render: () => (
		<div className="relative w-[800px] h-[600px] bg-muted rounded border">
			<PerformanceOverlay
				nodeCount={1000}
				edgeCount={2000}
				visibleNodeCount={250}
		...
		return (
			<div className="space-y-2">
				...
				<div className="text-xs text-muted-foreground text-center">
					Current: {fpsStats.current.toFixed(1)} FPS | Average:{" "}
					{fpsStats.average.toFixed(1)} FPS
				</div>
			</div>
		);
	},
...
export const CompleteDashboard: StoryObj = {
	render: () => {
		...
		return (
			<div className="relative w-[1000px] h-[600px] bg-muted rounded border p-4">
