...
function GraphLayoutWorkerDemo() {
	...
	return (
		<div className="p-6 space-y-6">
			<Card className="p-6">
				<h2 className="text-2xl font-bold mb-4">Graph Layout Worker Demo</h2>
				<p className="text-muted-foreground mb-6">
					Compare synchronous vs worker-based layout performance. Worker-based
					layouts run off the main thread, keeping the UI responsive.
				</p>
