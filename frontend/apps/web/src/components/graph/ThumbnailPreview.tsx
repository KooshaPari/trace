...
import { generateThumbnail, type ScreenshotMetadata } from "../../utils/screenshot";
...
function ThumbnailPreviewComponent({
  ...
  }, [showFullScreenshot, screenshotUrl, displayScreenshot, isLoading, hasScreenshot, hasCode, componentCode, label]);
