...
export function getTypeCategory(
  ...
  // UI types
  if (
    ["site", "page", "layout", "section", "subsection", "component", "subcomponent",
     "element", "modal", "popup", "toast", "drawer", "ui", "wireframe", "mockup"].includes(normalizedType)
  ) {
    return "ui";
  }
  ...
  // Product types
  if (
    ["initiative", "epic", "feature", "user_story", "story", "acceptance_criteria",
     "task", "subtask", "requirement"].includes(normalizedType)
  ) {
    return "product";
  }
  ...
  // Technical types
  if (
    ["service", "module", "class", "function", "api_endpoint", "api", "database_table",
     "database_field", "config", "code", "workflow", "process", "integration", "deployment",
     "database"].includes(normalizedType)
  ) {
    return "technical";
  }
  ...
  // Test types
  if (
    ["test_suite", "test_case", "test_step", "assertion", "fixture", "mock", "test"].includes(normalizedType)
  ) {
    return "test";
  }
  ...
  // Design types
  if (
    ["wireframe", "mockup", "prototype", "design_token", "style_guide", "design"].includes(normalizedType)
  ) {
    return "design";
  }
  ...
  // Documentation types
  if (
    ["doc_root", "doc_section", "doc_page", "doc_block", "documentation"].includes(normalizedType)
  ) {
