...
const normalizeType = (type: string): string =>
	type.toLowerCase().replaceAll(/[_-]/g, "_");
...
export const getTypeCategory = (
	...
	if (CATEGORY_TYPES.ui.has(normalizedType)) return "ui";
	if (CATEGORY_TYPES.product.has(normalizedType)) return "product";
	if (CATEGORY_TYPES.technical.has(normalizedType)) return "technical";
	if (CATEGORY_TYPES.test.has(normalizedType)) return "test";
	if (CATEGORY_TYPES.design.has(normalizedType)) return "design";
	if (CATEGORY_TYPES.documentation.has(normalizedType)) return "documentation";
