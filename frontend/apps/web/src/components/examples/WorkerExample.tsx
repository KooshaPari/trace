  ...
  return (
    <div className="p-4 border rounded">
      ...
      <div className="mb-4">
        ...
        {status.progress > 0 && (
          <div className="mt-2">
            <div className="text-sm mb-1">Progress: {status.progress.toFixed(0)}%</div>
...
export function DataTransformExample() {
  ...
  const handleTransform = async () => {
    ...
    try {
      ...
      setResult({ sorted: sorted.slice(0, 10), stats, aggregated });
    } catch (error) {
...
export function WorkerSupportCheck() {
  ...
  return (
    <div className={`p-4 border rounded ${supported ? 'bg-green-50' : 'bg-red-50'}`}>
