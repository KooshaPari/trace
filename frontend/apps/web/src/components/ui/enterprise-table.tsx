      ...
      >
        ...
        <div className='flex items-center gap-2'>
          {enableBulkActions && selectedRowCount > 0 && bulkActions && (
            <motion.div className='flex items-center gap-2' {...selectionBadgeAnimation}>
          ...
          <div className='flex items-center gap-1'>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align='end'>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuCheckboxItem checked={isCompact} onCheckedChange={handleToggleCompact}>
                  Compact View
                </DropdownMenuCheckboxItem>
              </DropdownMenuContent>
            </DropdownMenu>
                ...
                Array.from({ length: 5 }).map((_, index) => (
                  <TableRow key={`skeleton-${index}`}>
                    {columns.map((_, colIndex) => (
                      <TableCell key={colIndex} className={isCompact ? 'px-2 py-1' : undefined}>
