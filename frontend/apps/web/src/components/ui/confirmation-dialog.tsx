						...
						>
							...
							<AlertDialogFooter className="mt-6">
								<AlertDialogCancel
									...
									className="px-4 py-2 text-sm font-medium rounded-md border bg-background hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
								>
									{cancelText}
								</AlertDialogCancel>
...
export interface BulkConfirmationDialogProps
	extends Omit<ConfirmationDialogProps, "title" | "description"> {
...
export const BulkConfirmationDialog = React.forwardRef<
	HTMLDivElement,
