		...
		<div className="flex flex-col border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
			...
			<div className="flex items-center justify-between px-4 py-3 gap-2">
				<div className="flex items-center gap-2 flex-1">
					...
					{currentBranch && (
						<Badge variant={getStatusColor(currentBranch.status)}>
					...
					<div className="flex items-center justify-between">
						<div className="space-y-1">
							...
							<div className="text-xs text-gray-500 dark:text-gray-500">
								{currentVersion.timestamp.toLocaleString()} by{" "}
								{currentVersion.author || "unknown"}
							</div>
						</div>
			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div>
					...
					<Select
						...
						onValueChange={setCompareBranchId}
					>
						<SelectTrigger>
...
function ProgressView({ branches, versions }: ProgressViewProps) {
	...
	const progress =
		totalVersions > 0
			? Math.round((publishedVersions / totalVersions) * 100)
			: 0;
