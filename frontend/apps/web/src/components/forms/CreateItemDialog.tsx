				...
				return (
					<div className="p-4 text-center">
						...
						<button
							...
							className="mt-4 rounded-lg border px-4 py-2 hover:bg-accent"
						>
			...
			>
				...
				<div className="flex justify-end mt-6 pt-4 border-t">
					<button
						type="button"
						onClick={handleCancel}
						className="rounded-lg border px-4 py-2 hover:bg-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
					>
						Cancel
					</button>
				</div>
