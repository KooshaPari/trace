...
export function CreateTaskItemForm({
	onSubmit,
	onCancel,
	isLoading,
			...
			>
				...
				>
					...
					<div className="space-y-4">
						<h3 className="text-md font-medium border-b pb-2">Task Details</h3>
						...
						<FormArrayField
							...
							renderField={(index) => (
								<input
									...
									className="w-full rounded-lg border bg-background px-3 py-2 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
								/>
							)}
						/>
						{errors.subtasks && (
					...
					<div className="flex gap-3 pt-4">
						...
						<button
							...
							aria-label={
								isLoading || isSubmitting ? "Creating task..." : "Create task"
							}
