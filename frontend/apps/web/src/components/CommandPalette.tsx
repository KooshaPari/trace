  ...
  const commands: CommandItem[] = useMemo(() => {
    ...
    if (currentProjectId) {
      const projectViews: CommandItem[] = [
        {
          action: () => navigate({ to: `/projects/${currentProjectId}/views/feature` }),
          category: 'VIEWS',
        ...
        {
          action: () => navigate({ to: `/projects/${currentProjectId}/views/code` }),
          category: 'VIEWS',
        ...
        {
          action: () => navigate({ to: `/projects/${currentProjectId}/views/test` }),
          category: 'VIEWS',
        ...
        {
          action: () => navigate({ to: `/projects/${currentProjectId}/views/workflows` }),
          category: 'VIEWS',
      ...
      const specCommands: CommandItem[] = [
        {
          action: () => navigate({ to: `/projects/${currentProjectId}/specifications` }),
          category: 'SPECS',
