...
type ConceptProperties = Record<
	string,
	string | number | boolean | object | null | undefined
>;
type ProjectionProperties = Record<
	string,
	string | number | boolean | object | null | undefined
>;
...
const useCanonicalConcepts = (
	projectId: string,
	options?: UseQueryOptions<CanonicalConcept[], Error>,
): UseQueryResult<CanonicalConcept[], Error> => {
	const baseOptions = {
...
const useCanonicalProjections = (
	conceptId: string,
	options?: UseQueryOptions<CanonicalProjection[], Error>,
): UseQueryResult<CanonicalProjection[], Error> => {
	const baseOptions = {
		enabled: Boolean(conceptId),
...
const usePivotTargets = (
	itemId: string,
	options?: UseQueryOptions<PivotTarget[], Error>,
): UseQueryResult<PivotTarget[], Error> => {
	const baseOptions = {
