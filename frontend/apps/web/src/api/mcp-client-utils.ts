import type {	JsonRpcRequest,	JsonRpcResponse,	MCPClientConfig,	ProgressNotification,	} from "./mcp-client-types";
...
const parseProgressNotification = (
	data: unknown,
	...
	const { message, progress, total } = data;
