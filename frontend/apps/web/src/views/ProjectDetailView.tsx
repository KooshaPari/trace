...
const useProjectDetailActions = (navigate: ReturnType<typeof useNavigate>, project: Project | null) => {
...
const QuickConfigCard = ({
	...
	const metadata =
		project.metadata && typeof project.metadata === "object"
			...
			: EMPTY_METADATA;
	const metadataEntries = Object.entries(metadata).slice(
		0,
