						...
						<div className="flex items-center gap-2 text-blue-700">
							...
							<div>
								<p className="font-medium">
									User Story Detail View - Coming Soon
								</p>
								<p className="text-sm mt-1">
									Enhanced user story view with acceptance criteria and story
									points tracking is under development.
								</p>
							</div>
						</div>
					</CardContent>
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-2 text-blue-700">
							...
							<div>
								...
								<p className="text-sm mt-1">
									Enhanced task view with checklists and time tracking is under
									development.
								</p>
							</div>
						</div>
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-2 text-blue-700">
							...
							<div>
								...
								<p className="text-sm mt-1">
									Enhanced defect view with reproduction steps and severity
