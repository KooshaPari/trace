...
(() => {
	...
	function baseIsEqualDeep(
		...
		stack || (stack = []);
		var objStack = find(stack, (entry) => entry[0] == object);
		var othStack = find(stack, (entry) => entry[0] == other);
	...
	var bind = baseRest((func, thisArg, partials) =>
		createPartial(func, WRAP_BIND_FLAG | WRAP_PARTIAL_FLAG, thisArg, partials),
	);
