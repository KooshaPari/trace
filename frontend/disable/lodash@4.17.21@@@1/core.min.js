...
(() => {
	...
	function m(n, t) {
		return (n = Object(n)), C(t, (t, r) => (r in n && (t[r] = n[r]), t), {});
	}
	function O(n) {
	...
	function E(n, t) {
		var r;
		return mn(n, (n, e, u) => ((r = t(n, e, u)), !r)), !!r;
	}
	function w(n, r) {
		return C(r, (n, r) => r.func.apply(r.thisArg, t([n], r.args)), n);
	}
	function k(n, t, r) {
		var e = !r;
		r || (r = {});
	...
	var mn = ((n, t) => (r, e) => {
		...
		Dn = _n,
		In = D,
		$n = ((n) => xn(I(n, Z, $), n + ""))((n, t) => (null == n ? {} : m(n, t)));
	(o.assignIn = Bn),
		(o.before = G),
		(o.bind = En),
		(o.chain = (n) => ((n = o(n)), (n.__chain__ = true), n)),
		(o.compact = (n) => l(n, Boolean)),
		(o.concat = function () {
		...
		(o.defer = wn),
		(o.delay = kn),
		(o.filter = (n, t) => l(n, g(t))),
		(o.flatten = $),
		(o.flattenDeep = (n) => ((null == n ? 0 : n.length) ? p(n, nn) : [])),
		(o.iteratee = g),
		(o.keys = Dn),
		(o.map = (n, t) => j(n, g(t))),
		(o.matches = (n) => d(Tn({}, n))),
		...
		(o.tap = (n, t) => (t(n), n)),
		(o.thru = (n, t) => t(n)),
		(o.toArray = (n) => (M(n) ? (n.length ? A(n) : []) : W(n))),
		(o.values = W),
		(o.extend = Bn),
		Y(o, o),
		(o.clone = (n) => (V(n) ? (Nn(n) ? A(n) : k(n, _n(n))) : n)),
		(o.escape = (n) => ((n = Q(n)) && rn.test(n) ? n.replace(tn, fn) : n)),
		(o.every = (n, t, r) => ((t = r ? Z : t), f(n, g(t)))),
		(o.find = An),
		(o.forEach = z),
		(o.has = (n, t) => null != n && pn.call(n, t)),
		(o.head = q),
		(o.identity = X),
		(o.indexOf = P),
		(o.isArguments = n),
		...
		(o.isDate = (n) => H(n) && "[object Date]" == hn.call(n)),
		(o.isEmpty = (t) =>
			M(t) && (Nn(t) || L(t) || U(t.splice) || n(t))
				? !t.length
				: !_n(t).length),
		(o.isEqual = (n, t) => b(n, t)),
		(o.isFinite = (n) => typeof n == "number" && gn(n)),
		(o.isFunction = U),
		(o.isNaN = (n) => K(n) && n != +n),
		(o.isNull = (n) => null === n),
		(o.isNumber = K),
		(o.isObject = V),
		(o.isRegExp = (n) => H(n) && "[object RegExp]" == hn.call(n)),
		(o.isString = L),
		(o.isUndefined = (n) => n === Z),
		(o.last = (n) => {
		...
		(o.max = (n) => (n && n.length ? a(n, X, v) : Z)),
		(o.min = (n) => (n && n.length ? a(n, X, _) : Z)),
		...
		(o.size = (n) => (null == n ? 0 : ((n = M(n) ? n : _n(n)), n.length))),
		(o.some = (n, t, r) => ((t = r ? Z : t), E(n, g(t)))),
		(o.uniqueId = (n) => {
			var t = ++sn;
			return Q(n) + t;
		}),
		...
		mn(
			...
			(n) => {
				...
				o.prototype[n] = function () {
					...
					return this[r]((r) => t.apply(Nn(r) ? r : [], n));
				};
			},
		),
		(o.prototype.toJSON =
