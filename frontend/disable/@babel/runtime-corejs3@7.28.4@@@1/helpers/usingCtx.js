...
function _usingCtx() {
	var r =
			"function" == typeof _SuppressedError
				? _SuppressedError
				: (r, e) => {
						var n = Error();
						return (
	...
	function using(r, e) {
		if (null != e) {
			...
			if (r)
				var o = e[_Symbol$asyncDispose || _Symbol$for("Symbol.asyncDispose")];
			if (
				void 0 === o &&
				((o = e[_Symbol$dispose || _Symbol$for("Symbol.dispose")]), r)
			)
				var t = o;
				...
				for (; (o = n.pop()); )
					try {
						if (!o.a && 1 === s)
							return (
								(s = 0),
								_pushInstanceProperty(n).call(n, o),
								_Promise.resolve().then(next)
							);
						if (o.d) {
							var r = o.d.call(o.v);
