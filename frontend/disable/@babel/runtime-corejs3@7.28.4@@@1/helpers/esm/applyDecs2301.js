	...
	function createAddInitializerMethod(e, t) {
		return (r) => {
			!((e) => {
				...
				_pushInstanceProperty(e).call(e, r);
		};
	}
	...
	function memberDec(e, t, r, n, a, i, s, o, c) {
		...
		if (
			...
			if (2 === a)
				...
				(h || 3 === a) &&
					(l = s
						? (e) => (assertInstanceIfPrivate(c, e), r.get.call(e))
						: (e) => r.get.call(e)),
					(h || 4 === a) &&
						(f = s
							? (e, t) => {
		...
		var v = s ? _bindInstanceProperty(c).call(c) : (e) => t in e;
		p.access =
			l && f
				? {
						get: l,
	...
	function applyMemberDec(e, t, r, n, a, i, s, o, c) {
		...
		if (
			(s
				...
				: 0 !== a && (u = _Object$getOwnPropertyDescriptor(t, n)),
			1 === a
				? (p = {
						get: u.get,
						set: u.set,
				...
				void 0 !== (h = memberDec(g[m], n, u, o, a, i, s, p, c)) &&
					...
					void 0 !== b &&
						(void 0 === l
							...
							: "function" == typeof l
								? (l = [l, b])
								: _pushInstanceProperty(l).call(l, b)));
			}
		if (0 === a || 1 === a) {
			if (void 0 === l)
				l = function l(e, t) {
		...
		0 !== a &&
			...
			s
				? 1 === a
					? (_pushInstanceProperty(e).call(e, (e, t) => p.get.call(e, t)),
						_pushInstanceProperty(e).call(e, (e, t) => p.set.call(e, t)))
					: 2 === a
						? _pushInstanceProperty(e).call(e, p)
						: _pushInstanceProperty(e).call(e, (e, t) => p.call(e, t))
				: _Object$defineProperty(t, n, u));
	}
	function applyMemberDecs(e, t, r) {
		for (
			var n, a, i, s = [], o = new _Map(), c = new _Map(), u = 0;
			u < t.length;
			u++
		) {
			var l = t[u];
