...
function _objectSpread(e) {
	for (var r = 1; r < arguments.length; r++) {
		...
		var t = null != arguments[r] ? Object(arguments[r]) : {},
			o = _Object$keys(t);
		"function" == typeof _Object$getOwnPropertySymbols &&
			_pushInstanceProperty(o).apply(
				o,
				_filterInstanceProperty(
					(_context = _Object$getOwnPropertySymbols(t)),
				).call(
					_context,
					(e) => _Object$getOwnPropertyDescriptor(t, e).enumerable,
				),
			),
			_forEachInstanceProperty(o).call(o, (r) => {
