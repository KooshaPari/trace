...
function applyDecs2311(e, t, n, r, o, i) {
	...
	function applyDec(e, t, n, r, o, i, u, s, f, l, p) {
		...
		var h = _concatInstanceProperty((_context = [])).call(_context, t[0]),
			...
			E = 2 === o;
		function I(t, n, r) {
			return (o, i) => (n && ((i = o), (o = e)), r && r(o), P[t].call(o, i));
		}
		if (!w) {
			var P = {},
				k = [],
			...
			if (
				(f
					...
					: l || (P = _Object$getOwnPropertyDescriptor(e, r)),
				!l && !f)
			) {
				if ((c = y[+s][r]) && 7 !== (c ^ o))
					throw Error(
		...
		for (var N = e, O = h.length - 1; O >= 0; O -= n ? 2 : 1) {
			...
			var T = b(h[O], "A decorator", "be", !0),
				...
				H = {
					...
					addInitializer: _bindInstanceProperty(
						(_context2 = function _context2(e, t) {
							if (e.v)
								throw new TypeError(
									"attempted to call addInitializer after decoration was finished",
								);
							b(t, "An initializer", "be", !0),
								_pushInstanceProperty(i).call(i, t);
						}),
			...
			if (w)
				...
				(c = H.access =
					{
						has: f ? _bindInstanceProperty(p).call(p) : (e) => r in e,
					}),
				j ||
					(c.get = f
						? E
				...
				if ("object" == _typeof(N) && N)
					(c = b(N.get, "accessor.get")) && (P.get = c),
						...
						(c = b(N.init, "accessor.init")) &&
							_unshiftInstanceProperty(k).call(k, c);
				else if (void 0 !== N)
					throw new TypeError(
				...
				b(N, (l ? "field" : "method") + " decorators", "return") &&
					(l ? _unshiftInstanceProperty(k).call(k, N) : (P[F] = N));
		}
		return (
			o < 2 && _pushInstanceProperty(u).call(u, g(k, s, 1), g(i, s, 0)),
			l ||
				w ||
				(f
					? D
						? _spliceInstanceProperty(u).call(
								u,
								-1,
								0,
								I("get", s),
						...
						: _pushInstanceProperty(u).call(
								...
								E
									? P[F]
									: _bindInstanceProperty((_context3 = b.call)).call(
											_context3,
											P[F],
										),
							)
