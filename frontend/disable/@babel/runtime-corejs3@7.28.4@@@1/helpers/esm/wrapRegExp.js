...
function _wrapRegExp() {
	...
	function buildGroups(e, t) {
		var _context;
		var p = r.get(t);
		return _reduceInstanceProperty((_context = _Object$keys(p))).call(
			_context,
			(r, t) => {
				var o = p[t];
	...
	return (
		...
		(BabelRegExp.prototype[_Symbol$replace] = function (t, p) {
			if ("string" == typeof p) {
				var o = r.get(this);
				return e[_Symbol$replace].call(
					this,
					t,
					p.replace(/\$<([^>]+)(>|$)/g, (e, r, t) => {
						if ("" === t) return e;
						var p = o[r];
						return _Array$isArray(p)
							? "$" + p.join("$")
							: "number" == typeof p
								? "$" + p
								: "";
					...
					return (
						"object" != _typeof(e[e.length - 1]) &&
							_pushInstanceProperty(
								(_context2 = e = _sliceInstanceProperty([]).call(e)),
							).call(_context2, buildGroups(e, i)),
						p.apply(this, e)
					);
				});
			}
