...
function applyDecs2305(e, t, r, n, o, a) {
	...
	function applyDec(e, t, r, n, o, a, c, u, l, f, p, d, h) {
		...
		if (!b) {
			...
			f
				...
				: p || (w = _Object$getOwnPropertyDescriptor(e, n));
		}
		for (var P = e, j = v.length - 1; j >= 0; j -= r ? 2 : 1) {
			...
			var D = v[j],
				...
				O = {
					...
					name: n,
					metadata: a,
					addInitializer: _bindInstanceProperty(
						(_context = function _context(e, t) {
							if (e.v)
								throw Error(
									"attempted to call addInitializer after decoration was finished",
								);
							s(t, "An initializer", "be", !0),
								_pushInstanceProperty(c).call(c, t);
						}),
			...
			try {
				if (b)
					...
					var N = (O.access = {
						has: f ? _bindInstanceProperty(h).call(h) : (e) => n in e,
					});
					if (
						(k && (N.get = k),
						F && (N.set = F),
						...
						if ("object" == _typeof(P) && P)
							(y = s(P.get, "accessor.get")) && (w.get = y),
								...
								(y = s(P.init, "accessor.init")) &&
									_pushInstanceProperty(S).call(S, y);
						else if (void 0 !== P)
							throw new TypeError(
						...
						s(P, (p ? "field" : "method") + " decorators", "return") &&
							(p ? _pushInstanceProperty(S).call(S, P) : (w[A] = P));
				}
			} finally {
				I.v = !0;
			}
		...
		return (
			(p || d) &&
				_pushInstanceProperty(u).call(u, (e, t) => {
			...
			p ||
				...
				(f
					? d
						? _pushInstanceProperty(u).call(u, i(w, "get"), i(w, "set"))
						: _pushInstanceProperty(u).call(
								u,
								2 === o
									? w[A]
									: _bindInstanceProperty((_context2 = i.call)).call(
											_context2,
											w[A],
										),
							)
					: _Object$defineProperty(e, n, w)),
			P
		);
	}
	function u(e, t) {
		return _Object$defineProperty(
			e,
			_Symbol$metadata || _Symbol$for("Symbol.metadata"),
			{
				configurable: !0,
				enumerable: !0,
				value: t,
	...
	if (arguments.length >= 6)
		var l = a[_Symbol$metadata || _Symbol$for("Symbol.metadata")];
	var f = _Object$create(null == l ? null : l),
		p = ((e, t, r, n) => {
			...
			function l(e) {
				e &&
					_pushInstanceProperty(i).call(
						i,
						_bindInstanceProperty(c).call(c, null, e),
					);
			}
	...
	return (
		r.length || u(e, f),
		{
			...
			get c() {
				...
				return (
					r.length && [
						u(applyDec(e, [r], n, e.name, 5, f, t), f),
						_bindInstanceProperty(c).call(c, null, t, e),
					]
				);
			},
		}
