	...
	return {
		getMetadata: function getMetadata(o) {
			...
			if (void 0 !== i)
				...
				} else if (Object.hasOwn(i, "constructor")) return i.constructor;
		},
...
function old_convertMetadataMapToFinal(e, t) {
	...
	if (0 !== r.length) {
		...
		a && _Object$setPrototypeOf(t, a),
			(e[_Symbol$metadata || _Symbol$for("Symbol.metadata")] = t);
	}
}
function old_createAddInitializerMethod(e, t) {
	return (a) => {
		old_assertNotFinished(t, "addInitializer"),
			...
			_pushInstanceProperty(e).call(e, a);
	};
}
function old_memberDec(e, t, a, r, o, i, n, l, s) {
	...
	try {
		return e(
			s,
			_Object$assign(f, old_createMetadataMethodsForProperty(r, d, u, p)),
		);
	} finally {
		p.v = !0;
	}
...
function old_applyMemberDec(e, t, a, r, o, i, n, l, s) {
	...
	if (
		(n
			...
			: 0 !== o && (c = _Object$getOwnPropertyDescriptor(t, r)),
		1 === o
			? (f = {
					get: c.get,
					set: c.set,
			...
			void 0 !== (p = old_memberDec(h[m], r, c, l, s, o, i, n, f)) &&
				...
				void 0 !== b &&
					(void 0 === d
						...
						: "function" == typeof d
							? (d = [d, b])
							: _pushInstanceProperty(d).call(d, b)));
		}
	if (0 === o || 1 === o) {
		if (void 0 === d)
			d = function d(e, t) {
	...
	0 !== o &&
		...
		n
			? 1 === o
				? (_pushInstanceProperty(e).call(e, (e, t) => f.get.call(e, t)),
					_pushInstanceProperty(e).call(e, (e, t) => f.set.call(e, t)))
				: 2 === o
					? _pushInstanceProperty(e).call(e, f)
					: _pushInstanceProperty(e).call(e, (e, t) => f.call(e, t))
...
function old_pushInitializers(e, t) {
	t &&
		_pushInstanceProperty(e).call(e, (e) => {
...
function old_applyClassDecs(e, t, a, r) {
	if (r.length > 0) {
		...
		_pushInstanceProperty(e).call(e, i, () => {
