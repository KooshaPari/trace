...
function _applyDecoratedDescriptor(i, e, r, n, l) {
	...
	var a = {};
	return (
		_forEachInstanceProperty((_context = _Object$keys(n))).call(
			_context,
			(i) => {
				a[i] = n[i];
			},
		...
		(a = _reduceInstanceProperty(
			(_context2 = _reverseInstanceProperty(
				(_context3 = _sliceInstanceProperty(r).call(r)),
			).call(_context3)),
		).call(_context2, (r, n) => n(i, e, r) || r, a)),
		l &&
			void 0 !== a.initializer &&
			((a.value = a.initializer ? a.initializer.call(l) : void 0),
			(a.initializer = void 0)),
		void 0 === a.initializer ? (_Object$defineProperty(i, e, a), null) : a
	);
}
