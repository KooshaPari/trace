	...
	var s = r((e) => {
		...
		a = o.decorateClass(
			_coalesceClassElements(
				_mapInstanceProperty((_context = s.d)).call(
					_context,
	...
	var e = {
		...
		initializeInstanceElements: function initializeInstanceElements(e, r) {
			...
			_forEachInstanceProperty((_context2 = ["method", "field"])).call(
				_context2,
				function (t) {
					_forEachInstanceProperty(r).call(
						r,
						function (r) {
							r.kind === t &&
								"own" === r.placement &&
		...
		decorateClass: function decorateClass(e, r) {
			...
			if (
				(_forEachInstanceProperty(e).call(
					e,
					function (e) {
				...
				_forEachInstanceProperty(e).call(
					...
					function (e) {
						...
						_pushInstanceProperty(t).call(t, r.element),
							_pushInstanceProperty(t).apply(t, r.extras),
							_pushInstanceProperty(i).apply(i, r.finishers);
					},
					this,
				),
				!r)
			...
			return (
				_pushInstanceProperty(i).apply(i, n.finishers), (n.finishers = i), n
			);
		},
		addElementPlacement: function addElementPlacement(e, r, t) {
			var i = r[e.placement];
			if (!t && -1 !== _indexOfInstanceProperty(i).call(i, e.key))
		...
		decorateElement: function decorateElement(e, r) {
			for (
				...
				var s = r[e.placement];
				_spliceInstanceProperty(s).call(
					s,
					_indexOfInstanceProperty(s).call(s, e.key),
					1,
				);
				...
				(e = l.element),
					...
					l.finisher && _pushInstanceProperty(i).call(i, l.finisher);
				var c = l.extras;
				if (c) {
		...
		decorateConstructor: function decorateConstructor(e, r) {
			for (var t = [], i = r.length - 1; i >= 0; i--) {
				...
				if (
					(void 0 !== n.finisher &&
						_pushInstanceProperty(t).call(t, n.finisher),
					void 0 !== n.elements)
				) {
					e = n.elements;
		...
		fromElementDescriptor: function fromElementDescriptor(e) {
			...
			return (
				_Object$defineProperty(r, _Symbol$toStringTag, {
					value: "Descriptor",
					configurable: !0,
				}),
		...
		toElementDescriptors: function toElementDescriptors(e) {
			var _context4;
			if (void 0 !== e)
				return _mapInstanceProperty((_context4 = toArray(e))).call(
					_context4,
					function (e) {
		...
		fromClassDescriptor: function fromClassDescriptor(e) {
			var r = {
				kind: "class",
				elements: _mapInstanceProperty(e).call(
					e,
...
function _coalesceClassElements(e) {
	for (
		...
		if (
			"method" === o.kind &&
			(i = _findInstanceProperty(r).call(r, isSameElement))
		) {
