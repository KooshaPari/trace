...
function applyDecs2203Factory() {
	...
	function applyMemberDec(e, t, r, a, n, i, s, o) {
		...
		if (
			(s
				...
				: 0 !== n && (c = _Object$getOwnPropertyDescriptor(t, a)),
			1 === n
				? (u = {
						get: c.get,
						set: c.set,
				...
				void 0 !== (f = memberDec(h[v], a, c, o, n, i, s, u)) &&
					...
					void 0 !== g &&
						(void 0 === l
							...
							: "function" == typeof l
								? (l = [l, g])
								: _pushInstanceProperty(l).call(l, g)));
			}
		if (0 === n || 1 === n) {
			if (void 0 === l)
				l = function l(e, t) {
		...
		0 !== n &&
			...
			s
				? 1 === n
					? (_pushInstanceProperty(e).call(e, (e, t) => u.get.call(e, t)),
						_pushInstanceProperty(e).call(e, (e, t) => u.set.call(e, t)))
					: 2 === n
						? _pushInstanceProperty(e).call(e, u)
						: _pushInstanceProperty(e).call(e, (e, t) => u.call(e, t))
	...
	return (e, t, r) => {
		...
		return (
			((e, t, r) => {
				for (
					var a, n, i = new _Map(), s = new _Map(), o = 0;
					o < r.length;
					o++
				) {
					var c = r[o];
			...
			((e, t, r) => {
				if (r.length > 0) {
					...
					_pushInstanceProperty(e).call(e, n, () => {
