...
var YAMLCBWriter = /** @class */ (function (_super) {
	...
	/** @inheritdoc */
	YAMLCBWriter.prototype.declaration = function (
		version,
		encoding,
		standalone,
	) {
	...
	/** @inheritdoc */
	YAMLCBWriter.prototype.openTagEnd = function (
		name,
		selfClosing,
		voidElement,
	) {
	...
	YAMLCBWriter.prototype._beginLine = function (suppressArray) {
		...
		return (
			(this.hasData ? this._writerOptions.newline : "") +
	...
	YAMLCBWriter.prototype._indent = function (level, suppressArray) {
		if (level + this._additionalLevel <= 0) {
			...
			var chars = this._writerOptions.indent.repeat(
				level + this._additionalLevel,
			);
