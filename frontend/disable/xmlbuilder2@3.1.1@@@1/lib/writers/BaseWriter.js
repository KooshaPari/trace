...
var BaseWriter = /** @class */ (function () {
	 ...
	 */
	BaseWriter.prototype.declaration = function (
		version,
		encoding,
		standalone,
	) {};
	 ...
	 */
	BaseWriter.prototype.openTagEnd = function (
		name,
		selfClosing,
		voidElement,
	) {};
	...
	BaseWriter.prototype.attributes = function (attributes) {
		...
		try {
			for (
				var attributes_1 = __values(attributes),
				...
				this.attribute(
					attr[1] === null ? attr[2] : attr[1] + ":" + attr[2],
					attr[3],
				);
			}
		} catch (e_1_1) {
	...
	BaseWriter.prototype.serializeNode = function (node, requireWellFormed) {
		var hasNamespaces =
			node._nodeDocument !== undefined && node._nodeDocument._hasNamespaces;
		this.level = 0;
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeNodeNS = function (
		node,
		namespace,
		prefixMap,
		prefixIndex,
		...
		switch (node.nodeType) {
			...
			case interfaces_1.NodeType.DocumentFragment:
				this._serializeDocumentFragmentNS(
					node,
					namespace,
					prefixMap,
					prefixIndex,
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeElementNS = function (
		node,
		namespace,
		prefixMap,
		prefixIndex,
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeDocumentNS = function (
		node,
		namespace,
		prefixMap,
		prefixIndex,
	...
	BaseWriter.prototype._serializeText = function (node, requireWellFormed) {
		...
		var markup = node.data
			.replace(constants_1.nonEntityAmpersandRegex, "&amp;")
			.replace(/</g, "&lt;")
			.replace(/>/g, "&gt;");
		this.text(markup);
	};
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeDocumentFragmentNS = function (
		node,
		namespace,
		prefixMap,
		prefixIndex,
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeDocumentFragment = function (
		node,
		requireWellFormed,
	) {
		var e_7, _a;
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeDocumentType = function (
		node,
		requireWellFormed,
	) {
		/**
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeProcessingInstruction = function (
		node,
		requireWellFormed,
	) {
		/**
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeAttributesNS = function (
		node,
		map,
		prefixIndex,
		localPrefixesMap,
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeAttributes = function (
		node,
		requireWellFormed,
	) {
		var e_9, _a;
	 ...
	 * @param localPrefixesMap - local prefixes map
	 */
	BaseWriter.prototype._recordNamespaceInformation = function (
		node,
		map,
		localPrefixesMap,
	) {
	 ...
	 * @param prefixIndex - generated namespace prefix index
	 */
	BaseWriter.prototype._generatePrefix = function (
		newNamespace,
		prefixMap,
		prefixIndex,
	) {
	 ...
	 * @param requireWellFormed - whether to check conformance
	 */
	BaseWriter.prototype._serializeAttributeValue = function (
		value,
		requireWellFormed,
	) {
		/**
