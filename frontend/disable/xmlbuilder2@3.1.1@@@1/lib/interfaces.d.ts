...
export interface XMLBuilderOptions {
	...
	invalidCharReplacement:
		| string
		| ((char: string, offset: number, str: string) => string)
		| undefined;
	/**
...
export interface XMLBuilderCreateOptions
	extends RecursivePartial<XMLBuilderOptions> {}
/**
 ...
 * serialized nodes.
 */
export declare type XMLSerializedValue =
	| string
...
export declare type XMLSerializedAsObjectArray = Array<
	string | XMLSerializedAsObject
>;
export declare type XMLSerializedAsMap = Map<
	string,
	string | XMLSerializedAsMap | XMLSerializedAsMapArray
>;
export declare type XMLSerializedAsMapArray = Array<
	string | XMLSerializedAsMap
>;
/**
...
export interface XMLBuilder {
	 ...
	 */
	each(
		callback: (node: XMLBuilder, index: number, level: number) => void,
		self?: boolean,
		recursive?: boolean,
		thisArg?: any,
	): XMLBuilder;
	 ...
	 */
	map<T>(
		callback: (node: XMLBuilder, index: number, level: number) => T,
		self?: boolean,
		recursive?: boolean,
		thisArg?: any,
	): T[];
	 ...
	 */
	reduce<T>(
		callback: (value: T, node: XMLBuilder, index: number, level: number) => T,
		initialValue: T,
		self?: boolean,
		recursive?: boolean,
		thisArg?: any,
	 ...
	 */
	find(
		predicate: (node: XMLBuilder, index: number, level: number) => boolean,
		self?: boolean,
		recursive?: boolean,
		thisArg?: any,
	): XMLBuilder | undefined;
	 ...
	 */
	toObject(
		writerOptions?: ObjectWriterOptions,
	 ...
	 */
	toObject(
		writerOptions: MapWriterOptions,
 ...
 */
export declare type CBWriterOptions =
	| XMLCBWriterOptions
	| JSONCBWriterOptions
	| YAMLCBWriterOptions;
/**
 * Defines the options passed to the callback builder.
 */
export declare type XMLBuilderCBCreateOptions =
	RecursivePartial<XMLBuilderCBOptions>;
/**
 * Defines default values for builder options.
 */
