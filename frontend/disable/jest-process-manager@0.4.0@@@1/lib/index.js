...
exports.teardown =
	exports.getServers =
	exports.setup =
	exports.JestProcessManagerError =
		void 0;
...
async function killProc(proc) {
	...
	console.log(
		chalk_1.default.green(`Successfully killed process ${proc.name}`),
	);
}
function runServer(config, index) {
	...
	servers[index] = spawnd(config.command, {
		...
		env: {
			...process.env,
			...(((_a = config.options) === null || _a === void 0 ? void 0 : _a.env)
				? config.options.env
				: {}),
		},
	});
...
async function setupJestServer(providedConfig, index) {
	...
	if (config.port) {
		const { launchTimeout, protocol, host, port, basePath, waitOnScheme } =
			config;
