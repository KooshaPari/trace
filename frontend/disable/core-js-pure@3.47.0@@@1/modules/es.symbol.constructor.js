...
var fallbackDefineProperty = (O, P, Attributes) => {
...
if (!NATIVE_SYMBOL) {
	...
	defineBuiltIn($Symbol, "withoutSetter", (description) =>
	...
	wrappedWellKnownSymbolModule.f = (name) => wrap(wellKnownSymbol(name), name);
