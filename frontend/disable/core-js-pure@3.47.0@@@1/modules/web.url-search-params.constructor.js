...
var parseHexOctet = (string, start) => {
...
var replacer = (match) => replacements[match];

var serialize = (it) => replace(encodeURIComponent(it), find, replacer);
