...
export default function diverging() {
	...
	scale.copy = () => copy(scale, diverging());
...
export function divergingLog() {
	...
	scale.copy = () => copy(scale, divergingLog()).base(scale.base());
...
export function divergingSymlog() {
	...
	scale.copy = () => copy(scale, divergingSymlog()).constant(scale.constant());
...
export function divergingPow() {
	...
	scale.copy = () => copy(scale, divergingPow()).exponent(scale.exponent());
