...
export declare class XMLBuilderImpl implements XMLBuilder {
	...
	/** @inheritdoc */
	ele(
		p1: string | null | ExpandObject,
		p2?: AttributesObject | string,
		p3?: AttributesObject,
	): XMLBuilder;
	/** @inheritdoc */
	remove(): XMLBuilder;
	/** @inheritdoc */
	att(
		p1: AttributesObject | string | null,
		p2?: string,
		p3?: string,
	): XMLBuilder;
	/** @inheritdoc */
	...
	/** @inheritdoc */
	toString(
		writerOptions?: XMLWriterOptions | JSONWriterOptions | YAMLWriterOptions,
	): string;
	/** @inheritdoc */
