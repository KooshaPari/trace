...
var URLImpl = /** @class */ (() => {
	...
	Object.defineProperty(URLImpl.prototype, "origin", {
		...
		get: function () {
			 ...
			 */
			return URLAlgorithm_1.asciiSerializationOfAnOrigin(
				URLAlgorithm_1.origin(this._url),
			);
		},
		enumerable: true,
		configurable: true,
	...
	Object.defineProperty(URLImpl.prototype, "username", {
		...
		set: function (val) {
			 ...
			 */
			if (URLAlgorithm_1.cannotHaveAUsernamePasswordPort(this._url)) return;
	...
	Object.defineProperty(URLImpl.prototype, "host", {
		...
		get: function () {
			...
			if (this._url.host === null) {
				...
				return (
					URLAlgorithm_1.hostSerializer(this._url.host) +
					":" +
