...
var URLSearchParamsImpl = /** @class */ (() => {
	...
	function URLSearchParamsImpl(init) {
		...
		if (util_1.isArray(init)) {
			try {
				for (
					var init_1 = __values(init), init_1_1 = init_1.next();
					!init_1_1.done;
					init_1_1 = init_1.next()
				) {
				...
				try {
					if (init_1_1 && !init_1_1.done && (_a = init_1.return))
						_a.call(init_1);
				} finally {
	...
	URLSearchParamsImpl.prototype.get = function (name) {
		...
		try {
			 ...
			 */
			for (
				var _b = __values(this._list), _c = _b.next();
				!_c.done;
				_c = _b.next()
			) {
				var item = _c.value;
	...
	URLSearchParamsImpl.prototype.set = function (name, value) {
		...
		try {
			...
			try {
				if (toRemove_1_1 && !toRemove_1_1.done && (_a = toRemove_1.return))
					_a.call(toRemove_1);
			} finally {
