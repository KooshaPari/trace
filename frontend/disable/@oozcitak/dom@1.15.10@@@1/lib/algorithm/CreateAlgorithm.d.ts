 ...
 */
export declare function create_domImplementation(
	document: Document,
): DOMImplementation;
/**
 ...
 */
export declare function create_documentType(
	document: Document,
	name: string,
	publicId: string,
	systemId: string,
 ...
 */
export declare function create_element(
	document: Document,
	localName: string,
 ...
 * @param prefix - namespace prefix
 */
export declare function create_htmlElement(
	document: Document,
	localName: string,
	namespace: string | null,
	prefix: string | null,
 ...
 * @param prefix - namespace prefix
 */
export declare function create_htmlUnknownElement(
	document: Document,
	localName: string,
	namespace: string | null,
	prefix: string | null,
 ...
 * @param document - owner document
 */
export declare function create_documentFragment(
	document: Document,
): DocumentFragment;
/**
 ...
 */
export declare function create_shadowRoot(
	document: Document,
	host: Element,
): ShadowRoot;
/**
 ...
 * @param localName - local name
 */
export declare function create_attr(
	document: Document,
	localName: string,
): Attr;
/**
 ...
 * @param data - node contents
 */
export declare function create_cdataSection(
	document: Document,
	data: string,
): CDATASection;
/**
 ...
 * @param data - node contents
 */
export declare function create_comment(
	document: Document,
	data: string,
): Comment;
/**
 ...
 * @param data - node contents
 */
export declare function create_processingInstruction(
	document: Document,
	target: string,
	data: string,
): ProcessingInstruction;
 ...
 */
export declare function create_htmlCollection(
	root: Node,
 ...
 */
export declare function create_nodeListStatic(
	root: Node,
	items: Node[],
): NodeList;
/**
 ...
 * @param end - end point
 */
export declare function create_range(
	start?: BoundaryPoint,
	end?: BoundaryPoint,
): Range;
/**
 ...
 * reference node
 */
export declare function create_nodeIterator(
	root: Node,
	reference: Node,
 ...
 */
export declare function create_treeWalker(
	root: Node,
	current: Node,
): TreeWalker;
/**
 ...
 */
export declare function create_mutationRecord(
 ...
 */
export declare function create_domTokenList(
	element: Element,
	attribute: Attr,
): DOMTokenList;
