 ...
 */
export declare function mutation_ensurePreInsertionValidity(
	node: Node,
	parent: Node,
	child: Node | null,
): void;
 ...
 * @param child - child node to insert node before
 */
export declare function mutation_preInsert(
	node: Node,
	parent: Node,
	child: Node | null,
): Node;
 ...
 */
export declare function mutation_insert(
	node: Node,
	parent: Node,
	child: Node | null,
 ...
 * @param parent - parent node to receive node
 */
export declare function mutation_replace(
	child: Node,
	node: Node,
	parent: Node,
): Node;
 ...
 * @param parent - parent node to receive node
 */
export declare function mutation_replaceAll(
	node: Node | null,
	parent: Node,
): void;
/**
 ...
 * @param suppressObservers - whether to notify observers
 */
export declare function mutation_remove(
	node: Node,
	parent: Node,
	suppressObservers?: boolean,
): void;
