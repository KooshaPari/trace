 ...
 * of a subtree.
 */
var NodeIteratorImpl = /** @class */ ((_super) => {
	 ...
	 * reference node
	 */
	NodeIteratorImpl._create = (root, reference, pointerBeforeReference) =>
		new NodeIteratorImpl(root, reference, pointerBeforeReference);
