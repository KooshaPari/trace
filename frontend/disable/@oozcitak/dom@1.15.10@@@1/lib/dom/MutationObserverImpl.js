...
var MutationObserverImpl = /** @class */ (() => {
	...
	MutationObserverImpl.prototype.observe = function (target, options) {
		...
		var _loop_1 = (registered) => {
			...
			if (registered.observer === this) {
				...
				try {
					 ...
					 */
					for (
						var _b = ((e_2 = void 0), __values(this._nodeList)), _c = _b.next();
						!_c.done;
						_c = _b.next()
					) {
						var node = _c.value;
						infra_1.list.remove(
							...
							(ob) =>
								util_1.Guard.isTransientRegisteredObserver(ob) &&
								ob.source === registered,
						);
					}
				} catch (e_2_1) {
					e_2 = { error: e_2_1 };
		...
		try {
			for (
				var _b = __values(target._registeredObserverList), _c = _b.next();
				!_c.done;
				_c = _b.next()
			) {
	...
	MutationObserverImpl.prototype.disconnect = function () {
		...
		try {
			 ...
			 */
			for (
				var _b = __values(this._nodeList), _c = _b.next();
				!_c.done;
				_c = _b.next()
			) {
				var node = _c.value;
