...
var DocumentImpl = /** @class */ ((_super) => {
	...
	Object.defineProperty(DocumentImpl.prototype, "implementation", {
		...
		get: function () {
			...
			return (
				...
				(this._implementation = algorithm_1.create_domImplementation(this))
			);
		},
		enumerable: true,
		configurable: true,
	...
	Object.defineProperty(DocumentImpl.prototype, "doctype", {
		...
		get: function () {
			...
			try {
				 ...
				 */
				for (
					var _b = __values(this._children), _c = _b.next();
					!_c.done;
					_c = _b.next()
				) {
					var child = _c.value;
	...
	/** @inheritdoc */
	DocumentImpl.prototype.getElementsByTagNameNS = function (
		namespace,
		localName,
	) {
		/**
	...
	DocumentImpl.prototype.createElement = function (localName, options) {
		...
		var namespace =
			this._type === "html" || this._contentType === "application/xhtml+xml"
				...
				: null;
		return algorithm_1.element_createAnElement(
			this,
			localName,
			namespace,
			null,
	...
	/** @inheritdoc */
	DocumentImpl.prototype.createElementNS = function (
		namespace,
		qualifiedName,
		options,
	) {
		 ...
		 */
		return algorithm_1.document_internalCreateElementNS(
			this,
			namespace,
			qualifiedName,
			options,
	...
	/** @inheritdoc */
	DocumentImpl.prototype.createAttributeNS = function (
		namespace,
		qualifiedName,
	) {
		/**
	...
	/** @inheritdoc */
	DocumentImpl.prototype.createEvent = (eventInterface) =>
		algorithm_1.event_createLegacyEvent(eventInterface);
	/** @inheritdoc */
	...
	/** @inheritdoc */
	DocumentImpl.prototype.createNodeIterator = (root, whatToShow, filter) => {
	...
	/** @inheritdoc */
	DocumentImpl.prototype.createTreeWalker = (root, whatToShow, filter) => {
		if (whatToShow === void 0) {
			whatToShow = interfaces_1.WhatToShow.All;
		}
		if (filter === void 0) {
	 ...
	 */
	DocumentImpl.prototype._getTheParent = (event) => {
		/**
	...
	DocumentImpl.prototype.getElementById = (elementId) => {
	...
	/* istanbul ignore next */
	DocumentImpl.prototype.querySelector = (selectors) => {
		throw new Error("Mixin: ParentNode not implemented.");
	};
	/* istanbul ignore next */
	DocumentImpl.prototype.querySelectorAll = (selectors) => {
		throw new Error("Mixin: ParentNode not implemented.");
	};
	return DocumentImpl;
})(NodeImpl_1.NodeImpl);
...
WebIDLAlgorithm_1.idl_defineConst(
	...
	"_nodeType",
	interfaces_1.NodeType.Document,
);
