 ...
 */
var DocumentTypeImpl = /** @class */ ((_super) => {
	...
	/* istanbul ignore next */
	DocumentTypeImpl.prototype.remove = () => {
		throw new Error("Mixin: ChildNode not implemented.");
	};
	/**
	 ...
	 * @param systemId - `SYSTEM` identifier
	 */
	DocumentTypeImpl._create = (document, name, publicId, systemId) => {
		if (publicId === void 0) {
			publicId = "";
		}
		if (systemId === void 0) {
...
WebIDLAlgorithm_1.idl_defineConst(
	DocumentTypeImpl.prototype,
	"_nodeType",
	interfaces_1.NodeType.DocumentType,
);
