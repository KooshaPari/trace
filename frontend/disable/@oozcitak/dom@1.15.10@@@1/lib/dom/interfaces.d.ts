...
export interface Document
	...
	createNodeIterator(
		...
		filter?: NodeFilter | ((node: Node) => FilterResult) | null,
	): NodeIterator;
	/**
 ...
 */
export type DocumentOrShadowRoot = {};
/**
...
export interface NodeList extends Collection, Iterable<Node> {
	 ...
	 */
	forEach(
		callback: (node: Node, index: number, list: NodeList) => any,
		thisArg?: any,
	): void;
	/**
 ...
 */
export declare type MutationCallback = (
 ...
 */
export declare type AttributeChangeStep = (
	element: Element,
	localName: string,
