 ...
 */
var NamedNodeMapImpl = /** @class */ ((_super) => {
	...
	NamedNodeMapImpl.prototype.getNamedItem = function (qualifiedName) {
		 ...
		 */
		return algorithm_1.element_getAnAttributeByName(
			qualifiedName,
			this._element,
		);
	};
	...
	NamedNodeMapImpl.prototype.removeNamedItem = function (qualifiedName) {
		 ...
		 * 3. Return attr.
		 */
		var attr = algorithm_1.element_removeAnAttributeByName(
			qualifiedName,
			this._element,
		);
	...
	/** @inheritdoc */
	NamedNodeMapImpl.prototype.removeNamedItemNS = function (
		namespace,
		localName,
	) {
		/**
		 ...
		 * 3. Return attr.
		 */
		var attr = algorithm_1.element_removeAnAttributeByNamespaceAndLocalName(
			namespace || "",
			localName,
			this._element,
		);
	 ...
	 * @param element - parent element
	 */
	NamedNodeMapImpl._create = (element) => new NamedNodeMapImpl(element);
