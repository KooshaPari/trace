 ...
 */
var StaticRangeImpl = /** @class */ ((_super) => {
	...
	function StaticRangeImpl(init) {
		 ...
		 */
		if (
			util_1.Guard.isDocumentTypeNode(init.startContainer) ||
			util_1.Guard.isAttrNode(init.startContainer) ||
			util_1.Guard.isDocumentTypeNode(init.endContainer) ||
