 ...
 */
var DOMImplementationImpl = /** @class */ (() => {
	/**
	...
	/** @inheritdoc */
	DOMImplementationImpl.prototype.createDocumentType = function (
		qualifiedName,
		publicId,
		systemId,
	) {
		...
		return algorithm_1.create_documentType(
	...
	/** @inheritdoc */
	DOMImplementationImpl.prototype.createDocument = function (
		namespace,
		qualifiedName,
		doctype,
	) {
		...
		var element = null;
		if (qualifiedName) {
			element = algorithm_1.document_internalCreateElementNS(
				document,
				namespace,
				qualifiedName,
			);
	...
	DOMImplementationImpl.prototype.createHTMLDocument = function (title) {
		 ...
		 */
		var htmlElement = algorithm_1.element_createAnElement(
			doc,
			"html",
		 ...
		 */
		var headElement = algorithm_1.element_createAnElement(
			doc,
			"head",
			infra_1.namespace.HTML,
		);
		 ...
		 */
		if (title !== undefined) {
			var titleElement = algorithm_1.element_createAnElement(
				doc,
				"title",
				infra_1.namespace.HTML,
			);
		 ...
		 * HTML namespace, to the html element created earlier.
		 */
		var bodyElement = algorithm_1.element_createAnElement(
			doc,
			"body",
			infra_1.namespace.HTML,
		);
	...
	/** @inheritdoc */
	DOMImplementationImpl.prototype.hasFeature = () => true;
	/**
	 * Creates a new `DOMImplementation`.
	 *
	 * @param document - owner document
	 */
	DOMImplementationImpl._create = (document) =>
		new DOMImplementationImpl(document);
	return DOMImplementationImpl;
})();
exports.DOMImplementationImpl = DOMImplementationImpl;
WebIDLAlgorithm_1.idl_defineConst(
	DOMImplementationImpl.prototype,
	"_ID",
	"@oozcitak/dom",
);
