 ...
 */
var DocumentFragmentImpl = /** @class */ ((_super) => {
	...
	DocumentFragmentImpl.prototype.getElementById = (elementId) => {
	...
	/* istanbul ignore next */
	DocumentFragmentImpl.prototype.querySelector = (selectors) => {
		throw new Error("Mixin: ParentNode not implemented.");
	};
	/* istanbul ignore next */
	DocumentFragmentImpl.prototype.querySelectorAll = (selectors) => {
		throw new Error("Mixin: ParentNode not implemented.");
	};
	/**
	 ...
	 * @param host - shadow root's host element
	 */
	DocumentFragmentImpl._create = (document, host) => {
		if (host === void 0) {
			host = null;
		}
...
WebIDLAlgorithm_1.idl_defineConst(
	DocumentFragmentImpl.prototype,
	"_nodeType",
	interfaces_1.NodeType.DocumentFragment,
);
