...
var NodeFilterImpl = /** @class */ (() => {
	 ...
	 * Callback function.
	 */
	NodeFilterImpl.prototype.acceptNode = (node) =>
		interfaces_1.FilterResult.Accept;
	/**
	 * Creates a new `NodeFilter`.
	 */
	NodeFilterImpl._create = () => new NodeFilterImpl();
