...
var NodeImpl = /** @class */ ((_super) => {
	...
	Object.defineProperty(NodeImpl.prototype, "_childNodes", {
		get: function () {
			return (
				this.__childNodes ||
				(this.__childNodes = algorithm_1.create_nodeList(this))
			);
		},
		enumerable: true,
		configurable: true,
	...
	Object.defineProperty(NodeImpl.prototype, "isConnected", {
		...
		get: function () {
			...
			return (
				...
				algorithm_1.shadowTree_isConnected(this)
			);
		},
		enumerable: true,
		configurable: true,
	...
	Object.defineProperty(NodeImpl.prototype, "nodeValue", {
		...
		set: function (value) {
			...
			if (util_1.Guard.isAttrNode(this)) {
				...
				algorithm_1.characterData_replaceData(
					this,
					0,
					this._data.length,
					value,
		...
		set: function (value) {
			...
			if (
				...
				algorithm_1.characterData_replaceData(
					this,
					0,
					algorithm_1.tree_nodeLength(this),
					value,
				);
			}
		},
	...
	NodeImpl.prototype.normalize = function () {
		 ...
		 */
		var descendantNodes = [];
		var node = algorithm_1.tree_getFirstDescendantNode(
			this,
			false,
			false,
		...
		while (node !== null) {
			...
			node = algorithm_1.tree_getNextDescendantNode(
				this,
				node,
				false,
				false,
		...
		for (var i = 0; i < descendantNodes.length; i++) {
			...
			try {
				for (
					var _c =
							((e_1 = void 0),
							__values(algorithm_1.text_contiguousExclusiveTextNodes(node_1))),
						_d = _c.next();
					!_d.done;
					_d = _c.next()
				) {
			...
			if (DOMImpl_1.dom.rangeList.size !== 0) {
				...
				while (
					...
					try {
						for (
							var _e = ((e_2 = void 0), __values(DOMImpl_1.dom.rangeList)),
								_f = _e.next();
							!_f.done;
							_f = _e.next()
						) {
	...
	NodeImpl.prototype.compareDocumentPosition = function (other) {
		 ...
		 */
		if (
			(!attr1 && algorithm_1.tree_isAncestorOf(node2, node1)) ||
			(attr2 && node1 === node2)
		) {
		 ...
		 */
		if (
			(!attr2 && algorithm_1.tree_isDescendantOf(node2, node1)) ||
			(attr1 && node1 === node2)
		) {
			return (
	...
	NodeImpl.prototype.lookupPrefix = function (namespace) {
		...
		if (util_1.Guard.isElementNode(this)) {
			...
			if (this.documentElement === null) {
				...
				return algorithm_1.node_locateANamespacePrefix(
	...
	NodeImpl.prototype._getTheParent = function (event) {
		...
		if (
			...
			algorithm_1.shadowTree_isAssigned(this)
		) {
...
WebIDLAlgorithm_1.idl_defineConst(
	NodeImpl.prototype,
