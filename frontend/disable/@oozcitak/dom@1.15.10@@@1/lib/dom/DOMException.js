...
var DOMStringSizeError = /** @class */ ((_super) => {
...
var WrongDocumentError = /** @class */ ((_super) => {
	...
	function WrongDocumentError(message) {
		...
		return (
			_super.call(
				this,
				"WrongDocumentError",
				"The object is in the wrong document. " + message,
			) || this
		);
	}
...
var NoDataAllowedError = /** @class */ ((_super) => {
...
var NoModificationAllowedError = /** @class */ ((_super) => {
	...
	function NoModificationAllowedError(message) {
		...
		return (
			_super.call(
				...
				"The object can not be modified. " + message,
			) || this
		);
	}
...
var NotSupportedError = /** @class */ ((_super) => {
	...
	function NotSupportedError(message) {
		...
		return (
			_super.call(
				this,
				"NotSupportedError",
				"The operation is not supported. " + message,
			) || this
		);
	}
...
var InUseAttributeError = /** @class */ ((_super) => {
...
var InvalidStateError = /** @class */ ((_super) => {
	...
	function InvalidStateError(message) {
		...
		return (
			_super.call(
				this,
				"InvalidStateError",
				"The object is in an invalid state. " + message,
			) || this
		);
	}
...
var InvalidModificationError = /** @class */ ((_super) => {
	...
	function InvalidModificationError(message) {
		...
		return (
			_super.call(
				...
				"The object can not be modified in this way. " + message,
			) || this
		);
	}
...
var NamespaceError = /** @class */ ((_super) => {
	...
	function NamespaceError(message) {
		...
		return (
			_super.call(
				this,
				"NamespaceError",
				"The operation is not allowed by Namespaces in XML. [XMLNS] " + message,
			) || this
		);
	}
...
var InvalidAccessError = /** @class */ ((_super) => {
	...
	function InvalidAccessError(message) {
		...
		return (
			_super.call(
				this,
				"InvalidAccessError",
				"The object does not support the operation or argument. " + message,
			) || this
		);
	}
...
var TypeMismatchError = /** @class */ ((_super) => {
	...
	function SecurityError(message) {
		...
		return (
			_super.call(
				this,
				"SecurityError",
				"The operation is insecure. " + message,
			) || this
		);
	}
	...
	function AbortError(message) {
		...
		return (
			_super.call(
				this,
				"AbortError",
				"The operation was aborted. " + message,
			) || this
		);
	}
	return AbortError;
...
var URLMismatchError = /** @class */ ((_super) => {
	...
	function URLMismatchError(message) {
		...
		return (
			_super.call(
				this,
				"URLMismatchError",
				"The given URL does not match another URL. " + message,
			) || this
		);
	}
...
var QuotaExceededError = /** @class */ ((_super) => {
	...
	function QuotaExceededError(message) {
		...
		return (
			_super.call(
				this,
				"QuotaExceededError",
				"The quota has been exceeded. " + message,
			) || this
		);
	}
...
var InvalidNodeTypeError = /** @class */ ((_super) => {
...
var DataCloneError = /** @class */ ((_super) => {
	...
	function DataCloneError(message) {
		...
		return (
			_super.call(
				this,
				"DataCloneError",
				"The object can not be cloned. " + message,
			) || this
		);
	}
...
var NotImplementedError = /** @class */ ((_super) => {
	...
	function NotImplementedError(message) {
		...
		return (
			_super.call(
				this,
				"NotImplementedError",
				"The DOM method is not implemented by this module. " + message,
			) || this
		);
	}
...
var HierarchyRequestError = /** @class */ ((_super) => {
	...
	function HierarchyRequestError(message) {
		...
		return (
			_super.call(
				...
				"The operation would yield an incorrect node tree. " + message,
			) || this
		);
	}
...
var NotFoundError = /** @class */ ((_super) => {
	...
	function NotFoundError(message) {
		...
		return (
			_super.call(
				this,
				"NotFoundError",
				"The object can not be found here. " + message,
			) || this
		);
	}
...
var IndexSizeError = /** @class */ ((_super) => {
	...
	function IndexSizeError(message) {
		...
		return (
			_super.call(
				this,
				"IndexSizeError",
				"The index is not in the allowed range. " + message,
			) || this
		);
	}
...
var InvalidCharacterError = /** @class */ ((_super) => {
	...
	function InvalidCharacterError(message) {
		...
		return (
			_super.call(
				...
				"The string contains invalid characters. " + message,
			) || this
		);
	}
