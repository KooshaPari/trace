...
function replace(set, conditionOrItem, newItem) {
	...
	try {
		for (
			var set_1 = __values(set), set_1_1 = set_1.next();
			!set_1_1.done;
			set_1_1 = set_1.next()
		) {
...
function insert(set, item, index) {
	...
	try {
		for (
			var set_2 = __values(set), set_2_1 = set_2.next();
			!set_2_1.done;
			set_2_1 = set_2.next()
		) {
...
function remove(set, conditionOrItem) {
	...
	if (!util_1.isFunction(conditionOrItem)) {
		...
		try {
			for (
				var set_3 = __values(set), set_3_1 = set_3.next();
				!set_3_1.done;
				set_3_1 = set_3.next()
			) {
		...
		try {
			for (
				var toRemove_1 = __values(toRemove), toRemove_1_1 = toRemove_1.next();
				!toRemove_1_1.done;
...
function contains(set, conditionOrItem) {
	...
	if (!util_1.isFunction(conditionOrItem)) {
		...
		try {
			for (
				var set_4 = __values(set), set_4_1 = set_4.next();
				!set_4_1.done;
				set_4_1 = set_4.next()
			) {
...
function size(set, condition) {
	...
	if (condition === undefined) {
		...
		try {
			for (
				var set_5 = __values(set), set_5_1 = set_5.next();
				!set_5_1.done;
				set_5_1 = set_5.next()
			) {
...
function isSubsetOf(subset, superset) {
	...
	try {
		for (
			var subset_1 = __values(subset), subset_1_1 = subset_1.next();
			!subset_1_1.done;
			subset_1_1 = subset_1.next()
		) {
...
function intersection(setA, setB) {
	...
	try {
		for (
			var setA_1 = __values(setA), setA_1_1 = setA_1.next();
			!setA_1_1.done;
			setA_1_1 = setA_1.next()
		) {
