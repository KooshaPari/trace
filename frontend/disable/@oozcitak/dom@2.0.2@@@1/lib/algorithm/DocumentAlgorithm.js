 ...
 */
function document_internalCreateElementNS(
	document,
	namespace,
	qualifiedName,
	options,
	...
	NamespaceAlgorithm_1.namespace_validateAndExtract)(namespace, qualifiedName);
	let is = null;
	...
	return (0, ElementAlgorithm_1.element_createAnElement)(
		document,
		localName,
		ns,
		prefix,
	...
	if (document !== oldDocument) {
		...
		while (inclusiveDescendant !== null) {
			...
			if (DOMImpl_1.dom.features.steps) {
				(0, DOMAlgorithm_1.dom_runAdoptingSteps)(
					inclusiveDescendant,
					oldDocument,
				);
			}
