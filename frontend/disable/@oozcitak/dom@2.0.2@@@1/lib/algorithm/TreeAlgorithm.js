 ...
 */
function tree_getFirstDescendantNode(
	node,
	self = false,
	shadow = false,
	filter,
 ...
 * @param filter - a function to filter nodes
 */
function tree_getNextDescendantNode(
	node,
	currentNode,
	self = false,
	shadow = false,
 ...
 * @param filter - a function to filter nodes
 */
function tree_getDescendantElements(
	node,
	self = false,
	shadow = false,
	filter,
	...
	return {
		[Symbol.iterator]: () => {
			const it = tree_getDescendantNodes(node, self, shadow, (e) =>
