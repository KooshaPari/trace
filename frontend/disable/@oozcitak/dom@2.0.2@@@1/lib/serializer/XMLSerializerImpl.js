...
class XMLSerializerImpl {
	...
	_serializeElementNS(
		...
		const localPrefixesMap = {};
		const localDefaultNamespace = this._recordNamespaceInformation(
			node,
			map,
			localPrefixesMap,
		);
