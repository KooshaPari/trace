...
class ElementImpl extends NodeImpl_1.NodeImpl {
	...
	getAttribute(qualifiedName) {
		 ...
		 */
		const attr = (0, algorithm_1.element_getAnAttributeByName)(
			qualifiedName,
			this,
		);
	...
	getAttributeNS(namespace, localName) {
		 ...
		 * 3. Return attr’s value.
		 */
		const attr = (0, algorithm_1.element_getAnAttributeByNamespaceAndLocalName)(
			namespace,
			localName,
			this,
		);
	...
	setAttribute(qualifiedName, value) {
		 ...
		 */
		if (attribute === null) {
			attribute = (0, algorithm_1.create_attr)(
				this._nodeDocument,
				qualifiedName,
			);
	...
	setAttributeNS(namespace, qualifiedName, value) {
		 ...
		 */
		const [ns, prefix, localName] = (0,
		algorithm_1.namespace_validateAndExtract)(namespace, qualifiedName);
		(0, algorithm_1.element_setAnAttributeValue)(
			this,
			localName,
			value,
			prefix,
	...
	removeAttributeNS(namespace, localName) {
		 ...
		 */
		(0, algorithm_1.element_removeAnAttributeByNamespaceAndLocalName)(
			namespace,
			localName,
			this,
		);
	...
	getAttributeNodeNS(namespace, localName) {
		 ...
		 * the context object.
		 */
		return (0, algorithm_1.element_getAnAttributeByNamespaceAndLocalName)(
			namespace,
			localName,
			this,
		);
	...
	attachShadow(init) {
		 ...
		 */
		if (
			!(0, algorithm_1.customElement_isValidCustomElementName)(
				this._localName,
			) &&
		...
		if (
			...
			const definition = (0,
			algorithm_1.customElement_lookUpACustomElementDefinition)(
				this._nodeDocument,
				this._namespace,
				this._localName,
				this._is,
	...
	getElementsByTagName(qualifiedName) {
		 ...
		 * object.
		 */
		return (0, algorithm_1.node_listOfElementsWithQualifiedName)(
			qualifiedName,
			this,
		);
	}
	...
	getElementsByTagNameNS(namespace, localName) {
		 ...
		 */
		return (0, algorithm_1.node_listOfElementsWithNamespace)(
			namespace,
			localName,
			this,
		);
