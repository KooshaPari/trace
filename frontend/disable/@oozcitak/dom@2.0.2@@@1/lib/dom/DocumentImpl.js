...
class DocumentImpl extends NodeImpl_1.NodeImpl {
	...
	get implementation() {
		...
		return (
			...
			(this._implementation = (0, algorithm_1.create_domImplementation)(this))
		);
	}
	/** @inheritdoc */
	get URL() {
	...
	createElement(localName, options) {
		...
		const namespace =
			this._type === "html" || this._contentType === "application/xhtml+xml"
				...
				: null;
		return (0, algorithm_1.element_createAnElement)(
			this,
			localName,
			namespace,
			null,
	...
	createElementNS(namespace, qualifiedName, options) {
		 ...
		 */
		return (0, algorithm_1.document_internalCreateElementNS)(
			this,
			namespace,
			qualifiedName,
			options,
