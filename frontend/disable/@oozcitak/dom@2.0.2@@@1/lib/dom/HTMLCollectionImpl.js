...
class HTMLCollectionImpl {
	...
	namedItem(key) {
		 ...
		 */
		if (key === "") return null;
		let ele = (0, algorithm_1.tree_getFirstDescendantNode)(
			this._root,
			false,
			false,
			(e) => util_1.Guard.isElementNode(e) && this._filter(e),
		...
		while (ele != null) {
			...
			ele = (0, algorithm_1.tree_getNextDescendantNode)(
				this._root,
				ele,
				false,
				false,
	...
	[Symbol.iterator]() {
		...
		let currentNode = (0, algorithm_1.tree_getFirstDescendantNode)(
			root,
			false,
			false,
		...
		return {
			next() {
				if (currentNode === null) {
					...
					currentNode = (0, algorithm_1.tree_getNextDescendantNode)(
						root,
						currentNode,
						false,
						false,
