...
class DOMImplementationImpl {
	...
	createDocumentType(qualifiedName, publicId, systemId) {
		...
		return (0, algorithm_1.create_documentType)(
	...
	createDocument(namespace, qualifiedName, doctype = null) {
		...
		let element = null;
		if (qualifiedName) {
			element = (0, algorithm_1.document_internalCreateElementNS)(
				document,
				namespace,
				qualifiedName,
			);
	...
	createHTMLDocument(title) {
		 ...
		 */
		const htmlElement = (0, algorithm_1.element_createAnElement)(
			doc,
			"html",
		 ...
		 */
		const headElement = (0, algorithm_1.element_createAnElement)(
			doc,
			"head",
			infra_1.namespace.HTML,
		);
		 ...
		 */
		if (title !== undefined) {
			const titleElement = (0, algorithm_1.element_createAnElement)(
				doc,
				"title",
				infra_1.namespace.HTML,
			);
		 ...
		 * HTML namespace, to the html element created earlier.
		 */
		const bodyElement = (0, algorithm_1.element_createAnElement)(
			doc,
			"body",
			infra_1.namespace.HTML,
		);
