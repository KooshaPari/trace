...
exports.StringWalker =
	exports.Lazy =
	exports.CompareCache =
	exports.ObjectCache =
	exports.FixedSizeSet =
		void 0;
...
Object.defineProperty(exports, "StringWalker", {
	enumerable: true,
	get: () => StringWalker_js_1.StringWalker,
});
/**
	...
	Object.getOwnPropertyNames(mixinClass.prototype).forEach((name) => {
		if (name !== "constructor") {
			if (overrides.indexOf(name) !== -1) {
				const orgPropDesc = Object.getOwnPropertyDescriptor(
					baseClass.prototype,
					name,
				);
