...
interface KeelRealtimePlugin {
	subscribe: (
		realtimeKey: string,
		params: SyncedGetSetSubscribeBaseParams,
	) => () => void;
...
interface SyncedKeelPropsManyBase<
	TRemote extends {
		id: string;
	},
	TLocal,
...
interface SyncedKeelPropsSingle<
	TRemote extends {
		id: string;
	},
	TLocal,
...
>(
	props: SyncedKeelPropsBase<TRemote, TLocal> &
		SyncedKeelPropsSingle<TRemote, TLocal>,
...
>(
	props: SyncedKeelPropsBase<TRemote, TLocal> &
		SyncedKeelPropsMany<TRemote, TLocal, TOption, Where>,
): SyncedCrudReturnType<TLocal, Exclude<TOption, "value">>;

export {
	type KeelClient,
	type KeelErrorParams,
	type KeelGetParams,
	type KeelKey,
	KeelKeys,
	type KeelListParams,
	type KeelObjectBase,
	type KeelRealtimePlugin,
	type OmitKeelBuiltins,
	type SyncedKeelPropsBase,
	syncedKeel,
};
