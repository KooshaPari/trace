...
type DatabaseOf<Client extends SupabaseClient> =
	Client extends SupabaseClient<infer TDB> ? TDB : never;
...
type UnionToIntersection<U> = (U extends any ? (k: U) => void : never) extends (
	...
	? I
	: never;
type IsUnionOfStrings<T> = [T] extends [string]
	? [T] extends [UnionToIntersection<T>]
		? false
		: true
	: false;
type SupabaseSchemaOf<Client extends SupabaseClient> =
	Client extends SupabaseClient<infer _, infer __, infer Schema>
		? Schema
		: never;
...
type SupabaseCollectionOf<
	...
	SchemaName extends SchemaNameOf<Client>,
> =
	| keyof SupabaseTableOf<
			Client,
			IsUnionOfStrings<SchemaName> extends true ? "public" : SchemaName
	  >
	| keyof SupabaseViewOf<
			Client,
			IsUnionOfStrings<SchemaName> extends true ? "public" : SchemaName
	  >;
type SupabaseRowOf<
...
type SyncedSupabaseConfig<
	...
	TLocal,
> = Omit<SyncedCrudPropsBase<TRemote, TLocal>, "create" | "update" | "delete">;
interface SyncedSupabaseConfiguration
	extends Omit<
		SyncedSupabaseConfig<
			{
				id: string | number;
			},
			{
...
interface SyncedSupabaseProps<
	...
	TRemote extends SupabaseRowOf<Client, Collection, SchemaName> = SupabaseRowOf<
		Client,
		Collection,
		SchemaName
	>,
...
> extends SyncedSupabaseConfig<TRemote, TLocal>,
	...
	list?: (
		...params: Parameters<
			Required<SyncedCrudPropsMany<TRemote, TLocal, TOption>>["list"]
		>
	) =>
		| PromiseLike<PostgrestSingleResponse<TRemote[]>>
		| Promise<FunctionsResponse<NoInfer<TRemote>[]>>;
	create?: (
...
declare function configureSyncedSupabase(
	config: SyncedSupabaseConfiguration,
): void;
declare function syncedSupabase<
	...
	TLocal = TRemote,
>(
	props: SyncedSupabasePropsWithSelect<
		Client,
		Collection,
		SchemaName,
		AsOption,
...
export {
	...
	type SupabaseViewOf,
	type SyncedSupabaseConfig,
	type SyncedSupabaseConfiguration,
	configureSyncedSupabase,
	getSyncedSupabaseConfiguration,
	syncedSupabase,
};
