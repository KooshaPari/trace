...
interface SyncedCrudPropsSingle<TRemote extends object, TLocal> {
	...
	) => Promise<CrudResult<TRemote | null>> | CrudResult<TRemote | null>;
	list?: never | undefined;
	initial?: InitialValue<Partial<NoInfer<TLocal>>, "value">;
	as?: never | "value";
}
interface SyncedCrudPropsMany<
	TRemote extends object,
	TLocal,
	TAsOption extends CrudAsOption,
> {
	list: (
		params: SyncedGetParams<TRemote>,
	) => Promise<CrudResult<TRemote[] | null>> | CrudResult<TRemote[] | null>;
...
interface SyncedCrudPropsBase<TRemote extends object, TLocal = TRemote>
	extends Omit<
	...
	): Promise<CrudResult<TRemote> | null | undefined | void>;
	update?(
	...
	onSaved?(
		params: SyncedCrudOnSavedParams<TRemote, TLocal>,
	): Partial<TLocal> | void;
	fieldId?: string;
...
> = TAsOption extends "Map"
	...
	: TAsOption extends "object"
		...
		: TAsOption extends "value"
			? TLocal
			: TLocal[];
declare function syncedCrud<
	TRemote extends object,
	TLocal = TRemote,
	TAsOption extends CrudAsOption = "object",
>(
	props: SyncedCrudPropsNoRead<TRemote, TAsOption> &
...
declare function syncedCrud<TRemote extends object, TLocal = TRemote>(
	props: SyncedCrudPropsSingle<TRemote, TLocal> &
		SyncedCrudPropsBase<TRemote, TLocal>,
...
declare function syncedCrud<
	...
	TAsOption extends CrudAsOption = "object",
>(
	props: SyncedCrudPropsMany<TRemote, TLocal, TAsOption> &
		SyncedCrudPropsBase<TRemote, TLocal>,
...
export {
	...
	type CrudOnErrorFn,
	type CrudResult,
	type SyncedCrudOnSavedParams,
	type SyncedCrudPropsBase,
	type SyncedCrudPropsMany,
	type SyncedCrudPropsNoRead,
	type SyncedCrudPropsSingle,
	type SyncedCrudReturnType,
	type WaitForSetCrudFnParams,
	syncedCrud,
};
