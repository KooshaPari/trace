...
interface ParamsUseObservableNextRouter<T extends object>
	extends ParamsUseObservableNextRouterBase {
...
declare function useObservableNextRouter<T extends object>(
	params: ParamsUseObservableNextRouter<T>,
): Observable<T>;
declare function useObservableNextRouter(
	params: ParamsUseObservableNextRouterBase,
): Observable<ObservableNextRouterState>;

export {
	type ObservableNextRouterState,
	type ParamsUseObservableNextRouter,
	type ParamsUseObservableNextRouterBase,
