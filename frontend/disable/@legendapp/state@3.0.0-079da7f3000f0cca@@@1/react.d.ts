...
declare function Switch<T extends object>({
	value,
	children,
}: {
	value?: Selector<T>;
	children: Partial<
		Record<keyof T | "null" | "undefined" | "default", () => ReactNode>
	>;
}): ReactElement | null;
declare function Switch<T extends string | number | symbol>({
	value,
	children,
}: {
	value?: Selector<T | undefined | null>;
	children: Partial<
		Record<T | "null" | "undefined" | "default", () => ReactNode>
	>;
}): ReactElement | null;
declare function Switch<T extends boolean>({
	value,
	children,
}: {
	value?: Selector<T | undefined | null>;
	children: Partial<
		Record<"false" | "true" | "null" | "undefined" | "default", () => ReactNode>
	>;
}): ReactElement | null;
declare function Switch<T>({
	value,
	children,
}: {
	value?: Selector<T>;
...
type BindKeys<P = any, K extends keyof P = keyof P> = Partial<
	Record<K, BindKey<P>>
>;
...
declare function reactive<T extends object, K extends keyof T>(
	component: React.FC<T>,
	keys: K[] | (keyof T)[],
...
declare function reactive<T extends object>(
	component: React.ComponentClass<T>,
): React.ComponentClass<ShapeWith$<T>>;
declare function reactive<T extends object>(
	component: React.FC<T>,
): React.FC<ShapeWith$<T>>;
declare function reactive<T extends object>(
...
declare function reactiveObserver<T extends object>(
	component: React.FC<T>,
	keys: undefined | null,
	bindKeys?: BindKeys<T>,
): React.FC<ShapeWith$<T>>;
...
declare function reactiveObserver<T extends object, K extends keyof T>(
	component: React.FC<T>,
	keys: K[] | (keyof T)[],
	bindKeys?: BindKeys<T, K>,
): React.FC<ReactifyProps<T, K>>;
...
declare function reactiveComponents<P extends Record<string, any>>(
	components: P,
): ObjectShapeWith$<P>;
...
declare function useObservable<T>(
	value:
...
declare function useObservableReducer<R extends ReducerWithoutAction<any>, I>(
	reducer: R,
	initializerArg: I,
	initializer: (arg: I) => ReducerStateWithoutAction<R>,
): [Observable<ReducerStateWithoutAction<R>>, DispatchWithoutAction];
declare function useObservableReducer<R extends ReducerWithoutAction<any>>(
	reducer: R,
	initializerArg: ReducerStateWithoutAction<R>,
	initializer?: undefined,
): [Observable<ReducerStateWithoutAction<R>>, DispatchWithoutAction];
declare function useObservableReducer<R extends Reducer<any, any>, I>(
	reducer: R,
...
declare function useObservableReducer<R extends Reducer<any, any>>(
	reducer: R,
...
declare function useObserveEffect<T>(
	run: (e: ObserveEvent<T>) => T | void,
): void;
declare function useObserveEffect<T>(
	run: (e: ObserveEvent<T>) => T | void,
...
declare function useWhen<T, T2>(
	predicate: Selector<T>,
	effect: (value: T) => T2,
): Promise<T2>;
declare function useWhenReady<T>(predicate: Selector<T>): Promise<T>;
declare function useWhenReady<T, T2>(
	predicate: Selector<T>,
	effect: (value: T) => T2 | (() => T2),
): Promise<T2>;

declare function configureReactive({
	components,
	binders,
}: {
...
export {
	...
	Computed,
	type FCReactive,
	type FCReactiveObject,
	For,
	type IReactive,
	Memo,
	type ObjectShapeWith$,
	type ReactifyProps,
	Reactive,
	type ShapeWith$,
	type ShapeWithNew$,
	...
	useEffectOnce,
	useIsMounted,
	useObservable as useLocalObservable,
	useMount,
	useMountOnce,
	useObservable,
