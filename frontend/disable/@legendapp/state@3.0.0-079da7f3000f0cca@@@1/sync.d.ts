...
interface PersistOptions<T = any> {
	name?: string;
	plugin?:
		| ClassConstructor<ObservablePersistPlugin, T[]>
...
interface SyncedGetSetBaseParams<T = any>
	extends SyncedGetSetSubscribeBaseParams<T>,
		OnErrorRetryParams {}
...
interface SyncedOptions<TRemote = any, TLocal = TRemote>
	extends Omit<LinkedOptions<TRemote>, "get" | "set"> {
...
interface SyncedOptionsGlobal<T = any>
	extends Omit<
		SyncedOptions<T>,
		| "get"
		| "set"
	...
	persist?: ObservablePersistPluginOptions &
		Omit<PersistOptions, "name" | "transform" | "options">;
}
...
>;
declare type FieldTransforms<T> =
...
declare type FieldTransformsInner<T> = {
	...
	| {
			[K in keyof DictKeys<T> as `${K}_dict`]?: FieldTransforms<
				RecordValue<T[K]>
			>;
	  }
) & {
...
declare function removeNullUndefined<T extends Record<string, any>>(
	a: T,
	recursive?: boolean,
): T;
declare function diffObjects<T extends Record<string, any>>(
	obj1: T,
	obj2: T,
	deep?: boolean,
): Partial<T>;
declare function deepEqual<T extends Record<string, any> = any>(
	a: T,
	b: T,
	ignoreFields?: string[],
	nullVsUndefined?: boolean,
): boolean;
declare function combineTransforms<T, T2>(
...
type TransformStringifyKeys<TRemote, TLocal> = (
	| keyof TRemote
	| {
			from: keyof TRemote;
			to: keyof TLocal;
...
declare function transformStringifyKeys<
...
declare function transformStringifyDates<
	TRemote extends Record<string, any>,
...
>(
	...args: Keys[]
): SyncTransform<TransformStringsToDates<TRemote, Keys>, TRemote>;
declare function transformStringifyDates<
	TRemote extends Record<string, any>,
	TLocal extends Record<string, any> = TRemote,
>(...args: (keyof TRemote)[]): SyncTransform<TRemote, TLocal>;

declare const mapSyncPlugins: WeakMap<
...
declare function syncObservable<T>(
	obs$: ObservableParam<T>,
	syncOptions: SyncedOptions<T>,
): Observable<ObservableSyncState>;
declare function syncObservable<T>(
	obs$: ObservableParam<T>,
	syncOptions: Synced<T>,
): Observable<ObservableSyncState>;
declare function getAllSyncStates(): readonly [
	Observable<ObservableSyncState>,
	NodeInfo,
][];

declare function synced<TRemote, TLocal = TRemote>(
	params: SyncedOptions<TRemote, TLocal> | (() => TRemote),
): Synced<TLocal>;

declare function configureSynced<T extends (...args: any[]) => any>(
	fn: T,
	origOptions: Partial<Parameters<T>[0]>,
): T;
declare function configureSynced(origOptions: SyncedOptions): typeof synced;

declare function createRevertChanges(
	obs$: ObservableParam<any>,
	changes: Change[],
): () => void;

declare function waitForSet(
...
export {
	...
	type FieldTransformsInner,
	type ObservablePersistAsyncStoragePluginOptions,
	type ObservablePersistIndexedDBPluginOptions,
	type ObservablePersistPlugin,
	type ObservablePersistPluginOptions,
	type ObservableSyncFunctions,
	type ObservableSyncSetParams,
	type OnErrorRetryParams,
	type PendingChanges,
	type PersistMetadata,
	type PersistOptions,
	type QueryByModified,
	type StringToDate,
	type SubscribeOptions,
	type SyncTransform,
	type SyncTransformMethod,
	type Synced,
	type SyncedErrorParams,
	type SyncedGetParams,
	type SyncedGetSetBaseParams,
	type SyncedGetSetSubscribeBaseParams,
	type SyncedOptions,
	type SyncedOptionsGlobal,
	type SyncedSetParams,
	type SyncedSubscribeParams,
	type TransformStringifyKeys,
	type TransformStringifyOptions,
	type TransformStringsToDates,
	combineTransforms,
