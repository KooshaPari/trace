declare module "bun" {
	namespace __internal {
		...
		type LibEmptyOrNodeStreamWebDecompressionStream =
		...
		type LibEmptyOrPerformanceEntry = LibDomIsLoaded extends true
			? {}
			: import("node:perf_hooks").PerformanceEntry;
		type LibEmptyOrPerformanceMark = LibDomIsLoaded extends true
			? {}
			: import("node:perf_hooks").PerformanceMark;
		type LibEmptyOrPerformanceMeasure = LibDomIsLoaded extends true
			? {}
			: import("node:perf_hooks").PerformanceMeasure;
		...
		type LibEmptyOrNodeUtilTextEncoder = LibDomIsLoaded extends true
			? {}
		...
		type LibEmptyOrNodeUtilTextDecoder = LibDomIsLoaded extends true
			? {}
		...
		type LibEmptyOrNodeMessagePort = LibDomIsLoaded extends true
			? {}
			: import("node:worker_threads").MessagePort;
		type LibEmptyOrBroadcastChannel = LibDomIsLoaded extends true
			? {}
			: import("node:worker_threads").BroadcastChannel;
		type LibEmptyOrEventSource = LibDomIsLoaded extends true
			? {}
...
interface WritableStream<W = any>
	extends Bun.__internal.LibEmptyOrNodeWritableStream<W> {}
...
interface CompressionStream
	extends Bun.__internal.LibEmptyOrNodeStreamWebCompressionStream {}
/**
 * Unimplemented in Bun
 */
...
interface CryptoKeyPair
	extends Bun.__internal.NodeCryptoWebcryptoCryptoKeyPair {}
...
declare var FormData: Bun.__internal.UseLibDomIfAvailable<
	"FormData",
	{ prototype: FormData; new (): FormData }
>;
...
interface Performance
	extends Bun.__internal.LibPerformanceOrNodePerfHooksPerformance {}
...
interface PerformanceMeasure
	extends Bun.__internal.LibEmptyOrPerformanceMeasure {}
...
interface PerformanceObserver
	extends Bun.__internal.LibEmptyOrPerformanceObserver {}
...
interface PerformanceObserverEntryList
	extends Bun.__internal.LibEmptyOrPerformanceObserverEntryList {}
...
interface PerformanceResourceTiming
	extends Bun.__internal.LibEmptyOrPerformanceResourceTiming {}
...
interface ReadableByteStreamController
	extends Bun.__internal.LibEmptyOrReadableByteStreamController {}
...
interface ReadableStreamBYOBReader
	extends Bun.__internal.LibEmptyOrReadableStreamBYOBReader {}
...
interface ReadableStreamBYOBRequest
	extends Bun.__internal.LibEmptyOrReadableStreamBYOBRequest {}
...
interface TextDecoderStream
	extends Bun.__internal.LibEmptyOrNodeStreamWebTextDecoderStream {}
...
interface TextEncoderStream
	extends Bun.__internal.LibEmptyOrNodeStreamWebTextEncoderStream {}
