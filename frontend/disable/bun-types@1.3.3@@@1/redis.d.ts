declare module "bun" {
	...
	export class RedisClient {
		...
		hset(
			key: RedisClient.KeyLike,
			fields: Record<string | number, RedisClient.KeyLike | number>,
		): Promise<number>;
		...
		hsetex(
			...
			fieldsKeyword: "FIELDS",
			numfields: number,
			...fieldValues: RedisClient.KeyLike[]
		): Promise<number>;
		//prettier-ignore
		hsetex(
			key: RedisClient.KeyLike,
		 ...
		 */
		blpop(
			...args: (RedisClient.KeyLike | number)[]
		...
		type(
			key: RedisClient.KeyLike,
		): Promise<"none" | "string" | "list" | "set" | "zset" | "hash" | "stream">;
