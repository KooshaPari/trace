...
declare module "bun" {
	...
	namespace __internal {
		...
		type UseLibDomIfAvailable<
			...
			Otherwise,
		> = LibDomIsLoaded extends true // `onabort` is defined in lib.dom.d.ts, so we can check to see if lib dom is loaded by checking if `onabort` is defined
