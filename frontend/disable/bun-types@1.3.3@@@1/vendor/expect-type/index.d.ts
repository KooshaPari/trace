...
export interface PositiveExpectTypeOf<Actual>
	...
	toEqualTypeOf: {
		 ...
		 */
		<
			Expected extends StrictEqualUsingTSInternalIdenticalToOperator<
				Actual,
				Expected
			> extends true
				? unknown
	...
	branded: {
		...
		>(
			...MISMATCH: MismatchArgs<
				StrictEqualUsingBranding<Actual, Expected>,
				true
			>
		) => true;
	};
...
> {
	...
	toBeConstructibleWith: Options["positive"] extends true
		? <Args extends ConstructorOverloadParameters<Actual>>(
				...args: Args
			) => true
		: never;
	/**
	 ...
	 * ```
	 */
	constructorParameters: ExpectTypeOf<
		ConstructorOverloadParameters<Actual>,
		Options
	>;
	/**
	 ...
	 * ```
	 */
	instance: Actual extends new (
		...args: any[]
	) => infer I
		? ExpectTypeOf<I, Options>
		: never;
	/**
	 ...
	 * ```
	 */
	returns: Actual extends Function
		? ExpectTypeOf<OverloadReturnTypes<Actual>, Options>
		: never;
	/**
	 ...
	 * ```
	 */
	items: Actual extends ArrayLike<infer ItemType>
		? ExpectTypeOf<ItemType, Options>
		: never;
	/**
