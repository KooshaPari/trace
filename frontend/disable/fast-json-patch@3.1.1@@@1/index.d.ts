...
declare const _default: {
	...
	observe<T>(
		obj: Object | T[],
		callback?: (patches: core.Operation[]) => void,
	): duplex.Observer<T>;
	generate<T>(
		observer: duplex.Observer<Object>,
		invertible?: boolean,
	): core.Operation[];
	compare(
		tree1: Object | any[],
	...
	applyOperation<T>(
		...
		validateOperation?: boolean | core.Validator<T>,
	...
	validate<T>(
		...
		document?: T,
		externalValidator?: core.Validator<T>,
	): JsonPatchError;
