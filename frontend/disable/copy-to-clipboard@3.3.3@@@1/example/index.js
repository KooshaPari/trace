				...
				(e, t, o) => {
					...
					t.exports = (o, n) => {
						...
						try {
							...
							if (
								(((e = document.createElement("span")).textContent = o),
								(e.ariaHidden = "true"),
								(e.style.all = "unset"),
										...
										n.format &&
											...
											void 0 === e.clipboardData
												? (i && console.warn("unable to use e.clipboardData"),
													...
													(t = f[n.format] || f.default),
													window.clipboardData.setData(t, o))
												: (e.clipboardData.clearData(),
													e.clipboardData.setData(n.format, o))),
							...
							i && console.error("unable to copy using execCommand: ", e),
								i && console.warn("trying IE specific stuff");
							try {
								window.clipboardData.setData(n.format || "text", o),
			...
			2: [
				(e, t, o) => {
					t.exports = () => {
						...
						for (
							var e = document.activeElement, o = [], n = 0;
							n < t.rangeCount;
							n++
						)
							o.push(t.getRangeAt(n));
