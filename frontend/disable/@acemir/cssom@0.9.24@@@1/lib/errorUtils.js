...
function getErrorConstructor(context, errorType) {
	...
	if (
		...
		context.parentStyleSheet.__globalObject &&
		context.parentStyleSheet.__globalObject[errorType]
	) {
	...
	if (
		context.__parentStyleSheet &&
		context.__parentStyleSheet.__globalObject &&
		context.__parentStyleSheet.__globalObject[errorType]
	) {
	...
	return (
		(typeof global !== "undefined" && global[errorType]) ||
 ...
 */
function throwMissingArguments(
	context,
	methodName,
	objectName,
	required,
