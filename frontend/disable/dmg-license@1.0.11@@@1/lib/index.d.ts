...
export declare function dmgLicense(
	imagePath: string,
	spec: LicenseSpec,
	options: Options,
): Promise<void>;
export default dmgLicense;
export declare function dmgLicensePlist(
	spec: LicenseSpec,
	options: Options,
): Promise<{
	plist: PlistObject;
...
export declare function dmgLicenseFromJSON(
	imagePath: string,
	specJSON: string | object,
	options: FromJSONOptions,
): Promise<void>;
export declare function dmgLicensePlistFromJSON(
	specJSON: string | object,
	options: FromJSONOptions,
): Promise<{
