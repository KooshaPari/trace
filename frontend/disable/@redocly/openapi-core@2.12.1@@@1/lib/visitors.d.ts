...
export type NormalizeVisitor<Fn> =
	Fn extends VisitFunction<infer T> ? VisitorNode<T> : never;
...
type Oas3FlatVisitor = {
	Root?: VisitFunctionOrObject<
		Oas3Definition | Oas3_1Definition | Oas3_2Definition
	>;
	...
	Paths?: VisitFunctionOrObject<
		Record<string, Oas3PathItem<Oas3Schema | Oas3_1Schema>>
	>;
	...
	CallbacksMap?: VisitFunctionOrObject<
		Record<string, Oas3Callback<Oas3Schema | Oas3_1Schema>>
	>;
	...
	RequestBody?: VisitFunctionOrObject<
		Oas3RequestBody<Oas3Schema | Oas3_1Schema>
	>;
	MediaTypesMap?: VisitFunctionOrObject<
		Record<string, Oas3MediaType<Oas3Schema | Oas3_1Schema>>
	>;
	...
	Responses?: VisitFunctionOrObject<
		Record<string, Oas3Response<Oas3Schema | Oas3_1Schema>>
	>;
	...
	NamedResponses?: VisitFunctionOrObject<
		Record<string, Oas3Response<Oas3Schema | Oas3_1Schema>>
	>;
	NamedParameters?: VisitFunctionOrObject<
		Record<string, Oas3Parameter<Oas3Schema | Oas3_1Schema>>
	>;
	...
	>;
	NamedHeaders?: VisitFunctionOrObject<
		Record<string, Oas3Header<Oas3Schema | Oas3_1Schema>>
	>;
	NamedSecuritySchemes?: VisitFunctionOrObject<
		Record<string, Oas3SecurityScheme>
	>;
	NamedLinks?: VisitFunctionOrObject<Record<string, Oas3Link>>;
	NamedCallbacks?: VisitFunctionOrObject<
		Record<string, Oas3Callback<Oas3Schema | Oas3_1Schema>>
	>;
	ImplicitFlow?: VisitFunctionOrObject<
		NonNullable<OAuth2Auth["flows"]["implicit"]>
	>;
	PasswordFlow?: VisitFunctionOrObject<
		NonNullable<OAuth2Auth["flows"]["password"]>
	>;
	ClientCredentials?: VisitFunctionOrObject<
		NonNullable<OAuth2Auth["flows"]["clientCredentials"]>
	>;
	AuthorizationCode?: VisitFunctionOrObject<
		NonNullable<OAuth2Auth["flows"]["authorizationCode"]>
	>;
...
type Oas2FlatVisitor = {
	...
	NamedSecuritySchemes?: VisitFunctionOrObject<
		Record<string, Oas2SecurityScheme>
	>;
	SpecExtension?: VisitFunctionOrObject<unknown>;
};
...
export type Oas3Visitor = BaseVisitor &
	...
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, Oas3NestedVisitor>
	>;
export type Oas2Visitor = BaseVisitor &
	Oas2NestedVisitor &
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, Oas2NestedVisitor>
	>;
export type Async2Visitor = BaseVisitor &
	Async2NestedVisitor &
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, Async2NestedVisitor>
	>;
export type Async3Visitor = BaseVisitor &
	Async3NestedVisitor &
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, Async3NestedVisitor>
	>;
export type Arazzo1Visitor = BaseVisitor &
	ArazzoNestedVisitor &
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, ArazzoNestedVisitor>
	>;
export type Overlay1Visitor = BaseVisitor &
	Overlay1NestedVisitor &
	Record<
		string,
		VisitFunction<any> | NestedVisitObject<any, Overlay1NestedVisitor>
	>;
export type CatalogEntityVisitor = BaseVisitor &
	Record<string, VisitFunction<any>>;
...
export type Async2Preprocessor = (
	options: Record<string, any>,
) => Async2Visitor;
export type Async3Preprocessor = (
	options: Record<string, any>,
) => Async3Visitor;
export type Arazzo1Preprocessor = (
	options: Record<string, any>,
) => Arazzo1Visitor;
...
export declare function normalizeVisitors<T extends BaseVisitor>(
	visitorsConfig: (RuleInstanceConfig & {
