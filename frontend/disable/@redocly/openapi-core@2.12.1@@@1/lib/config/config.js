...
export class Config {
	constructor(resolvedConfig, opts = {}) {
		...
		this.rules = {
			...
			arazzo1: group({
				...
				...resolvedConfig.arazzo1Rules,
			}),
			overlay1: group({
				...resolvedConfig.rules,
				...resolvedConfig.overlay1Rules,
			}),
		};
		this.preprocessors = {
			oas2: {
				...resolvedConfig.preprocessors,
				...resolvedConfig.oas2Preprocessors,
			},
			oas3_0: {
				...resolvedConfig.preprocessors,
		...
		this.decorators = {
			...
			oas3_0: {
				...
				...resolvedConfig.oas3_0Decorators,
			},
			oas3_1: {
				...resolvedConfig.decorators,
				...resolvedConfig.oas3_1Decorators,
			},
			oas3_2: {
				...resolvedConfig.decorators,
				...resolvedConfig.oas3_2Decorators,
			},
			async2: {
				...resolvedConfig.decorators,
				...resolvedConfig.async2Decorators,
			},
			async3: {
				...resolvedConfig.decorators,
				...resolvedConfig.async3Decorators,
			},
			arazzo1: {
				...resolvedConfig.decorators,
	...
	forAlias(alias) {
		if (
			alias === undefined ||
			!isPlainObject(this.resolvedConfig?.apis?.[alias])
		) {
			return this;
		}
	...
	resolveIgnore(ignoreFile) {
		...
		this.ignore = parseYaml(fs.readFileSync(ignoreFile, "utf-8")) || {};
