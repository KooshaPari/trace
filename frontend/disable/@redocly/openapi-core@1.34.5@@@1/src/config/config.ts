...
import { SpecMajorVersion, SpecVersion } from "../oas-types";
...
export class StyleguideConfig {
	...
	constructor(
		public rawConfig: ResolvedStyleguideConfig,
...
function replaceSpecWithStruct(
	ruleGroups: string[],
	...
	for (const ruleGroup of ruleGroups) {
		if (
			config[ruleGroup] &&
			isPlainObject(config[ruleGroup]) &&
...
export class Config {
	...
	telemetry?: Telemetry;
	constructor(
		public rawConfig: ResolvedConfig,
		public configFile?: string,
	) {
