...
import type { LoadOptions, YAMLNode } from "yaml-ast-parser";
...
import { nextTick, parseYaml, readFileFromUrl } from "./utils";
...
export class Source {
	...
	getAst(
		safeLoad: (input: string, options?: LoadOptions | undefined) => YAMLNode,
	) {
...
export function makeDocumentFromString(
	sourceString: string,
	absoluteRef: string,
) {
