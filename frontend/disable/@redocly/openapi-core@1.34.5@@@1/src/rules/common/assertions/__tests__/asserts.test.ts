	...
	describe("generic rules", () => {
		...
		describe("pattern", () => {
			it("value should match regex pattern", () => {
				expect(
					asserts.pattern("test string", "/test/", assertionProperties),
				).toEqual([]);
				expect(
					asserts.pattern("test string", "/test me/", assertionProperties),
				).toEqual([
					{
				...
				expect(
					...
					{
						message:
							'"./other.yaml" should match a regex /^(./)?components/.*.yaml$/',
						location: baseLocation,
					},
				]);
			});
		...
		describe("notPattern", () => {
			it("value should not match regex pattern", () => {
				expect(
					asserts.notPattern("test string", "/test me/", assertionProperties),
				).toEqual([]);
				expect(
					asserts.notPattern("test string", "/test/", assertionProperties),
				).toEqual([
					{
						location: baseLocation,
						message: '"test string" should not match a regex /test/',
					},
				]);
				expect(
					asserts.notPattern(
		...
		describe("ref", () => {
			it("value should have ref", () => {
				...
				expect(
					asserts.ref({}, true, { ...assertionProperties, rawValue: {} }),
				).toEqual([
					{
			...
			it("value should not have ref", () => {
				...
				expect(
					asserts.ref({}, false, { ...assertionProperties, rawValue: {} }),
				).toEqual([]);
			});
			...
			it("value should match regex pattern", () => {
				...
				expect(
					...
					{
						message: "$ref value should match /test me/",
						location: baseLocation,
					},
				]);
				expect(
		...
		describe("enum", () => {
			it("value should be among predefined keys", () => {
				expect(
					asserts.enum("test", ["test", "example"], assertionProperties),
				).toEqual([]);
				expect(
					asserts.enum(["test"], ["test", "example"], assertionProperties),
				).toEqual([]);
				...
				expect(
					asserts.enum("test", ["foo", "example"], assertionProperties),
				).toEqual([
					{
		...
		describe("undefined", () => {
			...
			it("value should be defined", () => {
				...
				expect(
					asserts.undefined(undefined, false, assertionProperties),
				).toEqual([
					{
						message: "Should be defined",
						location: baseLocation,
		...
		describe("minLength", () => {
			it("value should have less or equal than 5 symbols length", () => {
				...
				expect(
					asserts.minLength([1, 2, 3, 4, 5], 5, assertionProperties),
				).toEqual([]);
				expect(
					asserts.minLength([1, 2, 3, 4, 5, 6], 5, assertionProperties),
				).toEqual([]);
		...
		describe("maxLength", () => {
			it("value should have more or equal than 5 symbols length", () => {
				...
				expect(
					asserts.maxLength([1, 2, 3, 4, 5], 5, assertionProperties),
				).toEqual([]);
				expect(
					asserts.maxLength([1, 2, 3, 4, 5, 6], 5, assertionProperties),
				).toEqual([
					{
		...
		describe("casing", () => {
			it("value should be camelCase", () => {
				...
				expect(
					asserts.casing(["fQ"], "camelCase", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["testExample", "FooBar"],
				...
				expect(
					asserts.casing("testExample", "camelCase", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing("TestExample", "camelCase", assertionProperties),
				).toEqual([
				...
				expect(
					asserts.casing("test-example", "camelCase", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("test_example", "camelCase", assertionProperties),
				).toEqual([
					{
			...
			it("value should be PascalCase", () => {
				expect(
					asserts.casing("TestExample", "PascalCase", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["TestExample", "FooBar"],
				...
				expect(
					asserts.casing("test-example", "PascalCase", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("test_example", "PascalCase", assertionProperties),
				).toEqual([
					{
			...
			it("value should be kebab-case", () => {
				expect(
					asserts.casing("test-example", "kebab-case", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
				...
				expect(
					asserts.casing("testExample", "kebab-case", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("test_example", "kebab-case", assertionProperties),
				).toEqual([
					{
			...
			it("value should be snake_case", () => {
				expect(
					asserts.casing("test_example", "snake_case", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["test_example", "foo_bar"],
						"snake_case",
						assertionProperties,
					),
				).toEqual([]);
				...
				expect(
					asserts.casing("testExample", "snake_case", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("test-example", "snake_case", assertionProperties),
				).toEqual([
					{
			...
			it("value should be MACRO_CASE", () => {
				expect(
					asserts.casing("TEST_EXAMPLE", "MACRO_CASE", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["TEST_EXAMPLE", "FOO_BAR"],
				...
				expect(
					asserts.casing("TEST_EXAMPLE_", "MACRO_CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("_TEST_EXAMPLE", "MACRO_CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("TEST__EXAMPLE", "MACRO_CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("TEST-EXAMPLE", "MACRO_CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("testExample", "MACRO_CASE", assertionProperties),
				).toEqual([
					{
			...
			it("value should be COBOL-CASE", () => {
				expect(
					asserts.casing("TEST-EXAMPLE", "COBOL-CASE", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["TEST-EXAMPLE", "FOO-BAR"],
				...
				expect(
					asserts.casing("0TEST-EXAMPLE", "COBOL-CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("TEST_EXAMPLE", "COBOL-CASE", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("testExample", "COBOL-CASE", assertionProperties),
				).toEqual([
					{
			...
			it("value should be flatcase", () => {
				expect(
					asserts.casing("testexample", "flatcase", assertionProperties),
				).toEqual([]);
				expect(
					asserts.casing(
						["testexample", "foobar"],
				...
				expect(
					asserts.casing("testexample_", "flatcase", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("0testexample", "flatcase", assertionProperties),
				).toEqual([
					{
				...
				expect(
					asserts.casing("test-example", "flatcase", assertionProperties),
				).toEqual([
					{
		...
		describe("sortOrder", () => {
			it("value should be ordered in ASC direction", () => {
				...
				expect(
					asserts.sortOrder(["example"], "asc", assertionProperties),
				).toEqual([]);
				expect(
					asserts.sortOrder(
						["example", "test", "foo"],
			...
			it("value should be ordered in DESC direction", () => {
				...
				expect(
					asserts.sortOrder(["example"], "desc", assertionProperties),
				).toEqual([]);
				expect(
					asserts.sortOrder(
						["example", "test", "foo"],
		...
		describe("mutuallyExclusive", () => {
			it("node should not have more than one property from predefined list", () => {
				...
				expect(
					...
					{
						message: "foo, bar keys should be mutually exclusive",
						location: baseLocation.key(),
					},
				]);
				expect(
		...
		describe("mutuallyRequired", () => {
			it("node should have all the properties from predefined list", () => {
				...
				expect(
					...
					{
						message: "Properties foo, test are mutually required",
						location: baseLocation.key(),
					},
				]);
				expect(
		...
		describe("requireAny", () => {
			it("node must have at least one property from predefined list", () => {
				...
				expect(
					asserts.requireAny(Object.keys(fakeNode), [], assertionProperties),
				).toEqual([
					{
			...
			it("node must have at least one property from predefined list", () => {
				const customFn = jest.fn((value: string[], options: any) => {
					if (value[0] === options.word) {
						return [
							{
								message: `First value should be ${options.word}`,
								location: baseLocation.key(),
							},
						];
					}
				...
				asserts["local/customFn" as keyof Asserts] =
					buildAssertCustomFunction(customFn);
				expect(
					asserts["local/customFn" as keyof Asserts](
						Object.keys(fakeNode),
						{ word: "foo" },
