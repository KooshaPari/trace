...
import {
	isPlainObject,
	isTruthy,
	isString as runOnValue,
} from "../../../utils";
import type { OrderDirection, OrderOptions } from "./utils";
import { getIntersectionLength, isOrdered, regexFromString } from "./utils";
...
export const asserts: Asserts = {
	...
	sortOrder: (
		...
		const direction =
			(condition as OrderOptions).direction || (condition as OrderDirection);
	...
	ref: (
		...
		const hasRef = Object.hasOwn(rawValue, "$ref");
