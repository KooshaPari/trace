...
exports.asserts = {
	...
	sortOrder: (value, condition, { baseLocation }) => {
		...
		if (
			...
			(0, utils_2.isOrdered)(value, condition)
		)
			return [];
		return [
			{
	...
	mutuallyExclusive: (value, condition, { baseLocation }) => {
		if ((0, utils_2.getIntersectionLength)(value, condition) < 2) return [];
		return [
			{
	...
	mutuallyRequired: (value, condition, { baseLocation }) => {
		const isValid =
			(0, utils_2.getIntersectionLength)(value, condition) > 0
				? (0, utils_2.getIntersectionLength)(value, condition) ===
					condition.length
				: true;
		return isValid
			? []
