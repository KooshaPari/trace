...
export declare function getAssertsToApply(
	assertion: AssertionDefinition,
): AssertToApply[];
export declare function buildVisitorObject(
	assertion: Assertion,
...
export declare function isOrdered(
	value: any[],
	options: OrderOptions | OrderDirection,
): boolean;
export declare function runAssertion({
	assert,
	ctx,
	assertionProperty,
