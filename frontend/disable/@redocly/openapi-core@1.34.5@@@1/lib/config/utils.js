...
function mergeExtends(rulesConfList) {
	...
	for (const rulesConf of rulesConfList) {
		...
		(0, utils_1.assignOnlyExistingConfig)(
			result.overlay1Rules,
			rulesConf.rules,
		);
		(0, utils_1.assignConfig)(result.preprocessors, rulesConf.preprocessors);
		(0, utils_1.assignConfig)(
			result.oas2Preprocessors,
			rulesConf.oas2Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.oas2Preprocessors,
			rulesConf.preprocessors,
		);
		(0, utils_1.assignConfig)(
			result.oas3_0Preprocessors,
			rulesConf.oas3_0Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.oas3_0Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignConfig)(
			result.oas3_1Preprocessors,
			rulesConf.oas3_1Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.oas3_1Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignConfig)(
			result.async2Preprocessors,
			rulesConf.async2Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.async2Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignConfig)(
			result.async3Preprocessors,
			rulesConf.async3Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.async3Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignConfig)(
			result.arazzo1Preprocessors,
			rulesConf.arazzo1Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.arazzo1Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignConfig)(
			result.overlay1Preprocessors,
			rulesConf.overlay1Preprocessors,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.overlay1Preprocessors,
			rulesConf.preprocessors,
		...
		(0, utils_1.assignOnlyExistingConfig)(
			...
			rulesConf.decorators,
		);
		(0, utils_1.assignConfig)(
			result.oas3_0Decorators,
			rulesConf.oas3_0Decorators,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.oas3_0Decorators,
			rulesConf.decorators,
		...
		(0, utils_1.assignConfig)(
			result.oas3_1Decorators,
			rulesConf.oas3_1Decorators,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.oas3_1Decorators,
			rulesConf.decorators,
		...
		(0, utils_1.assignConfig)(
			result.arazzo1Decorators,
			rulesConf.arazzo1Decorators,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.arazzo1Decorators,
			rulesConf.decorators,
		...
		(0, utils_1.assignConfig)(
			result.overlay1Decorators,
			rulesConf.overlay1Decorators,
		);
		(0, utils_1.assignOnlyExistingConfig)(
			result.overlay1Decorators,
			rulesConf.decorators,
...
function checkForDeprecatedFields(
	...
	if (rawConfig[deprecatedField] && updatedField === null) {
		(0, utils_1.showWarningForDeprecatedField)(
			deprecatedField,
			undefined,
			updatedObject,
			link,
	...
	if (rawConfig[deprecatedField] && updatedObject && rawConfig[updatedObject]) {
		(0, utils_1.showErrorForDeprecatedField)(
			deprecatedField,
			updatedField,
			updatedObject,
		);
...
function getUniquePlugins(plugins) {
	...
	for (const p of plugins) {
		if (!seen.has(p.id)) {
			...
			logger_1.logger.warn(
				`Duplicate plugin id "${logger_1.colorize.red(p.id)}".\n`,
			);
		}
	}
	return results;
