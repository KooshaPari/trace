...
const BorderThemeColors = {
	properties: (0, utils_1.pickObjectProps)(CommonThemeColors.properties, [
		"light",
		"dark",
	]),
};
...
const SecondaryColors = {
	properties: (0, utils_1.omitObjectProps)(CommonThemeColors.properties, [
		"dark",
	]),
};
...
const ButtonsConfig = {
	properties: {
		...(0, utils_1.omitObjectProps)(FontConfig.properties, [
			"fontSize",
			"lineHeight",
		]),
...
const BadgeFontConfig = {
	properties: (0, utils_1.pickObjectProps)(FontConfig.properties, [
		"fontSize",
		"lineHeight",
	]),
};
...
const Level1Items = {
	properties: (0, utils_1.pickObjectProps)(GroupItemsConfig.properties, [
		"textTransform",
	]),
};
const SpacingConfig = {
...
const Typography = {
	properties: {
		...
		...(0, utils_1.pickObjectProps)(FontConfig.properties, [
			"fontSize",
			"fontFamily",
		]),
...
const ConfigReferenceDocs = {
	properties: {
		...
		sideNavStyle: {
			enum: ["summary-only", "path-first", "id-only", "path-only"],
		},
...
function createConfigTypes(extraSchemas, config) {
	const nodeNames = Object.values(oas_types_1.SpecVersion).flatMap(
		(version) => {
			const types = config?.styleguide
				? config.styleguide.extendTypes(
	...
	const nodeTypes = (0, json_schema_adapter_1.getNodeTypesFromJSONSchema)(
...
exports.NormalizedConfigTypes = (0, types_1.normalizeTypes)(
	exports.ConfigTypes,
);
