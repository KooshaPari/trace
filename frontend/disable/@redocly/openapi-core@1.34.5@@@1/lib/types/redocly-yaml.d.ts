...
declare const builtInOAS2Rules: readonly [
	"info-contact",
...
declare const builtInOAS3Rules: readonly [
	"info-contact",
	"operation-operationId",
	"tag-description",
	"tags-alphabetical",
...
declare const builtInAsync2Rules: readonly [
	"info-contact",
	"info-license-strict",
	"operation-operationId",
	"tag-description",
...
declare const builtInAsync3Rules: readonly [
	"info-contact",
	"info-license-strict",
	"operation-operationId",
	"tag-description",
...
declare const oas2NodeTypesList: readonly [
	"Root",
	"Tag",
	"TagList",
	"ExternalDocs",
...
declare const oas3NodeTypesList: readonly [
	"Root",
	"Tag",
	"TagList",
	"ExternalDocs",
...
declare const oas3_1NodeTypesList: readonly [
	"Root",
	"Schema",
	"SchemaProperties",
	"PatternProperties",
...
export declare function createConfigTypes(
...
export declare const NormalizedConfigTypes: Record<
	string,
	import(".").NormalizedNodeType
>;
