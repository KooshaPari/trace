...
async function lintDocument(opts) {
	...
	const preprocessors = (0, config_2.initRules)(
		rules,
		config,
		"preprocessors",
		specVersion,
	);
	const regularRules = (0, config_2.initRules)(
		rules,
		config,
		"rules",
		specVersion,
	...
	const normalizedVisitors = (0, visitors_1.normalizeVisitors)(
		regularRules,
		types,
	);
	(0, walk_1.walkDocument)({
...
async function lintConfig(opts) {
	...
	const types = (0, types_1.normalizeTypes)(
		opts.externalConfigTypes ||
			(0, redocly_yaml_1.createConfigTypes)(
				config_1.rootRedoclyConfigSchema,
				config,
			),
	...
	const rules = [
		...
		},
		{
			...
			visitor: (0, no_unresolved_refs_1.NoUnresolvedRefs)({
				severity: "error",
			}),
		},
	];
