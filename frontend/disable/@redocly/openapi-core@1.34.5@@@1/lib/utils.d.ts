...
export declare function pushStack<T, P extends Stack<T> = Stack<T>>(
	head: P,
	value: T,
): {
	prev: P;
...
export declare function popStack<T, P extends Stack<T>>(
	head: P,
): StackFrame<T> | null;
...
export declare function isEmptyObject(
	value: unknown,
): value is Record<string, unknown>;
...
export declare function pickObjectProps<T extends Record<string, unknown>>(
	object: T,
	keys: Array<string>,
): T;
export declare function omitObjectProps<T extends Record<string, unknown>>(
	object: T,
	keys: Array<string>,
): T;
export declare function splitCamelCaseIntoWords(str: string): Set<string>;
export declare function validateMimeType(
	{ type, value }: any,
	{ report, location }: UserContext,
	allowedValues: string[],
): void;
export declare function validateMimeTypeOAS3(
	{ type, value }: any,
	{ report, location }: UserContext,
	allowedValues: string[],
): void;
...
export declare const assignConfig: <
	T extends
		| string
		| {
				severity?: string;
...
export declare function assignOnlyExistingConfig<
	T extends
		| string
		| {
				severity?: string;
...
export declare function getMatchingStatusCodeRange(
	code: number | string,
): string;
...
export declare function showWarningForDeprecatedField(
	deprecatedField: string,
	updatedField?: string,
	updatedObject?: string,
	link?: string,
): void;
export declare function showErrorForDeprecatedField(
	deprecatedField: string,
	updatedField?: string,
	updatedObject?: string,
): void;
export type Falsy = undefined | null | false | "" | 0;
export declare function isTruthy<Truthy>(
	value: Truthy | Falsy,
): value is Truthy;
export declare function identity<T>(value: T): T;
export declare function keysOf<T>(obj: T): (keyof T)[];
export declare function pickDefined<T extends Record<string, unknown>>(
	obj?: T,
