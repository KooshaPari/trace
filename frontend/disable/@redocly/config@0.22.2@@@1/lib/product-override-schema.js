...
exports.productConfigOverrideSchema = exports.productThemeOverrideSchema =
	void 0;
...
exports.productThemeOverrideSchema = {
	...
	properties: {
		...
		codeSnippet:
			default_theme_config_schema_1.themeConfigSchema.properties.codeSnippet,
		breadcrumbs:
			default_theme_config_schema_1.themeConfigSchema.properties.breadcrumbs,
		openapi: default_theme_config_schema_1.themeConfigSchema.properties.openapi,
		feedback:
			default_theme_config_schema_1.themeConfigSchema.properties.feedback,
		analytics: {
			type: "object",
			properties: {
...
exports.productConfigOverrideSchema = {
	...
	properties: Object.assign(
		Object.assign({}, exports.productThemeOverrideSchema.properties),
		{
			apis: {
				type: "object",
