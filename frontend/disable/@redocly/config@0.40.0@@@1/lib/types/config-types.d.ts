...
export type ProductGoogleAnalyticsConfig = FromSchema<
	typeof productGoogleAnalyticsConfigSchema
>;
export type MarkdownConfig = FromSchema<typeof markdownConfigSchema>;
export type AmplitudeAnalyticsConfig = FromSchema<
	typeof amplitudeAnalyticsConfigSchema
>;
export type RudderstackAnalyticsConfig = FromSchema<
	typeof rudderstackAnalyticsConfigSchema
>;
export type SegmentAnalyticsConfig = FromSchema<
	typeof segmentAnalyticsConfigSchema
>;
export type GtmAnalyticsConfig = FromSchema<typeof gtmAnalyticsConfigSchema>;
export type GoogleAnalyticsConfig = FromSchema<
	typeof googleAnalyticsConfigSchema
>;
...
export type RedoclyConfig = Omit<
	FromSchema<typeof rootRedoclyConfigSchema>,
	"theme" | "apis"
> & {
	/**
...
export type DevOnboardingAdapterConfig = FromSchema<
	typeof devOnboardingAdapterConfigSchema
>;
export type GraviteeAdapterConfig = FromSchema<
	typeof graviteeAdapterConfigSchema
>;
export type ApigeeAdapterConfig = FromSchema<
	typeof apigeeXAdapterConfigSchema | typeof apigeeEdgeAdapterConfigSchema
>;
export type ApigeeAdapterAuthOauth2 = FromSchema<
	typeof apigeeAdapterAuthOauth2Schema
>;
...
export type ProductConfigOverride = FromSchema<
	typeof productConfigOverrideSchema
>;
