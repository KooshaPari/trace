...
exports.navItemsSchema = {
	type: "array",
	items: Object.assign(Object.assign({}, navItemSchema), {
		properties: Object.assign(Object.assign({}, navItemSchema.properties), {
...
exports.searchFiltersConfigSchema = {
	...
	properties: Object.assign(
		{ facets: exports.searchFacetsConfigSchema },
	...
	properties: Object.assign(
		{
			...
			filters: exports.searchFiltersConfigSchema,
			placement: {
				type: "string",
				default: "navbar",
			},
...
const navigationActionsConfigSchema = {
	type: "object",
	properties: Object.assign(Object.assign({}, hideConfigSchema.properties), {
		items: {
			type: "array",
			items: {
				type: "string",
...
exports.openapiConfigSchema = Object.assign(
	Object.assign({}, redoc_config_schema_1.redocConfigSchema),
	{
		properties: Object.assign(
			Object.assign({}, redoc_config_schema_1.redocConfigSchema.properties),
			reference_docs_config_schema_1.deprecatedRefDocsSchema.properties,
		),
	},
);
