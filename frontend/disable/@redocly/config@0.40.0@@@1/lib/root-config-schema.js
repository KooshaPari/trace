...
exports.rootRedoclyConfigSchema =
	...
	exports.apigeeEdgeAdapterConfigSchema =
...
exports.saml2ProviderConfigSchema = {
	...
	properties: {
		...
		teamsAttributeName: {
			type: "string",
			default: constants_1.DEFAULT_TEAM_CLAIM_NAME,
		},
		teamsAttributeMap: {
			type: "object",
			additionalProperties: { type: "string" },
		...
		Object.assign(
			Object.assign(
				Object.assign(
					...
					common_1.ruleSchemas,
				),
				common_1.preprocessorSchemas,
			),
			common_1.decoratorsSchemas,
		),
...
exports.apigeeAdapterAuthOauth2Schema = {
	...
	properties: {
		type: {
			type: "string",
			const: constants_1.ApigeeDevOnboardingIntegrationAuthType.OAUTH2,
		},
...
exports.apigeeAdapterAuthServiceAccountSchema = {
	...
	properties: {
		type: {
			type: "string",
			const: constants_1.ApigeeDevOnboardingIntegrationAuthType.SERVICE_ACCOUNT,
		},
...
exports.apigeeEdgeAdapterConfigSchema = Object.assign(
	Object.assign({}, exports.apigeeXAdapterConfigSchema),
	{
		properties: Object.assign(
			Object.assign({}, exports.apigeeXAdapterConfigSchema.properties),
...
exports.redoclyConfigSchema = {
	...
	properties: Object.assign(
		...
		),
		{
			...
			residency: { type: "string", pattern: "^https?://.*" },
			...
			entitiesCatalog:
				entities_catalog_config_schema_1.entitiesCatalogConfigSchema,
...
const environmentSchema = Object.assign(
	Object.assign(
		{},
		(0, remove_property_recursively_1.removePropertyRecursively)(
			exports.redoclyConfigSchema,
			"default",
		),
	),
...
exports.rootRedoclyConfigSchema = Object.assign(
	Object.assign({ $id: "root-redocly-config" }, exports.redoclyConfigSchema),
	{
		properties: Object.assign(
			Object.assign(
				{
				...
				exports.redoclyConfigSchema.properties,
			),
			{
				env: {
					type: "object",
