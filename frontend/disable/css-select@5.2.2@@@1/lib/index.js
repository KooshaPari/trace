...
exports.selectAll = getSelectorFunc((query, elems, options) =>
	query === boolbase_1.default.falseFunc || !elems || elems.length === 0
		? []
...
function is(elem, query, options) {
	var opts = convertOptionFormats(options);
	return (
		typeof query === "function" ? query : (0, compile_js_1.compile)(query, opts)
	)(elem);
}
exports.is = is;
/**
...
Object.defineProperty(exports, "filters", {
	enumerable: true,
	get: () => index_js_1.filters,
});
Object.defineProperty(exports, "pseudos", {
	enumerable: true,
	get: () => index_js_1.pseudos,
});
Object.defineProperty(exports, "aliases", {
	enumerable: true,
	get: () => index_js_1.aliases,
});
