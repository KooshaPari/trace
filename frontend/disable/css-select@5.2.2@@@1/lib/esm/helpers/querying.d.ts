 ...
 */
export declare function findAll<Node, ElementNode extends Node>(
 ...
 */
export declare function findOne<Node, ElementNode extends Node>(
	query: Predicate<ElementNode>,
	elems: Node[],
	options: InternalOptions<Node, ElementNode>,
): ElementNode | null;
export declare function getNextSiblings<Node, ElementNode extends Node>(
	elem: Node,
	adapter: Adapter<Node, ElementNode>,
): ElementNode[];
export declare function getElementParent<Node, ElementNode extends Node>(
	node: ElementNode,
	adapter: Adapter<Node, ElementNode>,
): ElementNode | null;
