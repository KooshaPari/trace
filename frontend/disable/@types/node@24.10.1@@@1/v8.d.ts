...
declare module "v8" {
	 ...
	 */
	type Init = (promise: Promise<unknown>, parent: Promise<unknown>) => void;
	/**
	 ...
	 * @since v17.1.0, v16.14.0
	 */
	type Before = (promise: Promise<unknown>) => void;
	/**
	 * Called immediately after a promise continuation executes. This may be after a `then()`, `catch()`, or `finally()` handler or before an await after another await.
	 * @since v17.1.0, v16.14.0
	 */
	type After = (promise: Promise<unknown>) => void;
	/**
	 ...
	 * @since v17.1.0, v16.14.0
	 */
	type Settled = (promise: Promise<unknown>) => void;
	/**
