...
> extends EventEmitter {
	...
	/** Returns the value. */
	get<TRaw extends boolean = false>(
		key: string,
		options?: { raw?: TRaw },
	): Promise<
		(TRaw extends false ? TValue : Keyv.DeserializedData<TValue>) | undefined
	>;
	/**
	 * Set a value.
	 *
...
declare namespace Keyv {
	interface Options<TValue> {
		...
		deserialize?:
			| ((data: string) => DeserializedData<TValue> | undefined)
			| undefined;
