...
declare global {
	namespace Chai {
		...
		export type InstanceOf = (constructor: any, message?: string) => Assertion;
		...
		export type Equal = (value: any, message?: string) => Assertion;

		export type ContainSubset = (expected: any) => Assertion;
		...
		export type Match = (regexp: RegExp, message?: string) => Assertion;
		...
		export type RespondTo = (method: string, message?: string) => Assertion;

		export type Satisfy = (matcher: Function, message?: string) => Assertion;

		export type Members = (set: readonly any[], message?: string) => Assertion;
