...
type ExtractFromGlobalConstructors<Name extends string> = Name extends string
...
declare const objectTypeNames: readonly [
	"Function",
	"Generator",
	"AsyncGenerator",
	"GeneratorFunction",
...
declare const primitiveTypeNames: readonly [
	"null",
	"undefined",
	"string",
	"number",
...
declare const assertionTypeDescriptions: readonly [
	"positive number",
	"negative number",
	"Class",
...
export type AssertionTypeDescription =
	(typeof assertionTypeDescriptions)[number];
...
export declare function isOptional<T>(
	value: unknown,
	predicate: (value: unknown) => value is T,
): value is T | undefined;
export declare function isArray<T = unknown>(
	value: unknown,
	assertion?: (value: T) => value is T,
): value is T[];
export declare function isArrayBuffer(value: unknown): value is ArrayBuffer;
export declare function isArrayLike<T = unknown>(
	value: unknown,
): value is ArrayLike<T>;
export declare function isAsyncFunction<T = unknown>(
	value: unknown,
): value is (...arguments_: any[]) => Promise<T>;
export declare function isAsyncGenerator(
	value: unknown,
): value is AsyncGenerator;
export declare function isAsyncGeneratorFunction(
	value: unknown,
): value is (...arguments_: any[]) => Promise<unknown>;
export declare function isAsyncIterable<T = unknown>(
	value: unknown,
...
export declare function isDirectInstanceOf<T>(
	instance: unknown,
	class_: Class<T>,
): instance is T;
...
export declare function isEmptyObject<Key extends keyof any = string>(
	value: unknown,
...
export declare function isEmptyStringOrWhitespace(
	value: unknown,
): value is "" | Whitespace;
export declare function isEnumCase<T = unknown>(
	value: unknown,
	targetEnum: T,
): value is T[keyof T];
...
export declare function isIterable<T = unknown>(
	value: unknown,
): value is Iterable<T>;
export declare function isMap<Key = unknown, Value = unknown>(
	value: unknown,
): value is Map<Key, Value>;
export declare function isNan(value: unknown): boolean;
export declare function isNativePromise<T = unknown>(
	value: unknown,
): value is Promise<T>;
...
export declare function isNonEmptyArray<T = unknown, Item = unknown>(
	value: T | Item[],
): value is [Item, ...Item[]];
export declare function isNonEmptyMap<Key = unknown, Value = unknown>(
	value: unknown,
): value is Map<Key, Value>;
export declare function isNonEmptyObject<
	Key extends keyof any = string,
	Value = unknown,
>(value: unknown): value is Record<Key, Value>;
export declare function isNonEmptySet<T = unknown>(
	value: unknown,
): value is Set<T>;
export declare function isNonEmptyString(
	value: unknown,
): value is NonEmptyString;
export declare function isNonEmptyStringAndNotWhitespace(
	value: unknown,
): value is NonEmptyString;
...
export declare function isPlainObject<Value = unknown>(
	value: unknown,
...
export declare function isSharedArrayBuffer(
	value: unknown,
...
> = TypeGuardsOfT extends [TypeGuard<infer U>, ...infer TOthers]
	...
	: TypeGuardsOfT extends undefined[]
		? ResultOfT
		: never;
export declare function isTupleLike<T extends Array<TypeGuard<unknown>>>(
	value: unknown,
	guards: [...T],
...
export declare function isUrlSearchParams(
	value: unknown,
...
export declare function isWeakMap<Key extends object = object, Value = unknown>(
	value: unknown,
...
type Assert = {
	...
	tupleLike: <T extends Array<TypeGuard<unknown>>>(
		value: unknown,
		guards: [...T],
		message?: string,
	...
	nonEmptyArray: <T = unknown, Item = unknown>(
		value: T | Item[],
		message?: string,
...
export declare function assertAll(
	predicate: Predicate,
	...values: unknown[]
): void | never;
export declare function assertAny(
	predicate: Predicate | Predicate[],
	...values: unknown[]
): void | never;
export declare function assertOptional<T>(
	value: unknown,
	assertion: (value: unknown, message?: string) => asserts value is T,
	message?: string,
): asserts value is T | undefined;
...
export declare function assertArrayBuffer(
	value: unknown,
	message?: string,
): asserts value is ArrayBuffer;
export declare function assertArrayLike<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is ArrayLike<T>;
export declare function assertAsyncFunction(
	value: unknown,
	message?: string,
): asserts value is Function;
export declare function assertAsyncGenerator(
	value: unknown,
	message?: string,
): asserts value is AsyncGenerator;
export declare function assertAsyncGeneratorFunction(
	value: unknown,
	message?: string,
): asserts value is AsyncGeneratorFunction;
export declare function assertAsyncIterable<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is AsyncIterable<T>;
export declare function assertBigint(
	value: unknown,
	message?: string,
): asserts value is bigint;
export declare function assertBigInt64Array(
	value: unknown,
	message?: string,
): asserts value is BigInt64Array;
export declare function assertBigUint64Array(
	value: unknown,
	message?: string,
): asserts value is BigUint64Array;
export declare function assertBlob(
	value: unknown,
	message?: string,
...
export declare function assertBoundFunction(
	value: unknown,
	message?: string,
): asserts value is Function;
/**
Note: [Prefer using `Uint8Array` instead of `Buffer`.](https://sindresorhus.com/blog/goodbye-nodejs-buffer)
*/
export declare function assertBuffer(
	value: unknown,
	message?: string,
): asserts value is NodeBuffer;
export declare function assertClass<T>(
	value: unknown,
	message?: string,
): asserts value is Class<T>;
export declare function assertDataView(
	value: unknown,
	message?: string,
): asserts value is DataView;
export declare function assertDate(
	value: unknown,
	message?: string,
): asserts value is Date;
export declare function assertDirectInstanceOf<T>(
	instance: unknown,
	class_: Class<T>,
	message?: string,
): asserts instance is T;
export declare function assertEmptyArray(
	value: unknown,
	message?: string,
): asserts value is never[];
export declare function assertEmptyMap(
	value: unknown,
	message?: string,
): asserts value is Map<never, never>;
export declare function assertEmptyObject<Key extends keyof any = string>(
	value: unknown,
	message?: string,
): asserts value is Record<Key, never>;
export declare function assertEmptySet(
	value: unknown,
	message?: string,
): asserts value is Set<never>;
export declare function assertEmptyString(
	value: unknown,
	message?: string,
): asserts value is "";
export declare function assertEmptyStringOrWhitespace(
	value: unknown,
	message?: string,
): asserts value is "" | Whitespace;
export declare function assertEnumCase<T = unknown>(
	value: unknown,
	targetEnum: T,
	message?: string,
): asserts value is T[keyof T];
export declare function assertError(
	value: unknown,
	message?: string,
): asserts value is Error;
export declare function assertEvenInteger(
	value: number,
	message?: string,
): asserts value is number;
export declare function assertFalsy(
	value: unknown,
	message?: string,
): asserts value is Falsy;
export declare function assertFloat32Array(
	value: unknown,
	message?: string,
): asserts value is Float32Array;
export declare function assertFloat64Array(
	value: unknown,
	message?: string,
): asserts value is Float64Array;
export declare function assertFormData(
	value: unknown,
	message?: string,
...
export declare function assertGenerator(
	value: unknown,
	message?: string,
): asserts value is Generator;
export declare function assertGeneratorFunction(
	value: unknown,
	message?: string,
): asserts value is GeneratorFunction;
export declare function assertHtmlElement(
	value: unknown,
	message?: string,
): asserts value is HTMLElement;
export declare function assertInfinite(
	value: unknown,
	message?: string,
): asserts value is number;
...
export declare function assertInt16Array(
	value: unknown,
	message?: string,
): asserts value is Int16Array;
export declare function assertInt32Array(
	value: unknown,
	message?: string,
): asserts value is Int32Array;
export declare function assertInt8Array(
	value: unknown,
	message?: string,
): asserts value is Int8Array;
export declare function assertInteger(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertIterable<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is Iterable<T>;
export declare function assertMap<Key = unknown, Value = unknown>(
	value: unknown,
	message?: string,
): asserts value is Map<Key, Value>;
export declare function assertNan(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertNativePromise<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is Promise<T>;
export declare function assertNegativeNumber(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertNodeStream(
	value: unknown,
	message?: string,
): asserts value is NodeStream;
export declare function assertNonEmptyArray<T = unknown, Item = unknown>(
	value: T | Item[],
	message?: string,
): asserts value is [Item, ...Item[]];
export declare function assertNonEmptyMap<Key = unknown, Value = unknown>(
	value: unknown,
	message?: string,
): asserts value is Map<Key, Value>;
export declare function assertNonEmptyObject<
	Key extends keyof any = string,
	Value = unknown,
>(value: unknown, message?: string): asserts value is Record<Key, Value>;
export declare function assertNonEmptySet<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is Set<T>;
...
export declare function assertNonEmptyStringAndNotWhitespace(
	value: unknown,
	message?: string,
): asserts value is string;
export declare function assertNull(
	value: unknown,
	message?: string,
): asserts value is null;
export declare function assertNullOrUndefined(
	value: unknown,
	message?: string,
): asserts value is null | undefined;
...
export declare function assertNumericString(
	value: unknown,
	message?: string,
): asserts value is `${number}`;
export declare function assertObject(
	value: unknown,
	message?: string,
): asserts value is object;
export declare function assertObservable(
	value: unknown,
	message?: string,
): asserts value is ObservableLike;
export declare function assertOddInteger(
	value: number,
	message?: string,
): asserts value is number;
export declare function assertPlainObject<Value = unknown>(
	value: unknown,
	message?: string,
): asserts value is Record<PropertyKey, Value>;
export declare function assertPositiveNumber(
	value: unknown,
	message?: string,
): asserts value is number;
...
export declare function assertPromise<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is Promise<T>;
export declare function assertPropertyKey(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertRegExp(
	value: unknown,
	message?: string,
): asserts value is RegExp;
export declare function assertSafeInteger(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertSet<T = unknown>(
	value: unknown,
	message?: string,
): asserts value is Set<T>;
export declare function assertSharedArrayBuffer(
	value: unknown,
	message?: string,
): asserts value is SharedArrayBuffer;
...
export declare function assertSymbol(
	value: unknown,
	message?: string,
): asserts value is symbol;
export declare function assertTruthy<T>(
	value: T | Falsy,
	message?: string,
): asserts value is T;
export declare function assertTupleLike<T extends Array<TypeGuard<unknown>>>(
	value: unknown,
	guards: [...T],
	message?: string,
): asserts value is ResolveTypesOfTypeGuardsTuple<T>;
export declare function assertTypedArray(
	value: unknown,
	message?: string,
): asserts value is TypedArray;
export declare function assertUint16Array(
	value: unknown,
	message?: string,
): asserts value is Uint16Array;
export declare function assertUint32Array(
	value: unknown,
	message?: string,
): asserts value is Uint32Array;
export declare function assertUint8Array(
	value: unknown,
	message?: string,
): asserts value is Uint8Array;
export declare function assertUint8ClampedArray(
	value: unknown,
	message?: string,
): asserts value is Uint8ClampedArray;
export declare function assertUndefined(
	value: unknown,
	message?: string,
): asserts value is undefined;
export declare function assertUrlInstance(
	value: unknown,
	message?: string,
): asserts value is URL;
export declare function assertUrlSearchParams(
	value: unknown,
	message?: string,
): asserts value is URLSearchParams;
export declare function assertUrlString(
	value: unknown,
	message?: string,
): asserts value is UrlString;
export declare function assertValidDate(
	value: unknown,
	message?: string,
): asserts value is Date;
export declare function assertValidLength(
	value: unknown,
	message?: string,
): asserts value is number;
export declare function assertWeakMap<
	Key extends object = object,
	Value = unknown,
>(value: unknown, message?: string): asserts value is WeakMap<Key, Value>;
export declare function assertWeakRef<T extends object = object>(
	value: unknown,
	message?: string,
): asserts value is WeakRef<T>;
export declare function assertWeakSet<T extends object = object>(
	value: unknown,
	message?: string,
): asserts value is WeakSet<T>;
export declare function assertWhitespaceString(
	value: unknown,
	message?: string,
): asserts value is string;
export default is;
