...
Object.defineProperty(exports, "replaceCodePoint", {
	enumerable: true,
	get: () => decode_codepoint_js_2.replaceCodePoint,
});
Object.defineProperty(exports, "fromCodePoint", {
	enumerable: true,
	get: () => decode_codepoint_js_2.fromCodePoint,
});
var CharCodes;
((CharCodes) => {
...
function getDecoder(decodeTree) {
	var ret = "";
	var decoder = new EntityDecoder(
		decodeTree,
		(str) => (ret += (0, decode_codepoint_js_1.fromCodePoint)(str)),
	);
