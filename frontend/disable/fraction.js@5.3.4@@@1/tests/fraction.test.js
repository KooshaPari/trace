...
var DivisionByZero = () => new Error("Division by Zero");
var InvalidParameter = () => new Error("Invalid argument");
var NonIntegerParameter = () => new Error("Parameters must be integer");
...
describe("Fraction", () => {
	for (var i = 0; i < tests.length; i++) {
		((i) => {
			...
			if (tests[i].fn) {
				action = () => {
					var x = Fraction(tests[i].set, tests[i].set2)[tests[i].fn](
						tests[i].param,
					);
			...
			it(String(tests[i].label || tests[i].set), () => {
...
describe("JSON", () => {
	it("Should be possible to stringify the object", () => {
...
describe("Arguments", () => {
	it("Should be possible to use different kind of params", () => {
		// String
...
describe("Latex Output", () => {
	it("Should pass 123.'3' = \\frac{370}{3}", () => {
		var tmp = new Fraction("123.'3'");
		assert.equal("\\frac{370}{3}", tmp.toLatex());
	});

	it("Should pass 1.'3' = \\frac{4}{3}", () => {
...
describe("Fraction Output", () => {
	it("Should pass 123.'3' = 123 1/3", () => {
		var tmp = new Fraction("123.'3'");
		assert.equal("370/3", tmp.toFraction());
	});

	it("Should pass 1.'3' = 1 1/3", () => {
		var tmp = new Fraction("1.'3'");
