...
var _PathItem = _interopRequireDefault(
	require("../../../../elements/PathItem.cjs"),
);
 ...
 * @public
 */
class PathItemVisitor extends (0, _tsMixer.Mixin)(
	...
	ObjectElement(objectElement) {
		...
		this.element
			.filter(_predicates.isOperationElement)
			// @ts-ignore
			.forEach((operationElement, httpMethodElementCI) => {
				const httpMethodElementCS = (0, _apidomCore.cloneDeep)(
					httpMethodElementCI,
				);
				httpMethodElementCS.content = (0, _apidomCore.toValue)(
					httpMethodElementCS,
				).toUpperCase();
