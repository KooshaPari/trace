...
const JSONSchemaOrJSONReferenceVisitor =
	(exports.JSONSchemaOrJSONReferenceVisitor =
		_apidomNsJsonSchemaDraft.specificationObj.visitors.JSONSchemaOrJSONReferenceVisitor);
...
class SchemaOrJSONReferenceVisitor extends JSONSchemaOrJSONReferenceVisitor {
	ObjectElement(objectElement) {
		const result = JSONSchemaOrJSONReferenceVisitor.prototype.enter.call(
			this,
			objectElement,
		);
