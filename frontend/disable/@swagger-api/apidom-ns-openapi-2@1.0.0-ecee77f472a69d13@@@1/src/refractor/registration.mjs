...
InfoElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Info",
...
PathsElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Paths",
...
ItemsElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Items",
...
HeaderElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Header",
...
TagElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Tag",
...
SchemaElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Schema",
...
XmlElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"XML",
...
ScopesElement.refract = createRefractor([
	"visitors",
	"document",
	"objects",
	"Scopes",
