...
class Schema extends JSONSchemaElement {
	...
	get idProp() {
		throw new UnsupportedOperationError(
			"idProp getter in Schema class is not not supported.",
		);
	}
	set idProp(idProps) {
		throw new UnsupportedOperationError(
			"idProp setter in Schema class is not not supported.",
		);
	}
	get $schema() {
		throw new UnsupportedOperationError(
	...
	get anyOf() {
		throw new UnsupportedOperationError(
			"anyOf getter in Schema class is not not supported.",
		);
	}
	set anyOf(anyOf) {
		throw new UnsupportedOperationError(
			"anyOf setter in Schema class is not not supported.",
		);
	}
	get oneOf() {
		throw new UnsupportedOperationError(
			"oneOf getter in Schema class is not not supported.",
		);
	}
	set oneOf(oneOf) {
		throw new UnsupportedOperationError(
			"oneOf setter in Schema class is not not supported.",
		);
	}
	get not() {
		throw new UnsupportedOperationError(
			"not getter in Schema class is not not supported.",
		);
	}
	set not(not) {
		throw new UnsupportedOperationError(
			"not setter in Schema class is not not supported.",
		);
	}
	get definitions() {
		throw new UnsupportedOperationError(
	...
	get base() {
		throw new UnsupportedOperationError(
			"base getter in Schema class is not not supported.",
		);
	}
	set base(base) {
		throw new UnsupportedOperationError(
			"base setter in Schema class is not not supported.",
		);
	}
	get links() {
		throw new UnsupportedOperationError(
			"links getter in Schema class is not not supported.",
		);
	}
	set links(links) {
		throw new UnsupportedOperationError(
			"links setter in Schema class is not not supported.",
		);
	}
	get media() {
		throw new UnsupportedOperationError(
			"media getter in Schema class is not not supported.",
		);
	}
	set media(media) {
		throw new UnsupportedOperationError(
			"media setter in Schema class is not not supported.",
		);
	}
}
