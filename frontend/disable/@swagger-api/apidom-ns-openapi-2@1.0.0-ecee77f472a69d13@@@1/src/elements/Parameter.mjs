...
class Parameter extends JSONSchemaElement {
	...
	get idProp() {
		throw new UnsupportedOperationError(
			"idProp getter in Parameter class is not not supported.",
		);
	}
	set idProp(idProps) {
		throw new UnsupportedOperationError(
			"idProp setter in Parameter class is not not supported.",
		);
	}
	get $schema() {
		throw new UnsupportedOperationError(
			"$schema getter in Parameter class is not not supported.",
		);
	}
	set $schema($schema) {
		throw new UnsupportedOperationError(
			"$schema setter in Parameter class is not not supported.",
		);
	}
	...
	get allOf() {
		throw new UnsupportedOperationError(
			"allOf getter in Parameter class is not not supported.",
		);
	}
	set allOf(allOf) {
		throw new UnsupportedOperationError(
			"allOf setter in Parameter class is not not supported.",
		);
	}
	get anyOf() {
		throw new UnsupportedOperationError(
			"anyOf getter in Parameter class is not not supported.",
		);
	}
	set anyOf(anyOf) {
		throw new UnsupportedOperationError(
			"anyOf setter in Parameter class is not not supported.",
		);
	}
	get oneOf() {
		throw new UnsupportedOperationError(
			"oneOf getter in Parameter class is not not supported.",
		);
	}
	set oneOf(oneOf) {
		throw new UnsupportedOperationError(
			"oneOf setter in Parameter class is not not supported.",
		);
	}
	get not() {
		throw new UnsupportedOperationError(
			"not getter in Parameter class is not not supported.",
		);
	}
	set not(not) {
		throw new UnsupportedOperationError(
			"not setter in Parameter class is not not supported.",
		);
	}
	get definitions() {
		throw new UnsupportedOperationError(
	...
	get title() {
		throw new UnsupportedOperationError(
			"title getter in Parameter class is not not supported.",
		);
	}
	set title(title) {
		throw new UnsupportedOperationError(
			"title setter in Parameter class is not not supported.",
		);
	}
	get description() {
	...
	get base() {
		throw new UnsupportedOperationError(
			"base getter in Parameter class is not not supported.",
		);
	}
	set base(base) {
		throw new UnsupportedOperationError(
			"base setter in Parameter class is not not supported.",
		);
	}
	get links() {
		throw new UnsupportedOperationError(
			"links getter in Parameter class is not not supported.",
		);
	}
	set links(links) {
		throw new UnsupportedOperationError(
			"links setter in Parameter class is not not supported.",
		);
	}
	get media() {
		throw new UnsupportedOperationError(
			"media getter in Parameter class is not not supported.",
		);
	}
	set media(media) {
		throw new UnsupportedOperationError(
			"media setter in Parameter class is not not supported.",
		);
	}
	get readOnly() {
		throw new UnsupportedOperationError(
			"readOnly getter in Parameter class is not not supported.",
		);
	}
	set readOnly(readOnly) {
		throw new UnsupportedOperationError(
			"readOnly setter in Parameter class is not not supported.",
		);
	}
