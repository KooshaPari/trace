...
var _ArazzoSpecification = _interopRequireDefault(
	require("./elements/ArazzoSpecification1.cjs"),
);
...
var _SourceDescription = _interopRequireDefault(
	require("./elements/SourceDescription.cjs"),
);
...
var _SuccessAction = _interopRequireDefault(
	require("./elements/SuccessAction.cjs"),
);
var _FailureAction = _interopRequireDefault(
	require("./elements/FailureAction.cjs"),
);
 ...
 * @public
 */
const isArazzoSpecElement = (exports.isArazzoSpecElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _ArazzoSpec.default ||
 ...
 * @public
 */
const isArazzoSpecification1Element = (exports.isArazzoSpecification1Element =
	(0, _apidomCore.createPredicate)(
		({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
			return (element) =>
				element instanceof _ArazzoSpecification.default ||
				(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isSourceDescriptionElement = (exports.isSourceDescriptionElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _SourceDescription.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isSourceDescriptionsElement = (exports.isSourceDescriptionsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _SourceDescriptions.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isWorkflowsElement = (exports.isWorkflowsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _Workflows.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isWorkflowStepsElement = (exports.isWorkflowStepsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _WorkflowSteps.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isWorkflowOutputsElement = (exports.isWorkflowOutputsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _WorkflowOutputs.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isWorkflowElement = (exports.isWorkflowElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Workflow.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isStepOnSuccessElement = (exports.isStepOnSuccessElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepOnSuccess.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isStepOnFailureElement = (exports.isStepOnFailureElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepOnFailure.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isStepOutputsElement = (exports.isStepOutputsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepOutputs.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
...
const isStepElement = (exports.isStepElement = (0, _apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Step.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isStepParametersElement = (exports.isStepParametersElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepParameters.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isStepDependsOnElement = (exports.isStepDependsOnElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepDependsOn.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isStepSuccessCriteriaElement = (exports.isStepSuccessCriteriaElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			element instanceof _StepSuccessCriteria.default ||
			(hasBasicElementProps(element) &&
				isElementType("array", element) &&
				primitiveEq("array", element) &&
 ...
 * @public
 */
const isSuccessActionElement = (exports.isSuccessActionElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _SuccessAction.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isComponentsElement = (exports.isComponentsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Components.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isCriterionElement = (exports.isCriterionElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Criterion.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isSuccessActionCriteriaElement = (exports.isSuccessActionCriteriaElement =
	(0, _apidomCore.createPredicate)(
		({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
			return (element) =>
				element instanceof _SuccessActionCriteria.default ||
				(hasBasicElementProps(element) &&
					isElementType("array", element) &&
					primitiveEq("array", element) &&
 ...
 * @public
 */
const isFailureActionElement = (exports.isFailureActionElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _FailureAction.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isFailureActionCriteriaElement = (exports.isFailureActionCriteriaElement =
	(0, _apidomCore.createPredicate)(
		({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
			return (element) =>
				element instanceof _FailureActionCriteria.default ||
				(hasBasicElementProps(element) &&
					isElementType("array", element) &&
					primitiveEq("array", element) &&
