import { cloneDeep, visit } from "@swagger-api/apidom-core";
import { path, pathSatisfies, pick } from "ramda";
...
class SpecificationVisitor extends Visitor {
	...
	toRefractedElement(specPath, element, options = {}) {
		...
		if (
			visitor instanceof FallbackVisitor &&
			(visitor === null || visitor === void 0
				? void 0
				: visitor.constructor) === FallbackVisitor
		) {
