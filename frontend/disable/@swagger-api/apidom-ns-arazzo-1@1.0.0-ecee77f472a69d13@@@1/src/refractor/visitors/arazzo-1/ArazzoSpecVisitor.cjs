...
var _ArazzoSpec = _interopRequireDefault(
	require("../../../elements/ArazzoSpec.cjs"),
);
/**
 * @public
 */
 ...
 * @public
 */
class ArazzoSpecVisitor extends (0, _tsMixer.Mixin)(
	_SpecificationVisitor.default,
	_FallbackVisitor.default,
) {
	StringElement(stringElement) {
		const arazzoSpecElement = new _ArazzoSpec.default(
