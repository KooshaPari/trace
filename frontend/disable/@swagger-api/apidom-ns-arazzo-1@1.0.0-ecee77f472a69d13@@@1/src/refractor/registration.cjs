...
exports.JSONSchemaElement = _apidomNsJsonSchema.JSONSchemaElement;
...
exports.ArazzoSpecElement = _ArazzoSpec.default;
...
_ArazzoSpec.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"ArazzoSpecification",
...
_ArazzoSpecification.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"ArazzoSpecification",
...
_SourceDescription.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"SourceDescription",
...
_Workflow.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Workflow",
...
_Step.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Step",
...
_SuccessAction.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"SuccessAction",
...
_FailureAction.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"FailureAction",
...
_Criterion.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Criterion",
...
_apidomNsJsonSchema.JSONSchemaElement.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"JSONSchema",
