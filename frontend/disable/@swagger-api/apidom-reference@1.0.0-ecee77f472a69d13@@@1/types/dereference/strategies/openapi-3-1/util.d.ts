 ...
 * @public
 */
export declare const resolveSchema$refField: (
	retrievalURI: string,
 ...
 * @public
 */
export declare const resolveSchema$idField: (
	retrievalURI: string,
	schemaElement: SchemaElement,
) => string | undefined;
/**
 ...
 * @public
 */
export declare const maybeRefractToSchemaElement: <T extends Element>(
	element: T,
) => any;
