...
class OpenAPI3_0DereferenceVisitor {
	...
	toAncestorLineage(ancestors) {
		...
		const ancestorsLineage = new _util.AncestorLineage(
			...this.ancestors,
			directAncestors,
		);
				...
				const replacer =
					(_this$options$derefer =
						(_this$options$derefer2 =
							this.options.dereference.strategyOpts["openapi-3-0"]) == null
							? void 0
							: _this$options$derefer2.circularReplacer) != null
						? _this$options$derefer
				...
				const replacer =
					(_this$options$derefer3 =
						(_this$options$derefer4 =
							this.options.dereference.strategyOpts["openapi-3-0"]) == null
							? void 0
							: _this$options$derefer4.circularReplacer) != null
						? _this$options$derefer3
						: this.options.dereference.circularReplacer;
				const replacement = replacer(refElement);
				link.replaceWith(replacement, mutationReplacer);
