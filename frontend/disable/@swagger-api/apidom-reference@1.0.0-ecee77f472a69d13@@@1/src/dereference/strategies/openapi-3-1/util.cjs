...
exports.resolveSchema$refField =
	...
	exports.refractToSchemaElement =
...
const resolveSchema$refField = (retrievalURI, schemaElement) => {
	...
	const ancestorsSchemaIdentifiers = (0, _apidomCore.toValue)(
		schemaElement.meta.get("ancestorsSchemaIdentifiers"),
	);
	const $refBaseURI = (0, _ramda.reduce)(
		(acc, uri) => {
		...
		[
			...
			(0, _apidomCore.toValue)(schemaElement.$ref),
		],
	);
