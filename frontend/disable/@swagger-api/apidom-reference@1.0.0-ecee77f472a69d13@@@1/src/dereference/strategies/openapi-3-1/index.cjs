...
exports.resolveSchema$refField =
	exports.resolveSchema$idField =
	exports.maybeRefractToSchemaElement =
	exports.default =
		void 0;
var _ramda = require("ramda");
var _apidomCore = require("@swagger-api/apidom-core");
var _apidomNsOpenapi = _interopRequireWildcard(
	require("@swagger-api/apidom-ns-openapi-3-1"),
);
var _DereferenceStrategy = _interopRequireDefault(
	require("../DereferenceStrategy.cjs"),
);
var _Reference = _interopRequireDefault(require("../../../Reference.cjs"));
var _ReferenceSet = _interopRequireDefault(
	require("../../../ReferenceSet.cjs"),
);
...
class OpenAPI3_1DereferenceStrategy extends _DereferenceStrategy.default {
	...
	canDereference(file) {
		...
		return (0, _apidomNsOpenapi.isOpenApi3_1Element)(
			(_file$parseResult = file.parseResult) == null
				? void 0
				: _file$parseResult.result,
		);
	}
	async dereference(file, options) {
		var _options$dereference$;
		const namespace = (0, _apidomCore.createNamespace)(
			_apidomNsOpenapi.default,
		);
		const immutableRefSet =
			(_options$dereference$ = options.dereference.refSet) != null
				? _options$dereference$
				: new _ReferenceSet.default();
		...
		const dereferencedElement = await visitAsync(
			refSet.rootRef.value,
			visitor,
			{
