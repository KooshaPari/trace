	...
	async ReferenceElement(
		...
		if ((0, _apidomCore.isPrimitiveElement)(referencedElement)) {
			...
			if (this.refractCache.has(cacheKey)) {
				...
				referencedElement =
					_apidomNsAsyncapi2.ReferenceElement.refract(referencedElement);
				...
				const replacer =
					(_this$options$derefer =
						(_this$options$derefer2 =
							this.options.dereference.strategyOpts["asyncapi-3"]) == null
							? void 0
		...
		if (
			(isExternalReference ||
				isNonRootDocument ||
				(0, _apidomNsAsyncapi2.isReferenceElement)(referencedElement) ||
