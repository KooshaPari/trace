...
exports.unsanitize =
	exports.toFileSystemPath =
	exports.stripHash =
	exports.sanitize =
	exports.resolve =
	exports.isURI =
	exports.isHttpUrl =
	exports.isFileSystemPath =
	exports.hasProtocol =
	exports.getProtocol =
	exports.getHash =
	exports.getExtension =
	exports.fromFileSystemPath =
	exports.cwd =
		void 0;
...
const hasProtocol = (exports.hasProtocol = (0, _ramda.pipe)(
	getProtocol,
	_ramdaAdjunct.isNotUndefined,
));
...
const isFileSystemPath = (uri) => {
	...
	return (
		(0, _ramdaAdjunct.isUndefined)(protocol) ||
		protocol === "file" ||
...
const toFileSystemPath = (uri, options) => {
	...
	const keepFileProtocol = (0, _ramda.propOr)(
		false,
		"keepFileProtocol",
		options,
	);
	const isWindowsPredicate = (0, _ramda.propOr)(
		isWindows,
		"isWindows",
		options,
	);
