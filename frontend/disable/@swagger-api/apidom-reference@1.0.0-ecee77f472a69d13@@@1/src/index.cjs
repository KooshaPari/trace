...
exports.url =
	exports.resolveApiDOM =
	exports.resolve =
	exports.readFile =
	exports.parse =
	exports.options =
	exports.mergeOptions =
	exports.dereferenceApiDOM =
	exports.dereference =
	exports.bundle =
	exports.UnmatchedResolverError =
	exports.UnmatchedResolveStrategyError =
	exports.UnmatchedDereferenceStrategyError =
	exports.UnmatchedBundleStrategyError =
	exports.ResolverError =
	exports.Resolver =
	exports.ResolveStrategy =
	...
	exports.Parser =
	exports.ParseError =
	exports.MaximumResolveDepthError =
	exports.MaximumDereferenceDepthError =
	exports.MaximumBundleDepthError =
	exports.JsonSchemaURIError =
	exports.JsonSchema$anchorError =
	exports.InvalidJsonSchema$anchorError =
	exports.HTTPResolver =
	exports.EvaluationJsonSchemaUriError =
	exports.EvaluationJsonSchema$anchorError =
	exports.EvaluationElementIdError =
	exports.DereferenceStrategy =
	exports.DereferenceError =
	exports.DereferenceAncestorLineage =
	exports.BundleStrategy =
	exports.BundleError =
		void 0;
...
var _Resolver = _interopRequireDefault(
	require("./resolve/resolvers/Resolver.cjs"),
);
exports.Resolver = _Resolver.default;
var _HTTPResolver = _interopRequireDefault(
	require("./resolve/resolvers/HTTPResolver.cjs"),
);
exports.HTTPResolver = _HTTPResolver.default;
var _ResolveStrategy = _interopRequireDefault(
	require("./resolve/strategies/ResolveStrategy.cjs"),
);
exports.ResolveStrategy = _ResolveStrategy.default;
var _DereferenceStrategy = _interopRequireDefault(
	require("./dereference/strategies/DereferenceStrategy.cjs"),
);
...
var _BundleStrategy = _interopRequireDefault(
	require("./bundle/strategies/BundleStrategy.cjs"),
);
...
var _MaximumBundleDepthError = _interopRequireDefault(
	require("./errors/MaximumBundleDepthError.cjs"),
);
exports.MaximumBundleDepthError = _MaximumBundleDepthError.default;
var _UnmatchedBundleStrategyError = _interopRequireDefault(
	require("./errors/UnmatchedBundleStrategyError.cjs"),
);
exports.UnmatchedBundleStrategyError = _UnmatchedBundleStrategyError.default;
var _DereferenceError = _interopRequireDefault(
	require("./errors/DereferenceError.cjs"),
);
exports.DereferenceError = _DereferenceError.default;
var _EvaluationElementIdError = _interopRequireDefault(
	require("./errors/EvaluationElementIdError.cjs"),
);
exports.EvaluationElementIdError = _EvaluationElementIdError.default;
var _EvaluationJsonSchema$anchorError = _interopRequireDefault(
	require("./errors/EvaluationJsonSchema$anchorError.cjs"),
);
exports.EvaluationJsonSchema$anchorError =
	_EvaluationJsonSchema$anchorError.default;
...
var _InvalidJsonSchema$anchorError = _interopRequireDefault(
	require("./errors/InvalidJsonSchema$anchorError.cjs"),
);
exports.InvalidJsonSchema$anchorError = _InvalidJsonSchema$anchorError.default;
var _JsonSchema$anchorError = _interopRequireDefault(
	require("./errors/JsonSchema$anchorError.cjs"),
);
exports.JsonSchema$anchorError = _JsonSchema$anchorError.default;
var _JsonSchemaUriError = _interopRequireDefault(
	require("./errors/JsonSchemaUriError.cjs"),
);
...
var _ResolveError = _interopRequireDefault(
	require("./errors/ResolveError.cjs"),
);
exports.ResolveError = _ResolveError.default;
var _ResolverError = _interopRequireDefault(
	require("./errors/ResolverError.cjs"),
);
exports.ResolverError = _ResolverError.default;
var _UnmatchedDereferenceStrategyError = _interopRequireDefault(
	require("./errors/UnmatchedDereferenceStrategyError.cjs"),
);
exports.UnmatchedDereferenceStrategyError =
	_UnmatchedDereferenceStrategyError.default;
var _UnmatchedResolveStrategyError = _interopRequireDefault(
	require("./errors/UnmatchedResolveStrategyError.cjs"),
);
exports.UnmatchedResolveStrategyError = _UnmatchedResolveStrategyError.default;
var _UnmatchedResolverError = _interopRequireDefault(
	require("./errors/UnmatchedResolverError.cjs"),
);
