...
const baseURILens = (0, _ramda.lens)(
	(0, _ramda.path)(["resolve", "baseURI"]),
	(0, _ramda.assocPath)(["resolve", "baseURI"]),
);
const baseURIDefault = (baseURI) =>
	(0, _ramdaAdjunct.isEmptyString)(baseURI) ? (0, _url.cwd)() : baseURI;
