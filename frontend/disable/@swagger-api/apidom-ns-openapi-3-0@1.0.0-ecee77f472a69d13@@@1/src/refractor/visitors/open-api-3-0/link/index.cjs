 ...
 * @public
 */
class LinkVisitor extends (0, _tsMixer.Mixin)(
	...
	ObjectElement(objectElement) {
		...
		if (
			(0, _apidomCore.isStringElement)(this.element.operationId) ||
			(0, _apidomCore.isStringElement)(this.element.operationRef)
		) {
