...
var _FixedFieldsVisitor = _interopRequireDefault(
	require("./FixedFieldsVisitor.cjs"),
);
var _PatternedFieldsVisitor = _interopRequireDefault(
	require("./PatternedFieldsVisitor.cjs"),
);
/**
 * @public
 */
 ...
 * @public
 */
class MixedFieldsVisitor extends (0, _tsMixer.Mixin)(
	_FixedFieldsVisitor.default,
	_PatternedFieldsVisitor.default,
) {
	specPathFixedFields;
	specPathPatternedFields;
	constructor({ specPathFixedFields, specPathPatternedFields, ...rest }) {
		super({
			...rest,
		});
	...
	ObjectElement(objectElement) {
		...
		try {
			...
			const fixedFields = this.retrieveFixedFields(
				this.specPath(objectElement),
			);
			// let FixedFieldsVisitor only process fixed fields and leave rest to PatternedFieldsVisitor
			// @ts-ignore
			this.ignoredFields = [
				...ignoredFields,
				...(0, _ramda.difference)(objectElement.keys(), fixedFields),
			];
			_FixedFieldsVisitor.default.prototype.ObjectElement.call(
				this,
				objectElement,
			);
			this.specPath = this.specPathPatternedFields;
			this.ignoredFields = fixedFields;
			_PatternedFieldsVisitor.default.prototype.ObjectElement.call(
				this,
				objectElement,
			);
		} catch (e) {
