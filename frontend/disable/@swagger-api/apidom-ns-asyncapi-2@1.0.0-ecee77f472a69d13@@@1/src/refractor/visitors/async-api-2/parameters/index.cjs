...
var _Parameters = _interopRequireDefault(
	require("../../../../elements/Parameters.cjs"),
);
 ...
 * @public
 */
class ParametersVisitor extends (0, _tsMixer.Mixin)(
	...
	ObjectElement(objectElement) {
		const result = _PatternedFieldsVisitor.default.prototype.ObjectElement.call(
			this,
			objectElement,
		);
