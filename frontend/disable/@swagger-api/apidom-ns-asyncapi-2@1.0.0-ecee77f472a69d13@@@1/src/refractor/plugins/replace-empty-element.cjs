...
var _Identifier = _interopRequireDefault(
	require("../../elements/Identifier.cjs"),
);
...
var _Components = _interopRequireDefault(
	require("../../elements/Components.cjs"),
);
...
var _Parameter = _interopRequireDefault(
	require("../../elements/Parameter.cjs"),
);
...
var _OAuthFlows = _interopRequireDefault(
	require("../../elements/OAuthFlows.cjs"),
);
var _OAuthFlow = _interopRequireDefault(
	require("../../elements/OAuthFlow.cjs"),
);
var _Operation = _interopRequireDefault(
	require("../../elements/Operation.cjs"),
);
...
const schema = {
	...
	MessageElement: {
		...
		payload(...args) {
			...
			const schemaFormat = (0, _ramda.defaultTo)(
				_mediaTypes.default.latest(),
				(0, _apidomCore.toValue)(messageElement.schemaFormat),
			);
	...
	PulsarChannelBindingElement: {
		"geo-replication": (...args) => new _apidomCore.ArrayElement(...args),
		retention(...args) {
			return new _apidomCore.ObjectElement(...args);
		},
	},
