...
const isEmptyElement = (element) =>
	...
	includesClasses(["yaml-e-node", "yaml-e-scalar"], element);
const schema = {
	...
	PulsarChannelBindingElement: {
		"geo-replication": (...args) => new ArrayElement(...args),
		retention(...args) {
			return new ObjectElement(...args);
		},
	},
...
const findElementFactory = (ancestor, keyName) => {
	...
	const keyMapping =
		schema[elementType] || schema[toValue(ancestor.classes.first)];
