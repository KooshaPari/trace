 ...
 * @public
 */
const isAsyncApi2Element = (exports.isAsyncApi2Element = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
		return (element) =>
			(element instanceof _AsyncApi.default &&
				element.constructor === _AsyncApi.default) ||
 ...
 * @public
 */
const isAsyncApiVersionElement = (exports.isAsyncApiVersionElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _AsyncApiVersion.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isChannelBindingsElement = (exports.isChannelBindingsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _ChannelBindings.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isChannelItemElement = (exports.isChannelItemElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _ChannelItem.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isChannelsElement = (exports.isChannelsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Channels.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isIdentifierElement = (exports.isIdentifierElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Identifier.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isParametersElement = (exports.isParametersElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Parameters.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isServerBindingsElement = (exports.isServerBindingsElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _ServerBindings.default ||
			(hasBasicElementProps(element) &&
