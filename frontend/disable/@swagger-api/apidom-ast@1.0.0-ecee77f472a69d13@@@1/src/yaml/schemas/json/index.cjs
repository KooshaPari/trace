...
var _GenericSequence = _interopRequireDefault(
	require("../failsafe/GenericSequence.cjs"),
);
var _GenericMapping = _interopRequireDefault(
	require("../failsafe/GenericMapping.cjs"),
);
/**
 * @public
 */
