...
exports.formatFlowSingleQuoted =
	exports.formatFlowPlain =
	exports.formatFlowDoubleQuoted =
	exports.formatBlockLiteral =
	exports.formatBlockFolded =
		void 0;
...
const blockStyleRegExp =
	/^(?<style>[|>])(?<chomping>[+-]?)(?<indentation>[0-9]*)\s/;
const getIndentationIndicator = (content) => {
	...
	return (0, _ramdaAdjunct.isEmptyString)(indicator)
		? undefined
		: parseInt(indicator, 10);
};
const getIndentation = (content) => {
	...
	const implicitIndentationIndicator = (0, _ramda.pathOr)(
		0,
...
const collapseLineBreakToSpace = (val) => {
	...
	return val
		.replace(/(\n)?\n([^\n]+)/g, (match, p1, p2) =>
			p1 ? match : ` ${p2.trimStart()}`,
		)
		.replace(/[\n]{2}/g, "\n");
};
const removeQuotes = (0, _ramda.curry)((quoteType, val) =>
	val
		.replace(new RegExp(`^${quoteType}`), "")
		.replace(new RegExp(`${quoteType}$`), ""),
);
 ...
 */
const formatFlowPlain = (exports.formatFlowPlain = (0, _ramda.pipe)(
	normalizeLineBreaks,
	_ramda.trim,
	collapseLineBreakToSpace,
	(0, _ramda.split)("\n"),
	(0, _ramda.map)(_ramdaAdjunct.trimStart),
	(0, _ramda.join)("\n"),
));
...
const formatFlowSingleQuoted = (exports.formatFlowSingleQuoted = (0,
_ramda.pipe)(
	normalizeLineBreaks,
	_ramda.trim,
	collapseLineBreakToSpace,
 ...
 */
const formatFlowDoubleQuoted = (exports.formatFlowDoubleQuoted = (0,
_ramda.pipe)(
	normalizeLineBreaks,
	_ramda.trim,
...
const formatBlockLiteral = (content) => {
	...
	const transducer = (0, _ramda.compose)(
		(0, _ramda.map)((0, _ramdaAdjunct.trimCharsStart)(indentation)),
		(0, _ramda.map)((0, _ramdaAdjunct.concatRight)("\n")),
	);
	// @ts-ignore
	const deindented = (0, _ramda.transduce)(
		transducer,
		_ramda.concat,
		"",
		lines,
