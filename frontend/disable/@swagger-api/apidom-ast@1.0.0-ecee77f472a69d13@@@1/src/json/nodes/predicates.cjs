...
const isStringContent = (node) =>
	(0, _predicates.isNodeType)("stringContent", node);

/**
 * @public
 */
exports.isStringContent = isStringContent;
const isEscapeSequence = (node) =>
	(0, _predicates.isNodeType)("escapeSequence", node);
