...
var _JsonSchemaDialect = _interopRequireDefault(
	require("./elements/JsonSchemaDialect.cjs"),
);
 ...
 * @public
 */
const isJsonSchemaDialectElement = (exports.isJsonSchemaDialectElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _JsonSchemaDialect.default ||
			(hasBasicElementProps(element) &&
...
const isOpenApi3_1Element = (exports.isOpenApi3_1Element = (0,
_apidomCore.createPredicate)(
