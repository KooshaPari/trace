					...
					enter(element) {
						...
						allOfDiscriminatorMapping =
							(_element$getMetaPrope = element.getMetaProperty(
								"allOfDiscriminatorMapping",
							)) !== null && _element$getMetaPrope !== void 0
					...
					leave(schemaElement, key, parent, path, ancestors) {
							...
							if (
								...
								mapping.forEach((mappingValue, mappingKey) => {
									...
									const mappingValueSchemaRefBaseURI =
										...
										mappingValueSchema === void 0 ||
										(_mappingValueSchema$g =
											mappingValueSchema.getMetaProperty("ref-fields")) ===
											null ||
										_mappingValueSchema$g === void 0
											? void 0
											: _mappingValueSchema$g.get("$refBaseURI");
									if (
										mappingValueSchemaRefBaseURI !== null &&
										mappingValueSchemaRefBaseURI !== void 0 &&
										mappingValueSchemaRefBaseURI.equals(
											metaRefFields === null || metaRefFields === void 0
												? void 0
							...
							if (metaSchemaName) {
								...
								mapping.forEach((mappingValue, mappingKey) => {
									...
									const mappingValueSchemaName =
										mappingValueSchema === null || mappingValueSchema === void 0
											? void 0
						...
						isNormalized =
							...
							normalizedMapping.filter(
								(mappingValue) => !isSchemaElement(mappingValue),
							).length === 0 &&
