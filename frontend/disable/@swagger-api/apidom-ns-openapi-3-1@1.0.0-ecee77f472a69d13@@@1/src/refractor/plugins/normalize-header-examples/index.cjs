			...
			visitor: {
				...
				HeaderElement: {
					leave(headerElement, key, parent, path, ancestors) {
						...
						if (
							typeof ((_headerElement$schema = headerElement.schema) == null
								? void 0
								: _headerElement$schema.example) === "undefined" &&
							typeof ((_headerElement$schema2 = headerElement.schema) == null
								? void 0
								: _headerElement$schema2.examples) === "undefined"
						) {
							return;
						}
						...
						if (typeof headerElement.example !== "undefined") {
							if (typeof headerElement.schema.examples !== "undefined") {
								headerElement.schema.set("examples", [
									(0, _apidomCore.cloneDeep)(headerElement.example),
								]);
								storage.append(headerJSONPointer);
							}
							if (typeof headerElement.schema.example !== "undefined") {
								headerElement.schema.set(
									"example",
									(0, _apidomCore.cloneDeep)(headerElement.example),
								);
								storage.append(headerJSONPointer);
