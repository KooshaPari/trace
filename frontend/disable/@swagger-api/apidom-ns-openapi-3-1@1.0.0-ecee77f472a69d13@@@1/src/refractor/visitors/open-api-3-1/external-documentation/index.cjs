 ...
 * @public
 */
const BaseExternalDocumentationVisitor =
	(exports.BaseExternalDocumentationVisitor =
		_apidomNsOpenapi.specificationObj.visitors.document.objects.ExternalDocumentation.$visitor);
/**
 * @public
 */
