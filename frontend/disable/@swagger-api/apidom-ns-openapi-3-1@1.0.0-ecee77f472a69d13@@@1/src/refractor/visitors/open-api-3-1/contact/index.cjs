...
var _Contact = _interopRequireDefault(
	require("../../../../elements/Contact.cjs"),
);
/**
 * @public
 */
const BaseContactVisitor = (exports.BaseContactVisitor =
	_apidomNsOpenapi.specificationObj.visitors.document.objects.Contact.$visitor);
/**
 * @public
 */
