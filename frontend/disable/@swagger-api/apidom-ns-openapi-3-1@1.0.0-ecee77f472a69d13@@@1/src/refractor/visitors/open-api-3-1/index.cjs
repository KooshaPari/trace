...
var _OpenApi = _interopRequireDefault(
	require("../../../elements/OpenApi3-1.cjs"),
);
/**
 * @public
 */
 ...
 */
// eslint-disable-next-line @typescript-eslint/naming-convention
class OpenApi3_1Visitor extends (0, _tsMixer.Mixin)(
	...
	ObjectElement(objectElement) {
		...
		return _apidomNsOpenapi.FixedFieldsVisitor.prototype.ObjectElement.call(
			this,
			objectElement,
		);
	}
