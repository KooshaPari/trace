 ...
 * @public
 */
class JsonSchemaDialectVisitor extends (0, _tsMixer.Mixin)(
	_apidomNsOpenapi.SpecificationVisitor,
	_apidomNsOpenapi.FallbackVisitor,
) {
	StringElement(stringElement) {
		const jsonSchemaDialectElement = new _JsonSchemaDialect.default(
