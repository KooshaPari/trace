 ...
 * @public
 */
const BaseSecurityRequirementVisitor = (exports.BaseSecurityRequirementVisitor =
	_apidomNsOpenapi.specificationObj.visitors.document.objects.SecurityRequirement.$visitor);
/**
 * @public
 */
