...
var _Header = _interopRequireDefault(
	require("../../../../elements/Header.cjs"),
);
/**
 * @public
 */
const BaseHeaderVisitor = (exports.BaseHeaderVisitor =
	_apidomNsOpenapi.specificationObj.visitors.document.objects.Header.$visitor);
/**
 * @public
 */
