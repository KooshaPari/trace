...
var _Server = _interopRequireDefault(
	require("../../../../elements/Server.cjs"),
);
/**
 * @public
 */
const BaseServerVisitor = (exports.BaseServerVisitor =
	_apidomNsOpenapi.specificationObj.visitors.document.objects.Server.$visitor);
/**
 * @public
 */
