...
var _License = _interopRequireDefault(
	require("../../../../elements/License.cjs"),
);
/**
 * @public
 */
const BaseLicenseVisitor = (exports.BaseLicenseVisitor =
	_apidomNsOpenapi.specificationObj.visitors.document.objects.License.$visitor);
/**
 * @public
 */
