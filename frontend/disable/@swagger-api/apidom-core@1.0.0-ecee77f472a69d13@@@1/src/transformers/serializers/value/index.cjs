...
var _ephemeralArray = _interopRequireDefault(
	require("./ast/ephemeral-array.cjs"),
);
var _ephemeralObject = _interopRequireDefault(
	require("./ast/ephemeral-object.cjs"),
);
...
class Visitor {
	...
	RefElement(element, ...rest) {
		...
		if (
			((_ancestors = ancestors[ancestors.length - 1]) == null
				? void 0
				: _ancestors.type) === "EphemeralObject"
		) {
