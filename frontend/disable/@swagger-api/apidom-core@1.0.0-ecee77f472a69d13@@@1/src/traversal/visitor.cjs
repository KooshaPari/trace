...
exports.visit =
	exports.keyMapDefault =
	exports.isNode =
	exports.getNodeType =
	exports.cloneNode =
	exports.PredicateVisitor =
		void 0;
...
const getNodeType = (element) => {
	 ...
	 */
	return (0, _index.isObjectElement)(element)
		? "ObjectElement"
		: (0, _index.isArrayElement)(element)
			? "ArrayElement"
			: (0, _index.isMemberElement)(element)
				? "MemberElement"
				: (0, _index.isStringElement)(element)
					? "StringElement"
					: (0, _index.isBooleanElement)(element)
						? "BooleanElement"
						: (0, _index.isNumberElement)(element)
							? "NumberElement"
							: (0, _index.isNullElement)(element)
								? "NullElement"
								: (0, _index.isLinkElement)(element)
									? "LinkElement"
									: (0, _index.isRefElement)(element)
										? "RefElement"
										: undefined;
};
...
const isNode = (exports.isNode = (0, _ramda.pipe)(
	getNodeType,
	_ramdaAdjunct.isString,
));
...
class PredicateVisitor {
	...
	returnOnTrue;
	returnOnFalse;
	constructor({ predicate = _ramda.F, returnOnTrue, returnOnFalse } = {}) {
		this.result = [];
...
visit[Symbol.for("nodejs.util.promisify.custom")] = async (
	...
	// @ts-ignore
	return _apidomAst.visit[Symbol.for("nodejs.util.promisify.custom")](
		root,
		visitor,
		{
			// @ts-ignore
