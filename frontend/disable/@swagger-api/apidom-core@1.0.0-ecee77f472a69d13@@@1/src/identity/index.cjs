...
var _ElementIdentityError = _interopRequireDefault(
	require("./errors/ElementIdentityError.cjs"),
);
...
class IdentityManager {
	...
	identify(element) {
		if (!(0, _index.isElement)(element)) {
			throw new _ElementIdentityError.default(
		...
		if (
			...
			(0, _index.isStringElement)(element.meta.get("id")) &&
...
const defaultIdentityManager = (exports.defaultIdentityManager =
	new IdentityManager());
