...
import { isArrayElement, isObjectElement } from "../predicates/index.mjs";
...
export const emptyElement = (element) => {
	...
	const attributes =
		element.attributes.length > 0 ? cloneDeep(element.attributes) : undefined;
