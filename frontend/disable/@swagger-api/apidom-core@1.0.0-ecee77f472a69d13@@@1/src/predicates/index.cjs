...
const isElement = (exports.isElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.Element ||
...
const isStringElement = (exports.isStringElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.StringElement ||
...
const isNumberElement = (exports.isNumberElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.NumberElement ||
...
const isNullElement = (exports.isNullElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.NullElement ||
...
const isBooleanElement = (exports.isBooleanElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.BooleanElement ||
...
const isObjectElement = (exports.isObjectElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq, hasMethod }) => {
		return (element) =>
			element instanceof _minim.ObjectElement ||
...
const isArrayElement = (exports.isArrayElement = (0, _helpers.default)(
	({ hasBasicElementProps, primitiveEq, hasMethod }) => {
		return (element) =>
			(element instanceof _minim.ArrayElement &&
				!(element instanceof _minim.ObjectElement)) ||
			(hasBasicElementProps(element) &&
...
const isMemberElement = (exports.isMemberElement = (0, _helpers.default)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.MemberElement ||
			(hasBasicElementProps(element) &&
...
const isLinkElement = (exports.isLinkElement = (0, _helpers.default)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.LinkElement ||
			(hasBasicElementProps(element) &&
...
const isRefElement = (exports.isRefElement = (0, _helpers.default)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _minim.RefElement ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isAnnotationElement = (exports.isAnnotationElement = (0,
_helpers.default)(({ hasBasicElementProps, isElementType, primitiveEq }) => {
	return (element) =>
		element instanceof _Annotation.default ||
		(hasBasicElementProps(element) &&
...
const isCommentElement = (exports.isCommentElement = (0, _helpers.default)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Comment.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isParseResultElement = (exports.isParseResultElement = (0,
_helpers.default)(({ hasBasicElementProps, isElementType, primitiveEq }) => {
	return (element) =>
		element instanceof _ParseResult.default ||
		(hasBasicElementProps(element) &&
...
const isPrimitiveElement = (element) => {
	return (
		(0, _helpers.isElementType)("object", element) ||
		(0, _helpers.isElementType)("array", element) ||
		(0, _helpers.isElementType)("boolean", element) ||
		(0, _helpers.isElementType)("number", element) ||
		(0, _helpers.isElementType)("string", element) ||
		(0, _helpers.isElementType)("null", element) ||
		(0, _helpers.isElementType)("member", element)
	);
};
...
const includesSymbols = (symbols, element) => {
	...
	return (0, _ramda.all)(
		(0, _ramdaAdjunct.included)(elementSymbols.toValue()),
		symbols,
	);
};
...
const includesClasses = (classes, element) => {
	...
	return (0, _ramda.all)(
		(0, _ramdaAdjunct.included)(element.classes.toValue()),
		classes,
	);
};
