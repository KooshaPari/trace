...
exports.primitiveEq =
	exports.isElementType =
	exports.hasMethod =
	exports.hasClass =
	exports.hasBasicElementProps =
	exports.default =
		void 0;
...
const hasBasicElementProps = (element) =>
	typeof element === "object" &&
	element != null &&
...
const primitiveEq = (val, element) => {
	if (
		typeof element === "object" &&
		element !== null &&
		"primitive" in element
	) {
		return (
			typeof element.primitive === "function" && element.primitive() === val
		);
	}
	return false;
};
...
const hasClass = (cls, element) => {
	return (
		...
		(Array.isArray(element.classes) ||
			element.classes instanceof _minim.ArrayElement) &&
