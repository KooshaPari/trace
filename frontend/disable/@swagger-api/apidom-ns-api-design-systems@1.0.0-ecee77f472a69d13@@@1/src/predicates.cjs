...
var _Requirement = _interopRequireDefault(
	require("./elements/Requirement.cjs"),
);
...
var _StandardIdentifier = _interopRequireDefault(
	require("./elements/StandardIdentifier.cjs"),
);
/**
 * @public
 */
const isMainElement = (exports.isMainElement = (0, _apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Main.default ||
 ...
 * @public
 */
const isPrincipleElement = (exports.isPrincipleElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Principle.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isRequirementElement = (exports.isRequirementElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Requirement.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isRequirementLevelElement = (exports.isRequirementLevelElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _RequirementLevel.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isScenarioElement = (exports.isScenarioElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Scenario.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isStandardElement = (exports.isStandardElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _Standard.default ||
			(hasBasicElementProps(element) &&
 ...
 * @public
 */
const isStandardIdentifierElement = (exports.isStandardIdentifierElement = (0,
_apidomCore.createPredicate)(
	({ hasBasicElementProps, isElementType, primitiveEq }) => {
		return (element) =>
			element instanceof _StandardIdentifier.default ||
			(hasBasicElementProps(element) &&
