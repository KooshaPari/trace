import { ArrayElement, toValue, visit } from "@swagger-api/apidom-core";
	...
	const visitor = {
		enter(element) {
			...
			element.meta
				...
				.content.filter((accessorMapping) => {
					return (
						String(toValue(accessorMapping.get("subject"))) ===
						strStandardIdentifier
					);
				})
