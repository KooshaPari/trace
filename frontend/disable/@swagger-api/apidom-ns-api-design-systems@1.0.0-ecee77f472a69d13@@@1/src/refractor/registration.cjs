 ...
 * API Design Systems 2021-05-07 specification elements.
 */
_Main.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Main",
...
_Principle.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Principle",
...
_Requirement.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Requirement",
...
_RequirementLevel.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"RequirementLevel",
...
_Scenario.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Scenario",
...
_Standard.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"Standard",
...
_StandardIdentifier.default.refract = (0, _index.createRefractor)([
	"visitors",
	"document",
	"objects",
	"StandardIdentifier",
