...
class CstVisitor {
	...
	static kindNodeToYamlTag(node) {
		...
		const explicitName =
			(tagNode === null || tagNode === void 0 ? void 0 : tagNode.text) ||
	...
	yaml_directive = {
		enter: (node) => {
			...
			const version =
				node === null ||
				node === void 0 ||
				(_node$firstNamedChild = node.firstNamedChild) === null ||
				_node$firstNamedChild === void 0
					? void 0
					: _node$firstNamedChild.text;
				...
				assignSourceMap(
					{
						...
						parameters: {
							handle:
								tagHandleNode === null || tagHandleNode === void 0
									? void 0
									: tagHandleNode.text,
							prefix:
								tagPrefixNode === null || tagPrefixNode === void 0
									? void 0
									: tagPrefixNode.text,
						},
					},
		...
		enter: (node) => {
			...
			return new YamlDirective(
				assignSourceMap(
					{
						name:
							directiveNameNode === null || directiveNameNode === void 0
								? void 0
								: directiveNameNode.text,
						parameters: {
							handle:
								directiveParameter1Node === null ||
								directiveParameter1Node === void 0
									? void 0
									: directiveParameter1Node.text,
							prefix:
								directiveParameter2Node === null ||
								directiveParameter2Node === void 0
									? void 0
									: directiveParameter2Node.text,
						},
					},
					node,
				),
	...
	createKeyValuePairEmptyKey(node) {
		const { keyNode } = node;
		const children =
			(keyNode === null || keyNode === void 0 ? void 0 : keyNode.children) ||
			[];
	...
	createKeyValuePairEmptyValue(node) {
		...
		const children =
			(valueNode === null || valueNode === void 0
				? void 0
				: valueNode.children) || [];
		const tagNode = children.find(CstVisitor.isKind("tag"));
		const anchorNode = children.find(CstVisitor.isKind("anchor"));
