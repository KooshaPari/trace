...
HelpFormatter.prototype._joinParts = (partStrings) =>
	partStrings.filter((part) => part && part !== c.SUPPRESS).join("");
...
HelpFormatter.prototype._formatUsage = function (
	...
	if (usage) {
		...
		if (prefix.length + usage.length > textWidth) {
			...
			var _getLines = (parts, indent, prefix) => {
				var lines = [];
				var line = [];
...
HelpFormatter.prototype._formatActionsUsage = function (actions, groups) {
	...
	var text = parts.filter((part) => !!part).join(" ");
...
HelpFormatter.prototype._metavarFormatter = (action, metavarDefault) => {
	var result;
...
HelpFormatter.prototype._expandHelp = function (action) {
	...
	Object.keys(action).forEach((actionProperty) => {
...
HelpFormatter.prototype._getHelpString = (action) => action.help;
