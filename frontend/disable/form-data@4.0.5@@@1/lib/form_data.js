...
FormData.prototype._lengthRetriever = (value, callback) => {
	if (hasOwn(value, "fd")) {
...
FormData.prototype._getContentDisposition = (value, options) => {
...
FormData.prototype._getContentType = (value, options) => {
