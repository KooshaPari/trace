...
if (result.success) {
	...
	console.dir(data);
	let note =
		"Note that, unlike the parser callback functions, the AST callback functions\n";
	note +=
		"retain only the phases that were captured on ultimately successful branches of the parse tree.\n";
	console.log("\nAST NOTE");
	console.log(note);
