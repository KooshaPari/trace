...
export const ZodMiniMAC: core.$constructor<ZodMiniMAC> =
	/*@__PURE__*/ core.$constructor("ZodMiniMAC", (inst, def) => {
...
export const ZodMiniCodec: core.$constructor<ZodMiniCodec> =
	/*@__PURE__*/ core.$constructor("ZodMiniCodec", (inst, def) => {
...
) => ZodMiniCodec<ZodMiniString, ZodMiniBoolean> = (...args) =>
	core._stringbool(
		{
			Codec: ZodMiniCodec,
...
export const ZodMiniFunction: core.$constructor<ZodMiniFunction> =
	/*@__PURE__*/ core.$constructor("ZodMiniFunction", (inst, def) => {
