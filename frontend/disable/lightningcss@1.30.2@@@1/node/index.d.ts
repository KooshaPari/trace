...
type RuleVisitors<C extends CustomAtRules> = MappedRuleVisitors & {
	...
	custom?:
		| CustomVisitors<C>
		| Omit<RuleVisitor<AnyCustomAtRule<C>>, keyof CallableFunction>;
};

type PreludeTypes = Exclude<
	ParsedComponent["type"],
...
type MappedBody<P extends CustomAtRuleDefinition["body"]> =
	P extends "style-block" ? "rule-list" : P;
...
type FindProperty<Union, Name> = Union extends { property: Name }
	? Union
	: never;
...
type EnvironmentVariableVisitor = (
...
export type BundleOptions<C extends CustomAtRules> = Omit<
	TransformOptions<C>,
	"code"
>;
