...
KeyedCursorPrototype.deref =
	...
	IndexedCursorPrototype.valueOf =
...
IndexedCursorPrototype.push = function (/* values */) {
	var args = arguments;
	return updateCursor(this, (m) => m.push.apply(m, args));
};
...
IndexedCursorPrototype.unshift = function (/* values */) {
	var args = arguments;
	return updateCursor(this, (m) => m.unshift.apply(m, args));
};
...
IndexedCursorPrototype.mergeDeepWith = KeyedCursorPrototype.mergeDeepWith =
	function (merger /*, ...iters*/) {
		var args = arguments;
...
KeyedCursorPrototype.withMutations = IndexedCursorPrototype.withMutations =
	function (fn) {
