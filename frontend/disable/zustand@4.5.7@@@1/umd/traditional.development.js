((global, factory) => {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: typeof define === "function" && define.amd
			...
			: ((global =
				...
				factory(
					(global.zustandTraditional = {}),
					global.React,
					global.useSyncExternalStoreShimWithSelector,
					global.zustandVanilla,
				));
})(this, (exports, ReactExports, useSyncExternalStoreExports, vanilla) => {
	...
	function useStoreWithEqualityFn(api, selector, equalityFn) {
		...
		var slice = useSyncExternalStoreWithSelector(
			api.subscribe,
			api.getState,
	...
	var createWithEqualityFnImpl = function createWithEqualityFnImpl(
		createState,
		defaultEqualityFn,
	) {
		var api = vanilla.createStore(createState);
		var useBoundStoreWithEqualityFn = function useBoundStoreWithEqualityFn(
			selector,
			equalityFn,
		) {
	...
	var createWithEqualityFn = function createWithEqualityFn(
		createState,
		defaultEqualityFn,
	) {
		return createState
