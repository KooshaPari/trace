((global, factory) => {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: typeof define === "function" && define.amd
			? define(["react", "zustand/traditional"], factory)
			: ((global =
					typeof globalThis !== "undefined" ? globalThis : global || self),
				(global.zustandContext = factory(global.React, global.traditional)));
})(this, (ReactExports, traditional) => {
	function _extends() {
		return (
	...
	function createContext() {
		...
		var useStoreApi = function useStoreApi() {
			...
			return useMemo(() => _extends({}, store), [store]);
		};
		return {
			Provider: Provider,
