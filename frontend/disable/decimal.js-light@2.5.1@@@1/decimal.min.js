...
!((r) => {
	...
	function g(r) {
		function e(r) {
			...
			if (((this.constructor = e), r instanceof e))
				return (
					(this.s = r.s),
					(this.e = r.e),
					void (this.d = (r = r.d) ? r.slice() : r)
				);
			if ("number" == typeof r) {
				if (0 * r !== 0) throw Error(x + r);
				if (r > 0) this.s = 1;
				else {
					if (!(0 > r)) return (this.s = 0), (this.e = 0), void (this.d = [0]);
					(r = -r), (this.s = -1);
				}
				return r === ~~r && 1e7 > r
					? ((this.e = 0), void (this.d = [r]))
					: c(this, r.toString());
			}
			if ("string" != typeof r) throw Error(x + r);
			if (
				(45 === r.charCodeAt(0)
					? ((r = r.slice(1)), (this.s = -1))
					: (this.s = 1),
				!D.test(r))
			)
				throw Error(x + r);
		...
		if (
			...
			for (
				...
				Object.hasOwn(r, (n = i[t++])) || (r[n] = this[n]);
		return e.config(r), e;
	}
	function p(r) {
	...
	(A.absoluteValue = A.abs =
		...
		(A.comparedTo = A.cmp =
			function (r) {
				var e, t, n, i;
				if (((r = new this.constructor(r)), this.s !== r.s))
					return this.s || -r.s;
				if (this.e !== r.e) return (this.e > r.e) ^ (this.s < 0) ? 1 : -1;
				for (
					n = this.d.length, i = r.d.length, e = 0, t = i > n ? n : i;
					t > e;
					++e
				)
					if (this.d[e] !== r.d[e])
						return (this.d[e] > r.d[e]) ^ (this.s < 0) ? 1 : -1;
		...
		(A.dividedToIntegerBy = A.idiv =
			function (r) {
				...
				return h(P(this, new t(r), 0, 1), t.precision);
			}),
		(A.equals = A.eq =
			function (r) {
				return !this.cmp(r);
		...
		(A.logarithm = A.log =
			function (r) {
				...
				if (this.s < 1) throw Error(N + (this.s ? "NaN" : "-Infinity"));
				return this.eq(v)
					? new n(0)
					: ((E = !1), (e = P(f(this, o), f(r, o), o)), (E = !0), h(e, i));
			}),
		(A.minus = A.sub =
			function (r) {
				return (
					(r = new this.constructor(r)),
					this.s == r.s ? l(this, r) : e(this, ((r.s = -r.s), r))
				);
			}),
		(A.modulo = A.mod =
			function (r) {
				...
				return this.s
					? ((E = !1), (e = P(this, r, 0, 1).times(r)), (E = !0), this.minus(e))
					: h(new n(this), i);
			}),
		...
		(A.plus = A.add =
			function (r) {
				return (
					(r = new this.constructor(r)),
					this.s == r.s ? e(this, r) : l(this, ((r.s = -r.s), r))
				);
			}),
		(A.precision = A.sd =
			function (r) {
		...
		(A.toInteger = A.toint =
			function () {
				...
				return h(new e(this), o(this) + 1, e.rounding);
			}),
		(A.toNumber = function () {
			return +this;
		}),
		...
		(A.toString =
			...
			A.toJSON =
				function () {
					var e = o(this),
						t = this.constructor;
					return d(this, e <= t.toExpNeg || e >= t.toExpPos);
				});
	var P = (() => {
		function r(r, e) {
			var t,
