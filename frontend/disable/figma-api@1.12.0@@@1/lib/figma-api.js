	...
	return (() => {
	...
	})()(
		{
					...
					var Api = /** @class */ (() => {
						function Api(params) {
							this.appendHeaders = (headers) => {
								...
								if (this.oAuthToken)
									headers["Authorization"] = "Bearer ".concat(this.oAuthToken);
							};
									...
									return __generator(this, function (_a) {
										switch (_a.label) {
											case 0:
												headers = {};
												this.appendHeaders(headers);
												axiosParams = __assign(__assign({ url: url }, opts), {
													headers: headers,
												});
							...
							return __generator(this, (_a) => {
								switch (_a.label) {
									case 0:
										...
										url = "https://www.figma.com/api/oauth/token?".concat(
											queryParams,
										);
										return [
											4 /*yield*/,
											(0, axios_1.default)({ url: url, method: "POST" }),
										];
									case 1:
										res = _a.sent();
			...
			2: [
				function (require, module, exports) {
					...
					function getFileApi(
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/files/")
								.concat(fileKey, "?")
								.concat(queryParams),
						);
					}
					function getFileNodesApi(
						...
						var queryParams = (0, utils_1.toQueryParams)(
							__assign(__assign({}, opts), { ids: ids.join(",") }),
						);
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/files/")
								.concat(fileKey, "/nodes?")
								.concat(queryParams),
						);
					}
					function getImageApi(fileKey, opts) {
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/images/")
								.concat(fileKey, "?")
								.concat(queryParams),
						);
					}
					...
					function getCommentsApi(fileKey) {
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/files/")
								.concat(fileKey, "/comments"),
						);
					}
					function postCommentsApi(
						fileKey,
						...
						var body = comment_id
							...
							: { message: message, client_meta: client_meta };
					...
					function getTeamProjectsApi(team_id) {
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/teams/")
								.concat(team_id, "/projects"),
						);
					}
					function getProjectFilesApi(project_id, opts) {
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/projects/")
								.concat(project_id, "/files?")
								.concat(queryParams),
						);
					}
					...
					function getComponentApi(
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/components/")
								.concat(key),
						);
					}
					...
					function getFileComponentSetsApi(file_key) {
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/files/")
								.concat(file_key, "/component_sets"),
						);
					}
					function getComponentSetApi(
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/component_sets/")
								.concat(key),
						);
					}
					...
					function getStyleApi(
						...
						return this.request(
							""
								.concat(config_1.API_DOMAIN, "/")
								.concat(config_1.API_VER, "/styles/")
								.concat(key),
						);
					}
				},
			...
			3: [
				(require, module, exports) => {
					...
					exports.LineTypes =
						...
						exports.PaintSolidScaleMode =
						exports.PaintType =
						exports.EffectType =
						exports.AxisSizingMode =
						exports.LayoutGridAlignment =
						...
						exports.EasingType =
						exports.BlendMode =
						exports.ConstrainType =
						exports.LineHeightUnit =
						exports.TextAutoResize =
						exports.TextDecoration =
						exports.TextCase =
						exports.BooleanOperationType =
						exports.ImageType =
						exports.StrokeJoin =
						exports.StrokeAlign =
						exports.StrokeCap =
					...
					((BooleanOperationType) => {
						...
						BooleanOperationType ||
							(exports.BooleanOperationType = BooleanOperationType = {}),
					);
					...
					((LayoutConstraintVertical) => {
						...
						LayoutConstraintVertical ||
							(exports.LayoutConstraintVertical = LayoutConstraintVertical =
								{}),
					);
					...
					((LayoutConstraintHorizontal) => {
						...
						LayoutConstraintHorizontal ||
							(exports.LayoutConstraintHorizontal = LayoutConstraintHorizontal =
								{}),
					);
					var LayoutAlign;
					((LayoutAlign) => {
					...
					((LayoutGridPattern) => {
						...
						LayoutGridPattern ||
							(exports.LayoutGridPattern = LayoutGridPattern = {}),
					);
					...
					((LayoutGridAlignment) => {
						...
						LayoutGridAlignment ||
							(exports.LayoutGridAlignment = LayoutGridAlignment = {}),
					);
					var AxisSizingMode;
					((AxisSizingMode) => {
					...
					((PaintSolidScaleMode) => {
						...
						PaintSolidScaleMode ||
							(exports.PaintSolidScaleMode = PaintSolidScaleMode = {}),
					);
			...
			5: [
				...
				{ "./api-class": 1, "./ast-types": 3, "./config": 4 },
			],
			6: [
				function (require, module, exports) {
					var __extends =
						...
						return Object.entries(x)
							.map((_a) => {
								var k = _a[0],
									v = _a[1];
								return (
									k && v && "".concat(k, "=").concat(encodeURIComponent(v))
								);
							})
							.filter(Boolean)
							.join("&");
			...
			16: [
				...
				{ "../helpers/combineURLs": 26, "../helpers/isAbsoluteURL": 28 },
			],
			17: [
				(require, module, exports) => {
					var utils = require("./../utils");
								...
								function build(data, parentKey) {
									if (utils.isPlainObject(data) || utils.isArray(data)) {
										if (stack.indexOf(data) !== -1) {
											throw Error(
												"Circular reference detected in " + parentKey,
											);
										}
			...
			37: [
				...
				{ "../core/AxiosError": 14, "../env/data": 23 },
			],
			38: [
				(require, module, exports) => {
					var bind = require("./helpers/bind");
			...
			40: [
				...
				{ "base64-js": 39, buffer: 40, ieee754: 41 },
			],
			41: [
				(require, module, exports) => {
