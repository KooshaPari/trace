...
export declare function getFileApi(
	this: ApiClass,
	/**
...
export declare function getFileNodesApi<T extends NodeType = "DOCUMENT">(
	this: ApiClass,
	/**
	 * File to export JSON from
	 *
...
export declare function getImageApi(
	this: ApiClass,
	fileKey: string,
	opts: {
...
export declare function getImageFillsApi(
	this: ApiClass,
	fileKey: string,
): Promise<GetImageFillsResult>;
export declare function getCommentsApi(
	this: ApiClass,
	fileKey: string,
): Promise<GetCommentsResult>;
export declare function postCommentsApi(
	this: ApiClass,
	fileKey: string,
...
export declare function deleteCommentsApi(
	this: ApiClass,
	fileKey: string,
	comment_id: string,
): Promise<DeleteCommentsResult>;
export declare function getUserMeApi(this: ApiClass): Promise<GetUserMeResult>;
export declare function getVersionsApi(
	this: ApiClass,
	fileKey: string,
): Promise<GetVersionsResult>;
export declare function getTeamProjectsApi(
	this: ApiClass,
	team_id: string,
): Promise<GetTeamProjectsResult>;
export declare function getProjectFilesApi(
	this: ApiClass,
	project_id: string,
	opts?: {
		/** Set to returns branch metadata for the requested file */
...
export declare function getTeamComponentsApi(
	this: ApiClass,
...
export declare function getFileComponentsApi(
	this: ApiClass,
	fileKey: string,
): Promise<GetFileComponentsResult>;
/** Get metadata on a component by key. */
export declare function getComponentApi(
	this: ApiClass,
	/** The unique identifier of the component. */
	key: string,
): Promise<GetComponentResult>;
export declare function getTeamComponentSetsApi(
	this: ApiClass,
...
export declare function getFileComponentSetsApi(
	this: ApiClass,
	file_key: string,
): Promise<GetFileComponentSetsResult>;
export declare function getComponentSetApi(
	this: ApiClass,
	/** The unique identifier of the component_set */
	key: string,
): Promise<GetComponentSetResult>;
export declare function getTeamStylesApi(
	this: ApiClass,
	team_id: string,
	opts?: {
		/** Number of items in a paged list of results. Defaults to 30. */
...
export declare function getFileStylesApi(
	this: ApiClass,
	file_key: string,
): Promise<GetFileStylesResult>;
export declare function getStyleApi(
	this: ApiClass,
