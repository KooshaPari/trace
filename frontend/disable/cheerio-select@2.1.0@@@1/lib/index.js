...
Object.defineProperty(exports, "filters", {
	enumerable: true,
	get: () => css_select_2.filters,
});
Object.defineProperty(exports, "pseudos", {
	enumerable: true,
	get: () => css_select_2.pseudos,
});
Object.defineProperty(exports, "aliases", {
	enumerable: true,
	get: () => css_select_2.aliases,
});
...
function some(elements, selector, options) {
	...
	return (
		(plain.length > 0 &&
			elements.some((0, css_select_1._compileToken)(plain, options))) ||
...
function filterByPosition(filter, elems, data, options) {
	...
	switch (filter) {
		...
		case "not": {
			...
			return elems.filter((e) => !filtered_1.has(e));
		}
	}
}
	...
	if (selector.some(css_what_1.isTraversal)) {
		...
		var root =
			(_a = options.root) !== null && _a !== void 0
				? _a
				: (0, helpers_js_1.getDocumentRoot)(elements[0]);
...
function select(selector, root, options, limit) {
	...
	return DomUtils.uniqueSort(
		results.reduce((a, b) =>
			__spreadArray(__spreadArray([], a, true), b, true),
		),
	);
}
...
function findFilterElements(
	 ...
	 */
	var limit = (0, positionals_js_1.getLimit)(
		filter.name,
		filter.data,
		partLimit,
	);
	...
	if (remainingHasTraversal) {
		if ((0, css_what_1.isTraversal)(remainingSelector[0])) {
			...
			if (
				type === css_what_1.SelectorType.Sibling ||
...
function find(root, query, limit) {
	...
	var elems = (0, css_select_1.prepareContext)(
		root,
		DomUtils,
		query.shouldTestNextSiblings,
	);
	return DomUtils.find(
		(node) => DomUtils.isTag(node) && query(node),
		elems,
		true,
		limit,
	);
