 ...
 * Testing
 */
export function testJSONPointer(
	jsonPointer: string,
): jsonPointer is JSONPointer;
export function testReferenceToken(
	referenceToken: string,
): referenceToken is ReferenceToken;
export function testArrayLocation(
	referenceToken: string,
): referenceToken is ArrayLocation;
export function testArrayIndex(
	referenceToken: string,
): referenceToken is ArrayIndex;
export function testArrayDash(
	referenceToken: string,
): referenceToken is ArrayDash;
...
export function unescape(
	referenceToken: EscapedReferenceToken,
): UnescapedReferenceToken;

/**
 * Compiling
 */
export function compile(
	referenceTokens: readonly UnescapedReferenceToken[],
): JSONPointer;
...
export declare abstract class EvaluationRealm {
	...
	public abstract evaluate<T = unknown>(
		node: unknown,
		referenceToken: string,
	): T;
}
