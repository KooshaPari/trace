...
P.clampedTo = P.clamp = function (min, max) {
	...
	k = this.cmp(min);
	return k < 0 ? min : this.cmp(max) > 0 ? max : new Ctor(this);
};
...
P.cubeRoot = P.cbrt = function () {
	...
	// Initial estimate.
	s = this.s * mathpow(this.s * this, 1 / 3);
...
P.modulo = P.mod = function (y) {
	...
	if (Ctor.modulo == 9) {
		...
		q = divide(this, y.abs(), 0, 3, 1);
		q.s *= y.s;
	} else {
		q = divide(this, y, 0, Ctor.modulo, 1);
	}
...
P.squareRoot = P.sqrt = function () {
	...
	if (s !== 1 || !d || !d[0]) {
		return new Ctor(!s || (s < 0 && (!d || d[0])) ? NaN : d ? this : 1 / 0);
	}
...
P.toString = function () {
	var Ctor = this.constructor,
		str = finiteToString(
			this,
			this.e <= Ctor.toExpNeg || this.e >= Ctor.toExpPos,
		);
