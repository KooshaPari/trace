...
class Command {
	...
	static checkFlag(flagName, commandName) {
		return !!Command.getFlagMap()[flagName][commandName];
	}
	...
	static getFlagMap() {
		if (!Command.flagMap) {
			Command.flagMap = Object.keys(Command.FLAGS).reduce((map, flagName) => {
				map[flagName] = {};
...
const hsetArgumentTransformer = (args) => {
	if (args.length === 2) {
