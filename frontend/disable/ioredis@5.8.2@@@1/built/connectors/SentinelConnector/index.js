...
class SentinelConnector extends AbstractConnector_1.default {
	constructor(options) {
		...
		this.sentinelIterator = new SentinelIterator_1.default(
	...
	async initFailoverDetector() {
		...
		while (sentinels.length < this.options.sentinelMaxConnections) {
			...
			client.on("reconnecting", () => {
				...
				(_a = this.emitter) === null || _a === void 0
					? void 0
					: _a.emit("sentinelReconnecting");
			});
		...
		this.failoverDetector = new FailoverDetector_1.FailoverDetector(
			this,
			sentinels,
		);
