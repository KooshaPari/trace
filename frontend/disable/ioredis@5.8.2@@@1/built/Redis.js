...
class Redis extends Commander_1.default {
	...
	connect(callback) {
		const promise = new Promise((resolve, reject) => {
			...
			(0, standard_as_callback_1.default)(
				this.connector.connect((type, err) => {
	...
	get mode() {
		...
		return this.options.monitor
			? "monitor"
			: (
						(_a = this.condition) === null || _a === void 0
							? void 0
							: _a.subscriber
					)
				? "subscriber"
		...
		if (!writable) {
			...
			if (debug.enabled) {
				debug(
					...
					this._getDescription(),
					(_b = this.condition) === null || _b === void 0 ? void 0 : _b.select,
					command.name,
					command.args,
				);
			}
