...
export declare function normalizeNodeOptions(
	nodes: Array<string | number | object>,
): RedisOptions[];
export declare function getUniqueHostnamesFromOptions(
	nodes: RedisOptions[],
): string[];
export declare function groupSrvRecords(
	records: SrvRecord[],
): GroupedSrvRecords;
export declare function weightSrvRecords(
	recordsGroup: SrvRecordsGroup,
): SrvRecord;
export declare function getConnectionName(
	component: any,
	nodeConnectionName: any,
): string;
