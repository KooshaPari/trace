...
backgroundImage_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
		...
		if (Array.isArray(value) && value.length === 1) {
			...
			switch (type) {
				...
				default: {
					const parsedValue =
						external_dependency_parsers_0.parseGradient(value);
					if (!parsedValue) {
						return;
					}
					parsedValues.push(parsedValue);
	...
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundImage_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundImage_local_var_property) ?? "";
...
const backgroundPosition_local_var_keywordsX = [
	"center",
	...backgroundPosition_local_var_keyX,
];
const backgroundPosition_local_var_keywordsY = [
	"center",
	...backgroundPosition_local_var_keyY,
];
const backgroundPosition_local_var_keywords = [
	"center",
	...backgroundPosition_local_var_keyX,
	...backgroundPosition_local_var_keyY,
];
backgroundPosition_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			backgroundPosition_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
		...
		if (Array.isArray(value) && value.length) {
			...
			switch (value.length) {
				case 1: {
					...
					const val1 =
						part1.type === "Identifier"
							? part1.name
							: external_dependency_parsers_0.parseLengthPercentage([part1]);
					if (val1) {
						if (val1 === "center") {
				...
				case 2: {
					...
					const val2 =
						part2.type === "Identifier"
							? part2.name
							: external_dependency_parsers_0.parseLengthPercentage([part2]);
					if (val1 && val2) {
						if (
							backgroundPosition_local_var_keywordsX.includes(val1) &&
							backgroundPosition_local_var_keywordsY.includes(val2)
						) {
							parsedValue = `${val1} ${val2}`;
						} else if (
							backgroundPosition_local_var_keywordsY.includes(val1) &&
							backgroundPosition_local_var_keywordsX.includes(val2)
						) {
				...
				case 3: {
					...
					const val3 =
						part3.type === "Identifier"
							? part3.name
							: external_dependency_parsers_0.parseLengthPercentage([part3]);
					if (val1 && val2 && val3) {
						let posX = "";
						let offX = "";
						let posY = "";
				...
				case 4: {
					...
					const val1 = part1.type === "Identifier" && part1.name;
					const val2 = external_dependency_parsers_0.parseLengthPercentage([
						part2,
					]);
					const val3 = part3.type === "Identifier" && part3.name;
					const val4 = external_dependency_parsers_0.parseLengthPercentage([
						part4,
					]);
					if (val1 && val2 && val3 && val4) {
						...
						if (
							backgroundPosition_local_var_keywordsX.includes(val1) &&
							backgroundPosition_local_var_keyY.includes(val3)
						) {
							posX = val1;
							offX = val2;
							posY = val3;
							...
							backgroundPosition_local_var_keyX.includes(val1) &&
							backgroundPosition_local_var_keywordsY.includes(val3)
						) {
							posX = val1;
							offX = val2;
							posY = val3;
							...
							backgroundPosition_local_var_keyY.includes(val1) &&
							backgroundPosition_local_var_keywordsX.includes(val3)
						) {
							posX = val3;
							offX = val4;
							posY = val1;
...
backgroundPosition_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundPosition_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundPosition_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
backgroundSize_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			backgroundSize_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
		...
		if (Array.isArray(value) && value.length) {
			if (value.length === 1) {
				...
				switch (type) {
					...
					default: {
						const parsedValue =
							external_dependency_parsers_0.parseLengthPercentage(value);
						if (!parsedValue) {
							return;
						}
						parsedValues.push(parsedValue);
...
backgroundSize_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundSize_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundSize_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
backgroundRepeat_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundRepeat_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundRepeat_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
backgroundOrigin_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			backgroundOrigin_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
backgroundOrigin_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundOrigin_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundOrigin_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
backgroundClip_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			backgroundClip_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
backgroundClip_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundClip_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundClip_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
backgroundAttachment_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			backgroundAttachment_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
backgroundAttachment_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundAttachment_local_var_shorthand,
				);
				const prior =
					this._priorities.get(backgroundAttachment_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
				this._setProperty(
					backgroundAttachment_local_var_property,
					val,
...
backgroundColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		backgroundColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
backgroundColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					backgroundColor_local_var_shorthand,
				);
				const prior =
...
var background_export_shorthandFor,
	background_export_parse,
	background_export_definition;
const background_local_var_property = "background";
const background_local_var_initialValues = new Map([
...
background_export_parse = function parse(v, opt = {}) {
	...
	if (
		!external_dependency_parsers_0.isValidPropertyValue(
			background_local_var_property,
			v,
		)
	) {
		return;
	...
	for (let i = 0; i < l; i++) {
		let bg = {
			"background-image":
				background_local_var_initialValues.get("background-image"),
			"background-position": background_local_var_initialValues.get(
				"background-position",
			),
			"background-size":
				background_local_var_initialValues.get("background-size"),
			"background-repeat":
				background_local_var_initialValues.get("background-repeat"),
			"background-origin":
				background_local_var_initialValues.get("background-origin"),
			"background-clip":
				background_local_var_initialValues.get("background-clip"),
			"background-attachment": background_local_var_initialValues.get(
				"background-attachment",
			),
			"background-color":
				background_local_var_initialValues.get("background-color"),
		};
		if (l > 1 && i !== l - 1) {
			bg = {
				"background-image":
		...
		for (const part of parts1) {
			...
			for (const [longhand, value] of background_export_shorthandFor) {
				if (
					external_dependency_parsers_0.isValidPropertyValue(longhand, part)
				) {
					partValid = true;
					switch (longhand) {
		...
		if (bgPosition.length) {
			const { parse: parser } = background_export_shorthandFor.get(
				"background-position",
			);
...
background_export_definition = {
	set(v) {
		...
		if (v === "" || external_dependency_parsers_0.hasVarFunc(v)) {
			...
			const priority =
				this._priorities.get(background_local_var_property) ?? "";
	...
	get() {
		...
		for (const [longhand] of background_export_shorthandFor) {
			...
			if (longhand === "background-image") {
				...
				if (
					val !== background_local_var_initialValues.get(longhand) ||
					v.includes(val)
				) {
				...
				bgMap.set(
					longhand,
					external_dependency_parsers_0.splitValue(val, {
						delimiter: ",",
					}),
				);
			}
				...
				switch (longhand) {
					case "background-color": {
						if (i === l - 1) {
							...
							if (
								value &&
								value !== background_local_var_initialValues.get(longhand)
							) {
...
borderTopWidth_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderTopWidth_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderTopWidth_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderTopWidth_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderTopWidth_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderTopWidth_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderTopWidth_local_var_property) ?? "";
				if (
...
borderRightWidth_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderRightWidth_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderRightWidth_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderRightWidth_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderRightWidth_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderRightWidth_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderRightWidth_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderBottomWidth_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderBottomWidth_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderBottomWidth_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderBottomWidth_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderBottomWidth_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderLeftWidth_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderLeftWidth_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderLeftWidth_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderLeftWidth_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderLeftWidth_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderLeftWidth_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderLeftWidth_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
var borderWidth_export_shorthandFor,
	borderWidth_export_parse,
...
borderWidth_export_parse = function parse(v, opt = {}) {
	...
	const values = external_dependency_parsers_0.parsePropertyValue(
	...
	if (Array.isArray(values) && values.length) {
		...
		for (const value of values) {
			...
			switch (type) {
				...
				default: {
					const parsedValue = external_dependency_parsers_0.parseLength(
						[value],
						{
							min: 0,
						},
	...
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (Array.isArray(val) || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderWidth_local_var_shorthand,
				);
				const prior =
					this._priorities.get(borderWidth_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
borderTopStyle_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderTopStyle_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderTopStyle_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderTopStyle_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderTopStyle_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderTopStyle_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderTopStyle_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderRightStyle_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderRightStyle_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderRightStyle_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderRightStyle_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderRightStyle_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderRightStyle_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderRightStyle_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderBottomStyle_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderBottomStyle_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderBottomStyle_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderBottomStyle_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderBottomStyle_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderBottomStyle_local_var_positionShorthand,
				);
				let priority =
...
borderLeftStyle_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderLeftStyle_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderLeftStyle_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderLeftStyle_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderLeftStyle_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
var borderStyle_export_shorthandFor,
	borderStyle_export_parse,
...
borderStyle_export_parse = function parse(v, opt = {}) {
	...
	const values = external_dependency_parsers_0.parsePropertyValue(
		borderStyle_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderStyle_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (Array.isArray(val) || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderStyle_local_var_shorthand,
				);
				const prior =
					this._priorities.get(borderStyle_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
borderTopColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderTopColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderTopColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderTopColor_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderTopColor_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderTopColor_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderTopColor_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderRightColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderRightColor_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderRightColor_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderRightColor_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderRightColor_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderBottomColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderBottomColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderBottomColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderBottomColor_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderBottomColor_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderBottomColor_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderBottomColor_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderLeftColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderLeftColor_local_var_shorthand,
				);
				const linePriority = this._priorities.get(
					borderLeftColor_local_var_lineShorthand,
				);
				const positionPriority = this._priorities.get(
					borderLeftColor_local_var_positionShorthand,
				);
				let priority =
					this._priorities.get(borderLeftColor_local_var_property) ?? "";
				if (
					(shorthandPriority || linePriority || positionPriority) &&
					priority
				) {
...
borderColor_export_parse = function parse(v, opt = {}) {
	...
	const values = external_dependency_parsers_0.parsePropertyValue(
		borderColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (Array.isArray(val) || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderColor_local_var_shorthand,
				);
				const prior =
					this._priorities.get(borderColor_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
var borderTop_export_initialValues,
	borderTop_export_shorthandFor,
	borderTop_export_parse,
...
var borderRight_export_initialValues,
...
borderRight_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			borderRight_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
borderRight_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (val || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderRight_local_var_shorthand,
				);
				const prior =
					this._priorities.get(borderRight_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
var borderBottom_export_initialValues,
	borderBottom_export_shorthandFor,
	borderBottom_export_parse,
...
borderBottom_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			borderBottom_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
borderBottom_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (val || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderBottom_local_var_shorthand,
				);
				const prior =
					this._priorities.get(borderBottom_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
var borderLeft_export_initialValues,
	borderLeft_export_shorthandFor,
	borderLeft_export_parse,
...
borderLeft_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (val || typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					borderLeft_local_var_shorthand,
				);
...
var border_export_initialValues,
	border_export_shorthandFor,
	border_export_positionShorthandFor,
	border_export_parse,
...
borderCollapse_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderCollapse_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderCollapse_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(borderCollapse_local_var_property) ?? "";
...
borderSpacing_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		borderSpacing_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
borderSpacing_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(borderSpacing_local_var_property) ?? "";
		...
		switch (type) {
			case "Function": {
				...
				for (const item of values) {
					const parsedValue = external_dependency_parsers_0.parseCSS(
						item,
						{
							context: "value",
						},
					...
					const val = external_dependency_parsers_0.parseLengthPercentage(
...
flexShrink_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					flexShrink_local_var_shorthand,
				);
...
var flex_export_initialValues,
	flex_export_shorthandFor,
	flex_export_parse,
...
floodColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(floodColor_local_var_property) ?? "";
...
fontVariant_export_parse = function parse(v, opt = {}) {
	...
	for (const val of values) {
		const value = external_dependency_parsers_0.parsePropertyValue(
			fontVariant_local_var_property,
			val,
			{
				globalObject,
				inArray: true,
...
fontVariant_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					fontVariant_local_var_shorthand,
				);
				const prior =
					this._priorities.get(fontVariant_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
...
fontWeight_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					fontWeight_local_var_shorthand,
				);
...
lineHeight_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					lineHeight_local_var_shorthand,
				);
...
fontFamily_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					fontFamily_local_var_shorthand,
				);
...
font_export_parse = function parse(v, opt = {}) {
	...
	const [fontBlockA, fontBlockB] = external_dependency_parsers_0.splitValue(
		fontBlock,
		{
			delimiter: "/",
		},
	...
	if (fontBlockB) {
		...
		const revParts = external_dependency_parsers_0
			.splitValue(fontBlockA.trim())
			.toReversed();
...
lightingColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		lightingColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
lightingColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(lightingColor_local_var_property) ?? "";
...
var marginTop_export_position,
	marginTop_export_parse,
...
var marginRight_export_position,
	marginRight_export_parse,
...
marginRight_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					marginRight_local_var_shorthand,
				);
				const prior =
...
var marginBottom_export_position,
	marginBottom_export_parse,
...
marginBottom_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					marginBottom_local_var_shorthand,
				);
				const prior =
					this._priorities.get(marginBottom_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
				this._positionLonghandSetter(
					marginBottom_local_var_property,
					val,
...
var marginLeft_export_position,
...
marginLeft_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					marginLeft_local_var_shorthand,
				);
...
var margin_export_position,
	margin_export_shorthandFor,
	margin_export_parse,
...
outlineColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		outlineColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
outlineColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(outlineColor_local_var_property) ?? "";
...
var paddingTop_export_position,
	paddingTop_export_parse,
...
paddingTop_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					paddingTop_local_var_shorthand,
				);
...
var paddingRight_export_position,
	paddingRight_export_parse,
...
paddingRight_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					paddingRight_local_var_shorthand,
				);
				const prior =
					this._priorities.get(paddingRight_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
				this._positionLonghandSetter(
					paddingRight_local_var_property,
					val,
...
var paddingBottom_export_position,
	paddingBottom_export_parse,
...
paddingBottom_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					paddingBottom_local_var_shorthand,
				);
				const prior =
					this._priorities.get(paddingBottom_local_var_property) ?? "";
				const priority = shorthandPriority && prior ? "" : prior;
				this._positionLonghandSetter(
					paddingBottom_local_var_property,
					val,
...
var paddingLeft_export_position,
	paddingLeft_export_parse,
...
paddingLeft_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const shorthandPriority = this._priorities.get(
					paddingLeft_local_var_shorthand,
				);
				const prior =
...
var padding_export_position,
	padding_export_shorthandFor,
	padding_export_parse,
...
stopColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(stopColor_local_var_property) ?? "";
...
var webkitBorderAfterColor_export_parse,
...
webkitBorderAfterColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitBorderAfterColor_local_var_property) ?? "";
				this._setProperty(
					webkitBorderAfterColor_local_var_property,
					val,
					priority,
...
var webkitBorderBeforeColor_export_parse,
	webkitBorderBeforeColor_export_definition;
const webkitBorderBeforeColor_local_var_property =
...
webkitBorderBeforeColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitBorderBeforeColor_local_var_property) ??
					"";
				this._setProperty(
					webkitBorderBeforeColor_local_var_property,
					val,
...
webkitBorderEndColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		webkitBorderEndColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
webkitBorderEndColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitBorderEndColor_local_var_property) ?? "";
				this._setProperty(
					webkitBorderEndColor_local_var_property,
					val,
					priority,
...
var webkitBorderStartColor_export_parse,
...
webkitBorderStartColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitBorderStartColor_local_var_property) ?? "";
				this._setProperty(
					webkitBorderStartColor_local_var_property,
					val,
					priority,
...
webkitColumnRuleColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		webkitColumnRuleColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
webkitColumnRuleColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitColumnRuleColor_local_var_property) ?? "";
				this._setProperty(
					webkitColumnRuleColor_local_var_property,
					val,
					priority,
...
var webkitTapHighlightColor_export_parse,
	webkitTapHighlightColor_export_definition;
const webkitTapHighlightColor_local_var_property =
...
webkitTapHighlightColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitTapHighlightColor_local_var_property) ??
					"";
				this._setProperty(
					webkitTapHighlightColor_local_var_property,
					val,
...
var webkitTextEmphasisColor_export_parse,
	webkitTextEmphasisColor_export_definition;
const webkitTextEmphasisColor_local_var_property =
...
webkitTextEmphasisColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitTextEmphasisColor_local_var_property) ??
					"";
				this._setProperty(
					webkitTextEmphasisColor_local_var_property,
					val,
...
webkitTextFillColor_export_parse = function parse(v, opt = {}) {
	...
	const value = external_dependency_parsers_0.parsePropertyValue(
		webkitTextFillColor_local_var_property,
		v,
		{
			globalObject,
			inArray: true,
...
webkitTextFillColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitTextFillColor_local_var_property) ?? "";
				this._setProperty(
					webkitTextFillColor_local_var_property,
					val,
					priority,
...
webkitTextStrokeColor_export_definition = {
	set(v) {
		...
		if (external_dependency_parsers_0.hasVarFunc(v)) {
			...
			if (typeof val === "string") {
				const priority =
					this._priorities.get(webkitTextStrokeColor_local_var_property) ?? "";
				this._setProperty(
					webkitTextStrokeColor_local_var_property,
					val,
					priority,
