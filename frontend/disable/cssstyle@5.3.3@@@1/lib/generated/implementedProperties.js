...
module.exports = new Map([
	["-webkit-border-after-color", null],
	["-webkit-border-before-color", null],
	["-webkit-border-end-color", null],
	["-webkit-border-start-color", null],
	["-webkit-column-rule-color", null],
	["-webkit-tap-highlight-color", null],
	["-webkit-text-emphasis-color", null],
	[
	...
	[
		"background-attachment",
		{
			...
			styleDeclaration: ["background-attachment", "backgroundAttachment"],
		},
	],
	[
		"background-clip",
		...
		"font-size",
		{
			...
			values: [
				...
				},
				{
					name: "<length-percentage [0,∞]>",
					prose:
						"A length value specifies an absolute font size (independent of the user agent’s font table). Negative lengths are invalid. A percentage value specifies an absolute font size relative to the parent element’s computed font-size. Negative percentages are invalid.",
