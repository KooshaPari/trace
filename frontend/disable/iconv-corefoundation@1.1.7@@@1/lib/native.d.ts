...
export declare type BufferLike =
	| Buffer
	| Uint8Array
	| DataView
	| ArrayBufferLike;
 ...
 */
export declare function encodeSmallest(
	text: string,
	options?: SelectAndEncodeOptions & {
		isEncodingOk?: never;
	},
): TextAndEncoding;
/**
...
export declare function transcode(
	text: BufferLike,
	fromEncoding: StringEncoding | string,
	toEncoding: StringEncoding | string,
 ...
 * @returns The encoded text and chosen encoding.
 */
export declare function transcodeSmallest(
	text: BufferLike,
	fromEncoding: StringEncoding | string,
	options?: DecodeOptions &
		SelectAndEncodeOptions & {
			isEncodingOk?: never;
		},
): TextAndEncoding;
/**
