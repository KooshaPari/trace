...
var create_cache_key_function_1 = __importDefault(
...
function createTransformer(swcTransformOpts) {
	...
	var cacheKeyFunction = (0, create_cache_key_function_1.default)(
		[],
		[
			core_1.version,
	...
	var _c =
			(_b =
				(_a =
					swcTransformOpts === null || swcTransformOpts === void 0
						? void 0
						: swcTransformOpts.experimental) === null || _a === void 0
					? void 0
					: _a.customCoverageInstrumentation) !== null && _b !== void 0
				? _b
				: {},
		canInstrument = _c.enabled,
		instrumentOptions = __rest(_c, ["enabled"]);
	return {
		...
		process: (src, filename, jestOptions) => {
			...
			var swcOptionsForProcess = insertInstrumentationOptions(
				jestOptions,
				!!canInstrument,
				computedSwcOptions,
				instrumentOptions,
			);
			return (0, core_1.transformSync)(
				src,
				__assign(__assign({}, swcOptionsForProcess), {
					module: __assign(__assign({}, swcOptionsForProcess.module), {
		...
		getCacheKey: function (src, filename) {
			...
			var baseCacheKey = cacheKeyFunction.apply(
				void 0,
				__spreadArray([src, filename], rest, false),
			);
...
function getOptionsFromSwrc() {
	...
	if (fs.existsSync(swcrc)) {
		var errors = [];
		var options = (0, jsonc_parser_1.parse)(
			fs.readFileSync(swcrc, "utf-8"),
			errors,
		);
		if (errors.length > 0) {
			throw new Error(
				"Error parsing ".concat(swcrc, ": ").concat(errors.join(", ")),
			);
		}
		return options;
	}
...
function buildSwcTransformOpts(swcOptions) {
	...
	var _c =
			swcOptions && Object.keys(swcOptions).length > 0
				? swcOptions
				: getOptionsFromSwrc(),
		experimental = _c.experimental,
		computedSwcOptions = __rest(_c, ["experimental"]);
	if (
		!computedSwcOptions.env &&
		!((_a = computedSwcOptions.jsc) === null || _a === void 0
			? void 0
			: _a.target)
	) {
	...
	if (
		(_b = computedSwcOptions.jsc) === null || _b === void 0
			? void 0
			: _b.baseUrl
	) {
		set(
		...
		(_c =
			(_b =
				(_a =
					swcTransformOpts === null || swcTransformOpts === void 0
						? void 0
						: swcTransformOpts.jsc) === null || _a === void 0
					? void 0
					: _a.experimental) === null || _b === void 0
				? void 0
				: _b.plugins) === null || _c === void 0
			? void 0
			: _c.some((x) => x[0] === "swc-plugin-coverage-instrument")
	) {
		return swcTransformOpts;
	}
	return __assign(__assign({}, swcTransformOpts), {
		jsc: __assign(
			__assign(
				{},
				(_d =
					swcTransformOpts === null || swcTransformOpts === void 0
						? void 0
						: swcTransformOpts.jsc) !== null && _d !== void 0
					? _d
					: {},
			),
			{
				experimental: __assign(
					__assign(
						{},
						(_f =
							(_e =
								swcTransformOpts === null || swcTransformOpts === void 0
									? void 0
									: swcTransformOpts.jsc) === null || _e === void 0
								? void 0
								: _e.experimental) !== null && _f !== void 0
							? _f
							: {},
					),
					{
						plugins: __spreadArray(
								...
								(_j =
									(_h =
										(_g =
											swcTransformOpts === null || swcTransformOpts === void 0
												? void 0
												: swcTransformOpts.jsc) === null || _g === void 0
											? void 0
											: _g.experimental) === null || _h === void 0
										? void 0
										: _h.plugins) !== null && _j !== void 0
									? _j
									: [],
								true,
							),
							[
								[
									...
									instrumentOptions !== null && instrumentOptions !== void 0
										? instrumentOptions
										: {},
								],
							],
