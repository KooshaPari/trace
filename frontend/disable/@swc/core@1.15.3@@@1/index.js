...
exports.DEFAULT_EXTENSIONS =
	...
	exports.parseSync =
	exports.parse =
	exports.experimental_analyze =
	exports.Compiler =
	exports.plugins =
	exports.version =
	exports.experimental_newMangleNameCache =
		void 0;
const path_1 = require("path");
// @ts-expect-error
var binding_1 = require("./binding");
Object.defineProperty(exports, "experimental_newMangleNameCache", {
	enumerable: true,
	get: () => binding_1.newMangleNameCache,
});
...
class Compiler {
		...
		return __awaiter(this, void 0, void 0, function* () {
			if (bindings) {
				return bindings.minify(
					Buffer.from(
						!Buffer.isBuffer(src) && typeof src === "object"
							? JSON.stringify(src)
							: src,
					),
	...
	transform(src, options) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			options = options || {};
			if (
				(_a = options === null || options === void 0 ? void 0 : options.jsc) ===
					null || _a === void 0
					? void 0
					: _a.parser
			) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (plugin) {
				const m = yield this.parseFile(
					path,
					(_c =
						options === null || options === void 0 ? void 0 : options.jsc) ===
						null || _c === void 0
						? void 0
						: _c.parser,
				);
	...
	transformFileSync(path, options) {
		...
		if (plugin) {
			const m = this.parseFileSync(
				path,
				(_c = options === null || options === void 0 ? void 0 : options.jsc) ===
					null || _c === void 0
					? void 0
					: _c.parser,
			);
