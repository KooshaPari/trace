...
interface CommandBuilderState {
	...
	stdin:
		| "inherit"
		| "null"
		| Box<Reader | dntShim.ReadableStream<Uint8Array> | "consumed">
		| Deferred<dntShim.ReadableStream<Uint8Array> | Reader>;
...
export declare class CommandBuilder implements PromiseLike<CommandResult> {
	...
	stdout(
		kind: dntShim.WritableStream<Uint8Array>,
		options?: dntShim.PipeOptions,
	): CommandBuilder;
	/** Set the stderr kind. */
	...
	[setCommandTextStateSymbol](
		textState: CommandBuilderStateCommand,
	): CommandBuilder;
}
...
export declare function parseAndSpawnCommand(
...
export declare function getSignalAbortCode(
	signal: dntShim.Deno.Signal,
): number | undefined;
export declare function template(
	strings: TemplateStringsArray,
	exprs: any[],
): CommandBuilderStateCommand;
export declare function templateRaw(
	strings: TemplateStringsArray,
	exprs: any[],
): CommandBuilderStateCommand;
