...
export declare function createPath(
	path: string | URL | ImportMeta | Path,
): Path;
...
export interface SymlinkOptions
	extends Partial<dntShim.Deno.SymlinkOptions>,
		Partial<PathSymlinkOptions> {}
/**
...
export declare class Path {
	...
	createSymlinkTo(
		targetPath: URL | Path,
		opts: Partial<dntShim.Deno.SymlinkOptions> & PathSymlinkOptions,
	): Promise<void>;
	/**
	...
	readMaybeBytes(
		options?: dntShim.Deno.ReadFileOptions,
	...
	append(
		data: Uint8Array,
		options?: Omit<dntShim.Deno.WriteFileOptions, "append">,
	): Promise<this>;
	...
	pipeTo(
		dest: dntShim.WritableStream<Uint8Array>,
