...
export declare function delayToIterator(
	delay: Delay | DelayIterator,
): DelayIterator;
export declare function delayToMs(delay: Delay): number;
export declare function filterEmptyRecordValues<TValue>(
...
export declare function safeLstat(
	path: string,
): Promise<dntShim.Deno.FileInfo | undefined>;
export declare function getFileNameFromUrl(
	url: string | URL,
): string | undefined;
/**
 ...
 */
export declare function getExecutableShebangFromPath(
	path: string,
): Promise<false | ShebangInfo | undefined>;
export interface ShebangInfo {
	stringSplit: boolean;
	command: string;
}
export declare function getExecutableShebang(
	reader: Reader,
