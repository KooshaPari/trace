...
import { Deno, Deno as Deno2 } from "@deno/shim-deno";
...
// npm/esm/deps/deno.land/std@0.213.0/fmt/colors.js
var colors_exports = {};
...
// npm/esm/deps/deno.land/std@0.213.0/fs/mod.js
var mod_exports = {};
__export(mod_exports, {
	CRLF: () => CRLF,
	EOL: () => EOL,
	LF: () => LF,
	SubdirectoryMoveError: () => SubdirectoryMoveError,
	WalkError: () => WalkError,
	copy: () => copy,
	copySync: () => copySync,
	detect: () => detect,
...
// npm/esm/deps/deno.land/std@0.213.0/path/_os.js
var osType = (() => {
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/assert_path.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/normalize.js
function assertArg(path) {
	assertPath(path);
	if (path.length === 0) return ".";
}

// npm/esm/deps/deno.land/std@0.213.0/path/_common/constants.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/normalize_string.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/_util.js
function isPosixPathSeparator(code2) {
	return code2 === CHAR_FORWARD_SLASH;
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/normalize.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/join.js
function join(...paths) {
...
// npm/esm/deps/deno.land/std@0.213.0/assert/assertion_error.js
...
// npm/esm/deps/deno.land/std@0.213.0/assert/assert.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/_util.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/normalize.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/join.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/join.js
function join3(...paths) {
	return isWindows ? join2(...paths) : join(...paths);
}

// npm/esm/deps/deno.land/std@0.213.0/path/_common/from_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/from_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/from_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/from_file_url.js
function fromFileUrl3(url) {
	return isWindows ? fromFileUrl2(url) : fromFileUrl(url);
}

// npm/esm/deps/deno.land/std@0.213.0/fs/_to_path_string.js
function toPathString(pathUrl) {
	return pathUrl instanceof URL ? fromFileUrl3(pathUrl) : pathUrl;
}

// npm/esm/deps/deno.land/std@0.213.0/fs/empty_dir.js
...
// npm/esm/deps/deno.land/std@0.213.0/fs/_get_file_info_type.js
...
// npm/esm/deps/deno.land/std@0.213.0/fs/ensure_dir.js
async function ensureDir(dir) {
	try {
		const fileInfo = await Deno2.lstat(dir);
...
function ensureDirSync(dir) {
	try {
		const fileInfo = Deno2.lstatSync(dir);
		if (!fileInfo.isDirectory) {
			throw new Error(
				`Ensure path exists, expected 'dir', got '${getFileInfoType(fileInfo)}'`,
			);
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/dirname.js
function assertArg3(path) {
	assertPath(path);
	if (path.length === 0) return ".";
}

// npm/esm/deps/deno.land/std@0.213.0/path/_common/strip_trailing_separators.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/dirname.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/dirname.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/dirname.js
function dirname3(path) {
	return isWindows ? dirname2(path) : dirname(path);
}

// npm/esm/deps/deno.land/std@0.213.0/fs/ensure_file.js
...
// npm/esm/deps/deno.land/std@0.213.0/fs/ensure_link.js
async function ensureLink(src, dest) {
	dest = toPathString(dest);
	await ensureDir(dirname3(dest));
	await Deno2.link(toPathString(src), dest);
}
function ensureLinkSync(src, dest) {
	dest = toPathString(dest);
	ensureDirSync(dirname3(dest));
	Deno2.linkSync(toPathString(src), dest);
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/resolve.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/resolve.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/resolve.js
function resolve3(...pathSegments) {
	return isWindows ? resolve2(...pathSegments) : resolve(...pathSegments);
}

// npm/esm/deps/deno.land/std@0.213.0/fs/ensure_symlink.js
...
async function ensureSymlink(target, linkName) {
	...
	const srcStatInfo = await Deno2.lstat(targetRealPath);
	...
	const options = isWindows2
		...
		: void 0;
	try {
		await Deno2.symlink(target, linkName, options);
	} catch (error) {
		if (!(error instanceof Deno2.errors.AlreadyExists)) {
			throw error;
		}
	}
}
function ensureSymlinkSync(target, linkName) {
	const targetRealPath = resolveSymlinkTarget(target, linkName);
	const srcStatInfo = Deno2.lstatSync(targetRealPath);
	const srcFilePathType = getFileInfoType(srcStatInfo);
	...
	const options = isWindows2
		...
		: void 0;
	try {
		Deno2.symlinkSync(target, linkName, options);
	} catch (error) {
		if (!(error instanceof Deno2.errors.AlreadyExists)) {
			throw error;
		}
...
// npm/esm/deps/deno.land/std@0.213.0/fs/exists.js
async function exists(path, options) {
	try {
		...
		if (error instanceof Deno2.errors.PermissionDenied) {
			if (
				(await Deno2.permissions.query({ name: "read", path })).state ===
				"granted"
			) {
...
function existsSync(path, options) {
	try {
		...
		if (error instanceof Deno2.errors.PermissionDenied) {
			if (
				Deno2.permissions.querySync({ name: "read", path }).state === "granted"
			) {
				return !options?.isReadable;
			}
		}
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/glob_to_reg_exp.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/glob_to_regexp.js
var constants = {
	sep: "/+",
	sepMaybe: "/*",
	seps: ["/"],
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/glob_to_regexp.js
var constants2 = {
	sep: "(?:\\\\|/)+",
	sepMaybe: "(?:\\\\|/)*",
	seps: ["\\", "/"],
...
// npm/esm/deps/deno.land/std@0.213.0/path/glob_to_regexp.js
function globToRegExp3(glob, options = {}) {
	return options.os === "windows" || (!options.os && isWindows)
		? globToRegExp2(glob, options)
		: globToRegExp(glob, options);
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/constants.js
var DELIMITER = ":";
var SEPARATOR = "/";
var SEPARATOR_PATTERN = /\/+/;

// npm/esm/deps/deno.land/std@0.213.0/path/posix/normalize_glob.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/join_globs.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/constants.js
var DELIMITER2 = ";";
var SEPARATOR2 = "\\";
var SEPARATOR_PATTERN2 = /[\\/]+/;

// npm/esm/deps/deno.land/std@0.213.0/path/windows/normalize_glob.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/join_globs.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/join_globs.js
function joinGlobs3(globs, options = {}) {
	return isWindows ? joinGlobs2(globs, options) : joinGlobs(globs, options);
}

// npm/esm/deps/deno.land/std@0.213.0/path/is_glob.js
function isGlob(str) {
	const chars = { "{": "}", "(": ")", "[": "]" };
	const regex =
		/\\(.)|(^!|\*|\?|[\].+)]\?|\[[^\\\]]+\]|\{[^\\}]+\}|\(\?[:!=][^\\)]+\)|\([^|]+\|[^\\)]+\))/;
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/is_absolute.js
function isAbsolute(path) {
	assertPath(path);
	return path.length > 0 && isPosixPathSeparator(path.charCodeAt(0));
}

// npm/esm/deps/deno.land/std@0.213.0/path/windows/is_absolute.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/is_absolute.js
function isAbsolute3(path) {
	return isWindows ? isAbsolute2(path) : isAbsolute(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/constants.js
var DELIMITER3 = isWindows ? ";" : ":";
var SEPARATOR3 = isWindows ? "\\" : "/";
var SEPARATOR_PATTERN3 = isWindows ? /[\\/]+/ : /\/+/;

// npm/esm/deps/deno.land/std@0.213.0/path/normalize.js
function normalize3(path) {
	return isWindows ? normalize2(path) : normalize(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/_common/basename.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/basename.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/basename.js
...
// npm/esm/deps/deno.land/std@0.213.0/fs/walk.js
...
async function* walk(
	...
	try {
		for await (const entry of Deno2.readDir(root)) {
			...
			if (isSymlink) {
				...
				const realPath = await Deno2.realPath(path);
				if (canonicalize) {
					path = realPath;
				}
				({ isSymlink, isDirectory: isDirectory2 } =
					await Deno2.lstat(realPath));
			}
...
function* walkSync(
	...
	for (const entry of entries) {
		...
		if (isSymlink) {
			...
			const realPath = Deno2.realPathSync(path);
			if (canonicalize) {
				path = realPath;
			}
			({ isSymlink, isDirectory: isDirectory2 } = Deno2.lstatSync(realPath));
		}
		if (isSymlink || isDirectory2) {
			yield* walkSync(path, {
				maxDepth: maxDepth - 1,
...
// npm/esm/deps/deno.land/std@0.213.0/fs/expand_glob.js
var isWindows3 = Deno2.build.os === "windows";
function split(path) {
	const s = SEPARATOR_PATTERN3.source;
	const segments = path
		.replace(new RegExp(`^${s}|${s}$`, "g"), "")
		.split(SEPARATOR_PATTERN3);
	const isAbsolute_ = isAbsolute3(path);
	return {
		segments,
		isAbsolute: isAbsolute_,
		hasTrailingSep: !!path.match(new RegExp(`${s}$`)),
		winRoot: isWindows3 && isAbsolute_ ? segments.shift() : void 0,
	};
}
...
async function* expandGlob(
	...
	root ??= isGlobAbsolute ? (winRoot ?? "/") : Deno2.cwd();
	...
	const excludePatterns = exclude
		.map(resolveFromRoot)
		.map((s) => globToRegExp3(s, globOptions));
...
// npm/esm/deps/deno.land/std@0.213.0/fs/_is_subdir.js
function isSubdir(src, dest, sep4 = SEPARATOR3) {
	if (src === dest) {
		return false;
	}
	src = toPathString(src);
	const srcArray = src.split(sep4);
	dest = toPathString(dest);
	const destArray = dest.split(sep4);
	return srcArray.every((current, i) => destArray[i] === current);
}

// npm/esm/deps/deno.land/std@0.213.0/fs/_is_same_path.js
...
// npm/esm/deps/deno.land/std@0.213.0/fs/move.js
var EXISTS_ERROR = new Deno2.errors.AlreadyExists("dest already exists.");
...
async function move(src, dest, { overwrite = false } = {}) {
	const srcStat = await Deno2.stat(src);
	...
	if (overwrite) {
		...
		try {
			await Deno2.remove(dest, { recursive: true });
		} catch (error) {
			if (!(error instanceof Deno2.errors.NotFound)) {
				throw error;
			}
		...
		try {
			await Deno2.lstat(dest);
			return Promise.reject(EXISTS_ERROR);
		} catch {}
	}
	await Deno2.rename(src, dest);
}
function moveSync(src, dest, { overwrite = false } = {}) {
	const srcStat = Deno2.statSync(src);
	if (srcStat.isDirectory && (isSubdir(src, dest) || isSamePath(src, dest))) {
		throw new SubdirectoryMoveError(src, dest);
	}
	if (overwrite) {
		if (isSamePath(src, dest)) return;
		try {
			Deno2.removeSync(dest, { recursive: true });
		} catch (error) {
			if (!(error instanceof Deno2.errors.NotFound)) {
				throw error;
			}
	...
	Deno2.renameSync(src, dest);
}

// npm/esm/deps/deno.land/std@0.213.0/fs/copy.js
var isWindows4 = Deno2.build.os === "windows";
...
// npm/esm/deps/deno.land/std@0.213.0/fs/eol.js
var LF = "\n";
var CRLF = "\r\n";
var EOL = Deno2?.build.os === "windows" ? CRLF : LF;
var regDetect = /(?:\r?\n)/g;
...
// npm/esm/deps/deno.land/std@0.213.0/bytes/copy.js
...
// npm/esm/deps/deno.land/std@0.213.0/io/buffer.js
...
// npm/esm/deps/deno.land/std@0.213.0/io/buf_reader.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/mod.js
var mod_exports4 = {};
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/mod.js
var mod_exports2 = {};
__export(mod_exports2, {
	DELIMITER: () => DELIMITER2,
	SEP: () => SEP,
	SEPARATOR: () => SEPARATOR2,
	SEPARATOR_PATTERN: () => SEPARATOR_PATTERN2,
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/extname.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/format.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/format.js
function format2(pathObject) {
	assertArg4(pathObject);
	return _format("\\", pathObject);
}

// npm/esm/deps/deno.land/std@0.213.0/path/windows/parse.js
function parse(path) {
	assertPath(path);
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/relative.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/relative.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/to_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/to_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/to_namespaced_path.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/_common/common.js
function _common(paths, sep4) {
...
// npm/esm/deps/deno.land/std@0.213.0/path/windows/common.js
function common(paths, sep4 = SEPARATOR2) {
	return _common(paths, sep4);
}

// npm/esm/deps/deno.land/std@0.213.0/path/windows/separator.js
var SEP = "\\";
var SEP_PATTERN = /[\\/]+/;
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/mod.js
var mod_exports3 = {};
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/extname.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/format.js
function format3(pathObject) {
	assertArg4(pathObject);
	return _format("/", pathObject);
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/parse.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/relative.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/to_file_url.js
...
// npm/esm/deps/deno.land/std@0.213.0/path/posix/to_namespaced_path.js
function toNamespacedPath2(path) {
	return path;
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/common.js
function common2(paths, sep4 = SEPARATOR) {
	return _common(paths, sep4);
}

// npm/esm/deps/deno.land/std@0.213.0/path/posix/separator.js
var SEP2 = "/";
var SEP_PATTERN2 = /\/+/;
...
// npm/esm/deps/deno.land/std@0.213.0/path/extname.js
function extname3(path) {
	return isWindows ? extname(path) : extname2(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/format.js
function format4(pathObject) {
	return isWindows ? format2(pathObject) : format3(pathObject);
}

// npm/esm/deps/deno.land/std@0.213.0/path/parse.js
function parse3(path) {
	return isWindows ? parse(path) : parse2(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/relative.js
function relative3(from, to) {
	return isWindows ? relative(from, to) : relative2(from, to);
}

// npm/esm/deps/deno.land/std@0.213.0/path/to_file_url.js
function toFileUrl3(path) {
	return isWindows ? toFileUrl(path) : toFileUrl2(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/to_namespaced_path.js
function toNamespacedPath3(path) {
	return isWindows ? toNamespacedPath(path) : toNamespacedPath2(path);
}

// npm/esm/deps/deno.land/std@0.213.0/path/common.js
function common3(paths, sep4 = SEPARATOR3) {
	return _common(paths, sep4);
}

// npm/esm/deps/deno.land/std@0.213.0/path/separator.js
var SEP3 = isWindows ? "\\" : "/";
var SEP_PATTERN3 = isWindows ? /[\\/]+/ : /\/+/;

// npm/esm/deps/deno.land/std@0.213.0/path/normalize_glob.js
function normalizeGlob3(glob, options = {}) {
	return isWindows
		? normalizeGlob2(glob, options)
		: normalizeGlob(glob, options);
}

// npm/esm/deps/deno.land/std@0.213.0/path/mod.js
var win32 = mod_exports2;
var posix = mod_exports3;
var sep3 = SEPARATOR3;
var delimiter3 = DELIMITER3;

// npm/esm/deps/deno.land/std@0.213.0/io/_constants.js
var DEFAULT_BUFFER_SIZE = 32 * 1024;

// npm/esm/deps/deno.land/std@0.213.0/io/write_all.js
...
// npm/esm/deps/deno.land/std@0.213.0/streams/reader_from_stream_reader.js
...
// npm/esm/deps/deno.land/x/which@0.3.0/mod.js
...
// npm/esm/deps/deno.land/std@0.213.0/streams/writer_from_stream_writer.js
...
function render(state) {
	return [
		colors_exports.bold(colors_exports.blue(state.title)) +
			" " +
			(state.hasCompleted
				? ""
				: state.default == null
...
function render2(state) {
	const items = [];
	items.push(colors_exports.bold(colors_exports.blue(state.title)));
	if (state.hasCompleted) {
		if (state.items.some((i) => i.selected)) {
			...
			items.push(colors_exports.italic(" <None>"));
		}
	} else {
...
function renderProgressBar(state, size) {
	if (state.hasCompleted) {
		...
		if (state.prefix != null) {
			text += colors_exports.green(state.prefix);
		}
		...
		let firstLine = "";
		if (state.prefix != null) {
			firstLine += colors_exports.green(state.prefix);
		}
		if (state.message != null) {
		...
		const lengthText =
			state.kind === "bytes"
				? humanDownloadSize(state.length, state.length)
		...
		if (completedBars != totalBars) {
			if (completedBars > 0) {
				secondLine += colors_exports.cyan("#".repeat(completedBars - 1) + ">");
			}
			secondLine += colors_exports.blue("-".repeat(totalBars - completedBars));
		} else {
			secondLine += colors_exports.cyan("#".repeat(completedBars));
		}
...
function resolvePath(cwd, arg) {
	return mod_exports4.resolve(
		mod_exports4.isAbsolute(arg) ? arg : mod_exports4.join(cwd, arg),
	);
}
var Box = class {
	value;
...
function printEnvCommand(context) {
	...
	try {
		...
		if (maybePromise instanceof Promise) {
			return maybePromise
				.then(() => ({ code: code2 }))
				.catch((err) => handleError2(context, err));
		} else {
			return { code: code2 };
		}
	} catch (_err) {
...
function executePrintEnv(env, args) {
	const isWindows5 = Deno2.build.os === "windows";
	if (args.length === 0) {
		return Object.entries(env)
			.map(([key, val]) => `${isWindows5 ? key.toUpperCase() : key}=${val}`)
			.join("\n");
	} else {
		if (isWindows5) {
...
async function copyDirRecursively(from, to) {
	...
	for await (const entry of readDir) {
		const newFrom = mod_exports4.join(from, mod_exports4.basename(entry.name));
		const newTo = mod_exports4.join(to, mod_exports4.basename(entry.name));
...
async function getCopyAndMoveOperations(cwd, paths) {
	...
	if (fromArgs.length > 1) {
		...
		for (const from of fromArgs) {
			...
			const toPath = mod_exports4.join(
				destination,
				mod_exports4.basename(fromPath),
			);
			operations.push({
				from: {
					specified: from,
...
function calculateDestinationPath(destination, from) {
	return mod_exports4.join(destination, mod_exports4.basename(from));
}
...
function pwdCommand(context) {
	try {
		...
		if (maybePromise instanceof Promise) {
			return maybePromise
				.then(() => result)
				.catch((err) => handleError3(context, err));
		} else {
			return result;
		}
	} catch (_err) {
...
function executePwd(cwd, args) {
	...
	if (flags.logical) {
		return mod_exports4.resolve(cwd);
	} else {
		return cwd;
	}
}
	...
	try {
		...
		switch (testFlag) {
			...
			case "-d":
				...
				break;
			case "-e":
				result = await mod_exports.exists(testPath);
				break;
			case "-s":
...
var Context = class _Context {
	...
	setEnvVar(key, value) {
		...
		if (key === "PWD") {
			if (value != null && mod_exports4.isAbsolute(value)) {
				this.#env.setCwd(mod_exports4.resolve(value));
			}
		} else {
...
async function resolveRedirectPipe(redirect, context) {
	function handleFileOpenError(outputPath, err) {
		return context.error(
			`failed opening file for redirect (${outputPath}). ${errorToString(err)}`,
		);
	}
	...
	if (ioFile.kind === "fd") {
		...
		switch (redirect.op.kind) {
			case "input": {
				const outputPath = mod_exports4.isAbsolute(words[0])
					? words[0]
					: mod_exports4.join(context.getCwd(), words[0]);
				try {
...
function checkMapCwdNotExistsError(cwd, err) {
	if (err.code === "ENOENT" && !mod_exports.existsSync(cwd)) {
		throw new Error(
...
async function executeCommandArgs(commandArgs, context) {
	...
	if (resolvedCommand.kind === "shebang") {
		return executeCommandArgs(
			[...resolvedCommand.args, resolvedCommand.path, ...commandArgs.slice(1)],
			context,
		);
	}
	...
	const stdinPromise = writeStdin(context.stdin, p, completeSignal).catch(
		async (err) => {
			...
			const maybePromise = context.stderr.writeLine(
				`stdin pipe broken. ${errorToString(err)}`,
			);
			...
			try {
				...
				if (
					!(
						err2 instanceof Deno2.errors.PermissionDenied ||
						err2 instanceof Deno2.errors.NotFound
					)
				) {
					throw err2;
				}
...
async function resolveCommand(commandName, context) {
	if (commandName.includes("/") || commandName.includes("\\")) {
		if (!mod_exports4.isAbsolute(commandName)) {
			commandName = mod_exports4.resolve(context.getCwd(), commandName);
		}
...
var Path = class {
	...
	constructor(path) {
		if (path instanceof URL) {
			this.#path = mod_exports4.fromFileUrl(path);
			...
			this.#path = mod_exports4.fromFileUrl(path.url);
		}
	}
	/** @internal */
	...
	toFileUrl() {
		...
		return mod_exports4.toFileUrl(resolvedPath.toString());
	}
	...
	join(...pathSegments) {
		return new _a(mod_exports4.join(this.#path, ...pathSegments));
	}
	...
	resolve(...pathSegments) {
		...
		const resolvedPath = mod_exports4.resolve(this.#path, ...pathSegments);
	 ...
	 */
	normalize() {
		return new _a(mod_exports4.normalize(this.#path));
	}
	...
	isAbsolute() {
		return mod_exports4.isAbsolute(this.#path);
	}
	 ...
	 */
	dirname() {
		return mod_exports4.dirname(this.#path);
	}
	/** Gets the file or directory name of the path. */
	basename() {
		return mod_exports4.basename(this.#path);
	}
	...
	*#rcomponents() {
	 ...
	 */
	extname() {
		const extName = mod_exports4.extname(this.#path);
	...
	relative(to) {
		...
		return mod_exports4.relative(this.resolve().#path, toPath.resolve().#path);
	}
	...
	realPath() {
		return Deno2.realPath(this.#path).then((path) => new _a(path));
	}
	/** Synchronously resolves to the absolute normalized path, with symbolic links resolved. */
	realPathSync() {
		return new _a(Deno2.realPathSync(this.#path));
	}
	...
	*readDirFilePathsSync() {
	...
	/** Opens a file. */
	open(options) {
		return Deno2.open(this.#path, options).then((file) =>
	...
	copyFile(destinationPath) {
		...
		return Deno2.copyFile(this.#path, pathRef.#path).then(() => pathRef);
	}
	/**
	...
	copyFileSync(destinationPath) {
		const pathRef = ensurePath(destinationPath);
		Deno2.copyFileSync(this.#path, pathRef.#path);
		return pathRef;
	}
	/**
	...
	rename(newPath) {
		...
		return Deno2.rename(this.#path, pathRef.#path).then(() => pathRef);
	}
	/**
	...
	renameSync(newPath) {
		const pathRef = ensurePath(newPath);
		Deno2.renameSync(this.#path, pathRef.#path);
		return pathRef;
	}
	/**
...
async function createSymlink(opts) {
	...
	if (kind == null && Deno2.build.os === "windows") {
		...
		if (info?.isDirectory) {
			...
			throw new Deno2.errors.NotFound(
...
var RequestBuilder = class {
	...
	#getClonedState() {
		...
		return {
			...
			noThrow:
				typeof state.noThrow === "boolean" ? state.noThrow : [...state.noThrow],
			url: state.url,
			body: state.body,
			cache: state.cache,
...
async function makeRequest(state) {
	...
	const response = await fetch(state.url, {
		body: state.body,
		// @ts-expect-error not supported in Node.js yet?
		cache: state.cache,
	...
	function getTimeoutAbortController() {
		...
		const timeoutId = setTimeout(
			() =>
				controller.abort(
					new TimeoutError(`Request timed out after ${formatMillis(timeout)}.`),
				),
			timeout,
		);
		return {
...
var CommandBuilder = class {
	#state = {
		...
		printCommandLogger: new LoggerTreeBox(
			...
			(cmd) =>
				console.error(colors_exports.white(">"), colors_exports.blue(cmd)),
		),
		timeout: void 0,
		signal: void 0,
	};
		...
		return this.#newWithState((state) => {
			state.cwd =
				dirPath instanceof URL
					? mod_exports4.fromFileUrl(dirPath)
					: dirPath instanceof Path
						? dirPath.resolve().toString()
						: mod_exports4.resolve(dirPath);
		});
	}
	/**
...
function parseAndSpawnCommand(state) {
	...
	return new CommandChild(
		async (resolve4, reject) => {
			try {
				const list = parseCommand(commandText);
				const stdin = await takeStdin();
				let code2 = await spawn2(list, {
					stdin:
						stdin instanceof ReadableStream2
							? readerFromStreamReader(stdin.getReader())
							: stdin,
					stdout,
					stderr,
				...
				if (code2 !== 0) {
					...
					if (!noThrow) {
						...
						if (timedOut) {
							...
							throw new Error(
								`${timedOut ? "Timed out" : "Aborted"} with exit code: ${code2}`,
							);
						} else {
				...
				const result = new CommandResult(
					...
					combinedBuffer instanceof Buffer2 ? combinedBuffer : void 0,
				);
		...
		{
			pipedStdoutBuffer:
				stdoutBuffer instanceof PipedBuffer ? stdoutBuffer : void 0,
			pipedStderrBuffer:
				stderrBuffer instanceof PipedBuffer ? stderrBuffer : void 0,
			killSignalController,
		},
	);
	...
	function finalizeCommandResultBuffer(buffer) {
		if (
			buffer instanceof CapturingBufferWriterSync ||
...
function buildEnv(env) {
	const result = Deno2.env.toObject();
...
function build$FromState(state) {
	...
	const result = Object.assign(
		...
		logDepthObj,
		{
			...
			logLight(...data) {
				state.infoLogger.getValue()(colors_exports.gray(getLogText(data)));
			},
			logStep(firstArg, ...data) {
				logStep(
					firstArg,
					data,
					(t) => colors_exports.bold(colors_exports.green(t)),
			...
			logError(firstArg, ...data) {
				logStep(
					firstArg,
					data,
					(t) => colors_exports.bold(colors_exports.red(t)),
			...
			logWarn(firstArg, ...data) {
				logStep(
					firstArg,
					data,
					(t) => colors_exports.bold(colors_exports.yellow(t)),
			...
			setErrorLogger(logger2) {
				...
				commandBuilder.setPrintCommandLogger((cmd) =>
					logger2(colors_exports.white(">"), colors_exports.blue(cmd)),
				);
	...
	state.requestBuilder = state.requestBuilder[withProgressBarFactorySymbol](
