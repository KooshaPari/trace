...
export { FsFileWrapper, Path } from "./src/path.js";
...
/** Type of `$` instances. */
export type $Type<TExtras extends ExtrasObject = {}> = $Template &
	(string extends keyof TExtras
		? $BuiltInProperties<TExtras>
...
export interface $BuiltInProperties<TExtras extends ExtrasObject = {}> {
	...
	maybePrompt(
		message: string,
		options?: Omit<PromptOptions, "message">,
	...
	progress(
		message: string,
		options?: Omit<ProgressOptions, "message" | "prefix">,
	): ProgressBar;
	/** Shows a progress message when indeterminate or bar when determinate. */
 ...
 * ```
 */
export declare function build$<TExtras extends ExtrasObject = {}>(
