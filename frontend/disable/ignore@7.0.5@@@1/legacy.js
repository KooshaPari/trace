...
var TRAILING_WILD_CARD_REPLACERS =
	...
	_defineProperty(_TRAILING_WILD_CARD_R, MODE_IGNORE, (_, p1) => {
		var prefix = p1
			? // '\^':
	...
	_defineProperty(_TRAILING_WILD_CARD_R, MODE_CHECK_IGNORE, (_, p1) => {
...
var makeRegexPrefix = function makeRegexPrefix(pattern) {
	return REPLACERS.reduce((prev, _ref) => {
	...
	_createClass(IgnoreRule, [
		...
		},
		{
			...
			value: function _make(mode, key) {
				var str = this.regexPrefix.replace(
...
var Ignore = /*#__PURE__*/ (() => {
	function Ignore() {
		var _ref4 =
			...
			allowRelativePaths =
				_ref4$allowRelativePa === void 0 ? false : _ref4$allowRelativePa;
