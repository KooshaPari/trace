...
class SVGAnimatedStringImpl {
	constructor(globalObject, args, privateData) {
		...
		this._attributeDeprecatedNamespace =
			privateData.attributeDeprecatedNamespace;
	...
	get baseVal() {
		if (!this._element.hasAttributeNS(null, this._attribute)) {
			if (
				...
				this._element.hasAttributeNS(
					this._attributeDeprecatedNamespace,
					this._attributeDeprecated,
				)
			) {
	...
	set baseVal(base) {
		if (
			!this._element.hasAttributeNS(null, this._attribute) &&
			this._attributeDeprecated !== undefined &&
