...
exports.hasAttribute = (element, A) => element._attributeList.includes(A);

exports.hasAttributeByName = (element, name) =>
	element._attributesByNameMap.has(name);

exports.hasAttributeByNameNS = (element, namespace, localName) =>
	element._attributeList.some((attribute) => {
		return (
...
exports.replaceAttribute = (element, oldAttr, newAttr) => {
...
exports.getAttributeByName = (element, name) => {
...
exports.getAttributeByNameNS = (element, namespace, localName) => {
...
exports.getAttributeValue = (element, localName) => {
...
exports.getAttributeValueNS = (element, namespace, localName) => {
...
exports.setAttribute = (element, attr) => {
...
exports.setAttributeValue = (element, localName, value, prefix, namespace) => {
...
exports.removeAttributeByNameNS = (element, namespace, localName) => {
