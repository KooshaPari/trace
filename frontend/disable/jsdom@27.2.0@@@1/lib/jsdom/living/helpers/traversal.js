...
exports.childrenByLocalNames = (parent, localNamesSet, namespace = HTML_NS) => {
	return domSymbolTree.childrenToArray(parent, {
		filter(node) {
			return (
				localNamesSet.has(node._localName) && node._namespaceURI === namespace
			);
		},
	});
};

exports.descendantsByLocalNames = (
	parent,
	localNamesSet,
	namespace = HTML_NS,
) => {
...
exports.firstChildWithLocalNames = (
	parent,
	localNamesSet,
	namespace = HTML_NS,
) => {
...
exports.firstDescendantWithLocalName = (
	parent,
	localName,
	namespace = HTML_NS,
) => {
	...
	for (const descendant of iterator) {
		if (
			...
			descendant._namespaceURI === namespace
		) {
			return descendant;
		}
	}
