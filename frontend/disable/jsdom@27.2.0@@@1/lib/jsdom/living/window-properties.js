...
const nameAttributeElementLocalNames = new Set([
	"embed",
	"form",
	"img",
	"object",
...
exports.elementAttributeModified = (
	element,
	attributeName,
	value,
	oldValue,
...
exports.create = (eventTargetPrototype, window) => {
	...
	const windowPropertiesProxy = new Proxy(windowProperties, {
		...
		set(target, property, value, receiver) {
			...
			return idlUtils.ordinarySetWithOwnDescriptor(
				target,
				property,
				value,
				receiver,
		...
		setPrototypeOf() {
			throw new TypeError(
				"Immutable prototype object WindowProperties cannot have its prototype set.",
			);
		},
		preventExtensions() {
			return false;
