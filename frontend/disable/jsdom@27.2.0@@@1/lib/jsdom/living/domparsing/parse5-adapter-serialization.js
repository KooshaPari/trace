...
exports.getTextNodeContent = exports.getCommentNodeContent = (node) =>
	node.data;
...
exports.getTemplateContent = (templateElement) =>
...
exports.isDocumentTypeNode = (node) =>
	node.nodeType === nodeTypes.DOCUMENT_TYPE_NODE;
