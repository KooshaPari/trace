...
exports.install = (globalObject, globalNames) => {
	...
	class Selection {
		...
		getRangeAt(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'getRangeAt' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		addRange(range) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'addRange' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		removeRange(range) {
			...
			const args = [];
			{
				...
				curArg = Range.convert(globalObject, curArg, {
					context:
						"Failed to execute 'removeRange' on 'Selection': parameter 1",
				});
				args.push(curArg);
			}
		...
		empty() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'empty' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		collapse(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'collapse' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		setPosition(node) {
			...
			const args = [];
			{
				...
				if (curArg === null || curArg === undefined) {
					...
					curArg = Node.convert(globalObject, curArg, {
						context:
							"Failed to execute 'setPosition' on 'Selection': parameter 1",
					});
				}
				args.push(curArg);
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["unsigned long"](curArg, {
						context:
							"Failed to execute 'setPosition' on 'Selection': parameter 2",
						globals: globalObject,
					});
				} else {
					curArg = 0;
		...
		extend(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'extend' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		setBaseAndExtent(anchorNode, anchorOffset, focusNode, focusOffset) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'setBaseAndExtent' on 'Selection': parameter 1",
				});
				args.push(curArg);
			}
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'setBaseAndExtent' on 'Selection': parameter 2",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'setBaseAndExtent' on 'Selection': parameter 3",
				});
				args.push(curArg);
			}
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'setBaseAndExtent' on 'Selection': parameter 4",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		selectAllChildren(node) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'selectAllChildren' on 'Selection': parameter 1",
				});
				args.push(curArg);
			}
		...
		containsNode(node) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'containsNode' on 'Selection': parameter 1",
				});
				args.push(curArg);
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'containsNode' on 'Selection': parameter 2",
						globals: globalObject,
					});
				} else {
					curArg = false;
		...
		toString() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'toString' called on an object that is not a valid instance of Selection.",
				);
			}
		...
		get type() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get type' called on an object that is not a valid instance of Selection.",
				);
			}
