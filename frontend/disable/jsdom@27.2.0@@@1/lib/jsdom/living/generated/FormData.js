...
exports.install = (globalObject, globalNames) => {
	...
	class FormData {
		...
		append(name, value) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'append' called on an object that is not a valid instance of FormData.",
				);
			}
						...
						if (Blob.is(curArg)) {
							{
								...
								curArg = Blob.convert(globalObject, curArg, {
									context:
										"Failed to execute 'append' on 'FormData': parameter 2",
								});
								args.push(curArg);
							}
						} else {
				...
				default:
					...
					}
					{
						...
						if (curArg !== undefined) {
							curArg = conversions["USVString"](curArg, {
								context:
									"Failed to execute 'append' on 'FormData': parameter 3",
								globals: globalObject,
							});
						}
						args.push(curArg);
		...
		delete(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'delete' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		get(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		getAll(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'getAll' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		has(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'has' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		set(name, value) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		keys() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'keys' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		values() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'values' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		entries() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'entries' called on an object that is not a valid instance of FormData.",
				);
			}
		...
		forEach(callback) {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'forEach' called on an object that is not a valid instance of FormData.",
				);
			}
			if (arguments.length < 1) {
				throw new globalObject.TypeError(
	...
	ctorRegistry["FormData Iterator"] = Object.create(
	...
	utils.define(ctorRegistry["FormData Iterator"], {
		next() {
			...
			if (!internal) {
				throw new globalObject.TypeError(
					"next() called on a value that is not a FormData iterator object",
				);
			}
