...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLHRElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLHRElement extends globalObject.HTMLElement {
		...
		get color() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("color");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get noShade() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("noshade") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get size() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("size");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
