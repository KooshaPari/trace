	...
	class NamedNodeMap {
		...
		item(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'item' called on an object that is not a valid instance of NamedNodeMap.",
				);
			}
		...
		getNamedItemNS(namespace, localName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getNamedItemNS(...args),
			);
		}
		...
		setNamedItem(attr) {
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].setNamedItem(...args),
				);
			} finally {
		...
		setNamedItemNS(attr) {
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].setNamedItemNS(...args),
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		removeNamedItem(qualifiedName) {
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].removeNamedItem(...args),
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		removeNamedItemNS(namespace, localName) {
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].removeNamedItemNS(...args),
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
