...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLMarqueeElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLMarqueeElement extends globalObject.HTMLElement {
		...
		get behavior() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("behavior");
		...
		get direction() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("direction");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get scrollAmount() {
			...
			try {
				let value =
					esValue[implSymbol]._reflectGetTheContentAttribute("scrollamount");
				if (value !== null) {
					value = parseNonNegativeInteger_helpers_strings(value);
					if (value !== null && value >= 0 && value <= 2147483647) {
						return value;
		...
		get scrollDelay() {
			...
			try {
				let value =
					esValue[implSymbol]._reflectGetTheContentAttribute("scrolldelay");
				if (value !== null) {
					value = parseNonNegativeInteger_helpers_strings(value);
					if (value !== null && value >= 0 && value <= 2147483647) {
						return value;
		...
		get trueSpeed() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("truespeed") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
