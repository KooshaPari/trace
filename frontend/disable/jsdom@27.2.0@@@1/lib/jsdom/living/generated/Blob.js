	...
	class Blob {
						...
						for (let nextItem of tmp) {
							if (exports.is(nextItem)) {
								...
								nextItem = conversions["ArrayBuffer"](nextItem, {
									context:
										"Failed to construct 'Blob': parameter 1" + "'s element",
		...
		slice() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'slice' called on an object that is not a valid instance of Blob.",
				);
			}
			const args = [];
			{
		...
		get size() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get size' called on an object that is not a valid instance of Blob.",
				);
			}
		...
		get type() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get type' called on an object that is not a valid instance of Blob.",
				);
			}
