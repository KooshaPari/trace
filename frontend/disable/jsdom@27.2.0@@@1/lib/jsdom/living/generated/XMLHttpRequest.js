...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'XMLHttpRequest'.`,
	);
};
	...
	class XMLHttpRequest extends globalObject.XMLHttpRequestEventTarget {
		...
		open(method, url) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'open' called on an object that is not a valid instance of XMLHttpRequest.",
				);
			}
				...
				case 2:
					{
						...
						curArg = conversions["ByteString"](curArg, {
							context:
								"Failed to execute 'open' on 'XMLHttpRequest': parameter 1",
					...
					}
					{
						...
						curArg = conversions["USVString"](curArg, {
							context:
								"Failed to execute 'open' on 'XMLHttpRequest': parameter 2",
							globals: globalObject,
						});
						args.push(curArg);
					}
				...
				case 3:
					...
					}
					{
						...
						curArg = conversions["boolean"](curArg, {
							context:
								"Failed to execute 'open' on 'XMLHttpRequest': parameter 3",
							globals: globalObject,
						});
						args.push(curArg);
					}
					...
					}
					{
						...
						if (curArg !== undefined) {
							if (curArg === null || curArg === undefined) {
								...
								curArg = conversions["USVString"](curArg, {
									context:
										"Failed to execute 'open' on 'XMLHttpRequest': parameter 4",
									globals: globalObject,
								});
							}
						} else {
					...
					}
					{
						...
						if (curArg !== undefined) {
							if (curArg === null || curArg === undefined) {
								...
								curArg = conversions["USVString"](curArg, {
									context:
										"Failed to execute 'open' on 'XMLHttpRequest': parameter 5",
									globals: globalObject,
								});
							}
						} else {
		...
		setRequestHeader(name, value) {
			...
			const args = [];
			{
				...
				curArg = conversions["ByteString"](curArg, {
					context:
						"Failed to execute 'setRequestHeader' on 'XMLHttpRequest': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				curArg = conversions["ByteString"](curArg, {
					context:
						"Failed to execute 'setRequestHeader' on 'XMLHttpRequest': parameter 2",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		send() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'send' called on an object that is not a valid instance of XMLHttpRequest.",
				);
			}
			const args = [];
			{
					...
					if (curArg === null || curArg === undefined) {
						...
						if (Document.is(curArg) || Blob.is(curArg) || FormData.is(curArg)) {
							...
							curArg = conversions["ArrayBuffer"](curArg, {
								context:
									"Failed to execute 'send' on 'XMLHttpRequest': parameter 1",
								globals: globalObject,
							});
		...
		abort() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'abort' called on an object that is not a valid instance of XMLHttpRequest.",
				);
			}
		...
		getResponseHeader(name) {
			...
			const args = [];
			{
				...
				curArg = conversions["ByteString"](curArg, {
					context:
						"Failed to execute 'getResponseHeader' on 'XMLHttpRequest': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		overrideMimeType(mime) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'overrideMimeType' on 'XMLHttpRequest': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		set onreadystatechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onreadystatechange' property on 'XMLHttpRequest': The provided value",
				});
			}
		...
		set timeout(V) {
			...
			V = conversions["unsigned long"](V, {
				context:
					"Failed to set the 'timeout' property on 'XMLHttpRequest': The provided value",
				globals: globalObject,
			});
		...
		set withCredentials(V) {
			...
			V = conversions["boolean"](V, {
				context:
					"Failed to set the 'withCredentials' property on 'XMLHttpRequest': The provided value",
				globals: globalObject,
			});
