...
exports.install = (globalObject, globalNames) => {
	...
	class DOMTokenList {
		...
		item(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'item' called on an object that is not a valid instance of DOMTokenList.",
				);
			}
		...
		contains(token) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'contains' on 'DOMTokenList': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		add() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'add' called on an object that is not a valid instance of DOMTokenList.",
				);
			}
			const args = [];
		...
		remove() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'remove' called on an object that is not a valid instance of DOMTokenList.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'remove' on 'DOMTokenList': parameter " +
						(i + 1),
					globals: globalObject,
				});
				args.push(curArg);
		...
		toggle(token) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'toggle' called on an object that is not a valid instance of DOMTokenList.",
				);
			}
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'toggle' on 'DOMTokenList': parameter 2",
						globals: globalObject,
					});
				}
				args.push(curArg);
		...
		replace(token, newToken) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'replace' called on an object that is not a valid instance of DOMTokenList.",
				);
			}
		...
		supports(token) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'supports' on 'DOMTokenList': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
