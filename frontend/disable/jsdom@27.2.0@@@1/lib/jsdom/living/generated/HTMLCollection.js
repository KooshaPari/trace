...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLCollection'.`,
	);
};
	...
	class HTMLCollection {
		...
		item(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'item' called on an object that is not a valid instance of HTMLCollection.",
				);
			}
		...
		namedItem(name) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'namedItem' on 'HTMLCollection': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
