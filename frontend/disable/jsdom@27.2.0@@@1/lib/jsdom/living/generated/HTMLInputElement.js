...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLInputElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLInputElement extends globalObject.HTMLElement {
			...
			const args = [];
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["long"](curArg, {
						context:
							"Failed to execute 'stepUp' on 'HTMLInputElement': parameter 1",
		...
		stepDown() {
			...
			const args = [];
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["long"](curArg, {
						context:
							"Failed to execute 'stepDown' on 'HTMLInputElement': parameter 1",
						globals: globalObject,
					});
				} else {
					curArg = 1;
		...
		get accept() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("accept");
		...
		get autocomplete() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("autocomplete");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get autofocus() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("autofocus") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get defaultChecked() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("checked") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get dirName() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("dirname");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get disabled() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("disabled") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get formNoValidate() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute(
						"formnovalidate",
					) !== null
				);
			} finally {
		...
		get formTarget() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("formtarget");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get inputMode() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("inputmode");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get maxLength() {
			...
			try {
				let value =
					esValue[implSymbol]._reflectGetTheContentAttribute("maxlength");
				if (value !== null) {
		...
		get minLength() {
			...
			try {
				let value =
					esValue[implSymbol]._reflectGetTheContentAttribute("minlength");
				if (value !== null) {
					value = parseNonNegativeInteger_helpers_strings(value);
					if (value !== null && conversions.long(value) === value) {
						return value;
		...
		get multiple() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("multiple") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get name() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("name");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get pattern() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("pattern");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get placeholder() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("placeholder");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get readOnly() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("readonly") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get required() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("required") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get step() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("step");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get defaultValue() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("value");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		set valueAsDate(V) {
			...
			if (V === null || V === undefined) {
				...
				V = conversions["object"](V, {
					context:
						"Failed to set the 'valueAsDate' property on 'HTMLInputElement': The provided value",
					globals: globalObject,
				});
			}
		...
		set valueAsNumber(V) {
			...
			V = conversions["unrestricted double"](V, {
				context:
					"Failed to set the 'valueAsNumber' property on 'HTMLInputElement': The provided value",
				globals: globalObject,
			});
		...
		get useMap() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("usemap");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
