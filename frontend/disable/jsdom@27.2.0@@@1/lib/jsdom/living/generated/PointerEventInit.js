...
exports._convertInherit = (
		...
		if (value !== undefined) {
			if (!utils.isObject(value)) {
				throw new globalObject.TypeError(
					context +
						" has member 'coalescedEvents' that" +
				...
				for (let nextItem of tmp) {
					nextItem = PointerEvent.convert(globalObject, nextItem, {
						context:
							context + " has member 'coalescedEvents' that" + "'s element",
					});
...

	{
		...
		if (value !== undefined) {
			value = conversions["long"](value, {
				context: context + " has member 'pointerId' that",
				globals: globalObject,
			});
...

	{
		...
		if (value !== undefined) {
			if (!utils.isObject(value)) {
				throw new globalObject.TypeError(
					context +
						" has member 'predictedEvents' that" +
						" is not an iterable object.",
				);
			} else {
				const V = [];
				...
				for (let nextItem of tmp) {
					nextItem = PointerEvent.convert(globalObject, nextItem, {
						context:
							context + " has member 'predictedEvents' that" + "'s element",
					});
...

	{
		...
		if (value !== undefined) {
			value = conversions["float"](value, {
				context: context + " has member 'pressure' that",
				globals: globalObject,
			});
...

	{
		...
		if (value !== undefined) {
			value = conversions["long"](value, {
				context: context + " has member 'tiltX' that",
				globals: globalObject,
			});
...

	{
		...
		if (value !== undefined) {
			value = conversions["long"](value, {
				context: context + " has member 'tiltY' that",
				globals: globalObject,
			});
...

	{
		...
		if (value !== undefined) {
			value = conversions["long"](value, {
				context: context + " has member 'twist' that",
				globals: globalObject,
			});
