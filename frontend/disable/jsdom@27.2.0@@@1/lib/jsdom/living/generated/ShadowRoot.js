...
exports.install = (globalObject, globalNames) => {
	...
	class ShadowRoot extends globalObject.DocumentFragment {
		...
		get mode() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get mode' called on an object that is not a valid instance of ShadowRoot.",
				);
			}
		...
		get host() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get host' called on an object that is not a valid instance of ShadowRoot.",
				);
			}
		...
		set innerHTML(V) {
			...
			V = conversions["DOMString"](V, {
				context:
					"Failed to set the 'innerHTML' property on 'ShadowRoot': The provided value",
