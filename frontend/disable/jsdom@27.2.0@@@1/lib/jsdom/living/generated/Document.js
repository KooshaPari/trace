...
const ceReactionsPreSteps_helpers_custom_elements =
	require("../helpers/custom-elements.js").ceReactionsPreSteps;
const ceReactionsPostSteps_helpers_custom_elements =
	require("../helpers/custom-elements.js").ceReactionsPostSteps;
	...
	if (unforgeables === undefined) {
		...
		utils.define(unforgeables, {
			...
			set location(V) {
				...
				if (!utils.isObject(Q)) {
					throw new globalObject.TypeError(
						"Property 'location' is not an object",
					);
				}
	...
	class Document extends globalObject.Node {
		...
		getElementsByTagName(qualifiedName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getElementsByTagName(...args),
			);
		}
		...
		getElementsByTagNameNS(namespace, localName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getElementsByTagNameNS(...args),
			);
		}
		...
		getElementsByClassName(classNames) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getElementsByClassName(...args),
			);
		}
		...
		createElement(localName) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createElement' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						curArg = ElementCreationOptions.convert(globalObject, curArg, {
							context:
								"Failed to execute 'createElement' on 'Document': parameter 2",
						});
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].createElement(...args),
				);
			} finally {
		...
		createElementNS(namespace, qualifiedName) {
			...
			}
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createElementNS' on 'Document': parameter 2",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						curArg = ElementCreationOptions.convert(globalObject, curArg, {
							context:
								"Failed to execute 'createElementNS' on 'Document': parameter 3",
						});
					} else if (utils.isObject(curArg)) {
						curArg = ElementCreationOptions.convert(globalObject, curArg, {
							context:
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].createElementNS(...args),
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		createDocumentFragment() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createDocumentFragment(),
			);
		}
		...
		createTextNode(data) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createTextNode' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createTextNode(...args),
			);
		}
		...
		createCDATASection(data) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createCDATASection(...args),
			);
		}
		...
		createComment(data) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createComment' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createComment(...args),
			);
		}
		...
		createProcessingInstruction(target, data) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createProcessingInstruction(...args),
			);
		}
		...
		importNode(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'importNode' called on an object that is not a valid instance of Document.",
				);
			}
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'importNode' on 'Document': parameter 2",
						globals: globalObject,
					});
				} else {
					curArg = false;
		...
		adoptNode(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'adoptNode' called on an object that is not a valid instance of Document.",
				);
			}
		...
		createAttribute(localName) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createAttribute' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createAttribute(...args),
			);
		}
		...
		createAttributeNS(namespace, qualifiedName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createAttributeNS(...args),
			);
		}
		...
		createEvent(interface_) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'createEvent' called on an object that is not a valid instance of Document.",
				);
			}
		...
		createRange() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'createRange' called on an object that is not a valid instance of Document.",
				);
			}
		...
		createNodeIterator(root) {
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = NodeFilter.convert(globalObject, curArg, {
							context:
								"Failed to execute 'createNodeIterator' on 'Document': parameter 3",
						});
					}
				} else {
					curArg = null;
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createNodeIterator(...args),
			);
		}
		...
		createTreeWalker(root) {
			...
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = NodeFilter.convert(globalObject, curArg, {
							context:
								"Failed to execute 'createTreeWalker' on 'Document': parameter 3",
						});
					}
				} else {
					curArg = null;
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createTreeWalker(...args),
			);
		}
		...
		getElementsByName(elementName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getElementsByName(...args),
			);
		}
		...
		open() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'open' called on an object that is not a valid instance of Document.",
				);
			}
			const args = [];
			{
		...
		close() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'close' called on an object that is not a valid instance of Document.",
				);
			}
		...
		write() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'write' called on an object that is not a valid instance of Document.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'write' on 'Document': parameter " + (i + 1),
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		writeln() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'writeln' called on an object that is not a valid instance of Document.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
		...
		hasFocus() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'hasFocus' called on an object that is not a valid instance of Document.",
				);
			}
		...
		clear() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'clear' called on an object that is not a valid instance of Document.",
				);
			}
		...
		getElementById(elementId) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'getElementById' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].getElementById(...args),
			);
		}
		...
		prepend() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'prepend' called on an object that is not a valid instance of Document.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
		...
		append() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'append' called on an object that is not a valid instance of Document.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
		...
		replaceChildren() {
			...
			for (let i = 0; i < arguments.length; i++) {
				...
				if (Node.is(curArg)) {
					...
					curArg = conversions["DOMString"](curArg, {
						context:
							"Failed to execute 'replaceChildren' on 'Document': parameter " +
							(i + 1),
						globals: globalObject,
					});
				}
		...
		querySelector(selectors) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'querySelector' on 'Document': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].querySelector(...args),
			);
		}
		...
		querySelectorAll(selectors) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].querySelectorAll(...args),
			);
		}
		...
		get URL() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get URL' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get charset() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get charset' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get doctype() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get doctype' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get cookie() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get cookie' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set cookie(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set cookie' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get title() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get title' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set title(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set title' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get dir() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get dir' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set dir(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set dir' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get body() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get body' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set body(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set body' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get head() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get head' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get images() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get images' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get embeds() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get embeds' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get plugins() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get plugins' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get links() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get links' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get forms() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get forms' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get scripts() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get scripts' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onreadystatechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onreadystatechange' property on 'Document': The provided value",
				});
			}
		...
		get anchors() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get anchors' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get applets() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get applets' called on an object that is not a valid instance of Document.",
				);
			}
		...
		get hidden() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get hidden' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onvisibilitychange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onvisibilitychange' property on 'Document': The provided value",
				});
			}
		...
		get onabort() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onabort' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onabort(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onabort' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onabort' property on 'Document': The provided value",
				});
			}
		...
		set onauxclick(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onauxclick' property on 'Document': The provided value",
				});
			}
		...
		set onbeforeinput(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforeinput' property on 'Document': The provided value",
				});
			}
		...
		set onbeforematch(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforematch' property on 'Document': The provided value",
				});
			}
		...
		set onbeforetoggle(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforetoggle' property on 'Document': The provided value",
				});
			}
		...
		get onblur() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onblur' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onblur(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onblur' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onblur' property on 'Document': The provided value",
				});
			}
		...
		set oncancel(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncancel' property on 'Document': The provided value",
				});
			}
		...
		set oncanplay(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncanplay' property on 'Document': The provided value",
				});
			}
		...
		set oncanplaythrough(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncanplaythrough' property on 'Document': The provided value",
				});
			}
		...
		set onchange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onchange' property on 'Document': The provided value",
				});
			}
		...
		get onclick() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onclick' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onclick(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onclick' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onclick' property on 'Document': The provided value",
				});
			}
		...
		get onclose() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onclose' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onclose(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onclose' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onclose' property on 'Document': The provided value",
				});
			}
		...
		set oncontextlost(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncontextlost' property on 'Document': The provided value",
				});
			}
		...
		set oncontextmenu(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncontextmenu' property on 'Document': The provided value",
				});
			}
		...
		set oncontextrestored(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncontextrestored' property on 'Document': The provided value",
				});
			}
		...
		get oncopy() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get oncopy' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set oncopy(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set oncopy' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncopy' property on 'Document': The provided value",
				});
			}
		...
		set oncuechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncuechange' property on 'Document': The provided value",
				});
			}
		...
		get oncut() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get oncut' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set oncut(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set oncut' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oncut' property on 'Document': The provided value",
				});
			}
		...
		set ondblclick(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondblclick' property on 'Document': The provided value",
				});
			}
		...
		get ondrag() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get ondrag' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set ondrag(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set ondrag' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondrag' property on 'Document': The provided value",
				});
			}
		...
		set ondragend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondragend' property on 'Document': The provided value",
				});
			}
		...
		set ondragenter(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondragenter' property on 'Document': The provided value",
				});
			}
		...
		set ondragleave(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondragleave' property on 'Document': The provided value",
				});
			}
		...
		set ondragover(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondragover' property on 'Document': The provided value",
				});
			}
		...
		set ondragstart(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondragstart' property on 'Document': The provided value",
				});
			}
		...
		get ondrop() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get ondrop' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set ondrop(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set ondrop' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondrop' property on 'Document': The provided value",
				});
			}
		...
		set ondurationchange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ondurationchange' property on 'Document': The provided value",
				});
			}
		...
		set onemptied(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onemptied' property on 'Document': The provided value",
				});
			}
		...
		get onended() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onended' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onended(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onended' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onended' property on 'Document': The provided value",
				});
			}
		...
		get onerror() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onerror' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onerror(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onerror' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = OnErrorEventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onerror' property on 'Document': The provided value",
				});
			}
		...
		get onfocus() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onfocus' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onfocus(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onfocus' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onfocus' property on 'Document': The provided value",
				});
			}
		...
		set onformdata(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onformdata' property on 'Document': The provided value",
				});
			}
		...
		get oninput() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get oninput' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set oninput(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set oninput' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oninput' property on 'Document': The provided value",
				});
			}
		...
		set oninvalid(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'oninvalid' property on 'Document': The provided value",
				});
			}
		...
		set onkeydown(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onkeydown' property on 'Document': The provided value",
				});
			}
		...
		set onkeypress(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onkeypress' property on 'Document': The provided value",
				});
			}
		...
		get onkeyup() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onkeyup' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onkeyup(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onkeyup' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onkeyup' property on 'Document': The provided value",
				});
			}
		...
		get onload() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onload' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onload(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onload' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onload' property on 'Document': The provided value",
				});
			}
		...
		set onloadeddata(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onloadeddata' property on 'Document': The provided value",
				});
			}
		...
		set onloadedmetadata(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onloadedmetadata' property on 'Document': The provided value",
				});
			}
		...
		set onloadstart(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onloadstart' property on 'Document': The provided value",
				});
			}
		...
		set onmousedown(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmousedown' property on 'Document': The provided value",
				});
			}
		...
		set onmouseenter(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmouseenter' property on 'Document': The provided value",
				});
			}
		...
		set onmouseleave(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmouseleave' property on 'Document': The provided value",
				});
			}
		...
		set onmousemove(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmousemove' property on 'Document': The provided value",
				});
			}
		...
		set onmouseout(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmouseout' property on 'Document': The provided value",
				});
			}
		...
		set onmouseover(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmouseover' property on 'Document': The provided value",
				});
			}
		...
		set onmouseup(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmouseup' property on 'Document': The provided value",
				});
			}
		...
		get onpaste() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onpaste' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onpaste(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onpaste' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpaste' property on 'Document': The provided value",
				});
			}
		...
		get onpause() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onpause' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onpause(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onpause' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpause' property on 'Document': The provided value",
				});
			}
		...
		get onplay() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onplay' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onplay(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onplay' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onplay' property on 'Document': The provided value",
				});
			}
		...
		set onplaying(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onplaying' property on 'Document': The provided value",
				});
			}
		...
		set onprogress(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onprogress' property on 'Document': The provided value",
				});
			}
		...
		set onratechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onratechange' property on 'Document': The provided value",
				});
			}
		...
		get onreset() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onreset' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onreset(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onreset' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onreset' property on 'Document': The provided value",
				});
			}
		...
		set onresize(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onresize' property on 'Document': The provided value",
				});
			}
		...
		set onscroll(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onscroll' property on 'Document': The provided value",
				});
			}
		...
		set onscrollend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onscrollend' property on 'Document': The provided value",
				});
			}
		...
		set onsecuritypolicyviolation(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onsecuritypolicyviolation' property on 'Document': The provided value",
				});
			}
		...
		set onseeked(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onseeked' property on 'Document': The provided value",
				});
			}
		...
		set onseeking(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onseeking' property on 'Document': The provided value",
				});
			}
		...
		set onselect(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onselect' property on 'Document': The provided value",
				});
			}
		...
		set onslotchange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onslotchange' property on 'Document': The provided value",
				});
			}
		...
		set onstalled(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onstalled' property on 'Document': The provided value",
				});
			}
		...
		set onsubmit(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onsubmit' property on 'Document': The provided value",
				});
			}
		...
		set onsuspend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onsuspend' property on 'Document': The provided value",
				});
			}
		...
		set ontimeupdate(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontimeupdate' property on 'Document': The provided value",
				});
			}
		...
		set ontoggle(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontoggle' property on 'Document': The provided value",
				});
			}
		...
		set onvolumechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onvolumechange' property on 'Document': The provided value",
				});
			}
		...
		set onwaiting(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwaiting' property on 'Document': The provided value",
				});
			}
		...
		get onwebkitanimationend() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onwebkitanimationend"],
			);
		}
		...
		set onwebkitanimationend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwebkitanimationend' property on 'Document': The provided value",
				});
			}
		...
		get onwebkitanimationiteration() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onwebkitanimationiteration"],
			);
		}
		...
		set onwebkitanimationiteration(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwebkitanimationiteration' property on 'Document': The provided value",
				});
			}
		...
		get onwebkitanimationstart() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onwebkitanimationstart"],
			);
		}
		...
		set onwebkitanimationstart(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwebkitanimationstart' property on 'Document': The provided value",
				});
			}
		...
		get onwebkittransitionend() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onwebkittransitionend"],
			);
		}
		...
		set onwebkittransitionend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwebkittransitionend' property on 'Document': The provided value",
				});
			}
		...
		get onwheel() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onwheel' called on an object that is not a valid instance of Document.",
				);
			}
		...
		set onwheel(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onwheel' called on an object that is not a valid instance of Document.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onwheel' property on 'Document': The provided value",
				});
			}
		...
		set ontouchstart(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontouchstart' property on 'Document': The provided value",
				});
			}
		...
		set ontouchend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontouchend' property on 'Document': The provided value",
				});
			}
		...
		set ontouchmove(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontouchmove' property on 'Document': The provided value",
				});
			}
		...
		set ontouchcancel(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontouchcancel' property on 'Document': The provided value",
				});
			}
		...
		set onpointerover(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerover' property on 'Document': The provided value",
				});
			}
		...
		set onpointerenter(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerenter' property on 'Document': The provided value",
				});
			}
		...
		set onpointerdown(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerdown' property on 'Document': The provided value",
				});
			}
		...
		set onpointermove(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointermove' property on 'Document': The provided value",
				});
			}
		...
		set onpointerrawupdate(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerrawupdate' property on 'Document': The provided value",
				});
			}
		...
		set onpointerup(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerup' property on 'Document': The provided value",
				});
			}
		...
		set onpointercancel(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointercancel' property on 'Document': The provided value",
				});
			}
		...
		set onpointerout(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerout' property on 'Document': The provided value",
				});
			}
		...
		set onpointerleave(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpointerleave' property on 'Document': The provided value",
				});
			}
		...
		get ongotpointercapture() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["ongotpointercapture"],
			);
		}
		...
		set ongotpointercapture(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ongotpointercapture' property on 'Document': The provided value",
				});
			}
		...
		get onlostpointercapture() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onlostpointercapture"],
			);
		}
		...
		set onlostpointercapture(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onlostpointercapture' property on 'Document': The provided value",
				});
			}
