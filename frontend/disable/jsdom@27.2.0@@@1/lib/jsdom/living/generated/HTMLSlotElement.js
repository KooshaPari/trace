...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLSlotElement'.`,
	);
};
	...
	class HTMLSlotElement extends globalObject.HTMLElement {
		...
		assignedNodes() {
			...
			const args = [];
			{
				...
				curArg = AssignedNodesOptions.convert(globalObject, curArg, {
					context:
						"Failed to execute 'assignedNodes' on 'HTMLSlotElement': parameter 1",
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].assignedNodes(...args),
			);
		}
		...
		assignedElements() {
			...
			const args = [];
			{
				...
				curArg = AssignedNodesOptions.convert(globalObject, curArg, {
					context:
						"Failed to execute 'assignedElements' on 'HTMLSlotElement': parameter 1",
				});
				args.push(curArg);
			}
			return utils.tryWrapperForImpl(
				esValue[implSymbol].assignedElements(...args),
			);
		}
		...
		set name(V) {
			...
			V = conversions["DOMString"](V, {
				context:
					"Failed to set the 'name' property on 'HTMLSlotElement': The provided value",
