...
exports._convertInherit = (
...
) => {
	{
		...
		if (value !== undefined) {
			...
			throw new globalObject.TypeError(
				"endContainer is required in 'StaticRangeInit'",
			);
		}
	}

	{
		...
		if (value !== undefined) {
			...
			throw new globalObject.TypeError(
				"endOffset is required in 'StaticRangeInit'",
			);
		}
	}

	{
		...
		if (value !== undefined) {
			...
			throw new globalObject.TypeError(
				"startContainer is required in 'StaticRangeInit'",
			);
		}
	}

	{
		...
		if (value !== undefined) {
			...
			throw new globalObject.TypeError(
				"startOffset is required in 'StaticRangeInit'",
			);
		}
	}
};
