...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'SVGStringList'.`,
	);
};
	...
	class SVGStringList {
		...
		clear() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'clear' called on an object that is not a valid instance of SVGStringList.",
				);
			}
		...
		initialize(newItem) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'initialize' on 'SVGStringList': parameter 1",
		...
		getItem(index) {
			...
			const args = [];
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'getItem' on 'SVGStringList': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		removeItem(index) {
			...
			const args = [];
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'removeItem' on 'SVGStringList': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		appendItem(newItem) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'appendItem' on 'SVGStringList': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
	...
	set(target, P, V, receiver) {
		...
		if (target[implSymbol][utils.wrapperSymbol] === receiver) {
			...
			if (utils.isArrayIndexPropName(P)) {
				...
				const creating =
					!target[implSymbol][utils.supportsPropertyIndex](index);
				if (creating) {
