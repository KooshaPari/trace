...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLImageElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLImageElement extends globalObject.HTMLElement {
		...
		get srcset() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("srcset");
		...
		get sizes() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("sizes");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get isMap() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("ismap") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
