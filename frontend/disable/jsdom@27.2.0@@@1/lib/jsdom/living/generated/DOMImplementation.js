...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'DOMImplementation'.`,
	);
};
	...
	class DOMImplementation {
		...
		createDocumentType(qualifiedName, publicId, systemId) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createDocumentType(...args),
			);
		}
		...
		createDocument(namespace, qualifiedName) {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createDocument(...args),
			);
		}
		...
		createHTMLDocument() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol].createHTMLDocument(...args),
			);
		}
