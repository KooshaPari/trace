...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLOListElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLOListElement extends globalObject.HTMLElement {
		...
		get reversed() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("reversed") !==
					null
				);
			} finally {
		...
		get compact() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("compact") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
