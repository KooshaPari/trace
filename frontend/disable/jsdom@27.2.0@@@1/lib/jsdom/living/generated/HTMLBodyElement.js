...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLBodyElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLBodyElement extends globalObject.HTMLElement {
		...
		get text() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("text");
		...
		get link() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("link");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get vLink() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("vlink");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get aLink() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("alink");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get background() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("background");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		set onafterprint(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onafterprint' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onbeforeprint(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforeprint' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onbeforeunload(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = OnBeforeUnloadEventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforeunload' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onhashchange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onhashchange' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onlanguagechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onlanguagechange' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onmessage(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmessage' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onmessageerror(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmessageerror' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onoffline(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onoffline' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set ononline(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ononline' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onpagehide(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpagehide' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onpageshow(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpageshow' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onpopstate(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpopstate' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onrejectionhandled(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onrejectionhandled' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onstorage(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onstorage' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		get onunhandledrejection() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["onunhandledrejection"],
			);
		}
		...
		set onunhandledrejection(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onunhandledrejection' property on 'HTMLBodyElement': The provided value",
				});
			}
		...
		set onunload(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onunload' property on 'HTMLBodyElement': The provided value",
				});
			}
