...
exports.install = (globalObject, globalNames) => {
	...
	class History {
		...
		go() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'go' called on an object that is not a valid instance of History.",
				);
			}
			const args = [];
			{
		...
		back() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'back' called on an object that is not a valid instance of History.",
				);
			}
		...
		forward() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'forward' called on an object that is not a valid instance of History.",
				);
			}
		...
		pushState(data, title) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'pushState' called on an object that is not a valid instance of History.",
				);
			}
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = conversions["USVString"](curArg, {
							context:
								"Failed to execute 'pushState' on 'History': parameter 3",
							globals: globalObject,
						});
					}
				} else {
		...
		replaceState(data, title) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'replaceState' called on an object that is not a valid instance of History.",
				);
			}
			...
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = conversions["USVString"](curArg, {
							context:
								"Failed to execute 'replaceState' on 'History': parameter 3",
							globals: globalObject,
						});
					}
				} else {
		...
		get length() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get length' called on an object that is not a valid instance of History.",
				);
			}
		...
		get state() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get state' called on an object that is not a valid instance of History.",
				);
			}
