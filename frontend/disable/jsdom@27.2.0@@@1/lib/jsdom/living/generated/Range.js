...
exports.install = (globalObject, globalNames) => {
	...
	class Range extends globalObject.AbstractRange {
		...
		setStart(node, offset) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setStart' called on an object that is not a valid instance of Range.",
				);
			}
		...
		setEnd(node, offset) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setEnd' called on an object that is not a valid instance of Range.",
				);
			}
		...
		setStartBefore(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setStartBefore' called on an object that is not a valid instance of Range.",
				);
			}
		...
		setStartAfter(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setStartAfter' called on an object that is not a valid instance of Range.",
				);
			}
		...
		setEndBefore(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setEndBefore' called on an object that is not a valid instance of Range.",
				);
			}
		...
		setEndAfter(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'setEndAfter' called on an object that is not a valid instance of Range.",
				);
			}
		...
		collapse() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'collapse' called on an object that is not a valid instance of Range.",
				);
			}
			const args = [];
			{
		...
		selectNode(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'selectNode' called on an object that is not a valid instance of Range.",
				);
			}
		...
		selectNodeContents(node) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'selectNodeContents' on 'Range': parameter 1",
				});
				args.push(curArg);
			}
		...
		compareBoundaryPoints(how, sourceRange) {
			...
			const args = [];
			{
				...
				curArg = conversions["unsigned short"](curArg, {
					context:
						"Failed to execute 'compareBoundaryPoints' on 'Range': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				curArg = exports.convert(globalObject, curArg, {
					context:
						"Failed to execute 'compareBoundaryPoints' on 'Range': parameter 2",
				});
				args.push(curArg);
			}
		...
		deleteContents() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'deleteContents' called on an object that is not a valid instance of Range.",
				);
			}
		...
		cloneContents() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'cloneContents' called on an object that is not a valid instance of Range.",
				);
			}
		...
		insertNode(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'insertNode' called on an object that is not a valid instance of Range.",
				);
			}
		...
		surroundContents(newParent) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'surroundContents' on 'Range': parameter 1",
				});
				args.push(curArg);
			}
			ceReactionsPreSteps_helpers_custom_elements(globalObject);
		...
		cloneRange() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'cloneRange' called on an object that is not a valid instance of Range.",
				);
			}
		...
		detach() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'detach' called on an object that is not a valid instance of Range.",
				);
			}
		...
		isPointInRange(node, offset) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'isPointInRange' called on an object that is not a valid instance of Range.",
				);
			}
		...
		comparePoint(node, offset) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'comparePoint' called on an object that is not a valid instance of Range.",
				);
			}
		...
		intersectsNode(node) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'intersectsNode' called on an object that is not a valid instance of Range.",
				);
			}
		...
		toString() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'toString' called on an object that is not a valid instance of Range.",
				);
			}
		...
		createContextualFragment(fragment) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'createContextualFragment' on 'Range': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			...
			try {
				return utils.tryWrapperForImpl(
					esValue[implSymbol].createContextualFragment(...args),
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get commonAncestorContainer() {
			...
			return utils.tryWrapperForImpl(
				esValue[implSymbol]["commonAncestorContainer"],
			);
		}
	}
