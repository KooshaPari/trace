...
exports.install = (globalObject, globalNames) => {
	...
	class TreeWalker {
		...
		lastChild() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'lastChild' called on an object that is not a valid instance of TreeWalker.",
				);
			}
		...
		nextNode() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'nextNode' called on an object that is not a valid instance of TreeWalker.",
				);
			}
		...
		get root() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get root' called on an object that is not a valid instance of TreeWalker.",
				);
			}
