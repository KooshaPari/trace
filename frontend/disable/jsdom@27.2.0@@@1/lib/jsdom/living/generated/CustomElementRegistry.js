...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'CustomElementRegistry'.`,
	);
};
	...
	class CustomElementRegistry {
		...
		define(name, constructor) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'define' on 'CustomElementRegistry': parameter 1",
			...
			}
			{
				...
				curArg = CustomElementConstructor.convert(globalObject, curArg, {
					context:
						"Failed to execute 'define' on 'CustomElementRegistry': parameter 2",
				});
				args.push(curArg);
			}
			{
				...
				curArg = ElementDefinitionOptions.convert(globalObject, curArg, {
					context:
						"Failed to execute 'define' on 'CustomElementRegistry': parameter 3",
				});
				args.push(curArg);
			}
		...
		get(name) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'get' on 'CustomElementRegistry': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		getName(constructor) {
			...
			const args = [];
			{
				...
				curArg = CustomElementConstructor.convert(globalObject, curArg, {
					context:
						"Failed to execute 'getName' on 'CustomElementRegistry': parameter 1",
				});
				args.push(curArg);
			}
		...
		whenDefined(name) {
			try {
				...
				const args = [];
				{
					...
					curArg = conversions["DOMString"](curArg, {
						context:
							"Failed to execute 'whenDefined' on 'CustomElementRegistry': parameter 1",
						globals: globalObject,
					});
					args.push(curArg);
				}
				return utils.tryWrapperForImpl(
					esValue[implSymbol].whenDefined(...args),
				);
			} catch (e) {
		...
		upgrade(root) {
			...
			const args = [];
			{
				...
				curArg = Node.convert(globalObject, curArg, {
					context:
						"Failed to execute 'upgrade' on 'CustomElementRegistry': parameter 1",
				});
				args.push(curArg);
			}
			ceReactionsPreSteps_helpers_custom_elements(globalObject);
