...
exports.install = (globalObject, globalNames) => {
	...
	class Plugin {
		...
		item(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'item' called on an object that is not a valid instance of Plugin.",
				);
			}
		...
		namedItem(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'namedItem' called on an object that is not a valid instance of Plugin.",
				);
			}
		...
		get name() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get name' called on an object that is not a valid instance of Plugin.",
				);
			}
		...
		get filename() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get filename' called on an object that is not a valid instance of Plugin.",
				);
			}
		...
		get length() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get length' called on an object that is not a valid instance of Plugin.",
				);
			}
