...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLScriptElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLScriptElement extends globalObject.HTMLElement {
		...
		get defer() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("defer") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get event() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("event");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
