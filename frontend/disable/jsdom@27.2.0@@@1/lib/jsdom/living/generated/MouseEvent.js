...
exports.install = (globalObject, globalNames) => {
	...
	class MouseEvent extends globalObject.UIEvent {
		...
		get pageX() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get pageX' called on an object that is not a valid instance of MouseEvent.",
				);
			}
		...
		get pageY() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get pageY' called on an object that is not a valid instance of MouseEvent.",
				);
			}
		...
		get x() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get x' called on an object that is not a valid instance of MouseEvent.",
				);
			}
		...
		get y() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get y' called on an object that is not a valid instance of MouseEvent.",
				);
			}
