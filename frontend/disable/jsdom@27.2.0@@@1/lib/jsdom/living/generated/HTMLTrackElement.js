...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLTrackElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLTrackElement extends globalObject.HTMLElement {
		...
		get kind() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("kind");
		...
		get srclang() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("srclang");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get label() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("label");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get default() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("default") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
