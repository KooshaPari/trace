...
exports.install = (globalObject, globalNames) => {
	...
	class Attr extends globalObject.Node {
		...
		get prefix() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get prefix' called on an object that is not a valid instance of Attr.",
				);
			}
		...
		get localName() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get localName' called on an object that is not a valid instance of Attr.",
				);
			}
		...
		get name() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get name' called on an object that is not a valid instance of Attr.",
				);
			}
		...
		get value() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get value' called on an object that is not a valid instance of Attr.",
				);
			}
		...
		set value(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set value' called on an object that is not a valid instance of Attr.",
				);
			}
		...
		get specified() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get specified' called on an object that is not a valid instance of Attr.",
				);
			}
