...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLMetaElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLMetaElement extends globalObject.HTMLElement {
		...
		get httpEquiv() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("http-equiv");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get content() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("content");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get scheme() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("scheme");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
