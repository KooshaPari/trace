...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLObjectElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLObjectElement extends globalObject.HTMLElement {
		...
		get type() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("type");
		...
		get archive() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("archive");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get code() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("code");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get declare() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("declare") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get hspace() {
			...
			try {
				let value =
					esValue[implSymbol]._reflectGetTheContentAttribute("hspace");
				if (value !== null) {
		...
		get standby() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("standby");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get codeType() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("codetype");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get border() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("border");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
