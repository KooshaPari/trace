	...
	class StorageEvent extends globalObject.Event {
		...
		initStorageEvent(type) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 2",
						globals: globalObject,
					});
				} else {
					curArg = false;
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 3",
						globals: globalObject,
					});
				} else {
					curArg = false;
			...
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = conversions["DOMString"](curArg, {
							context:
								"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 4",
							globals: globalObject,
						});
					}
				} else {
			...
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = conversions["DOMString"](curArg, {
							context:
								"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 5",
							globals: globalObject,
						});
					}
				} else {
			...
			}
			{
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = conversions["DOMString"](curArg, {
							context:
								"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 6",
							globals: globalObject,
						});
					}
				} else {
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["USVString"](curArg, {
						context:
							"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 7",
						globals: globalObject,
					});
				} else {
					curArg = "";
				...
				if (curArg !== undefined) {
					if (curArg === null || curArg === undefined) {
						...
						curArg = Storage.convert(globalObject, curArg, {
							context:
								"Failed to execute 'initStorageEvent' on 'StorageEvent': parameter 8",
						});
					}
				} else {
					curArg = null;
		...
		get key() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get key' called on an object that is not a valid instance of StorageEvent.",
				);
			}
		...
		get url() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get url' called on an object that is not a valid instance of StorageEvent.",
				);
			}
