	...
	class WebSocket extends globalObject.EventTarget {
				...
				if (curArg !== undefined) {
					if (utils.isObject(curArg)) {
						if (curArg[Symbol.iterator] !== undefined) {
							if (!utils.isObject(curArg)) {
								throw new globalObject.TypeError(
									"Failed to construct 'WebSocket': parameter 2" +
										" sequence" +
		...
		close() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'close' called on an object that is not a valid instance of WebSocket.",
				);
			}
			const args = [];
			{
		...
		send(data) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'send' called on an object that is not a valid instance of WebSocket.",
				);
			}
				...
				if (Blob.is(curArg)) {
				...
				} else if (ArrayBuffer.isView(curArg)) {
					{
						...
						if (ArrayBuffer.isView(curArg)) {
							...
							throw new globalObject.TypeError(
								"Failed to execute 'send' on 'WebSocket': parameter 1" +
		...
		get url() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get url' called on an object that is not a valid instance of WebSocket.",
				);
			}
		...
		get onopen() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get onopen' called on an object that is not a valid instance of WebSocket.",
				);
			}
		...
		set onopen(V) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set onopen' called on an object that is not a valid instance of WebSocket.",
				);
			}
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onopen' property on 'WebSocket': The provided value",
				});
			}
		...
		set onerror(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onerror' property on 'WebSocket': The provided value",
				});
			}
		...
		set onclose(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onclose' property on 'WebSocket': The provided value",
				});
			}
		...
		set onmessage(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmessage' property on 'WebSocket': The provided value",
				});
			}
