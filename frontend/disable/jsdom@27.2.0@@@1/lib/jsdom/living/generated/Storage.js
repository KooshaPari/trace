...
exports.install = (globalObject, globalNames) => {
	...
	class Storage {
		...
		key(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'key' called on an object that is not a valid instance of Storage.",
				);
			}
		...
		getItem(key) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'getItem' called on an object that is not a valid instance of Storage.",
				);
			}
		...
		removeItem(key) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'removeItem' called on an object that is not a valid instance of Storage.",
				);
			}
		...
		clear() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'clear' called on an object that is not a valid instance of Storage.",
				);
			}
		...
		get length() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get length' called on an object that is not a valid instance of Storage.",
				);
			}
