...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLOutputElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLOutputElement extends globalObject.HTMLElement {
		...
		set defaultValue(V) {
			...
			V = conversions["DOMString"](V, {
				context:
					"Failed to set the 'defaultValue' property on 'HTMLOutputElement': The provided value",
				globals: globalObject,
			});
		...
		set value(V) {
			...
			V = conversions["DOMString"](V, {
				context:
					"Failed to set the 'value' property on 'HTMLOutputElement': The provided value",
				globals: globalObject,
			});
