...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLMediaElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLMediaElement extends globalObject.HTMLElement {
		...
		get preload() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("preload");
		...
		get autoplay() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("autoplay") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get loop() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("loop") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get controls() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("controls") !==
					null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
		...
		get defaultMuted() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("muted") !== null
				);
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
