...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLAnchorElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLAnchorElement extends globalObject.HTMLElement {
		...
		get target() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("target");
		...
		get download() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("download");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get hreflang() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("hreflang");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get coords() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("coords");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get charset() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("charset");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get shape() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("shape");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
