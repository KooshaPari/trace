...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLFormControlsCollection'.`,
	);
};
...
function makeWrapper(globalObject, newTarget) {
	...
	if (!utils.isObject(proto)) {
		proto =
			globalObject[ctorRegistrySymbol]["HTMLFormControlsCollection"].prototype;
	}
		...
		namedItem(name) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'namedItem' on 'HTMLFormControlsCollection': parameter 1",
