...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLTableElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLTableElement extends globalObject.HTMLElement {
		...
		get frame() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("frame");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get rules() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("rules");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get summary() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("summary");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get cellPadding() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("cellpadding");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		get cellSpacing() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("cellspacing");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
