...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLFrameSetElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLFrameSetElement extends globalObject.HTMLElement {
		...
		get cols() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("cols");
		...
		get rows() {
			...
			try {
				const value =
					esValue[implSymbol]._reflectGetTheContentAttribute("rows");
				return value === null ? "" : value;
			} finally {
				ceReactionsPostSteps_helpers_custom_elements(globalObject);
			}
		...
		set onafterprint(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onafterprint' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onbeforeprint(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforeprint' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onbeforeunload(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = OnBeforeUnloadEventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onbeforeunload' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onhashchange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onhashchange' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onlanguagechange(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onlanguagechange' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onmessage(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmessage' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onmessageerror(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onmessageerror' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onoffline(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onoffline' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set ononline(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ononline' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onpagehide(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpagehide' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onpageshow(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpageshow' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onpopstate(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onpopstate' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onrejectionhandled(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onrejectionhandled' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onstorage(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onstorage' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onunhandledrejection(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onunhandledrejection' property on 'HTMLFrameSetElement': The provided value",
				});
			}
		...
		set onunload(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onunload' property on 'HTMLFrameSetElement': The provided value",
				});
			}
