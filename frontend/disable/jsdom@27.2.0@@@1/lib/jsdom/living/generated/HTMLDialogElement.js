...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLDialogElement'.`,
	);
};
...
exports.install = (globalObject, globalNames) => {
	...
	class HTMLDialogElement extends globalObject.HTMLElement {
		...
		get open() {
			...
			try {
				return (
					esValue[implSymbol]._reflectGetTheContentAttribute("open") !== null
				);
			} finally {
		...
		set open(V) {
			...
			V = conversions["boolean"](V, {
				context:
					"Failed to set the 'open' property on 'HTMLDialogElement': The provided value",
