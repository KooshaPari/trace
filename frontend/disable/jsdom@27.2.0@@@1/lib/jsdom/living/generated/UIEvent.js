	...
	class UIEvent extends globalObject.Event {
		...
		initUIEvent(typeArg) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'initUIEvent' called on an object that is not a valid instance of UIEvent.",
				);
			}
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'initUIEvent' on 'UIEvent': parameter 2",
						globals: globalObject,
					});
				} else {
					curArg = false;
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["boolean"](curArg, {
						context:
							"Failed to execute 'initUIEvent' on 'UIEvent': parameter 3",
						globals: globalObject,
					});
				} else {
					curArg = false;
			...
			}
			{
				...
				if (curArg !== undefined) {
					curArg = conversions["long"](curArg, {
						context:
							"Failed to execute 'initUIEvent' on 'UIEvent': parameter 5",
						globals: globalObject,
					});
				} else {
					curArg = 0;
		...
		get view() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get view' called on an object that is not a valid instance of UIEvent.",
				);
			}
		...
		get detail() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get detail' called on an object that is not a valid instance of UIEvent.",
				);
			}
		...
		get which() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get which' called on an object that is not a valid instance of UIEvent.",
				);
			}
