...
const parseFloatingPointNumber_helpers_strings =
	require("../helpers/strings.js").parseFloatingPointNumber;
...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'HTMLProgressElement'.`,
	);
};
	...
	class HTMLProgressElement extends globalObject.HTMLElement {
		...
		set value(V) {
			...
			V = conversions["double"](V, {
				context:
					"Failed to set the 'value' property on 'HTMLProgressElement': The provided value",
		...
		set max(V) {
			...
			V = conversions["double"](V, {
				context:
					"Failed to set the 'max' property on 'HTMLProgressElement': The provided value",
				globals: globalObject,
			});
