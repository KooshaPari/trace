...
exports.install = (globalObject, globalNames) => {
	...
	class Headers {
		...
		append(name, value) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'append' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		delete(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'delete' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		get(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'get' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		getSetCookie() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'getSetCookie' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		has(name) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'has' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		set(name, value) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'set' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		keys() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'keys' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		values() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'values' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		entries() {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'entries' called on an object that is not a valid instance of Headers.",
				);
			}
		...
		forEach(callback) {
			if (!exports.is(this)) {
				throw new globalObject.TypeError(
					"'forEach' called on an object that is not a valid instance of Headers.",
				);
			}
			if (arguments.length < 1) {
				throw new globalObject.TypeError(
	...
	ctorRegistry["Headers Iterator"] = Object.create(
	...
	utils.define(ctorRegistry["Headers Iterator"], {
		next() {
			...
			if (!internal) {
				throw new globalObject.TypeError(
					"next() called on a value that is not a Headers iterator object",
				);
			}
