...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'MimeTypeArray'.`,
	);
};
	...
	class MimeTypeArray {
		...
		item(index) {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'item' called on an object that is not a valid instance of MimeTypeArray.",
				);
			}
		...
		namedItem(name) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'namedItem' on 'MimeTypeArray': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
