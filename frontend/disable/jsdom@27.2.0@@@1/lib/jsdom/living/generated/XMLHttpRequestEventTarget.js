...
function makeWrapper(globalObject, newTarget) {
	...
	if (!utils.isObject(proto)) {
		proto =
			globalObject[ctorRegistrySymbol]["XMLHttpRequestEventTarget"].prototype;
	}
	...
	class XMLHttpRequestEventTarget extends globalObject.EventTarget {
		...
		set onloadstart(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onloadstart' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set onprogress(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onprogress' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set onabort(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onabort' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set onerror(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onerror' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set onload(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onload' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set ontimeout(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'ontimeout' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
		...
		set onloadend(V) {
			...
			if (!utils.isObject(V)) {
				...
				V = EventHandlerNonNull.convert(globalObject, V, {
					context:
						"Failed to set the 'onloadend' property on 'XMLHttpRequestEventTarget': The provided value",
				});
			}
