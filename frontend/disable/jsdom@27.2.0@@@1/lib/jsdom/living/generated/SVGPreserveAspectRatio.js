...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'SVGPreserveAspectRatio'.`,
	);
};
...
function makeWrapper(globalObject, newTarget) {
	...
	if (!utils.isObject(proto)) {
		proto =
			globalObject[ctorRegistrySymbol]["SVGPreserveAspectRatio"].prototype;
	}
	...
	class SVGPreserveAspectRatio {
		...
		set align(V) {
			...
			V = conversions["unsigned short"](V, {
				context:
					"Failed to set the 'align' property on 'SVGPreserveAspectRatio': The provided value",
		...
		set meetOrSlice(V) {
			...
			V = conversions["unsigned short"](V, {
				context:
					"Failed to set the 'meetOrSlice' property on 'SVGPreserveAspectRatio': The provided value",
				globals: globalObject,
			});
