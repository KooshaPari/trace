...
exports.convert = (
	...
	throw new globalObject.TypeError(
		`${context} is not of type 'CharacterData'.`,
	);
};
	...
	class CharacterData extends globalObject.Node {
		...
		appendData(data) {
			...
			const args = [];
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'appendData' on 'CharacterData': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		insertData(offset, data) {
			...
			const args = [];
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'insertData' on 'CharacterData': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				curArg = conversions["DOMString"](curArg, {
					context:
						"Failed to execute 'insertData' on 'CharacterData': parameter 2",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		deleteData(offset, count) {
			...
			const args = [];
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'deleteData' on 'CharacterData': parameter 1",
					globals: globalObject,
				});
				args.push(curArg);
			}
			{
				...
				curArg = conversions["unsigned long"](curArg, {
					context:
						"Failed to execute 'deleteData' on 'CharacterData': parameter 2",
					globals: globalObject,
				});
				args.push(curArg);
			}
		...
		before() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'before' called on an object that is not a valid instance of CharacterData.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
				...
				if (Node.is(curArg)) {
					...
					curArg = conversions["DOMString"](curArg, {
						context:
							"Failed to execute 'before' on 'CharacterData': parameter " +
							(i + 1),
						globals: globalObject,
					});
				}
		...
		after() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'after' called on an object that is not a valid instance of CharacterData.",
				);
			}
			const args = [];
			for (let i = 0; i < arguments.length; i++) {
				...
				if (Node.is(curArg)) {
					...
					curArg = conversions["DOMString"](curArg, {
						context:
							"Failed to execute 'after' on 'CharacterData': parameter " +
							(i + 1),
						globals: globalObject,
					});
				}
		...
		remove() {
			...
			if (!exports.is(esValue)) {
				throw new globalObject.TypeError(
					"'remove' called on an object that is not a valid instance of CharacterData.",
				);
			}
