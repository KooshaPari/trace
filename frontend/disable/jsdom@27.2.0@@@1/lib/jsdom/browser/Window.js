...
const globalEventHandlersEvents =
	require("../living/nodes/GlobalEventHandlers-impl").events;
...
exports.createWindow = (options) => {
	...
	const windowPropertiesObject = windowProperties.create(
...
function installOwnProperties(window, options) {
	...
	Object.defineProperties(window, {
		...
		devicePixelRatio: makeReplaceablePropertyDescriptor(
			"devicePixelRatio",
			window,
		),
	...
	window.getComputedStyle = (elt, pseudoElt = undefined) => {
	...
	window.getSelection = () => window._document.getSelection();
