...
exports.in = (key, options = {}) =>
	exports.create(key, { ...options, in: true });

exports.isRef = (ref) => (ref ? !!ref[Common.symbols.ref] : false);
...
internals.context = (key, separator, prefix = {}) => {
	key = key.trim();
...
internals.ancestor = (key, separator) => {
	if (!separator) {
