...
function _default(x0, y0, y1) {
	...
	x0 =
		typeof x0 === "function"
			...
			: x0 === undefined
				? _point.x
				: (0, _constant.default)(+x0);
	y0 =
		typeof y0 === "function"
			? y0
			: y0 === undefined
				? (0, _constant.default)(0)
				: (0, _constant.default)(+y0);
	y1 =
		typeof y1 === "function"
			? y1
			: y1 === undefined
				? _point.y
				: (0, _constant.default)(+y1);
	...
	area.x = function (_) {
		return arguments.length
			? ((x0 = typeof _ === "function" ? _ : (0, _constant.default)(+_)),
				(x1 = null),
				area)
			: x0;
	};
	...
	area.x0 = function (_) {
		return arguments.length
			? ((x0 = typeof _ === "function" ? _ : (0, _constant.default)(+_)), area)
			: x0;
	};
	...
	area.y = function (_) {
		return arguments.length
			? ((y0 = typeof _ === "function" ? _ : (0, _constant.default)(+_)),
				(y1 = null),
				area)
			: y0;
	};
	...
	area.y0 = function (_) {
		return arguments.length
			? ((y0 = typeof _ === "function" ? _ : (0, _constant.default)(+_)), area)
			: y0;
	};
	...
	area.defined = function (_) {
		return arguments.length
			? ((defined = typeof _ === "function" ? _ : (0, _constant.default)(!!_)),
				area)
			: defined;
	};
