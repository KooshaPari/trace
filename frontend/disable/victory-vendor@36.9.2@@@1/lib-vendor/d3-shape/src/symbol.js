...
function Symbol(type, size) {
	...
	type =
		typeof type === "function"
			? type
			: (0, _constant.default)(type || _circle.default);
	size =
		typeof size === "function"
			? size
			: (0, _constant.default)(size === undefined ? 64 : +size);
	...
	symbol.type = function (_) {
		return arguments.length
			? ((type = typeof _ === "function" ? _ : (0, _constant.default)(_)),
				symbol)
			: type;
	};
	...
	symbol.size = function (_) {
		return arguments.length
			? ((size = typeof _ === "function" ? _ : (0, _constant.default)(+_)),
				symbol)
			: size;
	};
