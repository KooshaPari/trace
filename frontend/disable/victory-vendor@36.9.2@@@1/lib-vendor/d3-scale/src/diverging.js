...
function transformer() {
	...
	function range(interpolate) {
		return function (_) {
			...
			return arguments.length
				? (([r0, r1, r2] = _),
					(interpolator = (0, _index.piecewise)(interpolate, [r0, r1, r2])),
					scale)
...
function divergingSymlog() {
	...
	scale.copy = function () {
		return (0, _sequential.copy)(scale, divergingSymlog()).constant(
			scale.constant(),
		);
	};
...
function divergingPow() {
	...
	scale.copy = function () {
		return (0, _sequential.copy)(scale, divergingPow()).exponent(
			scale.exponent(),
		);
	};
