...
function tickFormat(start, stop, count, specifier) {
	var step = (0, _index.tickStep)(start, stop, count),
		precision;
	specifier = (0, _index2.formatSpecifier)(
	...
	switch (specifier.type) {
		case "s": {
			...
			if (
				...
				!isNaN((precision = (0, _index2.precisionPrefix)(step, value)))
			)
		...
		case "r": {
			if (
				specifier.precision == null &&
				!isNaN(
					(precision = (0, _index2.precisionRound)(
						step,
		...
		case "%": {
			if (
				specifier.precision == null &&
				!isNaN((precision = (0, _index2.precisionFixed)(step)))
			)
