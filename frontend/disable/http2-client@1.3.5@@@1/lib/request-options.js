...
function initializeOptions(options) {
	...
	options.Http1IncomingMessage =
		options.Http1IncomingMessage || this.http.IncomingMessage;
	options.Http1ServerResponse =
		options.Http1ServerResponse || this.http.ServerResponse;

	options.Http2ServerRequest =
		options.Http2ServerRequest || (this.http2 || {}).Http2ServerRequest;
	options.Http2ServerResponse =
		options.Http2ServerResponse || (this.http2 || {}).Http2ServerResponse;
	return options;
}
...
function initializeTLSOptions(options, servername) {
	...
	if (this.http2Support) ALPNProtocols.push("h2");
