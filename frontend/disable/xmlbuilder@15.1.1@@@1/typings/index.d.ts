...
declare namespace xmlbuilder {
	 ...
	 */
	function create(
		nameOrObject: string | { [name: string]: Object },
	 ...
	 */
	function begin(
		options?: BeginOptions | OnDataCallback,
	...
	abstract class XMLNode {
		 ...
		 */
		doctype(
			pubID?: string | { pubID?: string; sysID?: string },
			sysID?: string,
		): XMLDocType;
		dtd(
			pubID?: string | { pubID?: string; sysID?: string },
	...
	class XMLDocType {
		...
		entity(
			name: string,
			value: string | { pubID?: string; sysID?: string; nData?: string },
		): XMLDocType;
		ent(
			name: string,
			value: string | { pubID?: string; sysID?: string; nData?: string },
		...
		pEntity(
			name: string,
			value: string | { pubID?: string; sysID?: string },
		): XMLDocType;
		pent(
			name: string,
			value: string | { pubID?: string; sysID?: string },
		...
		notation(
			name: string,
			value: { pubID?: string; sysID?: string },
		): XMLDocType;
