...
(() => {
	...
	module.exports = XMLDocumentCB = class XMLDocumentCB {
		...
		dtdElement(name, value) {
			...
			this.onData(
				this.writer.dtdElement(node, this.writerOptions, this.currentLevel + 1),
				this.currentLevel + 1,
			);
			return this;
		}
		...
		attList(
			...
			this.onData(
				this.writer.dtdAttList(node, this.writerOptions, this.currentLevel + 1),
				this.currentLevel + 1,
			);
			return this;
		}
		...
		entity(name, value) {
			...
			this.onData(
				this.writer.dtdEntity(node, this.writerOptions, this.currentLevel + 1),
				this.currentLevel + 1,
			);
			return this;
		}
			...
			if (!node.isClosed) {
				...
				if (node.type === NodeType.Element) {
					chunk =
						...
						node.name +
						">" +
						this.writer.endline(node, this.writerOptions, this.currentLevel); // if node.type is NodeType.DocType
				} else {
					chunk =
						this.writer.indent(node, this.writerOptions, this.currentLevel) +
						"]>" +
