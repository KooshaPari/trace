...
module.exports = (obj, ref, options) => {
	options = Object.assign({ prototype: true }, options);

	return !!internals.isDeepEqual(obj, ref, options, []);
};

internals.isDeepEqual = (obj, ref, options, seen) => {
	if (obj === ref) {
...
internals.getSharedType = (obj, ref, checkPrototype) => {
	if (checkPrototype) {
...
internals.hasOwnEnumerableProperty = (obj, key) =>
	Object.prototype.propertyIsEnumerable.call(obj, key);

internals.isSetSimpleEqual = (obj, ref) => {
...
internals.isDeepEqualObj = (instanceType, obj, ref, options, seen) => {
