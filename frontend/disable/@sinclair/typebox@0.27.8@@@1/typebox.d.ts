...
export type TCompositeProperties<I, T extends readonly any[]> = Evaluate<
...
> = Exclude<Static<T>, Static<U>> extends infer S
	...
	: never;
export type TExcludeArray<T extends TSchema[], U extends TSchema> = Assert<
	UnionToTuple<
		{
...
> = Extract<Static<T>, Static<U>> extends infer S
	...
	: never;
export type TExtractArray<T extends TSchema[], U extends TSchema> = Assert<
	UnionToTuple<
		{
			[K in keyof T]: Static<Assert<T[K], TSchema>> extends Static<U>
				? T[K]
...
export type ObjectPropertyKeys<T> =
	T extends TObject<infer U> ? keyof U : never;
...
export type TPickProperties<T extends TProperties, K extends keyof any> = Pick<
	T,
	Assert<Extract<K, keyof T>, keyof T>
> extends infer R
	? {
...
export type TTemplateLiteralKind =
	...
	| TBoolean
	| TNever;
export type TTemplateLiteralConst<T, Acc extends string> = T extends TUnion<
	infer U
>
	? {
