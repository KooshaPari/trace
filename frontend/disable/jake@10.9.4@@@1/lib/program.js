...
const usage = require("fs")
	.readFileSync(`${__dirname}/../usage.txt`)
	.toString();
...
const AVAILABLE_OPTS = [
	{ full: "jakefile", abbr: "f", expectValue: true },
	{ full: "quiet", abbr: "q", expectValue: false },
	{ full: "directory", abbr: "C", expectValue: true },
	{ full: "always-make", abbr: "B", expectValue: false },
	{ full: "tasks", abbr: "T", expectValue: false, allowValue: true },
	// Alias t
	{ full: "tasks", abbr: "t", expectValue: false, allowValue: true },
	// Alias ls
	{ full: "tasks", abbr: "ls", expectValue: false, allowValue: true },
	{ full: "help", abbr: "h" },
	{ full: "version", abbr: "V" },
	// Alias lowercase v
	{ full: "version", abbr: "v" },
	{ full: "jakelibdir", abbr: "J", expectValue: true },
	{ full: "allow-rejection", abbr: "ar", expectValue: false },
];
...
Program.prototype = new (function () {
	...
	this.parseArgs = function (args) {
		const result = new parseargs.Parser(this.availableOpts).parse(args);
	...
	this.run = function () {
		...
		if (opts.autocomplete) {
			return this.autocompletions(
				opts["autocomplete-cur"],
				opts["autocomplete-prev"],
			);
		}
		...
		rootTask = task(Task.ROOT_TASK_NAME, taskNames, () => {});
		rootTask._internal = true;

		rootTask.once("complete", () => {
			jake.emit("complete");
		});
		jake.emit("start");
		rootTask.invoke();
