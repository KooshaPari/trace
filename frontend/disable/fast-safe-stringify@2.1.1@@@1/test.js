...
test("circular getter reference to root", (assert) => {
	const fixture = {
...
test("child circular reference with toJSON", (assert) => {
	...
	TestObject.prototype.toJSON = () => ({ special: "case" });
...
test("circular getters are restored when stringified", (assert) => {
	const fixture = {
		name: "Tywin Lannister",
		get circle() {
			return fixture;
...
test("non-configurable circular getters use a replacer instead of markers", (assert) => {
	const fixture = { name: "Tywin Lannister" };
...
test("getter child circular reference are replaced instead of marked", (assert) => {
	const fixture = {
		name: "Tywin Lannister",
		child: {
			name: "Tyrion Lannister",
...
test("depthLimit option - will replace deep objects", (assert) => {
	const fixture = {
		name: "Tywin Lannister",
		child: {
			name: "Tyrion Lannister",
...
test("edgesLimit option - will replace deep objects", (assert) => {
	const fixture = {
		object: {
			1: { test: "test" },
			2: { test: "test" },
