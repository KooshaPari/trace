...
describe("configure-python", () => {
	it("configure PYTHONPATH with no existing env", (done) => {
	...
	it("configure PYTHONPATH with existing env of one dir", (done) => {
	...
	it("configure PYTHONPATH with existing env of multiple dirs", (done) => {
