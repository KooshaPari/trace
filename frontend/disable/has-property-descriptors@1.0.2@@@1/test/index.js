...
test("hasPropertyDescriptors", (t) => {
	t.equal(typeof hasPropertyDescriptors, "function", "is a function");
	t.equal(
		typeof hasPropertyDescriptors.hasArrayLengthDefineBug,
		"function",
		"`hasArrayLengthDefineBug` property is a function",
	);

	var yes = hasPropertyDescriptors();
	t.test("property descriptors", { skip: !yes }, (st) => {
		var o = { a: sentinel };
	...
	t.test("defining array lengths", { skip: !yes || arrayBug }, (st) => {
