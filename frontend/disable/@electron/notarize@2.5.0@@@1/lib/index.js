...
Object.defineProperty(exports, "validateAuthorizationArgs", {
	enumerable: true,
	get: () => validate_args_1.validateNotaryToolAuthorizationArgs,
});
function notarize(_a) {
	var { appPath } = _a,
		otherOptions = __rest(_a, ["appPath"]);
	return __awaiter(this, void 0, void 0, function* () {
		...
		yield (0, notarytool_1.notarizeAndWaitForNotaryTool)(
			Object.assign({ appPath }, otherOptions),
		);
		yield (0, promise_retry_1.default)(
			() => (0, staple_1.stapleApp)({ appPath }),
			{
				retries: 3,
			},
		);
