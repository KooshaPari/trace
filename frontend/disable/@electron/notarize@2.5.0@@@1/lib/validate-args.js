...
exports.validateNotaryToolAuthorizationArgs =
	exports.isNotaryToolKeychainCredentials =
	exports.isNotaryToolApiKeyCredentials =
	exports.isNotaryToolPasswordCredentials =
	exports.validateLegacyAuthorizationArgs =
	exports.isLegacyApiKeyCredentials =
	exports.isLegacyPasswordCredentials =
		void 0;
/** @deprecated */
...
function validateLegacyAuthorizationArgs(opts) {
	...
	if (isPassword && isApiKey) {
		throw new Error(
			"Cannot use both password credentials and API key credentials at once",
		);
	}
	if (isPassword) {
	...
	throw new Error(
		"No authentication properties provided (e.g. appleId, appleApiKey)",
	);
}
...
function isNotaryToolPasswordCredentials(opts) {
	const creds = opts;
	return (
		creds.appleId !== undefined ||
		creds.appleIdPassword !== undefined ||
		creds.teamId !== undefined
	);
}
...
function validateNotaryToolAuthorizationArgs(opts) {
	...
	throw new Error(
		"No authentication properties provided (e.g. appleId, appleApiKey, keychain)",
	);
}
exports.validateNotaryToolAuthorizationArgs =
