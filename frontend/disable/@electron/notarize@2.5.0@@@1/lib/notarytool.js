...
function authorizationArgs(rawOpts) {
	const opts = (0, validate_args_1.validateNotaryToolAuthorizationArgs)(
		rawOpts,
	);
...
function getNotarizationLogs(opts, id) {
	return __awaiter(this, void 0, void 0, function* () {
		try {
			const logResult = yield runNotaryTool(
...
function notarizeAndWaitForNotaryTool(opts) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		return yield (0, helpers_1.withTempDir)((dir) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				if (fileExt === ".dmg" || fileExt === ".pkg") {
					...
					const zipResult = yield (0, spawn_1.spawn)(
						"ditto",
						[
							"-c",
							"-k",
