...
export type FilesystemFilesAndLinks<
	T extends BasicFilesArray | BasicStreamArray,
> = {
	files: T;
	links: T;
};
export declare function writeFilesystem(
	dest: string,
	filesystem: Filesystem,
	lists: FilesystemFilesAndLinks<BasicFilesArray>,
	metadata: InputMetadata,
): Promise<NodeJS.WritableStream>;
export declare function streamFilesystem(
	dest: string,
	filesystem: Filesystem,
...
export declare function readArchiveHeaderSync(
	archivePath: string,
): ArchiveHeader;
