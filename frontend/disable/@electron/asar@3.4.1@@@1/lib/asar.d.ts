...
export declare function createPackageWithOptions(
	src: string,
	dest: string,
 ...
 */
export declare function createPackageFromFiles(
	src: string,
	dest: string,
	filenames: string[],
 ...
 */
export declare function createPackageFromStreams(
	dest: string,
	streams: AsarStreamType[],
): Promise<import("fs").WriteStream>;
export declare function statFile(
	archivePath: string,
	filename: string,
	followLinks?: boolean,
): FilesystemEntry;
...
export declare function listPackage(
	archivePath: string,
	options: ListOptions,
): string[];
