(() => {
	...
	var W = Object.defineProperty,
		...
		S = function G(H, J, X) {
			...
			if (X !== null && X !== void 0 && X.addSuffix)
				if (X.comparison && X.comparison > 0) return Y + " n\u1EEFa";
				else return Y + " tr\u01B0\u1EDBc";
			return Y;
		};
	function K(G) {
	...
	var _ = {
		...
		c = function G(H, J) {
			var X = Number(H),
				Y = J === null || J === void 0 ? void 0 : J.unit;
			if (Y === "quarter")
				switch (X) {
					case 1:
						return "I";
