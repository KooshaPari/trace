(() => {
	...
	function Q(G) {
		return function (H) {
			...
			var B = Z[0],
				...
				A = Array.isArray(C) ? k(C, (E) => E.test(B)) : P(C, (E) => E.test(B)),
				T;
			(T = G.valueCallback ? G.valueCallback(A) : A),
	...
	var r = {
		...
		t = {
			date: $({ formats: r, defaultWidth: "full" }),
			time: $({ formats: a, defaultWidth: "full" }),
			dateTime: $({ formats: e, defaultWidth: "full" }),
		},
		GG = {
			code: "en-IN",
			formatDistance: S,
