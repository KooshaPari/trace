(() => {
	...
	var z = Object.defineProperty,
		...
		S = function C(G, H, J) {
			...
			if (J !== null && J !== void 0 && J.addSuffix)
				if (J.comparison && J.comparison > 0) return X + " dan keyin";
				else return X + " oldin";
			return X;
		};
	function A(C) {
	...
	var M = {
		...
		V = {
			...
			dateTime: A({ formats: L, defaultWidth: "any" }),
		},
		j = {
	...
	function Q(C) {
		return function (G) {
			...
			var Z = Y[0],
				...
				B = Array.isArray(T) ? c(T, (E) => E.test(Z)) : m(T, (E) => E.test(Z)),
				U;
			(U = C.valueCallback ? C.valueCallback(B) : B),
