(() => {
	...
	function O(B) {
		return function (G) {
			...
			var Z = Y[0],
				...
				q = Array.isArray(C) ? f(C, (A) => A.test(Z)) : F(C, (A) => A.test(Z)),
				U;
	...
	var P = /^(\d+)(\.)?/i,
		...
		p = { any: [/^so/i, /^mo/i, /^di/i, /^mi/i, /^do/i, /^f/i, /^sa/i] },
		u = {
			narrow:
	...
	var n = {
		...
		BB = {
			ordinalNumber: t,
			era: Q({ values: n, defaultWidth: "wide" }),
			quarter: Q({
				values: s,
				defaultWidth: "wide",
			...
			month: Q({ values: x, formattingValues: o, defaultWidth: "wide" }),
			day: Q({ values: r, defaultWidth: "wide" }),
			dayPeriod: Q({
				values: a,
				defaultWidth: "wide",
				formattingValues: e,
