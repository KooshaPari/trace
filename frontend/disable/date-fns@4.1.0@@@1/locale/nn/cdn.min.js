(() => {
	...
	var W = Object.defineProperty,
		...
		M = function G(H, J, X) {
			...
			else Y = Z.other.replace("{{count}}", J < 13 ? S[J] : String(J));
	...
	var R = {
		...
		j = {
			...
			time: A({ formats: V, defaultWidth: "full" }),
	...
	function O(G) {
		return function (H) {
			...
			var B = Z[0],
				...
				q = Array.isArray(C) ? y(C, (K) => K.test(B)) : m(C, (K) => K.test(B)),
				T;
	...
	var d = /^(\d+)\.?/i,
		...
		r = { any: [/^s/i, /^m/i, /^ty/i, /^o/i, /^to/i, /^f/i, /^l/i] },
		a = {
			narrow:
