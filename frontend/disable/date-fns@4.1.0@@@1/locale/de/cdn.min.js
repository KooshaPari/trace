(() => {
	...
	var D = Object.defineProperty,
		...
		M = function B(C, G, H) {
			...
			if (H !== null && H !== void 0 && H.addSuffix)
				if (H.comparison && H.comparison > 0) return "in " + J;
				else return "vor " + J;
			return J;
		};
	function K(B) {
	...
	var R = {
		...
		j = {
			...
			time: K({ formats: L, defaultWidth: "full" }),
	...
	var f = {
		...
		m = {
			ordinalNumber: h,
			era: I({ values: f, defaultWidth: "wide" }),
			quarter: I({
				values: F,
				defaultWidth: "wide",
			...
			month: I({ values: x, formattingValues: v, defaultWidth: "wide" }),
	...
	var g = /^(\d+)(\.)?/i,
		...
		a = { any: [/^so/i, /^mo/i, /^di/i, /^mi/i, /^do/i, /^f/i, /^sa/i] },
		e = {
			narrow:
