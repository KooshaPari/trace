(() => {
	...
	function _addMonths(date, amount, options) {
		...
		var endOfDesiredMonth = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			_date.getTime(),
		);
	...
	function _add(date, duration, options) {
		...
		var dateWithMonths =
			months || years ? _addMonths(_date, months + years * 12) : _date;
		var dateWithDays =
			days || weeks
				? _addDays(dateWithMonths, days + weeks * 7)
				: dateWithMonths;
	...
	// lib/startOfWeek.js
	function _startOfWeek(date, options) {
		var _ref,
			_ref2,
			_ref3,
	...
	function normalizeDates(context) {
		for (
			var _len = arguments.length,
				dates = new Array(_len > 1 ? _len - 1 : 0),
				_key = 1;
			_key < _len;
			_key++
		) {
		...
		var normalize = _constructFrom.bind(
			null,
	...
	function _startOfISOWeekYear(date, options) {
		...
		var fourthOfJanuary = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			0,
		);
	...
	function _setISOWeekYear(date, weekYear, options) {
		...
		var diff = _differenceInCalendarDays(
			_date,
			_startOfISOWeekYear(_date, options),
		);
		var fourthOfJanuary = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			0,
	...
	function _addISOWeekYears(date, amount, options) {
		return _setISOWeekYear(
			date,
			_getISOWeekYear(date, options) + amount,
			options,
		);
	}
	// lib/addMinutes.js
	...
	function _isValid(date) {
		return !(
			(!_isDate(date) && typeof date !== "number") ||
			isNaN(+_toDate(date))
		);
	}
	...
	function _differenceInCalendarISOWeekYears(laterDate, earlierDate, options) {
		...
		return (
			_getISOWeekYear(laterDate_, options) -
			_getISOWeekYear(earlierDate_, options)
		);
	}
	...
	function _differenceInDays(laterDate, earlierDate, options) {
		...
		var difference = Math.abs(
			_differenceInCalendarDays(laterDate_, earlierDate_),
		);
	...
	function _differenceInISOWeekYears(laterDate, earlierDate, options) {
		...
		var diff = Math.abs(
			_differenceInCalendarISOWeekYears(laterDate_, earlierDate_, options),
		);
		var adjustedDate = _subISOWeekYears(laterDate_, sign * diff, options);
		var isLastISOWeekYearNotFull = Number(
			_compareAsc(adjustedDate, earlierDate_) === -sign,
		);
	...
	function _differenceInMinutes(dateLeft, dateRight, options) {
		var diff =
			_differenceInMilliseconds(dateLeft, dateRight) / millisecondsInMinute;
		return getRoundingMethod(
			options === null || options === void 0 ? void 0 : options.roundingMethod,
		)(diff);
	}
	...
	function _differenceInMonths(laterDate, earlierDate, options) {
		...
		var difference = Math.abs(
			_differenceInCalendarMonths(workingLaterDate, earlierDate_),
		);
		...
		var isLastMonthNotFull =
			_compareAsc(workingLaterDate, earlierDate_) === -sign;
		if (
			_isLastDayOfMonth(laterDate_) &&
			difference === 1 &&
			_compareAsc(laterDate_, earlierDate_) === 1
		) {
	...
	function _eachDayOfInterval(interval, options) {
		var _options$step;
	...
	function _eachHourOfInterval(interval, options) {
		var _options$step2;
	...
	function _eachMinuteOfInterval(interval, options) {
		var _options$step3;
	...
	function _eachMonthOfInterval(interval, options) {
		var _options$step4;
	...
	function _eachQuarterOfInterval(interval, options) {
		var _options$step5;
	...
	function _eachWeekOfInterval(interval, options) {
		var _options$step6;
		...
		var startDateWeek = reversed
			? _startOfWeek(end, options)
			: _startOfWeek(start, options);
	...
	function _eachYearOfInterval(interval, options) {
		var _options$step7;
	...
	// lib/endOfWeek.js
	function _endOfWeek(date, options) {
		var _ref4,
			_ref5,
			_ref6,
	...
	function _endOfISOWeekYear(date, options) {
		var year = _getISOWeekYear(date, options);
		var fourthOfJanuaryOfNextYear = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			0,
		);
		fourthOfJanuaryOfNextYear.setFullYear(year + 1, 0, 4);
	...
	function _endOfTomorrow(options) {
		var now = _constructNow(
			options === null || options === void 0 ? void 0 : options.in,
		);
		var year = now.getFullYear();
		var month = now.getMonth();
		var day = now.getDate();
		var date = _constructNow(
			options === null || options === void 0 ? void 0 : options.in,
		);
		date.setFullYear(year, month, day + 1);
		date.setHours(23, 59, 59, 999);
		return options !== null && options !== void 0 && options.in
			? options.in(date)
			: date;
	}
	...
	// lib/getWeekYear.js
	function _getWeekYear(date, options) {
		var _ref7,
			_ref8,
			_ref9,
		...
		var firstWeekContainsDate =
			...
			_ref7 !== void 0
				? _ref7
				: 1;
		var firstWeekOfNextYear = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			0,
		);
		...
		var firstWeekOfThisYear = _constructFrom(
			(options === null || options === void 0 ? void 0 : options.in) || date,
			0,
		);
	...
	function _startOfWeekYear(date, options) {
		var _ref10,
			_ref11,
			_ref12,
	...
	function _getWeek(date, options) {
		...
		var diff =
			+_startOfWeek(_date, options) - +_startOfWeekYear(_date, options);
		return Math.round(diff / millisecondsInWeek) + 1;
	}
	...
	function _formatDistanceStrict(laterDate, earlierDate, options) {
	...
	function _formatDuration(duration, options) {
		var _ref22,
			_options$locale10,
			_options$format,
			_options$zero,
	...
	// lib/formatISO.js
	function _formatISO2(date, options) {
	...
	function _formatISO(date, options) {
	...
	function _formatRFC2(date, options) {
	...
	function formatRelative3(date, baseDate, options) {
		...
		return _format(date_, formatStr, {
			locale: locale,
			weekStartsOn: weekStartsOn,
		});
	}
	...
	function _getWeekOfMonth(date, options) {
		var _ref27,
			_ref28,
			_ref29,
			_options$weekStartsOn5,
			_options$locale13,
			_defaultOptions13$loc;
			...
			(_ref27 =
				(_ref28 =
					(_ref29 =
						...
						? _ref29
						: defaultOptions13.weekStartsOn) !== null && _ref28 !== void 0
					? _ref28
					: (_defaultOptions13$loc = defaultOptions13.locale) === null ||
							_defaultOptions13$loc === void 0 ||
							(_defaultOptions13$loc = _defaultOptions13$loc.options) ===
								null ||
							_defaultOptions13$loc === void 0
						? void 0
						: _defaultOptions13$loc.weekStartsOn) !== null && _ref27 !== void 0
				? _ref27
				: 0;
		var currentDayOfMonth = _getDate(
			_toDate(
				date,
				options === null || options === void 0 ? void 0 : options.in,
			),
	...
	function _getWeeksInMonth(date, options) {
		var contextDate = _toDate(
			date,
			options === null || options === void 0 ? void 0 : options.in,
		);
		return (
			_differenceInCalendarWeeks(
				_lastDayOfMonth(contextDate, options),
				_startOfMonth(contextDate, options),
				options,
			) + 1
		);
	}
	...
	function _intervalToDuration(interval2, options) {
		...
		var remainingSeconds = _add(remainingMinutes, {
	...
	// lib/intlFormat.js
	function _intlFormat(date, formatOrLocale, localeOptions) {
		var _localeOptions;
		var formatOptions;
	...
	function _intlFormatDistance(laterDate, earlierDate, options) {
		...
		if (!(options !== null && options !== void 0 && options.unit)) {
			...
			if (Math.abs(diffInSeconds) < secondsInMinute) {
				...
				Math.abs(_differenceInCalendarDays(laterDate_, earlierDate_)) < 1
			) {
	...
	var DateTimezoneSetter = /*#__PURE__*/ ((_Setter3) => {
		...
		function DateTimezoneSetter(context, reference) {
			...
			_this2.context = context || ((date) => _constructFrom(reference, date));
			return _this2;
		}
		...
		_createClass(LocalWeekYearParser, [
			...
			},
			{
				...
				value: function set(date, flags, value, options) {
					var currentYear = _getWeekYear(date, options);
					if (value.isTwoDigitYear) {
						var normalizedTwoDigitYear = normalizeTwoDigitYear(
							value.year,
							currentYear,
		...
		_createClass(ISOWeekYearParser, [
			...
			},
			{
				...
				value: function set(date, _flags, value) {
					var firstWeekOfYear = _constructFrom(date, 0);
					firstWeekOfYear.setFullYear(value, 0, 4);
					firstWeekOfYear.setHours(0, 0, 0, 0);
					return _startOfISOWeek(firstWeekOfYear);
				},
			},
		]);
		...
		_createClass(LocalWeekParser, [
			...
			},
			{
				...
				value: function set(date, _flags, value, options) {
					return _startOfWeek(_setWeek(date, value, options), options);
				},
			},
		]);
	...
	var ISOWeekParser = /*#__PURE__*/ ((_Parser11) => {
		...
		_createClass(ISOWeekParser, [
			...
			},
			{
				key: "set",
				value: function set(date, _flags, value) {
					return _startOfISOWeek(_setISOWeek(date, value));
				},
			},
		]);
	...
	// lib/setDay.js
	function _setDay(date, day, options) {
		var _ref30,
			_ref31,
			_ref32,
	...
	var TimestampSecondsParser = /*#__PURE__*/ ((_Parser30) => {
		...
		_createClass(TimestampSecondsParser, [
			...
			},
			{
				key: "set",
				value: function set(date, _flags, value) {
					return [_constructFrom(date, value * 1000), { timestampIsSet: true }];
				},
			},
		]);
	...
	var TimestampMillisecondsParser = /*#__PURE__*/ ((_Parser31) => {
		...
		_createClass(TimestampMillisecondsParser, [
			...
			},
			{
				key: "set",
				value: function set(date, _flags, value) {
					return [_constructFrom(date, value), { timestampIsSet: true }];
				},
			},
		]);
	...
	// lib/parse.js
	function _parse(dateStr, formatStr, referenceDate, options) {
		var _ref33,
			_options$locale15,
			_ref34,
			_ref35,
	...
	function _isSameWeek(laterDate, earlierDate, options) {
		...
		return (
			+_startOfWeek(laterDate_, options) ===
			+_startOfWeek(earlierDate_, options)
		);
	}
	...
	function _isSameISOWeekYear(laterDate, earlierDate, options) {
		...
		return (
			+_startOfISOWeekYear(laterDate_) === +_startOfISOWeekYear(earlierDate_)
		);
	}
	...
	function _lastDayOfWeek(date, options) {
		var _ref40,
			_ref41,
			_ref42,
	...
	// lib/parseISO.js
	function _parseISO(argument, options) {
	...
	function _roundToNearestHours(date, options) {
	...
	function _roundToNearestMinutes(date, options) {
	...
	function setDefaultOptions2(options) {
		...
		for (var property in defaultOptions16) {
			if (Object.hasOwn(defaultOptions16, property)) {
				result[property] = defaultOptions16[property];
			}
		}
		for (var _property in options) {
			if (Object.hasOwn(options, _property)) {
	...
	// lib/setWeekYear.js
	function _setWeekYear(date, weekYear, options) {
		var _ref44,
			_ref45,
			_ref46,
			_options$firstWeekCon5,
			_options$locale19,
			_defaultOptions17$loc;
		...
		var firstWeekContainsDate =
			(_ref44 =
				(_ref45 =
					...
					_ref46 !== void 0
						? _ref46
						: defaultOptions17.firstWeekContainsDate) !== null &&
				_ref45 !== void 0
					? _ref45
					: (_defaultOptions17$loc = defaultOptions17.locale) === null ||
							_defaultOptions17$loc === void 0 ||
							(_defaultOptions17$loc = _defaultOptions17$loc.options) ===
								null ||
							_defaultOptions17$loc === void 0
						? void 0
						: _defaultOptions17$loc.firstWeekContainsDate) !== null &&
			_ref44 !== void 0
				? _ref44
				: 1;
		var diff = _differenceInCalendarDays(
