...
const getSimilarity = (type, n1, n2, attributes) => {
...
const getPreference = (S, preference) => {
...
const assignClusters = (n, S, exemplars) => {
	const clusters = [];
