...
/*  deliver an action  */
var deliver = (curr, state, name, value) => {
...
var execute_handlers = (curr, name, value) => {
...
var resolver = (cb, next, method) => (value) => {
