...
CRp.safeDrawImage = (context, img, ix, iy, iw, ih, x, y, w, h) => {
...
CRp.drawInscribedImage = function (context, img, node, index, nodeOpacity) {
	...
	var smoothingEnabled = this.getImgSmoothing(context);
	...
	if (repeat === "no-repeat") {
		...
		this.safeDrawImage(context, img, 0, 0, imgW, imgH, x, y, w, h);
	...
	if (isSmoothingSwitched) {
		this.setImgSmoothing(context, smoothingEnabled);
	}
};
