...
BRp.registerArrowShapes = function () {
	...
	var bbCollide = (x, y, size, angle, translation, edgeWidth, padding) => {
	...
	var transform = (x, y, size, angle, translation) => {
	...
	var transformPoints = (pts, size, angle, translation) => {
		var retPts = [];
	...
	defineArrowShape("vee", {
		...
		gap: (edge) => standardGap(edge) * 0.525,
	});
