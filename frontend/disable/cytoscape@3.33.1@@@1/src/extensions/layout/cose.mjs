...
CoseLayout.prototype.run = function () {
	...
	if (options.animate === true || options.animate === false) {
		this.emit({ type: "layoutstart", layout: this });
	}
	...
	var layoutInfo = createLayoutInfo(cy, this, options);
 ...
 */
var createLayoutInfo = (cy, layout, options) => {
	// Shortcut
 ...
 *
 */
var findLCA = (node1, node2, layoutInfo) => {
 ...
 *                   all X nodes
 */
var findLCA_aux = (node1, node2, graphIx, layoutInfo) => {
...
if (process.env.NODE_ENV !== "production") {
	var printLayoutInfo = (layoutInfo) => {
		/* eslint-disable */
 ...
 */
var randomizePositions = (layoutInfo, cy) => {
...
var getScaleInBoundsFn = (layoutInfo, options, nodes) => {
 ...
 * @arg options    : Layout options
 */
var step = (layoutInfo, options, step) => {
	// var s = "\n\n###############################";
	// s += "\nSTEP: " + step;
	// s += "\n###############################\n";
	// logDebug(s);
 ...
 */
var calculateNodeForces = (layoutInfo, options) => {
...
var randomDistance = (max) => -max + 2 * max * Math.random();

/**
 * @brief : Compute the node repulsion forces between a pair of nodes
 */
var nodeRepulsion = (node1, node2, layoutInfo, options) => {
 ...
 */
var nodesOverlap = (node1, node2, dX, dY) => {
	if (dX > 0) {
 ...
 */
var findClippingPoint = (node, dX, dY) => {
	// Shorcuts
 ...
 */
var calculateEdgeForces = (layoutInfo, options) => {
	...
	for (var i = 0; i < layoutInfo.edgeSize; i++) {
		...
		var force = (edge.idealLength - l) ** 2 / edge.elasticity;
 ...
 */
var calculateGravityForces = (layoutInfo, options) => {
 ...
 * @arg options    : Layout options
 */
var propagateForces = (layoutInfo, options) => {
	// Inline implementation of a queue, used for traversing the graph in BFS order
	var queue = [];
	var start = 0; // Points to the start the queue
	var end = -1; // Points to the end of the queue
 ...
 */
var updatePositions = (layoutInfo, options) => {
 ...
 *          greater (in modulo) than max.
  ...
  */
var limitForce = (forceX, forceY, max) => {
 ...
 */
var updateAncestryBoundaries = (node, layoutInfo) => {
...
var separateComponents = (layoutInfo, options) => {
