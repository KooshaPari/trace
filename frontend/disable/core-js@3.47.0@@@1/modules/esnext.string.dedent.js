...
var dedentTemplateStringsArray = (template) => {
...
var dedentStringsArray = (template) => {
...
var commonLeadingIndentation = (a, b) => {
...
var makeDedentTag = (tag) =>
	makeBuiltIn(function (template /* , ...substitutions */) {
