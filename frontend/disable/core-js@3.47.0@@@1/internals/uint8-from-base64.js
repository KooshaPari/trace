...
var skipAsciiWhitespace = (string, index) => {
...
var decodeBase64Chunk = (chunk, alphabet, throwOnExtraBits) => {
...
var writeBytes = (bytes, elements, written) => {
...
module.exports = (string, options, into, maxLength) => {
	aString(string);
