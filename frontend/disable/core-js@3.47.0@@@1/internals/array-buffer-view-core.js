...
var getTypedArrayConstructor = (it) => {
...
var aTypedArrayConstructor = (C) => {
	if (isCallable(C) && (!setPrototypeOf || isPrototypeOf(TypedArray, C)))
		return C;
	throw new TypeError(tryToString(C) + " is not a typed array constructor");
};

var exportTypedArrayMethod = (KEY, property, forced, options) => {
...
var exportTypedArrayStaticMethod = (KEY, property, forced) => {
