...
### 1. `.oxlintrc.json.ai-strict` (RECOMMENDED FOR AI)
...
### 2. `.oxlintrc.json.strict` (MODERATE STRICTNESS)
...
| `.oxlintrc.json.ai-strict` | Recommended strict configuration |
| `.oxlintrc.json.strict` | Moderate strict configuration |
...
### Step 1: Apply AI-Strict Configuration
