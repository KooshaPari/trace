 ...
 */
export type EntityExpansionState =
	| "collapsed"
	| "preview"
	| "panel"
	| "full_page";
 ...
 */
export const NODE_DISPLAY_CONFIGS: Record<
...
export function isProductEntityType(
	type: EntityType,
): type is ProductEntityType {
	return [
		"initiative",
		"epic",
		"feature",
...
export function isTechnicalEntityType(
	type: EntityType,
): type is TechnicalEntityType {
	return [
		"service",
		"module",
		"class",
