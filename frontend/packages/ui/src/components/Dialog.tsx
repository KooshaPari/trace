...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className='absolute top-4 right-4 rounded-sm opacity-70 transition-all duration-200 ease-out hover:scale-105 hover:opacity-100 active:scale-95'>
        <X className='h-4 w-4' />
