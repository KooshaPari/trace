...
def _link_to_dict(link: Link, include_items: bool = False) -> dict[str, Any]:
...
def _resolve_item_id(session, project_id: str, item_ref: str) -> str | None:
...
async def create_link(
    ...
    with get_session() as session:
        ...
        return wrap_success(_link_to_dict(link), "create", ctx)
