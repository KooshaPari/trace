...
def wrap_success(data: Any, action: str, ctx: Any | None = None) -> dict[str, Any]:
...
def wrap_error(error: str, action: str, ctx: Any | None = None) -> dict[str, Any]:
...
async def cached_query(
    ...
    **cache_key_args: Any,
    ...
    Args:
        ...
        **cache_key_args: Any: Additional arguments for cache key generation
