...
async def authenticate_websocket(websocket: WebSocket, verify_token_func) -> dict[str, Any] | None:
...
async def websocket_endpoint(websocket: WebSocket, verify_token_func) -> None:
