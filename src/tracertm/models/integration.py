...
class IntegrationMapping(Base, TimestampMixin):
    ...
    # Mapping metadata
    mapping_metadata: Mapped[dict] = mapped_column(JSONType, default=dict, nullable=False)
    ...
    field_resolution_rules: Mapped[dict] = mapped_column(JSONType, default=dict, nullable=False)
