...
class TestCase(Base, TimestampMixin):
    ...
    test_steps: Mapped[list[dict[str, Any]] | None] = mapped_column(JSONType, nullable=True)
    # Format: [{"step_number": 1, "action": "...", "expected_result": "...", "test_data": "..."}]
    expected_result: Mapped[str | None] = mapped_column(Text, nullable=True)
    postconditions: Mapped[str | None] = mapped_column(Text, nullable=True)
    test_data: Mapped[dict[str, Any] | None] = mapped_column(JSONType, nullable=True)
