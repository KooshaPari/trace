...
class ExecutionEnvironmentConfig(Base, TimestampMixin):
    ...
    resource_limits: Mapped[dict[str, Any] | None] = mapped_column(JSONType, nullable=True)  # CPU, memory limits
    ...
    playwright_video_size: Mapped[dict[str, Any] | None] = mapped_column(JSONType, nullable=True)
