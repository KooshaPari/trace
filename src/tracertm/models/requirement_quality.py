...
class RequirementQuality(Base, TimestampMixin):
    ...
    quality_issues: Mapped[list[dict[str, Any]]] = mapped_column(JSONType, nullable=False, default=list)
    ...
    impact_assessment: Mapped[dict[str, Any]] = mapped_column(JSONType, nullable=False, default=dict)

    # Volatility Tracking
    change_count: Mapped[int] = mapped_column(Integer, default=0)
    volatility_index: Mapped[float] = mapped_column(Float, default=0.0)
    change_history: Mapped[list[dict[str, Any]]] = mapped_column(JSONType, nullable=False, default=list)
    ...
    verification_evidence: Mapped[list[dict[str, Any]]] = mapped_column(JSONType, nullable=False, default=list)
