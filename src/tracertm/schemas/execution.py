...
class ExecutionCreate(BaseModel):
    ...
    config: dict[str, Any] | None = Field(None, description="Execution configuration")
...
class ExecutionArtifactCreate(BaseModel):
    ...
    metadata: dict[str, Any] | None = Field(None, description="Dimensions, duration, etc.")
...
class CodexAgentTaskCreate(BaseModel):
    ...
    input_data: dict[str, Any] | None = Field(None, description="Additional input")
...
class ExecutionEnvironmentConfigCreate(BaseModel):
    ...
    resource_limits: dict[str, Any] | None = Field(None, description="CPU, memory limits")
    ...
    playwright_video_size: dict[str, Any] | None = None
...
class ExecutionEnvironmentConfigResponse(BaseModel):
    ...
    playwright_video_size: dict[str, Any] | None
