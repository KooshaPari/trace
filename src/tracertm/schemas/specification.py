...
class ScenarioCreate(BaseModel):
    ...
    given_steps: list[dict[str, Any]] = Field(default_factory=list)
    when_steps: list[dict[str, Any]] = Field(default_factory=list)
    then_steps: list[dict[str, Any]] = Field(default_factory=list)
...
class ScenarioResponse(BaseModel):
    ...
    given_steps: list[dict[str, Any]]
    when_steps: list[dict[str, Any]]
