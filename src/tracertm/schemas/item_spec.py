...
class TestSpecCreate(BaseModel):
    ...
    test_data_schema: dict[str, Any] = Field(default_factory=dict)
    fixtures: list[str] = Field(default_factory=list)
    parameterized_cases: list[dict[str, Any]] = Field(default_factory=list)
...
class TestSpecUpdate(BaseModel):
    ...
    test_data_schema: dict[str, Any] | None = None
    fixtures: list[str] | None = None
    parameterized_cases: list[dict[str, Any]] | None = None
...
class TestSpecResponse(BaseModel):
    ...
    test_data_schema: dict[str, Any]
    fixtures: list[str]
    parameterized_cases: list[dict[str, Any]]
